...
const externalResourceLockMessage = "This resource is locked by an external session. New sessions and Self-Driving are unavailable until the lock is released."
