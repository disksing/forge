...
func TestTemplateHTTPListRenderPreviewAndCreate(t *testing.T) {
	...
	request := map[string]any{"project": "project1", "templateName": "api", "templateFields": map[string]any{"summary": "Created"}, "autorun": false}
	...
	if preview.Template == nil || preview.AutoRun != nil || preview.Title != "Created" {
