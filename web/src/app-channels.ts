...
export function createForgeAppChannels(): ForgeAppChannels {
  return {
    ...
    detail: createModelChannel<DetailPanelModel>({ identity: "", workspaceId: "", workspaceName: "", resourceId: "", resourceType: "", resourceTitle: "", creator: undefined, parent: null, loading: false, detail: null, wiki: null, workspaceAgents: null, agentBinding: { kind: "profile", name: "default" }, agentProfiles: [], agents: [], onNavigate: noop, onCreateTask: noop, onArchive: noop, onSaveWorkspaceAgents: async () => ({ path: "AGENTS.md" }), onSaveAgentBinding: noopAsync, onToast: noop, onIconsChanged: noop }),
