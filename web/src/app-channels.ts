...
export function createPUAAppChannels(): PUAAppChannels {
  return {
    appShell: createModelChannel<AppShellModel>({
      identity: "", loading: true, error: "", version: "v0.1.0", activeWorkspaceId: "", workspaceName: "", workspaces: [], projects: [], treeEditing: false, activity: { running: [], favorites: [], unread: [], problems: [] },
      ...
      onReorder: noopAsync, onDragState: noop, onToggleTreeEditing: noop, onCreateFolder: async () => "", onRenameFolder: noopAsync, onDeleteFolder: noopAsync, onToggleFolder: noopAsync, onToggleFavorite: noopAsync, onPanePreview: noop, onPaneCommit: noop, onPaneViewport: noop, onMobileSidebar: noop, onMobileView: noop,
    ...
    detail: createModelChannel<DetailPanelModel>({ identity: "", workspaceId: "", workspaceName: "", resourceId: "", resourceType: "", resourceTitle: "", parent: null, loading: false, detail: null, wiki: null, workspaceAgents: null, workspaceDefaults: { project: { kind: "profile", name: "default" }, task: { kind: "profile", name: "default" } }, workspaceUsers: [], currentUserName: "User", generationPolicy: { enabled: true, maxTurns: 20, maxAccumulatedTurnMinutes: 120 }, agentBinding: { kind: "profile", name: "default" }, agentProfiles: [], agents: [], resolveResourceTitle: () => null, onNavigate: noop, onCreateTask: noop, onArchive: noop, onSaveWorkspaceAgents: async () => ({ path: "AGENTS.md" }), onSaveMarkdownFile: async (path) => ({ path }), onDeleteArtifact: noopAsync, onSaveAgentBinding: noopAsync, onRenameResource: noopAsync, onSaveDescription: noopAsync, onSaveWorkspaceDefaults: noopAsync, onSaveWorkspaceUserPreference: noopAsync, onDeleteWorkspaceUser: noopAsync, onSaveGenerationPolicy: noopAsync, onSaveTaskDefault: noopAsync, onToast: noop }),
    timeline: createModelChannel<EventTimelineModel>({ identity: "", workspaceId: "", resourceId: "", status: null, agentName: "Agent", resolveResourceTitle: () => null, onNavigate: noop, project: () => [], onEvent: noop, onNotice: noop, onApproval: noopAsync, onToast: noop }),
