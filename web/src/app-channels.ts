...
export function createForgeAppChannels(): ForgeAppChannels {
  return {
    ...
    settings: createModelChannel<SettingsModel>({
      ...
      agentHub: { configuredEndpoint: "", connected: false, compatible: false, error: "", apiVersion: "", version: "", capabilities: [], providers: [], agents: [], resourceDefaults: { workspace: { kind: "profile", name: "default" }, project: { kind: "profile", name: "default" }, task: { kind: "profile", name: "default" } } }, profiles: [], agents: [],
	...
	composer: createModelChannel<ComposerModel>({ identity: "", workspaceId: "", resourceId: "", draft: "", draftKey: "", draftResetVersion: 0, unavailableReason: "Loading work status.", sending: false, canEndTurn: false, endingTurn: false, stopNotice: "", waitingMessages: [], canSteerWaiting: false, steeringMessageId: "", agentBinding: { kind: "profile", name: "default" }, agentProfiles: [], agents: [], bindingSaving: false, onDraft: noop, onSend: async () => ({ accepted: false, clear: false }), onOpenUpload: noop, onEndTurn: noop, onDismissStopNotice: noop, onSteerWaiting: noopAsync, onSaveAgentBinding: noopAsync, onIconsChanged: noop }),
    detail: createModelChannel<DetailPanelModel>({ identity: "", workspaceId: "", workspaceName: "", resourceId: "", resourceType: "", resourceTitle: "", parent: null, loading: false, detail: null, wiki: null, workspaceAgents: null, agentBinding: { kind: "profile", name: "default" }, agentProfiles: [], agents: [], resolveResourceTitle: () => null, onNavigate: noop, onCreateTask: noop, onArchive: noop, onSaveWorkspaceAgents: async () => ({ path: "AGENTS.md" }), onSaveMarkdownFile: async (path) => ({ path }), onSaveAgentBinding: noopAsync, onToast: noop, onIconsChanged: noop }),
