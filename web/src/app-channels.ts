...
export function createPUAAppChannels(): PUAAppChannels {
  return {
    ...
    detail: createModelChannel<DetailPanelModel>({ identity: "", workspaceId: "", workspaceName: "", resourceId: "", resourceType: "", resourceTitle: "", parent: null, loading: false, detail: null, wiki: null, workspaceAgents: null, workspaceDefaults: { project: { kind: "profile", name: "default" }, task: { kind: "profile", name: "default" } }, generationPolicy: { enabled: true, maxTurns: 20, maxAccumulatedTurnMinutes: 120 }, agentBinding: { kind: "profile", name: "default" }, agentProfiles: [], agents: [], resolveResourceTitle: () => null, onNavigate: noop, onCreateTask: noop, onArchive: noop, onSaveWorkspaceAgents: async () => ({ path: "AGENTS.md" }), onSaveMarkdownFile: async (path) => ({ path }), onDeleteArtifact: noopAsync, onSaveAgentBinding: noopAsync, onRenameResource: noopAsync, onSaveDescription: noopAsync, onSaveWorkspaceDefaults: noopAsync, onSaveGenerationPolicy: noopAsync, onSaveTaskDefault: noopAsync, onToast: noop, onIconsChanged: noop }),
