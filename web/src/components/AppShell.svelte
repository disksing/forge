...
<aside id="mobileSidebar" class="sidebar">
  ...
  <ActivityPanel activity={model.activity} inbox={model.inbox} onSelect={model.onSelectResource} onToggleFavorite={model.onToggleFavorite} onOpenInboxMessage={model.onOpenInboxMessage} onReplyInboxMessage={model.onReplyInboxMessage} onToast={model.onToast} />
</aside>
