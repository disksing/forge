...
<aside id="mobileSidebar" class="sidebar">
  ...
  <GlobalSessionList identity={model.identity} mobileSidebarOpen={model.mobile.sidebarOpen} sessions={model.sessions} onSelect={model.onSelectResource} onReorder={model.onReorder} onDragState={model.onDragState} onToast={model.onToast} />
</aside>
