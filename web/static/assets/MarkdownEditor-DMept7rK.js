...
(() => {
	...
	for (let t = 0, n = 0; t < e.length; t++) (t % 2 ? ue : le).push(n += e[t]);
})();
function de(e) {
	if (e < 768) return !1;
	for (let t = 0, n = le.length;;) {
		let r = t + n >> 1;
		if (e < le[r]) n = r;
		else if (e >= ue[r]) t = r + 1;
		else return !0;
		if (t == n) return !1;
	}
}
...
function b(e, t, n) {
	...
	t && _e(e.charCodeAt(t)) && ve(e.charCodeAt(t - 1)) && t--;
	let r = ge(e, t);
	for (t += ye(r); t < e.length;) {
		let i = ge(e, t);
		if (r == pe || i == pe || n && de(i)) t += ye(i), r = i;
		else if (fe(i)) {
			let n = 0, r = t - 2;
			for (; r >= 0 && fe(ge(e, r));) n++, r -= 2;
			if (n % 2 == 0) break;
			t += 2;
		} else break;
	}
...
function ge(e, t) {
	...
	if (!ve(n) || t + 1 == e.length) return n;
	let r = e.charCodeAt(t + 1);
	return _e(r) ? (n - 55296 << 10) + (r - 56320) + 65536 : n;
}
function _e(e) {
...
var x = class e {
	...
	static of(t) {
		...
		return t.length == 1 && !t[0] ? e.empty : t.length <= 32 ? new S(t) : be.from(S.split(t, []));
	}
}, S = class e extends x {
	constructor(e, t = xe(e)) {
	...
	replace(t, n, r) {
		if ([t, n] = Oe(this, t, n), r.lines < this.lines) for (let i = 0, a = 0; i < this.children.length; i++) {
			let o = this.children[i], s = a + o.length;
			if (t >= a && n <= s) {
	...
	static from(t, n = t.reduce((e, t) => e + t.length + 1, -1)) {
		...
		function d(t) {
			...
			else t.lines > o && (c > o || !c) ? (f(), s.push(t)) : t instanceof S && c && (n = u[u.length - 1]) instanceof S && t.lines + n.lines <= 32 ? (c += t.lines, l += t.length + 1, u[u.length - 1] = new S(n.text.concat(t.text), n.length + 1 + t.length)) : (c + t.lines > i && f(), c += t.lines, l += t.length + 1, u.push(t));
		}
		function f() {
...
var we = class {
	...
	nextInner(e, t) {
		for (this.done = this.lineBreak = !1;;) {
			let n = this.nodes.length - 1, r = this.nodes[n], i = this.offsets[n], a = i >> 1, o = r instanceof S ? r.text.length : r.children.length;
			if (a == (t > 0 ? o : 0)) {
...
typeof Symbol < "u" && (x.prototype[Symbol.iterator] = function() {
	return this.iter();
}, we.prototype[Symbol.iterator] = Te.prototype[Symbol.iterator] = Ee.prototype[Symbol.iterator] = function() {
	return this;
});
var De = class {
	constructor(e, t, n, r) {
...
function je(e, t) {
	let n = e.charCodeAt(t);
	if (!Ae(n) || t + 1 == e.length) return n;
	let r = e.charCodeAt(t + 1);
	return ke(r) ? (n - 55296 << 10) + (r - 56320) + 65536 : n;
}
function Me(e) {
	return e < 65536 ? 1 : 2;
}
var Ne = /\r\n?|\n/, w = /*@__PURE__*/ (function(e) {
	...
	composeDesc(e) {
		return this.empty ? e : e.empty ? this : ze(this, e);
	}
	mapDesc(e, t = !1) {
		return e.empty ? this : Re(this, e, t);
	}
	...
	apply(e) {
		...
		return Le(this, (t, n, r, i, a) => e = e.replace(r, r + (n - t), a), !1), e;
	}
	mapDesc(e, t = !1) {
	...
	compose(e) {
		return this.empty ? e : e.empty ? this : ze(this, e, !0);
	}
	map(e, t = !1) {
		return e.empty ? this : Re(this, e, t, !0);
	}
	iterChanges(e, t = !1) {
		Le(this, e, t);
	}
	...
	filter(t) {
		let n = [], r = [], i = [], a = new Be(this);
			...
			for (; o < s || o == s && a.len == 0;) {
				...
				T(n, e, t), t > 0 && Ie(r, n, a.text), a.forward(e), o += e;
			}
			let c = t[e++];
			for (; o < c;) {
				if (a.done) break done;
	...
	static of(t, n, r) {
		...
		function l(t) {
			if (Array.isArray(t)) for (let e of t) l(e);
				...
				let u = l ? typeof l == "string" ? x.of(l.split(r || Ne)) : l : x.empty, d = u.length;
				if (e == s && d == 0) return;
				e < o && c(), e > o && T(i, e - o, -1), T(i, s - e, d), Ie(a, i, u), o = s;
			}
		}
		return l(t), c(!s), s;
	}
...
function Re(e, t, n, r = !1) {
	let i = [], a = r ? [] : null, o = new Be(e), s = new Be(t);
	for (let e = -1;;) if (o.done && s.len || s.done && o.len) throw Error("Mismatched change set lengths");
		...
		for (T(i, s.ins, -1); t;) {
			...
			o.ins >= 0 && e < o.i && o.len <= n && (T(i, 0, o.ins), a && Ie(a, i, o.text), e = o.i), o.forward(n), t -= n;
		}
		s.next();
	} else if (o.ins >= 0) {
		let t = 0, n = o.len;
		...
		T(i, t, e < o.i ? o.ins : 0), a && e < o.i && Ie(a, i, o.text), e = o.i, o.forward(o.len - n);
	} else if (o.done && s.done) return a ? Fe.createSet(i, a) : Pe.create(i);
	else throw Error("Mismatched change set lengths");
}
function ze(e, t, n = !1) {
	let r = [], i = n ? [] : null, a = new Be(e), o = new Be(t);
	for (let e = !1;;) if (a.done && o.done) return i ? Fe.createSet(r, i) : Pe.create(r);
	else if (a.ins == 0) T(r, a.len, 0, e), a.next();
	else if (o.len == 0 && !o.done) T(r, 0, o.ins, e), i && Ie(i, r, o.text), o.next();
		...
		if (a.ins == -1) {
			...
			T(r, t, n, e), i && n && Ie(i, r, o.text);
		} else o.ins == -1 ? (T(r, a.off ? 0 : a.len, t, e), i && Ie(i, r, a.textBit(t))) : (T(r, a.off ? 0 : a.len, o.off ? 0 : o.ins, e), i && !o.off && Ie(i, r, o.text));
...
var Be = class {
	...
	static fromJSON(t) {
		...
		return new e(t.ranges.map((e) => Ve.fromJSON(e)), t.main);
	}
	static single(t, n = t) {
	...
	static cursor(e, t = 0, n, r) {
		return Ve.create(e, e, (t == 0 ? 0 : t < 0 ? 8 : 16) | (n == null ? 7 : Math.min(6, n)), r);
	}
	static range(e, t, n, r, i) {
		let a = r == null ? 7 : Math.min(6, r);
		return !i && e != t && (i = t < e ? 1 : -1), i && (a |= i < 0 ? 8 : 16), t < e ? Ve.create(t, e, a | 32, n) : Ve.create(e, t, a, n);
	}
	static undirectionalRange(e, t) {
		return Ve.create(e, t, 64, void 0);
	}
...
var Ue = 0, D = class e {
	constructor(e, t, n, r, i) {
		this.combine = e, this.compareInput = t, this.compare = n, this.isStatic = r, this.id = Ue++, this.default = e([]), this.extensions = typeof i == "function" ? i(this) : i;
	}
	get reader() {
		return this;
	}
	static define(t = {}) {
		return new e(t.combine || ((e) => e), t.compareInput || ((e, t) => e === t), t.compare || (t.combine ? (e, t) => e === t : We), !!t.static, t.enables);
	}
	of(e) {
...
var Ge = class {
	constructor(e, t, n, r) {
		this.dependencies = e, this.facet = t, this.type = n, this.value = r, this.id = Ue++;
	}
	dynamicSlot(e) {
		...
		return {
			...
			update(e, r) {
				if (o && r.docChanged || s && (r.docChanged || r.selection) || qe(e, c)) {
					let r = t(e);
					if (a ? !Ke(r, e.values[i], n) : !n(r, e.values[i])) return e.values[i] = r, 1;
				}
				return 0;
			},
			reconfigure: (e, o) => {
				...
				if (c != null) {
					let r = ot(o, c);
					if (this.dependencies.every((t) => t instanceof D ? o.facet(t) === e.facet(t) : t instanceof Xe ? o.field(t, !1) == e.field(t, !1) : !0) || (a ? Ke(s = t(e), r, n) : n(s = t(e), r))) return e.values[i] = r, 0;
				} else s = t(e);
...
function Je(e, t, n) {
	...
	return {
		...
		reconfigure(e, i) {
			let a = qe(e, r), c = i.config.facets[t.id], l = i.facet(t);
			if (c && !a && We(n, c)) return e.values[o] = l, 0;
			let u = s(e);
			return t.compare(u, l) ? (e.values[o] = l, 0) : (e.values[o] = u, 1);
		}
	};
}
var Ye = /*@__PURE__*/ D.define({ static: !0 }), Xe = class e {
	constructor(e, t, n, r, i) {
		this.id = e, this.createF = t, this.updateF = n, this.compareF = r, this.spec = i, this.provides = void 0;
	}
	static define(t) {
		let n = new e(Ue++, t.create, t.update, t.compare || ((e, t) => e === t), t);
		return t.provide && (n.provides = t.provide(n)), n;
	}
	create(e) {
		return (e.facet(Ye).find((e) => e.field == this)?.create || this.createF)(e);
	}
	slot(e) {
		let t = e[this.id] >> 1;
		return {
			...
			reconfigure: (e, n) => {
				let r = e.facet(Ye), i = n.facet(Ye), a;
...
var $e = {
	highest: /*@__PURE__*/ Qe(Ze.highest),
	high: /*@__PURE__*/ Qe(Ze.high),
	default: /*@__PURE__*/ Qe(Ze.default),
	low: /*@__PURE__*/ Qe(Ze.low),
	lowest: /*@__PURE__*/ Qe(Ze.lowest)
}, et = class {
	constructor(e, t) {
	...
	static resolve(t, n, r) {
		...
		for (let e of it(t, n, o)) e instanceof Xe ? i.push(e) : (a[e.facet.id] || (a[e.facet.id] = [])).push(e);
		...
		for (let e in a) {
			...
			if (t.every((e) => e.type == 0)) {
				if (s[n.id] = c.length << 1 | 1, We(i, t)) c.push(r.facet(n));
				else {
				...
				s[n.id] = l.length << 1, l.push((e) => Je(e, n, t));
			}
		}
		let d = l.map((e) => e(s));
...
function it(e, t, n) {
	...
	function a(e, o) {
		...
		if (s != null) {
			if (s <= o) return;
			let t = r[s].indexOf(e);
			t > -1 && r[s].splice(t, 1), e instanceof nt && n.delete(e.compartment);
		}
		...
		} else if (e instanceof et) a(e.inner, e.prec);
		else if (e instanceof Xe) r[o].push(e), e.provides && a(e.provides, o);
		else if (e instanceof Ge) r[o].push(e), e.facet.extensions && a(e.facet.extensions, Ze.default);
		else {
			let t = e.extension;
	...
	return a(e, Ze.default), r.reduce((e, t) => e.concat(t));
}
function at(e, t) {
	if (t & 1) return 2;
...
var st = /*@__PURE__*/ D.define(), ct = /*@__PURE__*/ D.define({
	combine: (e) => e.some((e) => e),
	static: !0
}), lt = /*@__PURE__*/ D.define({
	combine: (e) => e.length ? e[0] : void 0,
	static: !0
}), ut = /*@__PURE__*/ D.define(), dt = /*@__PURE__*/ D.define(), ft = /*@__PURE__*/ D.define(), pt = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : !1 }), mt = class {
	constructor(e, t) {
...
k.time = /*@__PURE__*/ mt.define(), k.userEvent = /*@__PURE__*/ mt.define(), k.addToHistory = /*@__PURE__*/ mt.define(), k.remote = /*@__PURE__*/ mt.define();
function _t(e, t) {
	let n = [];
	for (let r = 0, i = 0;;) {
		let a, o;
...
function vt(e, t, n) {
	let r, i, a;
	return n ? (r = t.changes, i = Fe.empty(t.changes.length), a = e.changes.compose(t.changes)) : (r = t.changes.map(e.changes), i = e.changes.mapDesc(t.changes, !0), a = e.changes.compose(r)), {
		changes: a,
...
function yt(e, t, n) {
	let r = t.selection, i = wt(t.annotations);
	return t.userEvent && (i = i.concat(k.userEvent.of(t.userEvent))), {
		changes: t.changes instanceof Fe ? t.changes : Fe.of(t.changes || [], n, e.facet(lt)),
		selection: r && (r instanceof E ? r : E.single(r.anchor, r.head)),
		effects: wt(t.effects),
		annotations: i,
		scrollIntoView: !!t.scrollIntoView
	};
}
function bt(e, t, n) {
	let r = yt(e, t.length ? t[0] : {}, e.doc.length);
	t.length && t[0].filter === !1 && (n = !1);
	for (let i = 1; i < t.length; i++) {
		t[i].filter === !1 && (n = !1);
		let a = !!t[i].sequential;
		r = vt(r, yt(e, t[i], a ? r.changes.newLength : e.doc.length), a);
	}
...
function xt(e) {
	...
	for (let r of t.facet(ut)) {
		let t = r(e);
		if (t === !1) {
			n = !1;
			break;
		}
		Array.isArray(t) && (n = n === !0 ? t : _t(n, t));
	}
	if (n !== !0) {
		let r, i;
		if (n === !1) i = e.changes.invertedDesc, r = Fe.empty(t.doc.length);
		else {
	...
	for (let n = r.length - 1; n >= 0; n--) {
		let i = r[n](e);
		e = i instanceof k ? i : Array.isArray(i) && i.length == 1 && i[0] instanceof k ? i[0] : bt(t, wt(i), !1);
	}
	return e;
}
function St(e) {
	let t = e.startState, n = t.facet(ft), r = e;
	for (let i = n.length - 1; i >= 0; i--) {
		let a = n[i](e);
		a && Object.keys(a).length && (r = vt(r, yt(t, a, e.changes.newLength), !0));
	}
...
function kt(e) {
	return (t) => {
		if (!/\S/.test(t)) return Tt.Space;
		if (Ot(t)) return Tt.Word;
		for (let n = 0; n < e.length; n++) if (t.indexOf(e[n]) > -1) return Tt.Word;
		return Tt.Other;
	};
}
var A = class e {
	constructor(e, t, n, r, i, a) {
		...
		for (let e = 0; e < this.config.dynamicSlots.length; e++) at(this, e << 1);
	...
	applyTransaction(t) {
		...
		for (let e of t.effects) e.is(tt.reconfigure) ? (n &&= (i = /* @__PURE__ */ new Map(), n.compartments.forEach((e, t) => i.set(t, e)), null), i.set(e.value.compartment, e.value.extension)) : e.is(O.reconfigure) ? (n = null, r = e.value) : e.is(O.appendConfig) && (n = null, r = wt(r).concat(e.value));
		let a;
		n ? a = t.startState.values.slice() : (n = rt.resolve(r, i, this), a = new e(n, this.doc, this.selection, n.dynamicSlots.map(() => null), (e, t) => t.reconfigure(e, this), null).values);
		let o = t.startState.facet(ct) ? t.newSelection : t.newSelection.asSingle();
	...
	changeByRange(e) {
		let t = this.selection, n = e(t.ranges[0]), r = this.changes(n.changes), i = [n.range], a = wt(n.effects);
		for (let n = 1; n < t.ranges.length; n++) {
			let o = e(t.ranges[n]), s = this.changes(o.changes), c = s.map(r);
			for (let e = 0; e < n; e++) i[e] = i[e].map(c);
			let l = r.mapDesc(s, !0);
			i.push(o.range.map(l)), r = r.compose(c), a = O.mapEffects(a, c).concat(O.mapEffects(wt(o.effects), l));
		}
		return {
			changes: r,
	...
	changes(t = []) {
		return t instanceof Fe ? t : Fe.of(t, this.doc.length, this.facet(e.lineSeparator));
	}
	toText(t) {
		return x.of(t.split(this.facet(e.lineSeparator) || Ne));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (at(this, t), ot(this, t));
	}
	toJSON(e) {
		let t = {
			doc: this.sliceDoc(),
		...
		if (e) for (let n in e) {
			let r = e[n];
			r instanceof Xe && this.config.address[r.id] != null && (t[n] = r.spec.toJSON(this.field(e[n]), this));
		}
		return t;
	}
	...
	static create(t = {}) {
		let n = rt.resolve(t.extensions || [], /* @__PURE__ */ new Map()), r = t.doc instanceof x ? t.doc : x.of((t.doc || "").split(n.staticFacet(e.lineSeparator) || Ne)), i = t.selection ? t.selection instanceof E ? t.selection : E.single(t.selection.anchor, t.selection.head) : E.single(0);
		return He(i, r.length), n.staticFacet(ct) || (i = i.asSingle()), new e(n, r, i, n.dynamicSlots.map(() => null), (e, t) => t.create(e), null);
	}
	get tabSize() {
	...
	languageDataAt(e, t, n = -1) {
		let r = [];
		for (let i of this.facet(st)) for (let a of i(this, t, n)) Object.prototype.hasOwnProperty.call(a, e) && r.push(a[e]);
		return r;
	}
	charCategorizer(e) {
		let t = this.languageDataAt("wordChars", e);
		return kt(t.length ? t[0] : "");
	}
	wordAt(e) {
		let { text: t, from: n, length: r } = this.doc.lineAt(e), i = this.charCategorizer(e), a = e - n, o = e - n;
		for (; a > 0;) {
			let e = C(t, a, !1);
			if (i(t.slice(e, a)) != Tt.Word) break;
			a = e;
		}
		for (; o < r;) {
			let e = C(t, o);
			if (i(t.slice(o, e)) != Tt.Word) break;
			o = e;
		}
		return a == o ? null : E.range(a + n, o + n);
	}
};
A.allowMultipleSelections = ct, A.tabSize = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : 4 }), A.lineSeparator = lt, A.readOnly = pt, A.phrases = /*@__PURE__*/ D.define({ compare(e, t) {
	let n = Object.keys(e), r = Object.keys(t);
	return n.length == r.length && n.every((n) => e[n] == t[n]);
} }), A.languageData = st, A.changeFilter = ut, A.transactionFilter = dt, A.transactionExtender = ft, tt.reconfigure = /*@__PURE__*/ O.define();
function At(e, t, n = {}) {
	let r = {};
...
var jt = class {
	...
	range(e, t = e) {
		return Nt.create(e, t, this);
	}
};
jt.prototype.startSide = jt.prototype.endSide = 0, jt.prototype.point = !1, jt.prototype.mapMode = w.TrackDel;
function Mt(e, t) {
...
var Ft = class e {
	...
	update(t) {
		...
		if (r && (n = n.slice().sort(Pt)), this.isEmpty) return n.length ? e.of(n) : this;
		let s = new zt(this, null, -1).goto(0), c = 0, l = [], u = new Lt();
		...
		} else s.rangeIndex == 1 && s.chunkIndex < this.chunk.length && (c == n.length || this.chunkEnd(s.chunkIndex) < n[c].from) && (!o || i > this.chunkEnd(s.chunkIndex) || a < this.chunkPos[s.chunkIndex]) && u.addChunk(this.chunkPos[s.chunkIndex], this.chunk[s.chunkIndex]) ? s.nextChunk() : ((!o || i > s.to || a < s.from || o(s.from, s.to, s.value)) && (u.addInner(s.from, s.to, s.value) || l.push(Nt.create(s.from, s.to, s.value))), s.next());
	...
	static compare(e, t, n, r, i = -1) {
		let a = e.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), o = t.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), s = Rt(a, o, n), c = new Ht(a, s, i), l = new Ht(o, s, i);
		n.iterGaps((e, t, n) => Ut(c, e, l, t, n, r)), n.empty && n.length == 0 && Ut(c, 0, l, 0, 0, r);
	}
	static eq(e, t, n = 0, r) {
		r ??= 1e9 - 1;
		...
		let o = Rt(i, a), s = new Ht(i, o, 0).goto(n), c = new Ht(a, o, 0).goto(n);
		for (;;) {
			if (s.to != c.to || !Wt(s.active, c.active) || s.point && (!c.point || !Mt(s.point, c.point))) return !1;
			if (s.to > r) return !0;
			s.next(), c.next();
		}
	}
	...
	static of(e, t = !1) {
		let n = new Lt();
		for (let r of e instanceof Nt ? [e] : t ? It(e) : e) n.add(r.from, r.to, r.value);
		return n.finish();
	}
	static join(t) {
...
function It(e) {
	if (e.length > 1) for (let t = e[0], n = 1; n < e.length; n++) {
		let r = e[n];
		if (Pt(t, r) > 0) return e.slice().sort(Pt);
		t = r;
	}
	return e;
}
...
var Lt = class e {
	finishChunk(e) {
		this.chunks.push(new Ft(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, e && (this.from = [], this.to = [], this.value = []);
	}
	constructor() {
...
var zt = class {
	...
	static from(t, n = null, r = -1) {
		let i = [];
		for (let e = 0; e < t.length; e++) for (let a = t[e]; !a.isEmpty; a = a.nextLayer) a.maxPoint >= r && i.push(new zt(a, n, r, e));
	...
	goto(e, t = -1e9) {
		...
		for (let e = this.heap.length >> 1; e >= 0; e--) Vt(this.heap, e);
	...
	next() {
		if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
			...
			let e = this.heap[0];
			this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), Vt(this.heap, 0);
		}
	}
};
function Vt(e, t) {
...
var Ht = class {
	constructor(e, t, n) {
		this.minPoint = n, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = Bt.from(e, t, n);
	}
	goto(e, t = -1e9) {
	...
	removeActive(e) {
		Gt(this.active, e), Gt(this.activeTo, e), Gt(this.activeRank, e), this.minActive = qt(this.active, this.activeTo);
	}
	addActive(e) {
		let t = 0, { value: n, to: r, rank: i } = this.cursor;
		for (; t < this.activeRank.length && (i - this.activeRank[t] || r - this.activeTo[t]) > 0;) t++;
		Kt(this.active, t, n), Kt(this.activeTo, t, r), Kt(this.activeRank, t, i), e && Kt(e, t, this.cursor.from), this.minActive = qt(this.active, this.activeTo);
	}
	next() {
...
function Ut(e, t, n, r, i, a) {
	...
	for (let t = !1;;) {
		...
		if (e.point || n.point ? (e.point && n.point && Mt(e.point, n.point) && Wt(e.activeForPoint(e.to), n.activeForPoint(n.to)) || a.comparePoint(s, d, e.point, n.point), t = !1) : (t && a.boundChange(s), d > s && !Wt(e.active, n.active) && a.compareRange(s, d, e.active, n.active), l && d < o && (r || e.openEnd(u) != n.openEnd(u)) && (t = !0)), u > o) break;
		s = u, i <= 0 && e.next(), i >= 0 && n.next();
	}
}
function Wt(e, t) {
	if (e.length != t.length) return !1;
	for (let n = 0; n < e.length; n++) if (e[n] != t[n] && !Mt(e[n], t[n])) return !1;
	return !0;
}
function Gt(e, t) {
...
for (var Xt = "ͼ", Zt = typeof Symbol > "u" ? "__ͼ" : Symbol.for(Xt), Qt = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), $t = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, en = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
	...
	static newName() {
		let e = $t[Zt] || 1;
		return $t[Zt] = e + 1, Xt + e.toString(36);
	}
	static mount(e, t, n) {
		let r = e[Qt], i = n && n.nonce;
		r ? i && r.setNonce(i) : r = new nn(e, i), r.mount(Array.isArray(t) ? t : [t], e);
	}
}, tn = /* @__PURE__ */ new Map(), nn = class {
	constructor(e, t) {
		let n = e.ownerDocument || e, r = n.defaultView;
		if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
			let t = tn.get(n);
			if (t) return e[Qt] = t;
			this.sheet = new r.CSSStyleSheet(), tn.set(n, this);
		} else this.styleTag = n.createElement("style"), t && this.styleTag.setAttribute("nonce", t);
		this.modules = [], e[Qt] = this;
	}
	mount(e, t) {
	...
	221: "}",
	222: "\""
}, on = typeof navigator < "u" && /Mac/.test(navigator.platform), sn = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), M = 0; M < 10; M++) rn[48 + M] = rn[96 + M] = String(M);
for (var M = 1; M <= 24; M++) rn[M + 111] = "F" + M;
for (var M = 65; M <= 90; M++) rn[M] = String.fromCharCode(M + 32), an[M] = String.fromCharCode(M);
for (var cn in rn) an.hasOwnProperty(cn) || (an[cn] = rn[cn]);
function ln(e) {
	var t = !(on && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || sn && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? an : rn)[e.keyCode] || e.key || "Unidentified";
...
var N = typeof navigator < "u" ? navigator : {
	...
	vendor: "",
	platform: ""
}, un = typeof document < "u" ? document : { documentElement: { style: {} } }, dn = /*@__PURE__*/ /Edge\/(\d+)/.exec(N.userAgent), fn = /*@__PURE__*/ /MSIE \d/.test(N.userAgent), pn = /*@__PURE__*/ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(N.userAgent), mn = !!(fn || pn || dn), hn = !mn && /*@__PURE__*/ /gecko\/(\d+)/i.test(N.userAgent), gn = !mn && /*@__PURE__*/ /Chrome\/(\d+)/.exec(N.userAgent), _n = "webkitFontSmoothing" in un.documentElement.style, vn = !mn && /*@__PURE__*/ /Apple Computer/.test(N.vendor), yn = vn && (/*@__PURE__*/ /Mobile\/\w+/.test(N.userAgent) || N.maxTouchPoints > 2), P = {
	mac: yn || /*@__PURE__*/ /Mac/.test(N.platform),
	windows: /*@__PURE__*/ /Win/.test(N.platform),
	linux: /*@__PURE__*/ /Linux|X11/.test(N.platform),
	ie: mn,
	ie_version: fn ? un.documentMode || 6 : pn ? +pn[1] : dn ? +dn[1] : 0,
	gecko: hn,
	gecko_version: hn ? +(/*@__PURE__*/ /Firefox\/(\d+)/.exec(N.userAgent) || [0, 0])[1] : 0,
	chrome: !!gn,
	chrome_version: gn ? +gn[1] : 0,
	ios: yn,
	android: /*@__PURE__*/ /Android\b/.test(N.userAgent),
	webkit: _n,
	webkit_version: _n ? +(/*@__PURE__*/ /\bAppleWebKit\/(\d+)/.exec(N.userAgent) || [0, 0])[1] : 0,
	safari: vn,
	safari_version: vn ? +(/*@__PURE__*/ /\bVersion\/(\d+(\.\d+)?)/.exec(N.userAgent) || [0, 0])[1] : 0,
	tabSize: un.documentElement.style.tabSize == null ? "-moz-tab-size" : "tab-size"
};
function bn(e, t) {
...
var En = class {
	...
	static replace(e) {
		...
		return new kn(e, n, r, t, e.widget || null, !0);
	}
	static line(e) {
		return new On(e);
	}
...
I.none = j.empty;
var Dn = class e extends I {
	constructor(e) {
		let { start: t, end: n } = An(e);
		super(t ? -1 : 5e8, n ? 1 : -6e8, null, e), this.tagName = e.tagName || "span", this.attrs = e.class && e.attributes ? bn(e.attributes, { class: e.class }) : e.class ? { class: e.class } : e.attributes || xn;
	}
	eq(t) {
		return this == t || t instanceof e && this.tagName == t.tagName && Sn(this.attrs, t.attrs);
	}
	range(e, t = e) {
...
var On = class e extends I {
	constructor(e) {
		super(-2e8, -2e8, null, e);
	}
	eq(t) {
		return t instanceof e && this.spec.class == t.spec.class && Sn(this.spec.attributes, t.spec.attributes);
	}
	range(e, t = e) {
...
On.prototype.mapMode = w.TrackBefore, On.prototype.point = !0;
var kn = class e extends I {
	constructor(e, t, n, r, i, a) {
		super(t, n, i, e), this.block = r, this.isReplace = a, this.mapMode = r ? t <= 0 ? w.TrackBefore : w.TrackAfter : w.TrackDel;
	}
	get type() {
		return this.startSide == this.endSide ? this.startSide <= 0 ? F.WidgetBefore : F.WidgetAfter : F.WidgetRange;
	}
	get heightRelevant() {
		return this.block || !!this.widget && (this.widget.estimatedHeight >= 5 || this.widget.lineBreaks > 0);
	}
	eq(t) {
		return t instanceof e && jn(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
	}
	range(e, t = e) {
...
var Nn = class e extends jt {
	constructor(e, t, n) {
		super(), this.tagName = e, this.attributes = t, this.rank = n;
	}
	eq(t) {
		return t == this || t instanceof e && this.tagName == t.tagName && Sn(this.attributes, t.attributes);
	}
	static create(t) {
		return new e(t.tagName, t.attributes || xn, t.rank == null ? 50 : Math.max(0, Math.min(t.rank, 100)));
	}
	static set(e, t = !1) {
		return j.of(e, t);
	}
};
Nn.prototype.startSide = Nn.prototype.endSide = -1;
function Pn(e) {
	let t;
...
function In(e, t) {
	...
	try {
		return Fn(e, t.anchorNode);
	} catch {
		return !1;
	}
}
function Ln(e) {
	return e.nodeType == 3 ? er(e, 0, e.nodeValue.length).getClientRects() : e.nodeType == 1 ? e.getClientRects() : [];
}
function Rn(e, t, n, r) {
	return n ? Vn(e, t, n, r, -1) || Vn(e, t, n, r, 1) : !1;
}
function zn(e) {
...
var Jn = class {
	...
	setRange(e) {
		...
		this.set(t, Math.min(e.anchorOffset, t ? Hn(t) : 0), n, Math.min(e.focusOffset, n ? Hn(n) : 0));
	}
	set(e, t, n, r) {
...
var Zn = null;
P.safari && P.safari_version >= 26 && (Zn = !1);
function Qn(e) {
	if (e.setActive) return e.setActive();
	if (Zn) return e.focus(Zn);
	let t = Yn(e);
	e.focus(Zn == null ? { get preventScroll() {
		return Zn = { preventScroll: !0 }, !0;
	} } : void 0), Zn || (Zn = !1, Xn(t));
}
var $n;
function er(e, t, n = t) {
	let r = $n ||= document.createRange();
...
function rr(e, t) {
	...
	for (r = Math.min(r, Hn(n));;) if (r) {
		if (n.nodeType != 1) return !1;
		let e = n.childNodes[r - 1];
		e.contentEditable == "false" ? r-- : (n = e, r = Hn(n));
	} else if (n == e) return !0;
	else r = zn(n), n = n.parentNode;
}
function ir(e) {
...
function ar(e, t) {
	for (let n = e, r = t;;) if (n.nodeType == 3 && r > 0) return {
		...
		n = n.childNodes[r - 1], r = Hn(n);
	} else if (n.parentNode && !Bn(n)) r = zn(n), n = n.parentNode;
	else return null;
}
function or(e, t) {
	...
	} else if (n.parentNode && !Bn(n)) r = zn(n) + 1, n = n.parentNode;
	else return null;
}
var sr = class e {
	constructor(e, t, n = !0) {
	...
	static before(t, n) {
		return new e(t.parentNode, zn(t), n);
	}
	static after(t, n) {
		return new e(t.parentNode, zn(t) + 1, n);
	}
...
var dr = /*@__PURE__*/ ur("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), fr = /*@__PURE__*/ ur("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), pr = /*@__PURE__*/ Object.create(null), mr = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function hr(e) {
	return e <= 247 ? dr[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? fr[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var gr = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, _r = class {
	get dir() {
		return this.level % 2 ? lr : cr;
	}
	constructor(e, t, n) {
...
function vr(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !vr(r.inner, i.inner)) return !1;
	}
	return !0;
}
var R = [];
...
function br(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = pr[n = e.charCodeAt(t)]) {
			if (r < 0) {
				for (let e = s - 3; e >= 0; e -= 3) if (mr[e + 1] == -r) {
					let n = mr[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
					r && (R[t] = R[mr[e]] = r), s = e;
					break;
				}
			} else if (mr.length == 189) break;
			else mr[s++] = t, mr[s++] = n, mr[s++] = c;
		} else if ((o = R[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function Sr(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new _r(c, m.from, f)), Cr(e, m.direction == cr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? R[p] != s : R[p] == s)) break;
		else p++;
		d ? Sr(e, c, p, r + 1, i, d, o) : c < p && o.push(new _r(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new _r(m.to, c, f)), Cr(e, m.direction == cr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? R[p - 1] != s : R[p - 1] == s)) break;
		else p--;
		d ? Sr(e, p, c, r + 1, i, d, o) : p < c && o.push(new _r(p, c, f)), c = p;
	}
}
function Cr(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	yr(e, i, a, r, s), br(e, i, a, r, s), xr(i, a, r, s), Sr(e, i, a, t, n, r, o);
}
function wr(e, t, n) {
	if (!e) return [new _r(0, 0, +(t == lr))];
	if (t == cr && !n.length && !gr.test(e)) return Tr(e.length);
	if (n.length) for (; e.length > R.length;) R[R.length] = 256;
	let r = [], i = t == cr ? 0 : 1;
	return Cr(e, i, i, n, 0, e.length, r), r;
}
function Tr(e) {
	return [new _r(0, e, 0)];
}
...
function Dr(e, t, n, r, i) {
	let a = r.head - e.from, o = _r.find(t, a, r.bidiLevel ?? -1, r.assoc), s = t[o], c = s.side(i, n);
	if (a == c) {
		let e = o += i ? 1 : -1;
	...
	(l < s.from || l > s.to) && (l = c), Er = e.text.slice(Math.min(a, l), Math.max(a, l));
...
function Or(e, t, n) {
	for (let r = t; r < n; r++) {
		...
		if (t == 1) return cr;
		if (t == 2 || t == 4) return lr;
	}
	return cr;
}
var kr = /*@__PURE__*/ D.define(), Ar = /*@__PURE__*/ D.define(), jr = /*@__PURE__*/ D.define(), Mr = /*@__PURE__*/ D.define(), Nr = /*@__PURE__*/ D.define(), Pr = /*@__PURE__*/ D.define(), Fr = /*@__PURE__*/ D.define(), Ir = /*@__PURE__*/ D.define(), Lr = /*@__PURE__*/ D.define(), Rr = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), zr = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), Br = /*@__PURE__*/ D.define(), Vr = class e {
...
}, Hr = /*@__PURE__*/ O.define({ map: (e, t) => e.map(t) }), Ur = /*@__PURE__*/ O.define();
function Wr(e, t, n) {
	let r = e.facet(Mr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var Gr = /*@__PURE__*/ D.define({ combine: (e) => !e.length || e[0] }), Kr = 0, qr = /*@__PURE__*/ D.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(qr.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(qr.of({
			plugin: this,
			arg: e
		}));
	}
	static define(t, n) {
		...
		return new e(Kr++, t, r, i, (e) => {
			let t = [];
			return o && t.push(Qr.of((t) => {
				let n = t.plugin(e);
				return n ? o(n) : I.none;
			})), a && t.push(a(e)), t;
		});
	...
	update(e) {
		if (!this.value) {
			if (this.spec) try {
				...
				Wr(e.state, t, "CodeMirror plugin crashed"), this.deactivate();
			}
			...
			if (this.mustUpdate = null, this.value.update) try {
				...
				if (Wr(e.state, t, "CodeMirror plugin crashed"), this.value.destroy) try {
					this.value.destroy();
				} catch {}
				this.deactivate();
			}
	...
	destroy(e) {
		if (this.value?.destroy) try {
			...
			Wr(e.state, t, "CodeMirror plugin crashed");
		}
	}
	deactivate() {
		this.spec = this.value = null;
	}
}, Xr = /*@__PURE__*/ D.define(), Zr = /*@__PURE__*/ D.define(), Qr = /*@__PURE__*/ D.define(), $r = /*@__PURE__*/ D.define(), ei = /*@__PURE__*/ D.define(), ti = /*@__PURE__*/ D.define(), ni = /*@__PURE__*/ D.define();
function ri(e, t) {
	...
	return j.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n ??= Or(t.text, o, s), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var ii = /*@__PURE__*/ D.define();
function ai(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(ii)) {
		let o = a(e);
...
var oi = /*@__PURE__*/ D.define(), si = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		...
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new si(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		let n = zn(this.dom), r = this.length ? e > 0 : t > 0;
		return new sr(this.parent.dom, n + +!!r, e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof fi) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = di(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = di(r);
		this.length = a;
	}
};
function di(e) {
...
var fi = class extends ui {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof pi) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 && !(a.flags & 32) || n && gi(a, d))) && (f > c || d.flags & 32 && t <= 1) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden && t >= -1) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	coordsIn(e, t, n) {
		...
		return r ? r.tile.coordsIn(Math.max(0, r.offset), t, n) : hi(this);
	}
	domIn(e, t) {
		let n = this.resolveInline(e, t);
		if (n) {
			let { tile: e, offset: r } = n;
			if (this.dom.contains(e.dom)) return e.isText() ? new sr(e.dom, Math.min(e.dom.nodeValue.length, r)) : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
			let i = n.tile.parent, a = !1;
			for (let e of i.children) {
				if (a) return new sr(e.dom, 0);
				e == n.tile && (a = !0);
			}
		}
		return new sr(this.dom, 0);
	}
};
function hi(e) {
...
var _i = class e extends ui {
	...
	coordsIn(e, t, n) {
		...
		let s = er(this.dom, i, a).getClientRects();
		if (!s.length) return null;
		let c = s[(o ? o < 0 : t >= 0) ? 0 : s.length - 1];
		return P.safari && !o && c.width == 0 && (c = Array.prototype.find.call(s, (e) => e.width) || c), n == null ? c : Un(c, (o ? o > 0 : t < 0) == n);
	}
	static of(t, n) {
		let r = new e(n || document.createTextNode(t), t);
		return n || (r.flags |= 2), r;
	}
}, yi = class e extends z {
	constructor(e, t, n, r) {
	...
	coordsInWidget(e, t, n) {
		...
		if (r) return r;
		if (n) return Un(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
		{
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new vi(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || vi.of(e, this.cache.find(vi)?.dom));
	...
	addComposition(e, t) {
		...
		for (let e = t.marks.length - 1; e >= 0; e--) {
			...
			if (i instanceof _i && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(Ni(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = z.get(n.dom);
					e && e.setDOM(Ni(n.dom));
				}
				let e = _i.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new vi(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= Ai;
		let n = mi.start(e, t || this.cache.find(mi)?.dom, !!t);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let i = e[r], a;
			if (t > 0 && (a = n.lastChild) && a instanceof _i && a.mark.eq(i)) n = a, t--;
			else {
				let e = _i.of(i, this.cache.find(_i, (e) => e.mark.eq(i))?.dom);
				n.append(e), n = e, t = 0;
			}
		}
		return n;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !Oi(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(P.ios && Oi(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(Fi, 0, 32) || new yi(Fi.toDOM(), 0, Fi, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof pi && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = pi.of(t.wrapper, this.cache.find(pi, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(bi, void 0, 1);
		return n && (n.flags = t), n || new bi(t);
	}
	flushBuffer() {
...
for (let e = 0; e < Ti.length; e++) Ti[e].bucket = e;
var Ei = class {
	constructor(e) {
		this.view = e, this.buckets = Ti.map(() => []), this.index = Ti.map(() => 0), this.reused = /* @__PURE__ */ new Map();
	}
	add(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new yi(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Ei(e), this.text = new wi(e.state.doc), this.builder = new Ci(this.cache, new fi(e, e.contentDOM), j.iter(n)), this.cache.reused.set(t, 2), this.old = new xi(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		let r = Mi(this.old), i = this.openMarks;
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) {
					if (this.openWidget) this.builder.continueWidget(n - t);
					else {
						let a = n > 0 || t < e.length ? yi.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof bi) this.cache.add(e);
				else if (e instanceof _i) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof _i && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length &&= i = 0 : e instanceof _i && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof kn) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? Pi.block : Pi.inline), c = ki(a), l = this.cache.findWidget(i, t - e, c) || yi.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof _i ? t.push(e) : e?.isLine() ? n = e : e instanceof pi || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new mi(r, Ai) : n || t.push(_i.of(new Dn({
...
Pi.inline = /*@__PURE__*/ new Pi("span"), Pi.block = /*@__PURE__*/ new Pi("div");
var Fi = /*@__PURE__*/ new class extends En {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !qi(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? Bi(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new si(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		...
		this.updateDeco();
		let o = Ui(i, this.decorations, e.changes);
		o.length && (t = si.extendWithRanges(t, o));
		let s = Gi(a, this.blockWrappers, e.changes);
		return s.length && (t = si.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				let n = this.tile, r = new Di(this.view, n, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
				t && z.get(t.text) && r.cache.reused.set(z.get(t.text), 2), this.tile = r.run(e, t), Li(n, r.cache.reused);
			}
		...
		let r = [];
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let e of this.tile.children) e.isWidget() && e.widget instanceof Ji && r.push(e.dom);
		n.updateGaps(r);
	}
	updateEditContextFormatting(e) {
		this.editContextFormatting = this.editContextFormatting.map(e.changes);
		for (let t of e.transactions) for (let e of t.effects) e.is(Ur) && (this.editContextFormatting = e.value);
	}
	updateSelection(e = !1, t = !1) {
		(e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(Gr) || n.tabIndex > -1) && In(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), P.gecko && s.empty && !this.hasComposition && Ri(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new sr(e, 0), o = !0;
		}
		let u = this.view.observer.selectionRange;
		(o || !u.focusNode || (!Rn(c.node, c.offset, u.anchorNode, u.anchorOffset) || !Rn(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			P.android && P.chrome && n.contains(u.focusNode) && Ki(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = Pn(this.view.root);
			if (e) {
				if (s.empty) {
					if (P.gecko) {
						let e = Vi(c.node, c.offset);
						if (e && e != 3) {
							let t = (e == 1 ? ar : or)(c.node, c.offset);
							t && (c = new sr(t.node, t.offset));
						}
					}
		...
		}), this.view.observer.setSelectionRange(c, l)), this.impreciseAnchor = c.precise ? null : new sr(u.anchorNode, u.anchorOffset), this.impreciseHead = l.precise ? null : new sr(u.focusNode, u.focusOffset);
	}
	...
	enforceCursorAssoc() {
		...
		let { view: e } = this, t = e.state.selection.main, n = Pn(e.root), { anchorNode: r, anchorOffset: i } = e.observer.selectionRange;
	...
	coordsAt(e, t, n) {
		...
		return r.isWidget() ? r.widget instanceof Ji ? null : r.coordsInWidget(i, t, !0) : r.coordsIn(i, t, n);
	}
	lineAt(e, t) {
	...
	coordsForChar(e) {
		...
		function r(e, t) {
			if (e.isComposite()) for (let n of e.children) {
				...
				let n = C(e.text, t);
				if (n == t) return null;
				let r = er(e.dom, t, n).getClientRects();
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == L.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof pi) p > n && l(r, u, m);
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(Qr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(ei).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet($r).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(Br)) try {
			if (t(this.view, e.range, e)) return !0;
		} catch (e) {
			Wr(this.view.state, e, "scroll handler");
		}
...
function Li(e, t) {
	...
	if (n != 1) {
		n ?? e.destroy();
		for (let n of e.children) Li(n, t);
	}
}
function Ri(e) {
...
function zi(e, t) {
	...
	let r = ar(n.focusNode, n.focusOffset), i = or(n.focusNode, n.focusOffset), a = r || i;
...
function Bi(e, t, n) {
	...
	return {
		range: new si(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function Vi(e, t) {
...
function Xi(e, t, n, r, i) {
	...
	return n.from + Yt(o, a, e.state.tabSize);
}
function Zi(e, t, n) {
	...
	if (Array.isArray(r.type)) {
		...
		for (let i of r.type) {
			...
			if (!(i.to < t)) {
				...
				(!e || i.type == F.Text && (e.type != i.type || (n < 0 ? i.from < t : i.to > t))) && (e = i);
			}
		}
		return e || r;
	}
...
function Qi(e, t, n, r) {
	let i = Zi(e, t.head, t.assoc || -1), a = !r || i.type != F.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function ra(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = na(e, i.from, -1), n = na(e, i.to, 1);
...
function ia(e, t, n) {
	let r = na(e.state.facet(ti).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function oa(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new aa(0, 1);
		if (c > e.viewState.docHeight) return new aa(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == F.Text) {
			let t = Xi(e, i, l, o, s);
			return new aa(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != F.Text) return c < (l.top + l.bottom) / 2 ? new aa(l.from, 1) : new aa(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new sa(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var sa = class {
	constructor(e, t, n, r) {
	...
	baseDirAt(e, t) {
		...
		return r[_r.find(r, e - n.from, -1, t)].level == this.baseDir;
	}
	dirAt(e, t) {
		let { line: n, spans: r } = this.bidiSpansAt(e);
		return r[_r.find(r, e - n.from, -1, t)].dir;
	}
	bidiIn(e, t) {
			...
			if (p) for (let e = 0; e < p.length; e++) {
				...
				if (!(t.width == 0 && p.length > 1)) {
					if (t.bottom < this.y) (!s || s.bottom < t.bottom) && (s = t), m = 1;
						...
						n < u && (l = f, u = n, d = t), e && (m = e < 0 == (this.baseDir == L.LTR) ? -1 : 1);
					}
				}
			}
	...
	scanText(e, t) {
		...
		let r = this.scan(n, (r) => {
			...
			return er(e.dom, i, a).getClientRects();
		});
		return r.after ? new aa(n[r.i + 1], -1) : new aa(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new aa(t, 1);
		...
		let r = this.scan(n, (t) => {
			let n = e.children[t];
			return n.flags & 48 ? null : (n.dom.nodeType == 1 ? n.dom : er(n.dom, 0, n.length)).getClientRects();
		}), i = e.children[r.i], a = n[r.i];
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new aa(n[r.i + 1], -1) : new aa(a, 1);
	}
}, ca = "￿", la = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = z.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : Bn(r)) || Bn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !da(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (ua(e, n.node, n.offset) ? t : 0));
	}
};
function ua(e, t, n) {
	for (;;) {
		if (!t || n < Hn(t)) return !1;
		if (t == e) return !0;
		n = zn(t) + 1, t = t.parentNode;
	}
}
function da(e, t) {
	let n;
...
var fa = class {
	...
	constructor(e, t, n, r) {
		...
		else if (t > -1 && (this.bounds = ma(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : ya(e), n = new la(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = ba(t, this.bounds.from);
		} else {
			let t = e.observer.selectionRange, n = i && i.node == t.focusNode && i.offset == t.focusOffset || !Fn(e.contentDOM, t.focusNode) ? o.main.head : e.docView.posFromDOM(t.focusNode, t.focusOffset), r = a && a.node == t.anchorNode && a.offset == t.anchorOffset || !Fn(e.contentDOM, t.anchorNode) ? o.main.anchor : e.docView.posFromDOM(t.anchorNode, t.anchorOffset), s = e.viewport;
...
function ha(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, ca), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: x.of(t.text.slice(a.from - e, u).split(ca))
		} : (d = va(l, t.text, s - e, c)) && (P.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: x.of(t.text.slice(d.from, d.toB).split(ca))
		});
	} else r && (!e.hasFocus && i.facet(Gr) || xa(r, a)) && (r = null);
	if (!n && !r) return !1;
	if ((P.mac || P.android) && n && n.from == n.to && n.from == a.head - 1 && /^\. ?$/.test(n.insert.toString()) && e.contentDOM.getAttribute("autocorrect") == "off" ? (r && n.insert.length == 2 && (r = E.single(r.main.anchor - 1, r.main.head - 1)), n = {
		from: n.from,
		to: n.to,
	...
	if (r && !xa(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = ra(i.facet(ti).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function ga(e, t, n, r = -1) {
	...
	if (P.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && tr(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && tr(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && tr(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o ||= _a(e, t, n);
	return e.state.facet(Pr).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()), !0;
}
function _a(e, t, n) {
	let r, i = e.state, a = i.selection.main, o = -1;
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = na(i.facet(ti).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && zi(e, n.main.head);
			if (u) {
...
function ya(e) {
	...
	return n && (t.push(new fa(n, r)), (i != n || a != r) && t.push(new fa(i, a))), t;
}
function ba(e, t) {
...
var Sa = class {
	...
	ensureHandlers(e) {
		let t = Ta(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && Oa.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), P.android && P.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (P.ios && !e.synthetic && !e.altKey && !e.metaKey && (Ea.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || Da.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && P.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && Ca(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, tr(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function Ta(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(wa(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(wa(t.value, r));
		}
	}
	for (let e in La) n(e).handlers.push(La[e]);
	for (let e in B) n(e).observers.push(B[e]);
	return t;
}
var Ea = [
	{
...
var Ma = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = qn(e.contentDOM), this.atoms = e.state.facet(ti).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(A.allowMultipleSelections) && Na(e, t), this.dragging = Fa(e, t) && qa(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || this.dragging == null && ja(this.startEvent, e) < 10) return;
		...
		let s = ai(this.view);
		e.clientX - s.left <= r + ka ? t = -Aa(r - e.clientX) : e.clientX + s.right >= a - ka && (t = Aa(e.clientX - a)), e.clientY - s.top <= i + ka ? n = -Aa(i - e.clientY) : e.clientY + s.bottom >= o - ka && (n = Aa(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = ra(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var La = /*@__PURE__*/ Object.create(null), B = /*@__PURE__*/ Object.create(null), Ra = P.ie && P.ie_version < 15 || P.ios && P.webkit_version < 604;
function za(e) {
	let t = e.dom.parentNode;
	if (!t) return;
	let n = t.appendChild(document.createElement("textarea"));
	n.style.cssText = "position: fixed; left: -10000px; top: 10px", n.focus(), setTimeout(() => {
		e.focus(), n.remove(), Va(e, n.value);
	}, 50);
}
function Ba(e, t, n) {
...
function Va(e, t) {
	...
	if ($a != null && n.selection.ranges.every((e) => e.empty) && $a == a.toString()) {
		let e = -1;
		r = n.changeByRange((r) => {
...
B.scroll = (e) => {
...
}, B.wheel = B.mousewheel = (e) => {
	e.inputState.lastWheelEvent = Date.now();
}, La.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), B.touchstart = (e, t) => {
	...
	let n = null;
	for (let r of e.state.facet(jr)) if (n = r(e, t), n) break;
	if (!n && t.button == 0 && (n = Ja(e, t)), n) {
		let r = !e.hasFocus;
		e.inputState.startMouseSelection(new Ma(e, t, n, r)), r && e.observer.ignore(() => {
			Qn(e.contentDOM);
...
var Ua = P.ie && P.ie_version <= 11, Wa = null, Ga = 0, Ka = 0;
function qa(e) {
	if (!Ua) return e.detail;
	let t = Wa, n = Ka;
	return Wa = e, Ka = Date.now(), Ga = !t || n > Date.now() - 400 && Math.abs(t.clientX - e.clientX) < 2 && Math.abs(t.clientY - e.clientY) < 2 ? (Ga + 1) % 3 : 1;
}
function Ja(e, t) {
	let n = e.posAndSideAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = qa(t), i = e.state.selection;
	return {
		update(e) {
		...
		get(t, a, o) {
			let s = e.posAndSideAtCoords({
				x: t.clientX,
				y: t.clientY
			}, !1), c, l = Ha(e, s.pos, s.assoc, r);
			if (n.pos != s.pos && !a) {
				let t = Ha(e, n.pos, n.assoc, r), i = Math.min(t.from, l.from), a = Math.max(t.to, l.to);
				l = i < l.from ? E.range(i, a, l.assoc) : E.range(a, i, l.assoc);
			}
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = Ya(i, s.pos)) ? c : o ? i.addRange(l) : E.create([l]);
		}
	};
}
function Ya(e, t) {
...
La.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", Ba(e.state, Lr, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, La.dragend = (e) => (e.inputState.draggedContent = null, !1);
function Xa(e, t, n, r) {
	if (n = Ba(e.state, Ir, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && Pa(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
La.drop = (e, t) => {
	...
	if (e.state.readOnly) return !0;
	e.observer.flush();
	let n = Ra ? null : t.clipboardData;
	return n ? (Va(e, n.getData("text/plain") || n.getData("text/uri-list")), !0) : (za(e), !1);
};
function Za(e, t) {
...
function Qa(e) {
	...
	return {
		text: Ba(e, Lr, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
var $a = null;
La.copy = La.cut = (e, t) => {
	if (!In(e.contentDOM, e.observer.selectionRange)) return !1;
	let { text: n, ranges: r, linewise: i } = Qa(e.state);
	if (!n && !i) return !1;
	$a = i ? n : null, t.type == "cut" && !e.state.readOnly && e.dispatch({
		changes: r,
		scrollIntoView: !0,
		userEvent: "delete.cut"
	});
	let a = Ra ? null : t.clipboardData;
	return a ? (a.clearData(), a.setData("text/plain", n), !0) : (Za(e, n), !1);
};
var eo = /*@__PURE__*/ mt.define();
function to(e, t) {
	let n = [];
	for (let r of e.facet(Fr)) {
		let i = r(e, t);
		i && n.push(i);
	}
...
B.focus = (e) => {
	e.inputState.lastFocusTime = Date.now(), !e.scrollDOM.scrollTop && (e.inputState.lastScrollTop || e.inputState.lastScrollLeft) && (e.scrollDOM.scrollTop = e.inputState.lastScrollTop, e.scrollDOM.scrollLeft = e.inputState.lastScrollLeft), no(e);
}, B.blur = (e) => {
	e.observer.clearSelectionRange(), no(e);
}, B.compositionstart = B.compositionupdate = (e) => {
	...
	let n;
	if (P.chrome && P.android && (n = Ea.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
		let t = window.visualViewport?.height || 0;
		setTimeout(() => {
			(window.visualViewport?.height || 0) > t + 10 && e.hasFocus && (e.contentDOM.blur(), e.focus());
		}, 100);
	}
	return P.ios && t.inputType == "deleteContentForward" && e.observer.flushSoon(), P.safari && t.inputType == "insertText" && e.inputState.composing >= 0 && setTimeout(() => B.compositionend(e, t), 20), !1;
};
var ro = /*@__PURE__*/ new Set();
function io(e) {
	ro.has(e) || (ro.add(e), e.addEventListener("copy", () => {}), e.addEventListener("cut", () => {}));
}
var ao = [
	"pre-wrap",
	"normal",
...
var co = class {
	...
	mustRefreshForWrapping(e) {
		return ao.indexOf(e) > -1 != this.lineWrapping;
	}
	...
	refresh(e, t, n, r, i, a) {
		let o = ao.indexOf(e) > -1, s = Math.abs(t - this.lineHeight) > .3 || this.lineWrapping != o;
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > fo && (oo = !0), this.height = e);
	}
	replace(t, n, r) {
		return e.of(r);
	}
	...
	static of(t) {
		...
		let o = 0;
		return t[n - 1] == null ? (o = 1, n--) : t[n] ?? (o = 1, r++), new yo(e.of(t.slice(0, n)), o, e.of(t.slice(r)));
	}
};
function mo(e, t) {
	return e == t ? e : (e.constructor != t.constructor && (oo = !0), t);
}
po.prototype.size = 1;
var ho = /*@__PURE__*/ I.replace({}), go = class extends po {
	constructor(e, t, n) {
		super(e, t), this.deco = n, this.spaceAbove = 0;
	}
	mainBlock(e, t) {
		return new uo(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.deco || 0);
	}
	blockAt(e, t, n, r) {
		return this.spaceAbove && e < n + this.spaceAbove ? new uo(r, 0, n, this.spaceAbove, ho) : this.mainBlock(n, r);
	}
	lineAt(e, t, n, r, i) {
	...
	mainBlock(e, t) {
		return new uo(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.breaks);
	}
	replace(t, n, r) {
		let i = r[0];
		return r.length == 1 && (i instanceof e || i instanceof vo && i.flags & 4) && Math.abs(this.length - i.length) < 10 ? (i instanceof vo ? i = new e(i.length, this.height, this.spaceAbove) : i.height = this.height, this.outdated || (i.outdated = !1), i) : po.of(r);
	}
	updateHeight(e, t = 0, n = !1, r) {
	...
	lineAt(e, t, n, r, i) {
		...
		return new uo(c.from, c.length, Math.max(r, Math.min(d, r + this.height - l)), l, 0);
	}
	forEachLine(e, t, n, r, i, a) {
		...
		for (let l = e, u = r; l <= t;) {
			...
			let r = s + c * t.length;
			a(new uo(t.from, t.length, u, r, 0)), u += r, l = t.to + 1;
		}
	}
	replace(t, n, r) {
		let i = this.length - n;
	...
	updateHeight(t, n = 0, r = !1, i) {
		...
		if (i && i.from <= n + this.length && i.more) {
			...
			for (i.from > n && r.push(new e(i.from - n - 1).updateHeight(t, n)); o <= a && i.more;) {
				...
				n < 0 && (a = -n, n = i.heights[i.index++]), s == -1 ? s = n : Math.abs(n - s) >= fo && (s = -2);
				let c = new _o(e, n, a);
				c.outdated = !1, r.push(c), o += e + 1;
			}
			o <= a && r.push(null, new e(a - o).updateHeight(t, o));
			let c = po.of(r);
			return (s < 0 || Math.abs(c.height - this.height) >= fo || Math.abs(s - this.heightMetrics(t, n).perLine) >= fo) && (oo = !0), mo(this, c);
		}
	...
	replace(e, t, n) {
		...
		if (e > 0 && bo(i, a - 1), t < this.length) {
			let e = i.length;
			this.decomposeRight(t, i), bo(i, e);
		}
		return po.of(i);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size ? po.of(this.break ? [
			e,
			null,
			t
		] : [e, t]) : (this.left = mo(this.left, e), this.right = mo(this.right, t), this.setHeight(e.height + t.height), this.outdated = e.outdated || t.outdated, this.size = e.size + t.size, this.length = e.length + this.break + t.length, this);
	}
	updateHeight(e, t = 0, n = !1, r) {
...
function bo(e, t) {
	let n, r;
	e[t] == null && (n = e[t - 1]) instanceof vo && (r = e[t + 1]) instanceof vo && e.splice(t - 1, 3, new vo(n.length + 1 + r.length));
}
var xo = 5, So = class e {
	constructor(e, t) {
	...
	span(e, t) {
		if (this.lineStart > -1) {
			...
			n instanceof _o ? n.length += e - this.pos : (e > this.pos || !this.isCovered) && this.nodes.push(new _o(e - this.pos, -1, 0)), this.writtenTo = e, t > e && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
		}
		this.pos = t;
	}
	point(e, t, n) {
		if (e < t || n.heightRelevant) {
			...
			let a = t - e;
			n.block ? this.addBlock(new go(a, r, n)) : (a || i || r >= xo) && this.addLineDeco(r, i, a);
	...
	enterLine() {
		...
		this.lineStart = e, this.lineEnd = t, this.writtenTo < e && ((this.writtenTo < e - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, e - 1)), this.nodes.push(null)), this.pos > e && this.nodes.push(new _o(this.pos - e, -1, 0)), this.writtenTo = this.pos;
	}
	blankContent(e, t) {
		let n = new vo(t - e);
	...
	finish(e) {
		...
		this.lineStart > -1 && !(t instanceof _o) && !this.isCovered ? this.nodes.push(new _o(0, -1, 0)) : (this.writtenTo < this.pos || t == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
		let n = e;
		for (let e of this.nodes) e instanceof _o && e.updateHeight(this.oracle, n), n += e ? e.length : 1;
		return this.nodes;
	}
...
var wo = class {
	...
	comparePoint(e, t, n, r) {
		(e < t || n && n.heightRelevant || r && r.heightRelevant) && Mn(e, t, this.changes, 5);
	}
};
function To(e, t) {
...
var Oo = class {
	...
	draw(e, t) {
		return I.replace({ widget: new ko(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, ko = class extends En {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = Io, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = L.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(Zr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new co(n), this.stateDeco = Lo(t), this.heightMap = po.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle.setDoc(t.doc), [new si(0, 0, 0, t.doc.length)]);
	...
	updateScaler() {
		let e = this.scaler;
		return this.scaler = this.heightMap.height <= 7e6 ? Io : new Ro(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
	}
	updateViewportLines() {
		this.viewportLines = [], this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (e) => {
			this.viewportLines.push(zo(e, this.scaler));
		});
	}
	update(e, t = null) {
		this.state = e.state;
		...
		let r = e.changedRanges, i = si.extendWithRanges(r, Co(n, this.stateDeco, e ? e.changes : Fe.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		so(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), i), (this.heightMap.height != a || oo) && (e.flags |= 2), o ? (this.scrollAnchorPos = e.changes.mapPos(o.from, -1), this.scrollAnchorHeight = o.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = a);
		...
		this.viewport = s, e.flags |= this.updateForViewport(), (c || !e.changes.empty || e.flags & 2) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps, e.changes))), e.flags |= this.computeVisibleRanges(e.changes), t && (this.scrollTarget = t), !this.mustEnforceCursorAssoc && (e.selectionSet || e.focusChanged) && e.view.lineWrapping && e.state.selection.main.empty && e.state.selection.main.assoc && !e.state.facet(zr) && (this.mustEnforceCursorAssoc = !0);
	}
	measure() {
		...
		let f = qn(this.view.contentDOM, !1).y;
		f != this.scrollParent && (this.scrollParent = f, this.scrollAnchorHeight = -1, this.scrollOffset = 0);
		let p = this.getScrollOffset();
		this.scrollOffset != p && (this.scrollAnchorHeight = -1, this.scrollOffset = p), this.scrolledToBottom = ir(this.scrollParent || e.win);
		let m = (this.printing ? Do : To)(t, this.paddingTop), h = m.top - this.pixelViewport.top, g = m.bottom - this.pixelViewport.bottom;
		...
		if (_ != this.inView && (this.inView = _, _ && (s = !0)), !this.inView && !this.scrollTarget && !Eo(e.dom)) return 0;
		let ee = o.width;
		if ((this.contentDOMWidth != ee || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			h > 0 && g > 0 ? l = Math.max(h, g) : h < 0 && g < 0 && (l = Math.min(h, g)), so();
			for (let n of this.viewports) {
				let i = n.from == this.viewport.from ? t : e.docView.measureVisibleLineHeights(n);
				this.heightMap = (a ? po.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle, [new si(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new lo(n.from, i));
			}
			oo && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new jo(r.lineAt(a - n * 1e3, V.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, V.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, V.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new jo(r.lineAt(o - 500, V.ByHeight, i, 0, 0).from, r.lineAt(o + n + 500, V.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new jo(this.heightMap.lineAt(n, V.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, V.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	mapLineGaps(e, t) {
		...
		let n = [];
		for (let r of e) t.touchesRange(r.from, r.to) || n.push(new Oo(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
		return n;
	}
	ensureLineGaps(e, t) {
		...
		let o = [], s = (r, a, c, l) => {
			...
			let f = Fo(e, (e) => e.from >= c.from && e.to <= c.to && Math.abs(e.from - r) < i && Math.abs(e.to - a) < i && !d.some((t) => e.from < t && e.to > t));
			if (!f) {
				...
				f = new Oo(r, a, e, n || e < 2e6 ? e : 2e6);
			}
			o.push(f);
		}, c = (t) => {
			if (t.length < a || t.type != F.Text) return;
			let i = Mo(t.from, t.to, this.stateDeco);
			if (i.total < a) return;
			...
			if (n) {
				...
				if (o != null) {
					let r = Po(i, o), s = ((this.visibleBottom - this.visibleTop) / 2 + e) / t.height;
					n = r - s, a = r + s;
	...
	updateLineGaps(e) {
		Oo.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = I.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || zo(this.heightMap.lineAt(e, V.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || zo(this.heightMap.lineAt(this.scaler.fromDOM(e), V.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
	...
	elementAtHeight(e) {
		return zo(this.heightMap.blockAt(this.scaler.fromDOM(e), this.heightOracle, 0, 0), this.scaler);
	}
	get docHeight() {
...
function No({ total: e, ranges: t }, n) {
...
function Lo(e) {
	let t = e.facet(Qr).filter((e) => typeof e != "function"), n = e.facet(ei).filter((e) => typeof e != "function");
...
function zo(e, t) {
	...
	return new uo(e.from, e.length, n, r - n, Array.isArray(e._content) ? e._content.map((e) => zo(e, t)) : e._content);
}
var Bo = /*@__PURE__*/ D.define({ combine: (e) => e.join(" ") }), Vo = /*@__PURE__*/ D.define({ combine: (e) => e.indexOf(!0) > -1 }), Ho = /*@__PURE__*/ en.newName(), Uo = /*@__PURE__*/ en.newName(), Wo = /*@__PURE__*/ en.newName(), Go = {
	"&light": "." + Uo,
	"&dark": "." + Wo
};
function Ko(e, t, n) {
	return new en(t, { finish(t) {
...
var qo = /*@__PURE__*/ Ko("." + Ho, {
...
}, Yo = P.ie && P.ie_version <= 11, Xo = class {
	constructor(e) {
		...
		}), window.EditContext && P.android && e.constructor.EDIT_CONTEXT !== !1 && !(P.chrome && P.chrome_version < 126) && (this.editContext = new es(e), e.state.facet(Gr) && (e.contentDOM.editContext = this.editContext.editContext)), Yo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(Gr) ? n.root.activeElement != this.dom : !In(this.dom, r)) return;
		let i = r.anchorNode && n.docView.tile.nearest(r.anchorNode);
		if (i && i.isWidget() && i.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		(P.ie && P.ie_version <= 11 || P.android && P.chrome) && !n.state.selection.main.empty && r.focusNode && Rn(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset) ? this.flushSoon() : this.flush(!1);
	}
	readSelectionRange() {
		let { view: e } = this, t = Pn(e.root);
		if (!t) return !1;
		let n = P.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && $o(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = In(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && rr(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	start() {
		this.active ||= (this.observer.observe(this.dom, Jo), Yo && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), !0);
	}
	stop() {
		this.active && (this.active = !1, this.observer.disconnect(), Yo && this.dom.removeEventListener("DOMCharacterDataModified", this.onCharData));
	}
	clear() {
	...
	delayAndroidKey(e, t) {
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && tr(this.dom, e.key, e.keyCode));
			};
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = ha(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !xa(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
	...
	update(e) {
		this.editContext && (this.editContext.update(e), e.startState.facet(Gr) != e.state.facet(Gr) && (e.view.contentDOM.editContext = e.state.facet(Gr) ? this.editContext.editContext : null));
	}
	destroy() {
		var e, t, n;
...
function Qo(e, t) {
	...
	return Rn(o.node, o.offset, i, a) && ([n, r, i, a] = [
		i,
		a,
		n,
		r
...
function $o(e, t) {
	...
	return e.contentDOM.addEventListener("beforeinput", r, !0), e.dom.ownerDocument.execCommand("indent"), e.contentDOM.removeEventListener("beforeinput", r, !0), n ? Qo(e, n) : null;
}
var es = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = va(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((P.mac || P.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				ga(e, u, E.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
			...
			e.dispatch({ effects: Ur.of(I.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || nr(e.parent) || document, this.viewState = new Ao(this, e.state || A.create(e)), e.scrollTo && e.scrollTo.is(Hr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(qr).map((e) => new Yr(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new Xo(this), this.inputState = new Sa(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Ii(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		t.some((e) => e.annotation(eo)) ? (this.inputState.notifiedFocused = o, s = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, c = to(a, o), c || (s = 1));
		...
		i = ci.create(this, a, t), i.flags |= s;
		...
		try {
			...
			for (let n of t) {
				if (d &&= d.map(n.changes), n.scrollIntoView) {
					...
					d = new Vr(t.empty ? t : E.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(Hr) && (d = e.value.clip(this.state));
			}
			this.viewState.update(i, d), this.bidiCache = rs.update(this.bidiCache, i.changes), i.empty || (this.updatePlugins(i), this.inputState.update(i)), n = this.docView.update(i), this.state.facet(oi) != this.styleModules && this.mountStyles(), r = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(n, t.some((e) => e.isUserEvent("select.pointer")));
		} finally {
			this.updateState = 0;
		}
		if (i.startState.facet(Bo) != i.state.facet(Bo) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(Nr)) try {
			e(i);
		} catch (e) {
			Wr(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !ha(this, u) && l.force && tr(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new Ao(this, e), this.plugins = e.facet(qr).map((e) => new Yr(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
			this.docView.destroy(), this.docView = new Ii(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
		} finally {
			this.updateState = 0;
		}
	...
	updatePlugins(e) {
		let t = e.startState.facet(qr), n = e.state.facet(qr);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
				if (n < 0) r.push(new Yr(i));
				else {
	...
	docViewUpdate() {
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate) try {
				...
				Wr(this.state, e, "doc view update listener");
			}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) {
					if (ir(n || this.win)) i = -1, a = this.viewState.heightMap.height;
					else {
				...
				let c = s.map((e) => {
					try {
						...
						return Wr(this.state, e), ns;
					}
				}), l = ci.create(this, this.state, []), u = !1;
				...
				for (let e = 0; e < s.length; e++) if (c[e] != ns) try {
					let t = s[e];
		...
		if (t && !t.empty) for (let e of this.state.facet(Nr)) e(t);
	}
	get themeClasses() {
		return Ho + " " + (this.state.facet(Vo) ? Wo : Uo) + " " + this.state.facet(Bo);
	}
	updateAttrs() {
		let e = is(this, Xr, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
			writingsuggestions: "false",
			translate: "no",
			contenteditable: this.state.facet(Gr) ? "true" : "false",
			class: "cm-content",
			style: `${P.tabSize}: ${this.state.tabSize}`,
			role: "textbox",
			"aria-multiline": "true"
		};
		this.state.readOnly && (t["aria-readonly"] = "true"), is(this, Zr, t);
		let n = this.observer.ignore(() => {
			let n = wn(this.contentDOM, this.contentAttrs, t), r = wn(this.dom, this.editorAttrs, e);
			return n || r;
		});
	...
	mountStyles() {
		...
		en.mount(this.root, this.styleModules.concat(qo).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return ia(this, e, $i(this, e, t, n));
	}
	moveByGroup(e, t) {
		return ia(this, e, $i(this, e, t, (t) => ea(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return ia(this, e, ta(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	posAndSideAtCoords(e, t = !0) {
		return this.readMeasured(), oa(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), i = r[_r.find(r, e - n.from, -1, t)];
	...
	textDirectionAt(e) {
		return !this.state.facet(Rr) || e < this.viewport.from || e > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(e));
	}
	get lineWrapping() {
		return this.viewState.heightOracle.lineWrapping;
	}
	bidiSpans(e) {
		if (e.length > ts) return Tr(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || vr(r.isolates, n = ri(this, e)))) return r.order;
		n ||= ri(this, e);
		let r = wr(e.text, t, n);
		return this.bidiCache.push(new rs(e.from, e.to, t, n, !0, r)), r;
	}
	get hasFocus() {
	...
	focus() {
		this.observer.ignore(() => {
			Qn(this.contentDOM), this.docView.updateSelection();
		});
	}
	setRoot(e) {
	...
	static scrollIntoView(e, t = {}) {
		return Hr.of(new Vr(typeof e == "number" ? E.cursor(e) : e, t.y ?? "nearest", t.x ?? "nearest", t.yMargin ?? 5, t.xMargin ?? 5));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return Hr.of(new Vr(E.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
		e == null ? this.inputState.tabFocusMode = this.inputState.tabFocusMode < 0 ? 0 : -1 : typeof e == "boolean" ? this.inputState.tabFocusMode = e ? 0 : -1 : this.inputState.tabFocusMode != 0 && (this.inputState.tabFocusMode = Date.now() + e);
	}
	static domEventHandlers(e) {
		return Jr.define(() => ({}), { eventHandlers: e });
	}
	static domEventObservers(e) {
		return Jr.define(() => ({}), { eventObservers: e });
	}
	static theme(e, t) {
		let n = en.newName(), r = [Bo.of(n), oi.of(Ko(`.${n}`, e))];
		return t && t.dark && r.push(Vo.of(!0)), r;
	}
	static baseTheme(e) {
		return $e.lowest(oi.of(Ko("." + Ho, e, Go)));
	}
...
H.styleModule = oi, H.inputHandler = Pr, H.clipboardInputFilter = Ir, H.clipboardOutputFilter = Lr, H.scrollHandler = Br, H.focusChangeEffect = Fr, H.perLineTextDirection = Rr, H.exceptionSink = Mr, H.updateListener = Nr, H.editable = Gr, H.mouseSelectionStyle = jr, H.dragMovesSelection = Ar, H.clickAddsSelectionRange = kr, H.decorations = Qr, H.blockWrappers = $r, H.outerDecorations = ei, H.atomicRanges = ti, H.bidiIsolatedRanges = ni, H.cursorScrollMargin = /*@__PURE__*/ D.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), H.scrollMargins = ii, H.darkTheme = Vo, H.cspNonce = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : "" }), H.contentAttributes = Zr, H.editorAttributes = Xr, H.lineWrapping = /*@__PURE__*/ H.contentAttributes.of({ class: "cm-lineWrapping" }), H.announce = /*@__PURE__*/ O.define();
var ts = 4096, ns = {}, rs = class e {
	constructor(e, t, n, r, i, a) {
...
var as = P.mac ? "mac" : P.windows ? "win" : P.linux ? "linux" : "key";
function os(e, t) {
...
var cs = /*@__PURE__*/ $e.default(/*@__PURE__*/ H.domEventHandlers({ keydown(e, t) {
	return gs(ds(t.state), e, t, "editor");
} })), ls = /*@__PURE__*/ D.define({ enables: cs }), us = /*@__PURE__*/ new WeakMap();
function ds(e) {
	let t = e.facet(ls), n = us.get(t);
	return n || us.set(t, n = ms(t.reduce((e, t) => e.concat(t), []))), n;
}
var fs = null, ps = 4e3;
function ms(e, t = as) {
	let n = Object.create(null), r = Object.create(null), i = (e, t) => {
		...
		let c = n[e] || (n[e] = Object.create(null)), l = r.split(/ (?!$)/).map((e) => os(e, t));
...
function gs(e, t, n, r) {
	hs = t;
	let i = ln(t), a = Me(je(i, 0)) == i.length && i != " ", o = "", s = !1, c = !1, l = !1;
	fs && fs.view == n && fs.scope == r && (o = fs.prefix + " ", Oa.indexOf(t.keyCode) < 0 && (c = !0, fs = null));
	...
	return f && (d(f[o + ss(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(P.windows && t.ctrlKey && t.altKey) && !(P.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = rn[t.keyCode]) && p != i ? (d(f[o + ss(p, t, !0)]) || t.shiftKey && (m = an[t.keyCode]) != i && m != p && d(f[o + ss(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + ss(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), hs = null, s;
}
var _s = class e {
	constructor(e, t, n, r, i) {
...
function bs(e, t, n) {
	...
	let r = Math.max(n.from, e.viewport.from), i = Math.min(n.to, e.viewport.to), a = e.textDirection == L.LTR, o = e.contentDOM, s = o.getBoundingClientRect(), c = vs(e), l = o.querySelector(".cm-line"), u = l && window.getComputedStyle(l), d = s.left + (u ? parseInt(u.paddingLeft) + Math.min(0, parseInt(u.textIndent)) : 0), f = s.right - (u ? parseInt(u.paddingRight) : 0), p = Zi(e, r, 1), m = Zi(e, i, -1), h = p.type == F.Text ? p : null, g = m.type == F.Text ? m : null;
	if (h && (e.lineWrapping || p.widgetLineBreaks) && (h = ys(e, r, 1, h)), g && (e.lineWrapping || m.widgetLineBreaks) && (g = ys(e, i, -1, g)), h && g && h.from == g.from && h.to == g.to) return ee(te(n.from, n.to, h));
	{
		let t = h ? te(n.from, null, h) : ne(p, !1), r = g ? te(null, n.to, g) : ne(m, !0), i = [];
		return (h || p).to < (g || m).from - (h && g ? 1 : 0) || p.widgetLineBreaks > 1 && t.bottom + e.defaultLineHeight / 2 < r.top ? i.push(_(d, t.bottom, f, r.top)) : t.bottom < r.top && e.elementAtHeight((t.bottom + r.top) / 2).type == F.Text && (t.bottom = r.top = (t.bottom + r.top) / 2), ee(t).concat(i).concat(ee(r));
	}
	function _(e, n, r, i) {
		return new _s(t, e - c.left, n - c.top, Math.max(0, r - e), i - n);
	}
	function ee({ top: e, bottom: t, horizontal: n }) {
		let r = [];
...
var Ss = class {
	...
	draw(e) {
		if (e.length != this.drawn.length || e.some((e, t) => !xs(e, this.drawn[t]))) {
...
}, Cs = /*@__PURE__*/ D.define();
function ws(e) {
	return [Jr.define((t) => new Ss(t, e)), Cs.of(e)];
}
var Ts = /*@__PURE__*/ D.define({ combine(e) {
	return At(e, {
...
function Ds(e) {
	return e.startState.facet(Ts) != e.state.facet(Ts);
}
var Os = /*@__PURE__*/ ws({
	above: !0,
	markers(e) {
		let { state: t } = e, n = t.facet(Ts), r = [];
		for (let i of t.selection.ranges) {
			let a = i == t.selection.main;
			if (i.empty || n.drawRangeCursor && !(a && P.ios && n.iosSelectionHandles)) {
				let t = a ? "cm-cursor cm-cursor-primary" : "cm-cursor cm-cursor-secondary", n = i.empty ? i : E.cursor(i.head, i.assoc);
				for (let i of _s.forRange(e, t, n)) r.push(i);
			}
		}
		return r;
	},
	update(e, t) {
		...
		let n = Ds(e);
		return n && ks(e.state, t), e.docChanged || e.selectionSet || n;
	},
	mount(e, t) {
		ks(t.state, e);
	},
...
function ks(e, t) {
	t.style.animationDuration = e.facet(Ts).cursorBlinkRate + "ms";
}
var As = /*@__PURE__*/ ws({
	above: !1,
	markers(e) {
		let t = [], { main: n, ranges: r } = e.state.selection;
		for (let n of r) if (!n.empty) for (let r of _s.forRange(e, "cm-selectionBackground", n)) t.push(r);
		if (P.ios && !n.empty && e.state.facet(Ts).iosSelectionHandles) {
			for (let r of _s.forRange(e, "cm-selectionHandle cm-selectionHandle-start", E.cursor(n.from, 1))) t.push(r);
			for (let r of _s.forRange(e, "cm-selectionHandle cm-selectionHandle-end", E.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || Ds(e);
	},
	class: "cm-selectionLayer"
}), js = P.gecko && P.gecko_version == 153 ? "#ffffff01" : "transparent", Ms = /*@__PURE__*/ $e.highest(/*@__PURE__*/ H.theme({
	".cm-line": {
		"& ::selection, &::selection": { backgroundColor: `${js} !important` },
...
var Fs = class {
	...
	createDeco(e) {
		let t = new Lt(), n = t.add.bind(t);
		for (let { from: t, to: r } of Ps(e, this.maxLength)) Ns(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else Ns(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, Is = /x/.unicode == null ? "g" : "gu", Ls = /*@__PURE__*/ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", Is), Rs = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function Bs() {
	if (zs == null && typeof document < "u" && document.body) {
		...
		zs = (e.tabSize ?? e.MozTabSize) != null;
	}
	return zs || !1;
}
var Vs = /*@__PURE__*/ D.define({ combine(e) {
	let t = At(e, {
		render: null,
		specialChars: Ls,
		addSpecialChars: null
	});
	return (t.replaceTabs = !Bs()) && (t.specialChars = RegExp("	|" + t.specialChars.source, Is)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Is)), t;
} });
function Hs(e = {}) {
	return [Vs.of(e), Ws()];
}
var Us = null;
function Ws() {
	return Us ||= Jr.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = I.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(Vs)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new Fs({
				regexp: e.specialChars,
				decoration: (t, n, r) => {
					let { doc: i } = n.state, a = je(t[0], 0);
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = Jt(e.text, t, r - e.from);
						return I.replace({ widget: new Js((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = I.replace({ widget: new qs(e, a) }));
				},
				boundary: e.replaceTabs ? void 0 : /[^]/
			});
		}
		update(e) {
			let t = e.state.facet(Vs);
			e.startState.facet(Vs) == t ? this.decorations = this.decorator.updateDeco(e, this.decorations) : (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(e.view));
		}
	}, { decorations: (e) => e.decorations });
}
var Gs = "•";
function Ks(e) {
	return e >= 32 ? Gs : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var qs = class extends En {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = Ks(this.code), n = e.state.phrase("Control character") + " " + (Rs[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var Xs = /*@__PURE__*/ I.line({ class: "cm-activeLine" }), Zs = /*@__PURE__*/ Jr.fromClass(class {
	constructor(e) {
	...
	getDeco(e) {
		...
		for (let r of e.state.selection.ranges) {
			...
			i.from > t && (n.push(Xs.range(i.from)), t = i.from);
		}
		return I.set(n);
	}
}, { decorations: (e) => e.decorations }), Qs = class extends jt {
	compare(e) {
		return this == e || this.constructor == e.constructor && this.eq(e);
	}
	eq(e) {
...
Qs.prototype.elementClass = "", Qs.prototype.toDOM = void 0, Qs.prototype.mapMode = w.TrackBefore, Qs.prototype.startSide = Qs.prototype.endSide = -1, Qs.prototype.point = !0;
var $s = /*@__PURE__*/ D.define(), ec = /*@__PURE__*/ D.define(), tc = /*@__PURE__*/ D.define(), nc = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) });
function rc(e) {
	let t = [ic];
	return e && e.fixed === !1 && t.push(nc.of(!0)), t;
}
var ic = /*@__PURE__*/ Jr.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(tc).map((t) => new cc(e, t)), this.fixed = !e.state.facet(nc);
	...
	update(e) {
		...
		this.view.state.facet(nc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = j.iter(this.view.state.facet($s), this.view.viewport.from), r = [], i = this.gutters.map((e) => new sc(e, this.view.viewport, -this.view.documentPadding.top));
		for (let e of this.view.viewportLineBlocks) if (r.length && (r = []), Array.isArray(e.type)) {
			let t = !0;
			for (let a of e.type) if (a.type == F.Text && t) {
				oc(n, r, a.from);
				for (let e of i) e.line(this.view, a, r);
				t = !1;
			} else if (a.widget) for (let e of i) e.widget(this.view, a);
		} else if (e.type == F.Text) {
			oc(n, r, e.from);
	...
	updateGutters(e) {
		let t = e.startState.facet(tc), n = e.state.facet(tc), r = e.docChanged || e.heightChanged || e.viewportChanged || !j.eq(e.startState.facet($s), e.state.facet($s), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new cc(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var sc = class {
	...
	line(e, t, n) {
		let r = [];
		oc(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = ac(t.markers(e)), t.initialSpacer && (this.spacer = new lc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
		if (this.markers = ac(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), uc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var dc = /*@__PURE__*/ D.define(), fc = /*@__PURE__*/ D.define(), pc = /*@__PURE__*/ D.define({ combine(e) {
	return At(e, {
		formatNumber: String,
		domEventHandlers: {}
...
function hc(e, t) {
	return e.state.facet(pc).formatNumber(t, e.state);
}
var gc = /*@__PURE__*/ tc.compute([pc], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(dc);
	},
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new mc(hc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
	...
	initialSpacer(e) {
		return new mc(hc(e, vc(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = hc(t.view, vc(t.view.state.doc.lines));
		return n == e.number ? e : new mc(n);
	},
	domEventHandlers: e.facet(pc).domEventHandlers,
	side: "before"
}));
function _c(e = {}) {
	return [
...
var yc = /*@__PURE__*/ new class extends Qs {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), bc = /*@__PURE__*/ $s.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(yc.range(i)));
	}
	return j.of(t);
});
function xc() {
...
var Sc = 1024, Cc = 0, wc = class {
	...
	constructor(e = {}) {
		this.id = Cc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
...
}, Ec = Object.create(null), W = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Ec, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
}, Oc = /* @__PURE__ */ new WeakMap(), kc = /* @__PURE__ */ new WeakMap(), G;
(function(e) {
...
var K = class e {
	...
	cursor(e = 0) {
		return new Uc(this.topNode, e);
	}
	cursorAt(e, t = 0, n = 0) {
		let r = new Uc(Oc.get(this) || this.topNode);
		return r.moveTo(e, t), Oc.set(this, r._tree), r;
	}
	get topNode() {
		return new Fc(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = Nc(Oc.get(this) || this.topNode, e, t, !1);
		return Oc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = Nc(kc.get(this) || this.topNode, e, t, !0);
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : Jc(W.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(W.none, t, n, r)));
	}
	static build(e) {
		return Gc(e);
	}
...
var Ac = class e {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(Mc(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function Nc(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof Fc && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : G.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof Fc && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var Pc = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & G.EnterBracketed && l instanceof K && (d = Tc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !Mc(i, r, u, u + l.length))) {
					if (l instanceof jc) {
						if (a & G.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new zc(new Rc(o, l, t, u), null, e);
					} else if (a & G.IncludeAnonymous || !l.type.isAnonymous || Wc(l)) {
						let s;
						if (!(a & G.IgnoreMounts) && (s = Tc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & G.IgnoreOverlays) && (i = Tc.get(this._tree)) && i.overlay) {
...
function Bc(e) {
	...
	let r = n instanceof Fc && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new Vc(i, n);
}
var Vc = class {
	constructor(e, t) {
...
function Hc(e, t, n) {
	...
	for (let e = r instanceof Fc ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = Tc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new Fc(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(Nc(o, t, n, !1));
		}
	}
	return i ? Bc(i) : r;
...
var Uc = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~G.EnterBracketed, e instanceof Fc) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof Fc ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & G.IncludeAnonymous || e instanceof jc || !e.type.isAnonymous || Wc(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	get node() {
		...
		for (let e = n; e < this.stack.length; e++) t = new zc(this.buffer, t, this.stack[e]);
		return this.bufferNode = new zc(this.buffer, t, this.index);
	}
	get tree() {
	...
	matchContext(e) {
		if (!this.buffer) return Lc(this.node.parent, e);
		let { buffer: t } = this.buffer, { types: n } = t.set;
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return Lc(this._tree, e, r);
...
function Wc(e) {
	return e.children.some((e) => e instanceof jc || !e.type.isAnonymous || Wc(e));
}
function Gc(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = Sc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new Ac(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, ee, te, ne) {
		let { id: re, start: v, end: ie, size: ae } = o, oe = l, se = c;
		if (ae < 0) {
			if (o.next(), ae == -1) {
				let t = i[re];
				_.push(t), ee.push(v - e);
				return;
			}
			if (ae == -3) {
				c = re;
			...
			throw RangeError(`Unrecognized record size: ${ae}`);
		}
		let ce = s[re], y, le, ue = v - e;
		if (ie - v <= r && (le = h(o.pos - t, te))) {
			let t = new Uint16Array(le.size - le.skip), r = o.pos - le.size, i = t.length;
			for (; o.pos > r;) i = g(le.start, t, i);
			y = new jc(t, ie - le.start, n), ue = le.start - e;
		} else {
			let e = o.pos - ae;
			o.next();
			let t = [], n = [], i = re >= a ? re : -1, s = 0, c = ie;
			for (; o.pos > e;) i >= 0 && o.id == i && o.size >= 0 ? (o.end <= c - r && (p(t, n, v, s, o.end, c, i, oe, se), s = t.length, c = o.end), o.next()) : ne > 2500 ? d(v, e, t, n) : u(v, e, t, n, i, ne + 1);
			if (i >= 0 && s > 0 && s < t.length && p(t, n, v, s, v, c, i, oe, se), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ce, se);
				y = Jc(ce, t, n, 0, t.length, 0, ie - v, e, e);
			} else y = m(ce, t, n, ie - v, oe - ie, se);
		}
		_.push(y), ee.push(ue);
	}
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new jc(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
	...
	let _ = [], ee = [];
	for (; o.pos > 0;) u(e.start || 0, e.bufferStart || 0, _, ee, -1, 0);
	let te = e.length ?? (_.length ? ee[0] + _[0].length : 0);
	return new K(s[e.topID], _.reverse(), ee.reverse(), te);
}
var Kc = /* @__PURE__ */ new WeakMap();
function qc(e, t) {
	if (!e.isAnonymous || t instanceof jc || t.type != e) return 1;
	let n = Kc.get(t);
	if (n == null) {
		n = 1;
...
function Jc(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += qc(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = qc(e, t[s]);
			for (s++; s < i; s++) {
				let n = qc(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(Jc(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var Yc = class {
	...
	set(e, t) {
		e instanceof zc ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof Fc && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof zc ? this.getBuffer(e.context.buffer, e.index) : e instanceof Fc ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new Qc(e)), n = n ? n.length ? n.map((e) => new wc(e.from, e.to)) : [new wc(0, 0)] : [new wc(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function $c(e) {
	return (t, n, r, i) => new il(t, e, n, r, i);
}
var el = class {
	constructor(e, t, n, r, i, a) {
...
var nl = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new K(e.type, e.children, e.positions, e.length, e.propValues.concat([[rl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[U.mounted.id] = new Tc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new ll(this.fragments), t = null, n = null, r = new Uc(new Fc(this.baseTree, this.ranges[0].from, 0, null), G.IncludeAnonymous | G.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = al(n.ranges, r.from, r.to))) o = a != 2;
			else if (!r.type.isAnonymous && (i = this.nest(r, this.input)) && (r.from < r.to || !i.overlay)) {
				r.tree || (sl(r), t && t.depth++, n && n.depth++);
				let a = e.findMounts(r.from, i.parser);
				if (typeof i.overlay == "function") t = new nl(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = ul(this.ranges, i.overlay || (r.from < r.to ? [new wc(r.from, r.to)] : []));
					e.length && tl(e), (e.length || !i.overlay) && this.inner.push(new el(i.parser, e.length ? i.parser.startParse(this.input, fl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new wc(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
				}
			} else if (t && (s = t.predicate(r)) && (s === !0 && (s = new wc(r.from, r.to)), s.from < s.to)) {
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = ul(this.ranges, t.ranges);
					e.length && (tl(e), this.inner.splice(t.index, 0, new el(t.parser, t.parser.startParse(this.input, fl(t.mounts, e), e), t.ranges.map((e) => new wc(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
function sl(e) {
	...
	function l(e, r, i, a, u, d) {
		...
		return p.push(_), m.push(h - a), ol(o, s[f + 3], r, p, m, a), new K(i, p, m, u);
	}
	i.children[a] = l(0, s.length, W.none, 0, o.length, n.length - 1);
	for (let t of c) {
		let n = e.tree.children[t], r = e.tree.positions[t];
		e.yield(new Fc(n, r + e.from, t, e._tree));
	}
}
var cl = class {
	constructor(e, t) {
		this.offset = t, this.done = !1, this.cursor = e.cursor(G.IncludeAnonymous | G.IgnoreMounts);
	}
	moveTo(e) {
		let { cursor: t } = this, n = e - this.offset;
		for (; !this.done && t.from < n;) if (!(t.to >= e && t.enter(n, 1, G.IgnoreOverlays | G.ExcludeBuffers))) {
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(rl) ?? t.to, this.inner = new cl(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(rl) ?? e.to, this.inner = new cl(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function ul(e, t) {
	...
	for (let i = 1, a = 0; i < e.length; i++) {
		...
		for (; a < r.length; a++) {
			let e = r[a];
			if (e.from >= s) break;
			e.to <= o || (n || (r = n = t.slice()), e.from < o ? (n[a] = new wc(e.from, o), e.to > s && n.splice(a + 1, 0, new wc(s, e.to))) : e.to > s ? n[a--] = new wc(s, e.to) : n.splice(a--, 1));
		}
	}
	return r;
}
...
function fl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = dl(t, i.overlay.map((e) => new wc(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new Xc(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new Xc(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var pl = 0, ml = class e {
	...
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && _l(n, e.modified));
		if (r) return r;
		let i = [], a = new ml(t.name, i, t, n);
...
function wl(e, t, n, r = 0, i = e.length) {
	let a = new Tl(r, Array.isArray(t) ? t : [t], n);
...
var Tl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = El(e) || xl.empty, u = Cl(i, l.tags);
...
function El(e) {
	let t = e.type.prop(bl);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var q = ml.define, Dl = q(), Ol = q(), kl = q(Ol), Al = q(Ol), jl = q(), Ml = q(jl), Nl = q(jl), Pl = q(), Fl = q(Pl), Il = q(), Ll = q(), Rl = q(), zl = q(Rl), Bl = q(), J = {
	comment: Dl,
	lineComment: q(Dl),
	blockComment: q(Dl),
	docComment: q(Dl),
	...
	unit: q(Il),
	modifier: q(Il),
	operatorKeyword: q(Il),
	controlKeyword: q(Il),
	definitionKeyword: q(Il),
	moduleKeyword: q(Il),
	operator: Ll,
	derefOperator: q(Ll),
	arithmeticOperator: q(Ll),
	logicOperator: q(Ll),
	bitwiseOperator: q(Ll),
	compareOperator: q(Ll),
	updateOperator: q(Ll),
	definitionOperator: q(Ll),
	typeOperator: q(Ll),
	controlOperator: q(Ll),
	punctuation: Rl,
	separator: q(Rl),
	bracket: zl,
	angleBracket: q(zl),
	...
	documentMeta: q(Bl),
	annotation: q(Bl),
	processingInstruction: q(Bl),
	definition: ml.defineModifier("definition"),
	constant: ml.defineModifier("constant"),
	function: ml.defineModifier("function"),
	standard: ml.defineModifier("standard"),
	local: ml.defineModifier("local"),
	special: ml.defineModifier("special")
};
for (let e in J) {
	let t = J[e];
	t instanceof ml && (t.name = e);
}
Sl([
	{
		tag: J.link,
...
var Ul = /*@__PURE__*/ new U(), Wl = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, A.prototype.hasOwnProperty("tree") || Object.defineProperty(A.prototype, "tree", { get() {
			return Y(this);
		} }), this.parser = t, this.extension = [tu.of(this), A.languageData.of((e, t, n) => {
			let r = Gl(e, t, n), i = r.type.prop(Vl);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(Ul);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return Gl(e, t, n).type.prop(Vl) == this.data;
	}
	findRegions(e) {
		let t = e.facet(tu);
...
Wl.setState = /*@__PURE__*/ O.define();
function Gl(e, t, n) {
	let r = e.facet(tu), i = Y(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, G.ExcludeBuffers | G.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var Kl = class e extends Wl {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = Hl(t.languageData);
		return new e(n, t.parser.configure({ props: [Vl.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var ql = class {
	...
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != K.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) {
					if (this.fragments = this.withoutTempSkipped(Xc.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
					else return !0;
				}
				if (e()) return !1;
			}
	...
	takeTree() {
		...
		}), this.treeLen = e, this.tree = t, this.fragments = this.withoutTempSkipped(Xc.addTree(this.tree, this.fragments, !0)), this.parse = null);
	}
	withContext(e) {
		let t = Jl;
		Jl = this;
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = Xl(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = Xc.applyChanges(r, e), i = K.empty, a = 0, o = {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = Xl(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
...
var Zl = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = Yl.create(t.facet(tu).parser, t, {
			from: 0,
			to: n
		});
...
Wl.state = /*@__PURE__*/ Xe.define({
	create: Zl.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(Wl.setState)) return e.value;
		return t.startState.facet(tu) == t.state.facet(tu) ? e.apply(t) : Zl.init(t.state);
	}
});
var Ql = (e) => {
...
typeof requestIdleCallback < "u" && (Ql = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var $l = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, eu = /*@__PURE__*/ Jr.fromClass(class {
	constructor(e) {
		this.view = e, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
	}
	update(e) {
		let t = this.view.state.field(Wl.state).context;
		(t.updateViewport(e.view.viewport) || this.view.viewport.to > t.treeLen) && this.scheduleWork(), (e.docChanged || e.selectionSet) && (this.view.hasFocus && (this.chunkBudget += 50), this.scheduleWork()), this.checkAsyncSchedule(t);
	}
	scheduleWork() {
		if (this.working) return;
		let { state: e } = this.view, t = e.field(Wl.state);
	...
	work(e) {
		...
		let { state: n, viewport: { to: r } } = this.view, i = n.field(Wl.state);
		if (i.tree == i.context.tree && i.context.isDone(r + 1e5)) return;
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !$l ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => $l && $l() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Wl.setState.of(new Zl(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
	checkAsyncSchedule(e) {
		e.scheduleOn &&= (this.workScheduled++, e.scheduleOn.then(() => this.scheduleWork()).catch((e) => Wr(this.view.state, e)).then(() => this.workScheduled--), null);
	}
	destroy() {
...
}, iu = /*@__PURE__*/ D.define(), au = /*@__PURE__*/ D.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function cu(e, t) {
	e instanceof A && (e = new lu(e));
	for (let n of e.state.facet(iu)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = Y(e.state);
	return n.length >= t ? du(e, n, t) : null;
}
var lu = class {
	constructor(e, t = {}) {
...
function mu(e) {
	let t = e.type.prop(uu);
	if (t) return t;
	let n = e.firstChild, r;
	if (n && (r = n.type.prop(U.closedBy))) {
		let t = e.lastChild, n = t && r.indexOf(t.name) > -1;
		return (e) => bu(e, !0, 1, void 0, n && !pu(e) ? t.from : void 0);
	}
	return e.parent == null ? hu : null;
}
function hu() {
	return 0;
}
var gu = class e extends lu {
	constructor(e, t, n) {
...
function yu({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => bu(r, t, n, e);
}
...
var xu = (e) => e.baseIndent;
function Su({ except: e, units: t = 1 } = {}) {
	return (n) => {
		let r = e && e.test(n.textAfter);
		return n.baseIndent + (r ? 0 : t * n.unit);
	};
}
var Cu = /*@__PURE__*/ D.define(), wu = /*@__PURE__*/ new U();
function Tu(e) {
...
var Eu = class e {
	constructor(e, t) {
		...
		this.scope = a instanceof Wl ? (e) => e.prop(Vl) == a.data : a ? (e) => e == a : void 0, this.style = Sl(e.map((e) => ({
			tag: e.tag,
			class: e.class || r(Object.assign({}, e, { tag: null }))
		})), { all: i }).style, this.module = n ? new en(n) : null, this.themeType = t.themeType;
	}
	static define(t, n) {
		return new e(t, n || {});
	}
}, Du = /*@__PURE__*/ D.define(), Ou = /*@__PURE__*/ D.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function ku(e) {
	let t = e.facet(Du);
...
function Au(e, t) {
	let n = [Mu], r;
	return e instanceof Eu && (e.module && n.push(H.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(Ou.of(e)) : r ? n.push(Du.computeN([H.darkTheme], (t) => t.facet(H.darkTheme) == (r == "dark") ? [e] : [])) : n.push(Du.of(e)), n;
}
var ju = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = Y(e.state), this.decorations = this.buildDeco(e, ku(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = Y(e.state), n = ku(e.state), r = n != ku(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new Lt();
		for (let { from: r, to: i } of e.visibleRanges) wl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = I.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, Mu = /*@__PURE__*/ $e.high(/*@__PURE__*/ Jr.fromClass(ju, { decorations: (e) => e.decorations })), Nu = /*@__PURE__*/ Eu.define([
	{
		tag: J.meta,
		color: "#404740"
	},
...
function zu(e, t, n, r = {}) {
	let i = r.maxScanDistance || Pu, a = r.brackets || Fu, o = Y(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Lu(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Ru(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Bu(e, t, n, r, o, i, a);
		}
	}
	return Vu(e, t, n, o, s.type, i, a);
}
...
var Hu = /*@__PURE__*/ Object.create(null), Uu = [W.none], Wu = [], Gu = /*@__PURE__*/ Object.create(null), Ku = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
]) Ku[e] = /*@__PURE__*/ Ju(Hu, t);
function qu(e, t) {
	Wu.indexOf(e) > -1 || (Wu.push(e), console.warn(t));
}
function Ju(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || J[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : qu(n, `Modifier ${n} used at start of tag`) : t.length ? qu(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : qu(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = Gu[i];
	if (a) return a.id;
	let o = Gu[i] = W.define({
		id: Uu.length,
		name: r,
...
var Zu = /*@__PURE__*/ Xu(ad, 0), Qu = /*@__PURE__*/ Xu(id, 0), $u = /*@__PURE__*/ Xu((e, t) => id(e, t, rd(t)), 0);
function ed(e, t) {
	let n = e.languageDataAt("commentTokens", t, 1);
	return n.length ? n[0] : {};
}
var td = 50;
function nd(e, { open: t, close: n }, r, i) {
	let a = e.sliceDoc(r - td, r), o = e.sliceDoc(i, i + td), s = /\s*$/.exec(a)[0].length, c = /^\s*/.exec(o)[0].length, l = a.length - s;
	...
	let u, d;
	i - r <= 100 ? u = d = e.sliceDoc(r, i) : (u = e.sliceDoc(r, r + td), d = e.sliceDoc(i - td, i));
...
function id(e, t, n = t.selection.ranges) {
	let r = n.map((e) => ed(t, e.from).block);
	if (!r.every((e) => e)) return null;
	let i = n.map((e, n) => nd(t, r[n], e.from, e.to));
...
function ad(e, t, n = t.selection.ranges) {
	let r = [], i = -1;
	ranges: for (let { from: e, to: a } of n) {
		let n = r.length, o = 1e9, s;
		for (let n = e; n <= a;) {
			let c = t.doc.lineAt(n);
			if (s == null && (s = ed(t, c.from).line, !s)) continue ranges;
...
var od = /*@__PURE__*/ mt.define(), sd = /*@__PURE__*/ mt.define(), cd = /*@__PURE__*/ D.define(), ld = /*@__PURE__*/ D.define({ combine(e) {
	return At(e, {
		minDepth: 100,
		newGroupDelay: 500,
		joinToEvent: (e, t) => t
...
} }), ud = /*@__PURE__*/ Xe.define({
	create() {
		return kd.empty;
	},
	update(e, t) {
		let n = t.state.facet(ld), r = t.annotation(od);
		if (r) {
			let i = _d.fromTransaction(t, r.selection), a = r.side, o = a == 0 ? e.undone : e.done;
			return o = i ? vd(o, o.length, n.minDepth, i) : wd(o, t.startState.selection), new kd(a == 0 ? r.rest : o, a == 0 ? o : r.rest);
		}
		let i = t.annotation(sd);
		if ((i == "full" || i == "before") && (e = e.isolate()), t.annotation(k.addToHistory) === !1) return t.changes.empty ? e : e.addMapping(t.changes.desc);
		let a = _d.fromTransaction(t), o = t.annotation(k.time), s = t.annotation(k.userEvent);
	...
	fromJSON(e) {
		return new kd(e.done.map(_d.fromJSON), e.undone.map(_d.fromJSON));
	}
});
function dd(e = {}) {
	return [
		...
		H.domEventHandlers({ beforeinput(e, t) {
			let n = e.inputType == "historyUndo" ? pd : e.inputType == "historyRedo" ? md : null;
...
var pd = /*@__PURE__*/ fd(0, !1), md = /*@__PURE__*/ fd(1, !1), hd = /*@__PURE__*/ fd(0, !0), gd = /*@__PURE__*/ fd(1, !0), _d = class e {
	constructor(e, t, n, r, i) {
	...
	static fromJSON(t) {
		return new e(t.changes && Fe.fromJSON(t.changes), [], t.mapped && Pe.fromJSON(t.mapped), t.startSelection && E.fromJSON(t.startSelection), t.selectionsAfter.map(E.fromJSON));
	}
	static fromTransaction(t, n) {
		let r = Sd;
		for (let e of t.startState.facet(cd)) {
			let n = e(t);
			n.length && (r = r.concat(n));
		}
		return !r.length && t.changes.empty ? null : new e(t.changes.invert(t.startState.doc), r, void 0, n || t.startState.selection, Sd);
	}
	static selection(t) {
		return new e(void 0, Sd, void 0, void 0, t);
	}
};
function vd(e, t, n, r) {
...
function wd(e, t) {
	if (e.length) {
		let n = e[e.length - 1], r = n.selectionsAfter.slice(Math.max(0, n.selectionsAfter.length - Cd));
		return r.length && r[r.length - 1].eq(t) ? e : (r.push(t), vd(e, e.length - 1, 1e9, n.setSelAfter(r)));
	}
	return [_d.selection([t])];
}
function Td(e) {
...
function Ed(e, t) {
	...
	return r.length ? [_d.selection(r)] : Sd;
}
function Dd(e, t, n) {
	let r = xd(e.selectionsAfter.length ? e.selectionsAfter.map((e) => e.map(t)) : Sd, n);
	if (!e.changes) return _d.selection(r);
	let i = e.changes.map(t), a = t.mapDesc(e.changes, !0), o = e.mapped ? e.mapped.composeDesc(a) : a;
	return new _d(i, O.mapEffects(e.effects, t), o, e.startSelection.map(a), r);
}
var Od = /^(input\.type|delete)($|\.)/, kd = class e {
	...
	addChanges(t, n, r, i, a) {
		...
		return o = s && s.changes && !s.changes.empty && t.changes && (!r || Od.test(r)) && (!s.selectionsAfter.length && n - this.prevTime < i.newGroupDelay && i.joinToEvent(a, yd(s.changes, t.changes)) || r == "input.type.compose") ? vd(o, o.length - 1, i.minDepth, new _d(t.changes.compose(s.changes), xd(O.mapEffects(t.effects, s.changes), s.effects), s.mapped, s.startSelection, Sd)) : vd(o, o.length, i.minDepth, t), new e(o, Sd, n, r);
	}
	addSelection(t, n, r, i) {
		let a = this.done.length ? this.done[this.done.length - 1].selectionsAfter : Sd;
		return a.length > 0 && n - this.prevTime < i && r == this.prevUserEvent && r && /^select($|\.)/.test(r) && bd(a[a.length - 1], t) ? this : new e(wd(this.done, t), this.undone, n, r);
	}
	addMapping(t) {
		return new e(Ed(this.done, t), Ed(this.undone, t), this.prevTime, this.prevUserEvent);
	}
	pop(e, t, n) {
		...
		if (i.changes) {
			let n = r.length == 1 ? Sd : r.slice(0, r.length - 1);
			return i.mapped && (n = Ed(n, i.mapped)), t.update({
				changes: i.changes,
...
kd.empty = /*@__PURE__*/ new kd(Sd, Sd);
var Ad = [
	{
		key: "Mod-z",
		run: pd,
...
function Nd({ state: e, dispatch: t }, n) {
	let r = jd(e.selection, n);
	return !r.eq(e.selection, !0) && (t(Md(e, r)), !0);
}
function Pd(e, t) {
	return E.cursor(t ? e.to : e.from);
}
function Fd(e, t) {
	return Nd(e, (n) => n.empty ? e.moveByChar(n, t) : Pd(n, t));
}
function X(e) {
	return e.textDirectionAt(e.state.selection.main.head) == L.LTR;
}
var Id = (e) => Fd(e, !X(e)), Ld = (e) => Fd(e, X(e));
function Rd(e, t) {
	return Nd(e, (n) => n.empty ? e.moveByGroup(n, t) : Pd(n, t));
}
var zd = (e) => Rd(e, !X(e)), Bd = (e) => Rd(e, X(e));
...
function Hd(e, t, n) {
	...
	for (let a = t.head;;) {
		...
		if (!t) break;
		Vd(e, t, i) ? r = t : a = n ? t.to : t.from;
	}
	let a = r.type.prop(i), o, s;
	return s = a && (o = n ? zu(e, r.from, 1) : zu(e, r.to, -1)) && o.matched ? n ? o.end.to : o.end.from : n ? r.to : r.from, E.cursor(s, n ? -1 : 1);
}
var Ud = (e) => Nd(e, (t) => Hd(e.state, t, !X(e))), Wd = (e) => Nd(e, (t) => Hd(e.state, t, X(e)));
function Gd(e, t) {
	return Nd(e, (n) => {
		if (!n.empty) return Pd(n, t);
		let r = e.moveVertically(n, t);
		return r.head == n.head ? e.moveToLineBoundary(n, t) : r;
	});
}
var Kd = (e) => Gd(e, !1), qd = (e) => Gd(e, !0);
function Jd(e) {
...
function Yd(e, t) {
	let n = Jd(e), { state: r } = e, i = jd(r.selection, (r) => r.empty ? e.moveVertically(r, t, n.height) : Pd(r, t));
	...
	return e.dispatch(Md(r, i), { effects: a }), !0;
}
var Xd = (e) => Yd(e, !1), Zd = (e) => Yd(e, !0);
function Qd(e, t, n) {
...
var $d = (e) => Nd(e, (t) => Qd(e, t, !0)), ef = (e) => Nd(e, (t) => Qd(e, t, !1)), tf = (e) => Nd(e, (t) => Qd(e, t, !X(e))), nf = (e) => Nd(e, (t) => Qd(e, t, X(e))), rf = (e) => Nd(e, (t) => E.cursor(e.lineBlockAt(t.head).from, 1)), af = (e) => Nd(e, (t) => E.cursor(e.lineBlockAt(t.head).to, -1));
function of(e, t, n) {
	let r = !1, i = jd(e.selection, (t) => {
		let i = zu(e, t.head, -1) || zu(e, t.head, 1) || t.head > 0 && zu(e, t.head - 1, 1) || t.head < e.doc.length && zu(e, t.head + 1, -1);
		if (!i || !i.end) return t;
		r = !0;
		let a = i.start.from == t.head ? i.end.to : i.end.from;
		return n ? E.range(t.anchor, a) : E.cursor(a);
	});
	return r ? (t(Md(e, i)), !0) : !1;
}
var sf = ({ state: e, dispatch: t }) => of(e, t, !1);
function cf(e, t, n) {
	let r = jd(e.state.selection, (e) => {
	...
	return !r.eq(e.state.selection) && (e.dispatch(Md(e.state, r)), !0);
}
function lf(e, t) {
	return cf(e, t, (n) => e.moveByChar(n, t));
}
var uf = (e) => lf(e, !X(e)), df = (e) => lf(e, X(e));
function ff(e, t) {
	return cf(e, t, (n) => e.moveByGroup(n, t));
}
var pf = (e) => ff(e, !X(e)), mf = (e) => ff(e, X(e)), hf = (e) => {
	let t = !X(e);
	return cf(e, t, (n) => Hd(e.state, n, t));
}, gf = (e) => {
	let t = X(e);
	return cf(e, t, (n) => Hd(e.state, n, t));
};
function _f(e, t) {
	return cf(e, t, (n) => e.moveVertically(n, t));
}
var vf = (e) => _f(e, !1), yf = (e) => _f(e, !0);
function bf(e, t) {
	return cf(e, t, (n) => e.moveVertically(n, t, Jd(e).height));
}
var xf = (e) => bf(e, !1), Sf = (e) => bf(e, !0), Cf = (e) => cf(e, !0, (t) => Qd(e, t, !0)), wf = (e) => cf(e, !1, (t) => Qd(e, t, !1)), Tf = (e) => {
	let t = !X(e);
	return cf(e, t, (n) => Qd(e, n, t));
}, Ef = (e) => {
	let t = X(e);
	return cf(e, t, (n) => Qd(e, n, t));
}, Df = (e) => cf(e, !1, (t) => E.cursor(e.lineBlockAt(t.head).from)), Of = (e) => cf(e, !0, (t) => E.cursor(e.lineBlockAt(t.head).to)), kf = ({ state: e, dispatch: t }) => (t(Md(e, { anchor: 0 })), !0), Af = ({ state: e, dispatch: t }) => (t(Md(e, { anchor: e.doc.length })), !0), jf = ({ state: e, dispatch: t }) => (t(Md(e, {
	anchor: e.selection.main.anchor,
	head: 0
})), !0), Mf = ({ state: e, dispatch: t }) => (t(Md(e, {
	anchor: e.selection.main.anchor,
	head: e.doc.length
})), !0), Nf = ({ state: e, dispatch: t }) => (t(e.update({
	selection: {
		anchor: 0,
		head: e.doc.length
	},
	userEvent: "select"
})), !0), Pf = ({ state: e, dispatch: t }) => {
	let n = $f(e).map(({ from: t, to: n }) => E.range(t, Math.min(n + 1, e.doc.length)));
	return t(e.update({
		selection: E.create(n),
		userEvent: "select"
	})), !0;
}, Ff = ({ state: e, dispatch: t }) => {
	let n = jd(e.selection, (t) => {
		...
		for (let e = r; e; e = e.next) {
			let { node: n } = e;
			if ((n.from < t.from && n.to >= t.to || n.to > t.to && n.from <= t.from) && e.next) return E.range(n.to, n.from);
		}
		return t;
	});
	return !n.eq(e.selection) && (t(Md(e, n)), !0);
};
function If(e, t) {
	...
	return i.length != r.ranges.length && (e.dispatch(Md(n, E.create(i, i.length - 1))), !0);
}
var Lf = (e) => If(e, !1), Rf = (e) => If(e, !0), zf = ({ state: e, dispatch: t }) => {
	let n = e.selection, r = null;
	return n.ranges.length > 1 ? r = E.create([n.main]) : n.main.empty || (r = E.create([E.cursor(n.main.head)])), r ? (t(Md(e, r)), !0) : !1;
};
function Bf(e, t) {
	...
	let n = "delete.selection", { state: r } = e, i = r.changeByRange((r) => {
		...
		if (i == a) {
			let o = t(r);
			o < i ? (n = "delete.backward", o = Vf(e, o, !1)) : o > i && (n = "delete.forward", o = Vf(e, o, !0)), i = Math.min(i, o), a = Math.max(a, o);
		} else i = Vf(e, i, !1), a = Vf(e, a, !0);
		return i == a ? { range: r } : {
			changes: {
				from: i,
				to: a
...
var Hf = (e, t, n) => Bf(e, (r) => {
	...
	if (n && !t && i > o.from && i < o.from + 200 && !/[^ \t]/.test(s = o.text.slice(0, i - o.from))) {
		...
		let e = Jt(s, a.tabSize) % ou(a) || ou(a);
	...
	return c;
}), Uf = (e) => Hf(e, !1, !0), Wf = (e) => Hf(e, !0, !1), Gf = (e, t) => Bf(e, (n) => {
	...
	return r;
}), Kf = (e) => Gf(e, !1), qf = (e) => Gf(e, !0), Jf = (e) => Bf(e, (t) => {
...
var tp = ({ state: e, dispatch: t }) => ep(e, t, !1), np = ({ state: e, dispatch: t }) => ep(e, t, !0);
function rp(e, t, n) {
	if (e.readOnly) return !1;
	let r = [];
...
var ip = ({ state: e, dispatch: t }) => rp(e, t, !1), ap = ({ state: e, dispatch: t }) => rp(e, t, !0), op = (e) => {
	if (e.state.readOnly) return !1;
...
var cp = /*@__PURE__*/ up(!1), lp = /*@__PURE__*/ up(!0);
function up(e) {
	return ({ state: t, dispatch: n }) => {
		if (t.readOnly) return !1;
		let r = t.changeByRange((n) => {
			let { from: r, to: i } = n, a = t.doc.lineAt(r), o = !e && r == i && sp(t, r);
			e && (r = i = (i <= a.to ? a : t.doc.lineAt(i)).to);
			let s = new lu(t, {
				simulateBreak: r,
				simulateDoubleBreak: !!o
			}), c = cu(s, r);
			for (c ??= Jt(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize); i < a.to && /\s/.test(a.text[i - a.from]);) i++;
			o ? {from: r, to: i} = o : r > a.from && r < a.from + 100 && !/\S/.test(a.text.slice(0, r)) && (r = a.from);
			let l = ["", su(t, c)];
			return o && l.push(su(t, s.lineIndent(a.from, -1))), {
				changes: {
					from: r,
					to: i,
					insert: x.of(l)
...
var fp = ({ state: e, dispatch: t }) => {
	if (e.readOnly) return !1;
	let n = Object.create(null), r = new lu(e, { overrideIndentation: (e) => n[e] ?? -1 }), i = dp(e, (t, i, a) => {
		let o = cu(r, t.from);
		if (o == null) return;
		/\S/.test(t.text) || (o = 0);
		let s = /^\s*/.exec(t.text)[0], c = su(e, o);
...
}, pp = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(dp(e, (t, n) => {
	n.push({
		from: t.from,
		insert: e.facet(au)
	});
}), { userEvent: "input.indent" })), !0), mp = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(dp(e, (t, n) => {
	let r = /^\s*/.exec(t.text)[0];
	if (!r) return;
	let i = Jt(r, e.tabSize), a = 0, o = su(e, Math.max(0, i - ou(e)));
...
}), { userEvent: "delete.dedent" })), !0), hp = (e) => (e.setTabFocusMode(), !0), gp = [
	{
		key: "Ctrl-b",
		run: Id,
		shift: uf,
	...
	matchBefore(e) {
		let t = this.state.doc.lineAt(this.pos), n = Math.max(t.from, this.pos - 250), r = t.text.slice(n - t.from, this.pos - t.from), i = r.search(wp(e, !1));
		return i < 0 ? null : {
			from: n + i,
			to: this.pos,
			text: r.slice(i)
...
function Sp(e) {
	let t = e.map((e) => typeof e == "string" ? { label: e } : e), [n, r] = t.every((e) => /^\w+$/.test(e.label)) ? [/\w*$/, /\w+$/] : xp(t);
	return (e) => {
...
var Tp = /*@__PURE__*/ mt.define();
typeof navigator == "object" && navigator.platform;
var Ep = /*@__PURE__*/ H.baseTheme({
	...
	instantiate(e, t) {
		...
		for (let i of this.lines) {
			if (n.length) {
				...
				for (let t = 0; t < o; t++) n += e.facet(au);
		...
		return {
			text: n,
			ranges: this.fieldPositions.map((e) => new Op(e.field, r[e.line] + e.from, r[e.line] + e.to))
		};
	}
	static parse(t) {
		let n = [], r = [], i = [], a;
		for (let e of t.split(/\r\n?|\n/)) {
			for (; a = /[#$]\{(?:(\d+)(?::([^{}]*))?|((?:\\[{}]|[^{}])*))\}/.exec(e);) {
				...
				i.push(new Dp(s, r.length, a.index, a.index + c.length)), e = e.slice(0, a.index) + o + e.slice(a.index + a[0].length);
			}
			e = e.replace(/\\([{}])/g, (e, t, n) => {
...
}, Ap = /*@__PURE__*/ I.widget({ widget: /*@__PURE__*/ new class extends En {
	toDOM() {
		let e = document.createElement("span");
...
}() }), jp = /*@__PURE__*/ I.mark({ class: "cm-snippetField" }), Mp = class e {
	constructor(e, t) {
		this.ranges = e, this.active = t, this.deco = I.set(e.map((e) => (e.from == e.to ? Ap : jp).range(e.from, e.to)), !0);
	}
	map(t) {
		let n = [];
...
}, Np = /*@__PURE__*/ O.define({ map(e, t) {
	return e && e.map(t);
} }), Pp = /*@__PURE__*/ O.define(), Fp = /*@__PURE__*/ Xe.define({
	create() {
		return null;
	},
	update(e, t) {
		for (let n of t.effects) {
			if (n.is(Np)) return n.value;
			if (n.is(Pp) && e) return new Mp(e.ranges, n.value);
		}
...
function Lp(e) {
	...
	return (e, n, r, i) => {
		let { text: a, ranges: o } = t.instantiate(e.state, r), { main: s } = e.state.selection, c = {
			...
			scrollIntoView: !0,
			annotations: n ? [Tp.of(n), k.userEvent.of("input.complete")] : void 0
		};
		if (o.length && (c.selection = Ip(o, 0)), o.some((e) => e.field > 0)) {
			let t = new Mp(o, 0), n = c.effects = [Np.of(t)];
			e.state.field(Fp, !1) === void 0 && n.push(O.appendConfig.of([
				Fp,
				Vp,
				Up,
				Ep
...
function Rp(e) {
	return ({ state: t, dispatch: n }) => {
		...
		return n(t.update({
			selection: Ip(r.ranges, i),
			effects: Np.of(a ? null : new Mp(r.ranges, i)),
			scrollIntoView: !0
		})), !0;
	};
}
var zp = [{
	...
	key: "Escape",
	run: ({ state: e, dispatch: t }) => e.field(Fp, !1) ? (t(e.update({ effects: Np.of(null) })), !0) : !1
}], Bp = /*@__PURE__*/ D.define({ combine(e) {
	return e.length ? e[0] : zp;
} }), Vp = /*@__PURE__*/ $e.highest(/*@__PURE__*/ ls.compute([Bp], (e) => e.facet(Bp)));
function Hp(e, t) {
	return {
		...t,
		apply: Lp(e)
...
var Up = /*@__PURE__*/ H.domEventHandlers({ mousedown(e, t) {
	let n = t.state.field(Fp, !1), r;
	...
	return !i || i.field == n.active ? !1 : (t.dispatch({
		selection: Ip(n.ranges, i.field),
		effects: Np.of(n.ranges.some((e) => e.field > i.field) ? new Mp(n.ranges, i.field) : null),
		scrollIntoView: !0
	}), !0);
...
var Gp = [
	...
	constructor(e, t, n, r, i, a, o) {
		this.type = e, this.value = t, this.from = n, this.hash = r, this.end = i, this.children = a, this.positions = o, this.hashProp = [[U.contextHash, r]];
	}
	addChild(e, t) {
		e.prop(U.contextHash) != this.hash && (e = new K(e.type, e.children, e.positions, e.length, this.hashProp)), this.children.push(e), this.positions.push(t);
	}
	toTree(e, t = this.end) {
		let n = this.children.length - 1;
		return n >= 0 && (t = Math.max(t, this.positions[n] + this.children[n].length + this.from)), new K(e.types[this.type], this.children, this.positions, t - this.from).balance({ makeTree: (e, t, n) => new K(W.none, e, t, n, this.hashProp) });
	}
}, Z;
(function(e) {
...
function Yp(e, t, n) {
	...
	let r = (e.type == Z.OrderedList ? am : im)(n, t, !1);
	return r > 0 && (e.type != Z.BulletList || nm(n, t, !1) < 0) && n.text.charCodeAt(n.pos + r - 1) == e.value;
}
var Xp = {
	[Z.Blockquote](e, t, n) {
		return n.next == 62 && (n.markers.push(Q(Z.QuoteMark, t.lineStart + n.pos, t.lineStart + n.pos + 1)), n.moveBase(n.pos + (Zp(n.text.charCodeAt(n.pos + 1)) ? 2 : 1)), e.end = t.lineStart + n.text.length, !0);
	},
	[Z.ListItem](e, t, n) {
...
function Qp(e, t = 0) {
	for (; t < e.length && Zp(e.charCodeAt(t));) t++;
	return t;
}
function $p(e, t, n) {
	for (; t > n && Zp(e.charCodeAt(t - 1));) t--;
	return t;
}
function em(e) {
...
function nm(e, t, n) {
	...
	for (let t = e.pos + 1; t < e.text.length; t++) {
		...
		if (n == e.next) r++;
		else if (!Zp(n)) return -1;
	}
	return n && e.next == 45 && sm(e) > -1 && e.depth == t.stack.length && t.parser.leafBlockParsers.indexOf(ym.SetextHeading) > -1 || r < 3 ? -1 : 1;
}
function rm(e, t) {
...
function im(e, t, n) {
	return (e.next == 45 || e.next == 43 || e.next == 42) && (e.pos == e.text.length - 1 || Zp(e.text.charCodeAt(e.pos + 1))) && (!n || rm(t, Z.BulletList) || e.skipSpace(e.pos + 2) < e.text.length) ? 1 : -1;
}
function am(e, t, n) {
	...
	return r == e.pos || r > e.pos + 9 || i != 46 && i != 41 || r < e.text.length - 1 && !Zp(e.text.charCodeAt(r + 1)) || n && !rm(t, Z.OrderedList) && (e.skipSpace(r + 1) == e.text.length || r > e.pos + 1 || e.next != 49) ? -1 : r + 1 - e.pos;
}
function om(e) {
...
function sm(e) {
	...
	for (; t < e.text.length && e.text.charCodeAt(t) == e.next;) t++;
	let n = t;
	for (; t < e.text.length && Zp(e.text.charCodeAt(t));) t++;
...
var cm = /^[ \t]*$/, lm = /-->/, um = /\?>/, dm = [
	...
	[/^\s*<![A-Z]/, />/],
	[/^\s*<!\[CDATA\[/, /\]\]>/],
	[/^\s*<\/?(?:address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h1|h2|h3|h4|h5|h6|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul)(?:\s|\/?>|$)/i, cm],
	[/^\s*(?:<\/[a-z][\w-]*\s*>|<[a-z][\w-]*(\s+[a-z:_][\w-.]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*>)\s*$/i, cm]
];
function fm(e, t, n) {
	if (e.next != 60) return -1;
	let r = e.text.slice(e.pos);
	for (let e = 0, t = dm.length - +!!n; e < t; e++) if (dm[e][0].test(r)) return e;
	return -1;
}
function pm(e, t) {
...
var hm = {
	...
	IndentedCode(e, t) {
		...
		for (mm(o, i, a); e.nextLine() && t.depth >= e.stack.length;) if (t.pos == t.text.length) {
			mm(s, e.lineStart - 1, e.lineStart);
			for (let e of t.markers) s.push(e);
		} else if (t.indent < n) break;
		else {
			if (s.length) {
				for (let e of s) e.type == Z.CodeText ? mm(o, e.from, e.to) : o.push(e);
				s = [];
			}
			mm(o, e.lineStart - 1, e.lineStart);
	...
	FencedCode(e, t) {
		let n = em(t);
		if (n < 0) return !1;
		let r = e.lineStart + t.pos, i = t.next, a = n - t.pos, o = t.skipSpace(n), s = $p(t.text, t.text.length, o), c = [Q(Z.CodeMark, r, r + a)];
		...
		for (let n = !0, r = !0, o = !1; e.nextLine() && t.depth >= e.stack.length; n = !1) {
			...
			if (s - t.pos >= a && t.skipSpace(s) == t.text.length) {
				...
				r && o && mm(c, e.lineStart - 1, e.lineStart), c.push(Q(Z.CodeMark, e.lineStart + t.pos, e.lineStart + s)), e.nextLine();
				break;
			}
			{
				o = !0, n || (mm(c, e.lineStart - 1, e.lineStart), r = !1);
				for (let e of t.markers) c.push(e);
	...
	ATXHeading(e, t) {
		let n = om(t);
		if (n < 0) return !1;
		let r = t.pos, i = e.lineStart + r, a = $p(t.text, t.text.length, r), o = a;
		for (; o > r && t.text.charCodeAt(o - 1) == t.next;) o--;
		(o == a || o == r || !Zp(t.text.charCodeAt(o - 1))) && (o = t.text.length);
	...
	HTMLBlock(e, t) {
		let n = fm(t, e, !1);
		if (n < 0) return !1;
		let r = e.lineStart + t.pos, i = dm[n][1], a = [], o = i != cm;
		...
		o && e.nextLine();
		let s = i == lm ? Z.CommentBlock : i == um ? Z.ProcessingInstructionBlock : Z.HTMLBlock, c = e.prevLineEnd();
	...
	finish(e, t) {
		return (this.stage == 2 || this.stage == 3) && Qp(t.content, this.pos) == t.content.length && this.complete(e, t, t.content.length);
	}
	complete(e, t, n) {
	...
	advance(e) {
		for (;;) if (this.stage == -1) return -1;
			...
			if (!this.nextStage(Wm(e, this.pos, this.start, !0))) return -1;
			...
			if (!this.nextStage(Hm(e, Qp(e, this.pos), this.start))) return -1;
		} else if (this.stage == 2) {
			let t = Qp(e, this.pos), n = 0;
			if (t > this.pos) {
				let r = Um(e, t, this.start);
				if (r) {
					let t = _m(e, r.to - this.start);
					t > 0 && (this.nextStage(r), n = t);
				}
			}
			return n ||= _m(e, this.pos), n > 0 && n < e.length ? n : -1;
		} else return _m(e, this.pos);
	}
};
function _m(e, t) {
	for (; t < e.length; t++) {
...
var vm = class {
	nextLine(e, t, n) {
		let r = t.depth < e.stack.length ? -1 : sm(t), i = t.next;
		if (r < 0) return !1;
	...
	LinkReference(e, t) {
		return t.content.charCodeAt(0) == 91 ? new gm(t) : null;
	},
	SetextHeading() {
		return new vm();
	}
	...
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.line = new Jp(), this.atEnd = !1, this.reusePlaceholders = /* @__PURE__ */ new Map(), this.stoppedAt = null, this.rangeI = 0, this.to = r[r.length - 1].to, this.lineStart = this.absoluteLineStart = this.absoluteLineEnd = r[0].from, this.block = Kp.create(Z.Document, 0, this.lineStart, 0, 0), this.stack = [this.block], this.fragments = n.length ? new Jm(n, t) : null, this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let t = new qp(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	reuseFragment(e) {
		...
		return t ? (this.absoluteLineStart += t, this.lineStart = Ym(this.absoluteLineStart, this.ranges), this.moveRangeI(), this.absoluteLineStart < this.to ? (this.lineStart++, this.absoluteLineStart++, this.readLine()) : (this.atEnd = !0, this.readLine()), !0) : !1;
	}
	get depth() {
	...
	startContext(e, t, n = 0) {
		this.block = Kp.create(e, n, this.lineStart + t, this.block.hash, this.lineStart + this.line.text.length), this.stack.push(this.block);
	}
	startComposite(e, t, n = 0) {
		this.startContext(this.parser.getNodeType(e), t, n);
	}
	addNode(e, t, n) {
		typeof e == "number" && (e = new K(this.parser.nodeSet.types[e], km, km, (n ?? this.prevLineEnd()) - t)), this.block.addChild(e, t - this.block.from);
	}
	addElement(e) {
		this.block.addChild(e.toTree(this.parser.nodeSet), e.from - this.block.from);
	}
	addLeafElement(e, t) {
		this.addNode(this.buffer.writeElements(Km(t.children, e.marks), -t.from).finish(t.type, t.to - t.from), t.from);
	}
	finishContext() {
	...
	addGaps(e) {
		return this.ranges.length > 1 ? Cm(this.ranges, 0, e.topNode, this.ranges[0].from, this.reusePlaceholders) : e;
	}
	finishLeaf(e) {
		for (let t of e.parsers) if (t.finish(this, e)) return;
		let t = Km(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(this.buffer.writeElements(t, -e.start).finish(Z.Paragraph, e.content.length), e.start);
	}
	elt(e, t, n, r) {
		return typeof e == "string" ? Q(this.parser.getNodeType(e), t, n, r) : new Mm(e, t);
	}
	get buffer() {
		return new Am(this.parser.nodeSet);
	}
};
function Cm(e, t, n, r, i) {
	...
	for (let u = n.firstChild; u; u = u.nextSibling) {
		...
		f ? d = f : u.to + r > a ? (d = Cm(e, t, u, r, i), l(u.to + r, !1)) : d = u.toTree(), o.push(d), s.push(n - c);
	}
	return l(n.to + r, !1), new K(n.type, o, s, n.to + r - c, n.tree ? n.tree.propValues : void 0);
}
var wm = class e extends Zc {
		...
		if (Tm(n.defineNodes)) {
			...
			for (let r of n.defineNodes) {
				...
				e.push(W.define({
					...
					name: n,
					props: l && [[U.group, l]]
				})), s && (t ||= {}, Array.isArray(s) || s instanceof ml ? t[n] = s : Object.assign(t, s));
			}
			r = new Dc(e), t && (r = r.extend(yl(t)));
		}
		if (Tm(n.props) && (r = r.extend(...n.props)), Tm(n.remove)) for (let e of n.remove) {
			let t = this.blockNames.indexOf(e), n = this.inlineNames.indexOf(e);
			t > -1 && (a[t] = o[t] = void 0), n > -1 && (c[n] = void 0);
		}
		if (Tm(n.parseBlock)) for (let e of n.parseBlock) {
			let t = s.indexOf(e.name);
			if (t > -1) a[t] = e.parse, o[t] = e.leaf;
			else {
				let t = e.before ? Dm(s, e.before) : e.after ? Dm(s, e.after) + 1 : s.length - 1;
				a.splice(t, 0, e.parse), o.splice(t, 0, e.leaf), s.splice(t, 0, e.name);
			}
			e.endLeaf && u.push(e.endLeaf);
		}
		if (Tm(n.parseInline)) for (let e of n.parseInline) {
			let t = l.indexOf(e.name);
			if (t > -1) c[t] = e.parse;
			else {
				let t = e.before ? Dm(l, e.before) : e.after ? Dm(l, e.after) + 1 : l.length - 1;
...
function Em(e) {
	...
	let n = Em(e.slice(1));
	if (!n || !t) return t || n;
	let r = (e, t) => (e || km).concat(t || km), i = t.wrap, a = n.wrap;
	return {
...
var Om = [W.none];
for (let e = 1, t; t = Z[e]; e++) Om[e] = W.define({
	id: e,
	name: t,
	props: e >= Z.Escape ? [] : [[U.group, e in Xp ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
	top: t == "Document"
});
var km = [], Am = class {
	constructor(e) {
	...
	toTree(e) {
		return new Am(e).writeElements(this.children, -this.from).finish(this.type, this.to - this.from);
	}
}, Mm = class {
	constructor(e, t) {
...
try {
	zm = /* @__PURE__ */ RegExp("[\\p{S}|\\p{P}]", "u");
} catch {}
var Bm = {
	Escape(e, t, n) {
		if (t != 92 || n == e.end - 1) return -1;
		let r = e.char(n + 1);
		for (let t = 0; t < 32; t++) if (Rm.charCodeAt(t) == r) return e.append(Q(Z.Escape, n, n + 2));
		return -1;
	},
	Entity(e, t, n) {
		if (t != 38) return -1;
	...
	Emphasis(e, t, n) {
		...
		let r = n + 1;
		for (; e.char(r) == t;) r++;
		let i = e.slice(n - 1, n), a = e.slice(r, r + 1), o = zm.test(i), s = zm.test(a), c = /\s|^$/.test(i), l = /\s|^$/.test(a), u = !l && (!s || c || o), d = !c && (!o || l || s), f = u && (t == 42 || !d || o), p = d && (t == 42 || !u || s);
		return e.append(new Lm(t == 95 ? Nm : Pm, n, r, !!f | (p ? 2 : 0)));
	},
	HardBreak(e, t, n) {
	...
	Link(e, t, n) {
		return t == 91 ? e.append(new Lm(Fm, n, n + 1, 1)) : -1;
	},
	Image(e, t, n) {
		return t == 33 && e.char(n + 1) == 91 ? e.append(new Lm(Im, n, n + 2, 1)) : -1;
	},
	LinkEnd(e, t, n) {
		if (t != 93) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let r = e.parts[t];
			if (r instanceof Lm && (r.type == Fm || r.type == Im)) {
				if (!r.side || e.skipSpace(r.to) == n && !/[(\[]/.test(e.slice(n + 1, n + 2))) return e.parts[t] = null, -1;
				let i = e.takeContent(t), a = e.parts[t] = Vm(e, i, r.type == Fm ? Z.Link : Z.Image, r.from, n + 1);
				if (r.type == Fm) for (let n = 0; n < t; n++) {
					let t = e.parts[n];
					t instanceof Lm && t.type == Fm && (t.side = 0);
				}
				return a.to;
			}
		}
...
function Vm(e, t, n, r, i) {
	...
	if (t.unshift(Q(Z.LinkMark, r, r + (n == Z.Image ? 2 : 1))), t.push(Q(Z.LinkMark, i - 1, i)), o == 40) {
		let n = e.skipSpace(i + 1), r = Hm(a, n - e.offset, e.offset), o;
		r && (n = e.skipSpace(r.to), n != r.to && (o = Um(a, n - e.offset, e.offset), o && (n = e.skipSpace(o.to)))), e.char(n) == 41 && (t.push(Q(Z.LinkMark, i, i + 1)), s = n + 1, r && t.push(r), o && t.push(o), t.push(Q(Z.LinkMark, n, s)));
	} else if (o == 91) {
		let n = Wm(a, i - e.offset, e.offset, !1);
		n && (t.push(n), s = n.to);
	}
	return Q(n, r, s, t);
}
...
var Gm = class {
	...
	addDelimiter(e, t, n, r, i) {
		return this.append(new Lm(e, t, n, !!r | (i ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof Lm && (t.type == Fm || t.type == Im)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let n = this.parts[t];
			if (!(n instanceof Lm && n.type.resolve && n.side & 2)) continue;
			let r = n.type == Nm || n.type == Pm, i = n.to - n.from, a, o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
				if (e instanceof Lm && e.side & 1 && e.type == n.type && !(r && (n.side & 1 || e.side & 2) && (e.to - e.from + i) % 3 == 0 && ((e.to - e.from) % 3 || i % 3))) {
					a = e;
					break;
				}
			}
			...
			for (let e = o + 1; e < t; e++) this.parts[e] instanceof jm && c.push(this.parts[e]), this.parts[e] = null;
			n.type.mark && c.push(this.elt(n.type.mark, n.from, u));
			let d = this.elt(s, l, u, c);
			this.parts[o] = r && a.from != l ? new Lm(a.type, a.from, l, a.side) : null, (this.parts[t] = r && n.to != u ? new Lm(n.type, u, n.to, n.side) : null) ? this.parts.splice(t, 0, d) : this.parts[t] = d;
		}
		let t = [];
		for (let n = e; n < this.parts.length; n++) {
			let e = this.parts[n];
			e instanceof jm && t.push(e);
		}
		return t;
	}
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let n = this.parts[t];
			if (n instanceof Lm && n.type == e && n.side & 1) return t;
		}
		return null;
	}
	takeContent(e) {
	...
	skipSpace(e) {
		return Qp(this.text, e - this.offset) + this.offset;
	}
	elt(e, t, n, r) {
		return typeof e == "string" ? Q(this.parser.getNodeType(e), t, n, r) : new Mm(e, t);
	}
};
Gm.linkStart = Fm, Gm.imageStart = Im;
function Km(e, t) {
	...
	for (let e of t) {
		...
		if (r < n.length && n[r].from < e.from) {
			let t = n[r];
			t instanceof jm && (n[r] = new jm(t.type, t.from, t.to, Km(t.children, [e])));
		} else n.splice(r++, 0, e);
	}
	return n;
}
var qm = [
	...
	matches(e) {
		...
		return t && t.prop(U.contextHash) == e;
	}
	takeNodes(e) {
		...
		for (;;) {
			...
			if (t.type.is("Block") && (qm.indexOf(t.type.id) < 0 ? (a = t.to - n, o = e.block.children.length) : (a = s, o = c), s = t.to - n, c = e.block.children.length), !t.nextSibling()) break;
		}
...
var Xm = yl({
	...
	LinkTitle: J.string,
	Paragraph: J.content
}), Zm = new wm(new Dc(Om).extend(Xm), Object.keys(hm).map((e) => hm[e]), Object.keys(hm).map((e) => ym[e]), Object.keys(hm), bm, Xp, Object.keys(Bm).map((e) => Bm[e]), Object.keys(Bm), []);
function Qm(e, t, n) {
	let r = [];
...
var eh = {
	...
	parseInline: [{
		...
		parse(e, t, n) {
			...
			let r = e.slice(n - 1, n), i = e.slice(n + 2, n + 3), a = /\s|^$/.test(r), o = /\s|^$/.test(i), s = zm.test(r), c = zm.test(i);
			return e.addDelimiter(eh, n, n + 2, !o && (!c || a || s), !a && (!s || o || c));
		},
		after: "Emphasis"
	}]
};
function nh(e, t, n = 0, r, i = 0) {
...
var ih = /^[>\s]*\|?(\s*:?-+:?\s*\|)+(\s*:?-+:?\s*)?$/, ah = class {
	...
	nextLine(e, t, n) {
		if (this.rows == null) {
			this.rows = !1;
			let r;
			if ((t.next == 45 || t.next == 58 || t.next == 124) && ih.test(r = t.text.slice(t.pos))) {
				let i = [];
				nh(e, n.content, 0, i, n.start) == nh(e, r, 0) && (this.rows = [e.elt("TableHeader", n.start, n.start + n.content.length, i), e.elt("TableDelimiter", e.lineStart + t.pos, e.lineStart + t.text.length)]);
			}
		} else if (this.rows) {
			let n = [];
			nh(e, t.text, t.pos, n, e.lineStart), this.rows.push(e.elt("TableRow", e.lineStart + t.pos, e.lineStart + t.text.length, n));
		}
		return !1;
	}
	finish(e, t) {
	...
	parseBlock: [{
		name: "Table",
		leaf(e, t) {
			return rh(t.content, 0) ? new ah() : null;
		},
		endLeaf(e, t, n) {
			if (n.parsers.some((e) => e instanceof ah) || !rh(t.text, t.basePos)) return !1;
			let r = e.peekLine();
			return ih.test(r) && nh(e, t.text, t.basePos) == nh(e, r, t.basePos);
		},
	...
	parseBlock: [{
		name: "TaskList",
		leaf(e, t) {
			return /^\[[ xX]\][ \t]/.test(t.content) && e.parentType().name == "ListItem" ? new sh() : null;
		},
		after: "SetextHeading"
	}]
}, lh = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy, uh = /[\w-]+(\.[\w-]+)+(:\d+)?(\/[^\s<]*)?/gy, dh = /[\w-]+\.[\w-]+($|[/:])/, fh = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy, ph = /\/[a-zA-Z\d@.]+/gy;
function mh(e, t, n, r) {
	let i = 0;
...
function hh(e, t) {
	uh.lastIndex = t;
	let n = uh.exec(e);
	if (!n || dh.exec(n[0])[0].indexOf("_") > -1) return -1;
	let r = t + n[0].length;
	for (;;) {
		let n = e[r - 1], i;
		if (/[?!.,:*_~]/.test(n) || n == ")" && mh(e, t, r, ")") > mh(e, t, r, "(")) r--;
...
var _h = [
	...
	{ parseInline: [{
		...
		parse(e, t, n) {
			...
			lh.lastIndex = r;
			let i = lh.exec(e.text), a = -1;
			return !i || (i[1] || i[2] ? (a = hh(e.text, r + i[0].length), a > -1 && e.hasOpenLink && (a = r + /([^\[\]]|\[[^\]]*\])*/.exec(e.text.slice(r, a))[0].length)) : i[3] ? a = gh(e.text, r) : (a = gh(e.text, r + i[0].length), a > -1 && i[0] == "xmpp:" && (ph.lastIndex = a, i = ph.exec(e.text), i && (a = i.index + i[0].length))), a < 0) ? -1 : (e.addElement(e.elt("URL", n, a + e.offset)), a + e.offset);
		}
	}] }
];
function vh(e, t, n) {
	return (r, i, a) => {
		...
		for (let i = a + 1; i < r.end; i++) {
			...
			if (s == 92 && o.push(r.elt("Escape", i, i++ + 2)), Zp(s)) break;
		}
		return -1;
	};
}
var yh = {
	...
	parseInline: [{
		name: "Superscript",
		parse: vh(94, "Superscript", "SuperscriptMark")
	}]
}, bh = {
	defineNodes: [{
		name: "Subscript",
	...
	parseInline: [{
		name: "Subscript",
		parse: vh(126, "Subscript", "SubscriptMark")
	}]
}, xh = {
	defineNodes: [{
		name: "Emoji",
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new Ch(i, i.start) : null, 0, null);
	}
	get context() {
...
var Dh = class {
	...
	token(e, t) {
		let { parser: n } = t.p;
		Nh(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
Ah.prototype.contextual = Ah.prototype.fallback = Ah.prototype.extend = !1;
var jh = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? Eh(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
			let n = e.next < 0, i = e.resolveOffset(1, 1);
			if (Nh(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1) break;
...
jh.prototype.contextual = Ah.prototype.fallback = Ah.prototype.extend = !1;
var Mh = class {
	constructor(e, t = {}) {
...
function Nh(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || Fh(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function Fh(e, t, n, r) {
	let i = Ph(n, r, t);
	return i < 0 || Ph(n, r, e) < i;
}
var Ih = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Lh = null;
function Rh(e, t, n) {
...
var zh = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? Rh(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? Rh(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new Dh());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new Dh(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new Dh(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) {
				if (o[s + 1] == 1) s = qh(o, s + 2);
				else {
					r == 0 && o[s + 1] == 2 && (r = this.putAction(qh(o, s + 2), t, n, r));
					break;
				}
			}
			o[s] == t && (r = this.putAction(qh(o, s + 1), t, n, r));
		}
		return r;
	}
}, Vh = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new kh(t, r), this.tokens = new Bh(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [Sh.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new zh(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	advance() {
		...
		if (!n.length) {
			let e = r && Jh(r);
			if (e) return Ih && console.log("Finish with " + this.stackID(e)), this.stackToTree(e);
			if (this.parser.strict) throw Ih && r && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), SyntaxError("No parse at " + t);
			this.recovering ||= 5;
		}
		if (this.recovering && r) {
			let e = this.stoppedAt != null && r[0].pos > this.stoppedAt ? r[0] : this.runRecovery(r, i, n);
			if (e) return Ih && console.log("Force-finish " + this.stackID(e)), this.stackToTree(e.forceAll());
		}
		if (this.recovering) {
	...
	advanceStack(e, t, n) {
		let r = e.pos, { parser: i } = this, a = Ih ? this.stackID(e) + " -> " : "";
		...
		if (this.fragments) {
			...
			for (let o = this.fragments.nodeAt(r); o;) {
				...
				if (r > -1 && o.length && (!t || (o.prop(U.contextHash) || 0) == n)) return e.useNode(o, r), Ih && console.log(a + this.stackID(e) + ` (via reuse of ${i.getName(o.type.id)})`), !0;
		...
		if (o > 0) return e.reduce(o), Ih && console.log(a + this.stackID(e) + ` (via always-reduce ${i.getName(o & 65535)})`), !0;
		...
		for (let o = 0; o < s.length;) {
			...
			if (f.apply(c, l, p ? p.start : f.pos, u), Ih && console.log(a + this.stackID(f) + ` (via ${c & 65536 ? `reduce of ${i.getName(c & 65535)}` : "shift"} for ${i.getName(l)} @ ${r}${f == e ? "" : ", split"})`), d) return !0;
	...
	advanceFully(e, t) {
		...
		for (;;) {
			...
			if (e.pos > n) return Hh(e, t), !0;
		}
	}
	runRecovery(e, t, n) {
		let r = null, i = !1;
		for (let a = 0; a < e.length; a++) {
			let o = e[a], s = t[a << 1], c = t[(a << 1) + 1], l = Ih ? this.stackID(o) + " -> " : "";
			if (o.deadEnd && (i || (i = !0, o.restart(), Ih && console.log(l + this.stackID(o) + " (restarted)"), this.advanceFully(o, n)))) continue;
			let u = o.split(), d = l;
			for (let e = 0; e < 10 && u.forceReduce() && (Ih && console.log(d + this.stackID(u) + " (via force-reduce)"), !this.advanceFully(u, n)); e++) Ih && (d = this.stackID(u) + " -> ");
			for (let e of o.recoverByInsert(s)) Ih && console.log(l + this.stackID(e) + " (via recover-insert)"), this.advanceFully(e, n);
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), Ih && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), Hh(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Lh ||= /* @__PURE__ */ new WeakMap()).get(e);
...
var Uh = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Wh, this.reduce = e.reduce || Wh, this.reuse = e.reuse || Wh, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Kh = class e extends Zc {
	constructor(e) {
		...
		this.nodeSet = new Dc(t.map((t, i) => W.define({
		...
		let a = Eh(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Yh), this.states = Eh(e.states, Uint32Array), this.data = Eh(e.stateData), this.goto = Eh(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new Ah(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new Vh(this, e, t, n);
		for (let i of this.wrappers) r = i(r, e, t, n);
		return r;
	}
	getGoto(e, t, n = !1) {
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) {
				if (n[i + 1] == 1) a = n[i = qh(n, i + 2)];
				else if (n[i + 1] == 2) return qh(n, i + 2);
				else break;
			}
			if (a == t || a == 0) return qh(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) {
				if (this.data[n + 1] == 1) n = qh(this.data, n + 2);
				else break;
			}
			r = t(qh(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Yh(a), a;
...
var Ng = null, Pg = null, Fg = 0;
function Ig(e, t) {
	let n = e.pos + t;
	if (Fg == n && Pg == e) return Ng;
	let r = e.peek(t), i = "";
	for (; Mg(r);) i += String.fromCharCode(r), r = e.peek(++t);
	return Pg = e, Fg = n, Ng = i ? i.toLowerCase() : r == Bg || r == Vg ? void 0 : null;
}
var Lg = 60, Rg = 62, zg = 47, Bg = 63, Vg = 33, Hg = 45;
function Ug(e, t) {
...
var Wg = [
	...
	start: null,
	shift(e, t, n, r) {
		return Wg.indexOf(t) > -1 ? new Ug(Ig(r, 1) || "", e) : e;
	},
	reduce(e, t) {
		return t == gg && e ? e.parent : e;
	},
	reuse(e, t, n, r) {
		let i = t.type.id;
		return i == ig || i == Tg ? new Ug(Ig(r, 1) || "", e) : e;
	},
	strict: !1
}), Kg = new Mh((e, t) => {
	if (e.next != Lg) {
		e.next < 0 && t.context && e.acceptToken(fg);
		return;
	}
	e.advance();
	let n = e.next == zg;
	...
	let r = Ig(e, 0);
	if (r === void 0) return;
	if (!r) return e.acceptToken(n ? mg : pg);
	let i = t.context ? t.context.name : null;
	if (n) {
		if (r == i) return e.acceptToken(lg);
		if (i && Ag[i]) return e.acceptToken(fg, -2);
		if (t.dialectEnabled(Dg)) return e.acceptToken(ug);
		for (let e = t.context; e; e = e.parent) if (e.name == r) return;
		e.acceptToken(dg);
	} else {
		if (r == "script") return e.acceptToken(ag);
		if (r == "style") return e.acceptToken(og);
		if (r == "textarea") return e.acceptToken(sg);
		if (kg.hasOwnProperty(r)) return e.acceptToken(cg);
		i && jg[i] && jg[i][r] ? e.acceptToken(fg, -1) : e.acceptToken(ig);
	}
}, { contextual: !0 }), qg = new Mh((e) => {
	for (let t = 0, n = 0;; n++) {
		if (e.next < 0) {
			n && e.acceptToken(hg);
			break;
		...
		if (e.next == Hg) t++;
		else if (e.next == Rg && t >= 2) {
			n >= 3 && e.acceptToken(hg, -2);
			break;
		} else t = 0;
		e.advance();
	}
...
var Yg = new Mh((e, t) => {
	if (e.next == zg && e.peek(1) == Rg) {
		let n = t.dialectEnabled(Og) || Jg(t.context);
		e.acceptToken(n ? rg : ng, 2);
	} else e.next == Rg && e.acceptToken(ng, 1);
});
function Xg(e, t, n) {
	let r = 2 + e.length;
	return new Mh((i) => {
		for (let a = 0, o = 0, s = 0;; s++) {
			...
			if (a == 0 && i.next == Lg || a == 1 && i.next == zg || a >= 2 && a < r && i.next == e.charCodeAt(a - 2)) a++, o++;
			else if (a == r && i.next == Rg) {
...
var Zg = Xg("script", Xh, Zh), Qg = Xg("style", Qh, $h), $g = Xg("textarea", eg, tg), e_ = yl({
...
function n_(e, t) {
	let n = Object.create(null);
	for (let r of e.getChildren(vg)) {
		let e = r.getChild(yg), i = r.getChild(bg) || r.getChild(xg);
		e && (n[t.read(e.from, e.to)] = i ? i.type.id == bg ? t.read(i.from + 1, i.to - 1) : t.read(i.from, i.to) : "");
	}
	return n;
}
function r_(e, t) {
...
function i_(e, t, n) {
	let r;
	for (let i of n) if (!i.attrs || i.attrs(r ||= n_(e.node.parent.firstChild, t))) return {
		parser: i.parser,
		bracketed: !0
	};
	return null;
...
function a_(e = [], t = []) {
	...
	return $c((e, t) => {
		let s = e.type.id;
		if (s == Sg) return i_(e, t, n);
		if (s == Cg) return i_(e, t, r);
		if (s == wg) return i_(e, t, i);
		if (s == gg && a.length) {
			let n = e.node, r = n.firstChild, i = r && r_(r, t), o;
			if (i) {
				for (let e of a) if (e.tag == i && (!e.attrs || e.attrs(o ||= n_(r, t)))) {
					let t = n.lastChild, i = t.type.id == Eg ? t.from : n.to;
					if (i > r.to) return {
						parser: e.parser,
						overlay: [{
							from: r.to,
		...
		if (o && s == vg) {
			...
			if (r = n.firstChild) {
				...
				if (e) for (let r of e) {
					if (r.tagName && r.tagName != r_(n.parent, t)) continue;
					let e = n.lastChild;
					if (e.type.id == bg) {
...
var o_ = 148, s_ = 1, c_ = 149, l_ = 150, u_ = 2, d_ = 151, f_ = 3, p_ = 4, m_ = [
	...
	8287,
	12288
], h_ = 58, g_ = 40, __ = 95, v_ = 91, y_ = 45, b_ = 46, x_ = 35, S_ = 37, C_ = 38, w_ = 92, T_ = 10, E_ = 42;
function D_(e) {
...
function k_(e) {
	return O_(e) || e >= 97 && e <= 102 || e >= 65 && e <= 70;
}
var A_ = (e, t, n) => (r, i) => {
	for (let a = !1, o = 0, s = 0;; s++) {
		let { next: c } = r;
		if (D_(c) || c == y_ || c == __ || a && O_(c)) !a && (c != y_ || s > 0) && (a = !0), o === s && c == y_ && o++, r.advance();
		else if (c == w_ && r.peek(1) != T_) {
			if (r.advance(), k_(r.next)) {
				do
					r.advance();
				while (k_(r.next));
				r.next == 32 && r.advance();
			...
			a && r.acceptToken(o == 2 && i.canShift(u_) ? t : c == g_ ? n : e);
			break;
		}
	}
}, j_ = new Mh(A_(c_, u_, l_), { contextual: !0 }), M_ = new Mh(A_(d_, f_, p_), { contextual: !0 }), N_ = new Mh((e) => {
	if (m_.includes(e.peek(-1))) {
		let { next: t } = e;
		(D_(t) || t == __ || t == x_ || t == b_ || t == E_ || t == v_ || t == h_ && D_(e.peek(1)) || t == y_ || t == C_) && e.acceptToken(o_);
	}
}), P_ = new Mh((e) => {
	if (!m_.includes(e.peek(-1))) {
		let { next: t } = e;
		if (t == S_ && (e.advance(), e.acceptToken(s_)), D_(t)) {
			do
				e.advance();
			while (D_(e.next) || O_(e.next));
			e.acceptToken(s_);
		}
	}
}), F_ = yl({
	...
	tokenizers: [
		...
		3,
		4,
		new jh("m~RRYZ[z{a~~g~aO$b~~dP!P!Qg~lO$c~~", 28, 155)
	],
	topRules: {
		StyleSheet: [0, 6],
		Styles: [1, 129]
...
function U_() {
	if (!H_ && typeof document == "object" && document.body) {
...
var Z_ = /*@__PURE__*/ new Yc(), Q_ = ["Declaration"];
function $_(e) {
	for (let t = e;;) {
...
function ev(e, t, n) {
	if (t.to - t.from > 4096) {
		...
		if (o.firstChild()) do
			for (let t of ev(e, o.node, n)) a.has(t.label) || (a.add(t.label), i.push(t));
		while (o.nextSibling());
		return Z_.set(t, i), i;
	}
	{
		...
		return t.cursor().iterate((t) => {
			if (n(t) && t.matchContext(Q_) && t.node.nextSibling?.name == ":") {
...
var tv = /*@__PURE__*/ ((e) => (t) => {
	...
	if (e(i) || (t.explicit || a) && X_(i, n.doc)) return {
		from: e(i) || a ? i.from : r,
		options: ev(n.doc, $_(i), e),
		validFor: Y_
	};
	if (i.name == "TagName") {
...
})((e) => e.name == "VariableName"), nv = /*@__PURE__*/ Kl.define({
	name: "css",
	parser: /*@__PURE__*/ V_.configure({ props: [/*@__PURE__*/ uu.add({ Declaration: /*@__PURE__*/ Su() }), /*@__PURE__*/ wu.add({ "Block KeyframeList": Tu })] }),
	languageData: {
		commentTokens: { block: {
			open: "/*",
			close: "*/"
...
var iv = 316, av = 317, ov = 1, sv = 2, cv = 3, lv = 4, uv = 318, dv = 320, fv = 321, pv = 5, mv = 6, hv = 0, gv = [
	...
	8287,
	12288
], _v = 125, vv = 59, yv = 47, bv = 42, xv = 43, Sv = 45, Cv = 60, wv = 44, Tv = 63, Ev = 46, Dv = 91, Ov = new Gh({
	start: !1,
	shift(e, t) {
		return t == pv || t == mv || t == dv ? e : t == fv;
	},
	strict: !1
}), kv = new Mh((e, t) => {
	let { next: n } = e;
	(n == _v || n == -1 || t.context) && e.acceptToken(uv);
}, {
	contextual: !0,
	fallback: !0
}), Av = new Mh((e, t) => {
	let { next: n } = e, r;
	gv.indexOf(n) > -1 || (n != yv || (r = e.peek(1)) != yv && r != bv) && n != _v && n != vv && n != -1 && !t.context && e.acceptToken(iv);
}, { contextual: !0 }), jv = new Mh((e, t) => {
	e.next == Dv && !t.context && e.acceptToken(av);
}, { contextual: !0 }), Mv = new Mh((e, t) => {
	let { next: n } = e;
	if (n == xv || n == Sv) {
		if (e.advance(), n == e.next) {
			e.advance();
			let n = !t.context && t.canShift(ov);
			e.acceptToken(n ? ov : sv);
		}
	} else n == Tv && e.peek(1) == Ev && (e.advance(), e.advance(), (e.next < 48 || e.next > 57) && e.acceptToken(cv));
}, { contextual: !0 });
function Nv(e, t) {
	return e >= 65 && e <= 90 || e >= 97 && e <= 122 || e == 95 || e >= 192 || !t && e >= 48 && e <= 57;
}
var Pv = new Mh((e, t) => {
	if (e.next != Cv || !t.dialectEnabled(hv) || (e.advance(), e.next == yv)) return;
	let n = 0;
	for (; gv.indexOf(e.next) > -1;) e.advance(), n++;
	if (Nv(e.next, !0)) {
		for (e.advance(), n++; Nv(e.next, !1);) e.advance(), n++;
		for (; gv.indexOf(e.next) > -1;) e.advance(), n++;
		if (e.next == wv) return;
		for (let t = 0;; t++) {
			if (t == 7) {
				if (!Nv(e.next, !0)) return;
				break;
			}
	...
	tokenizers: [
		...
		14,
		kv,
		new jh("$S~RRtu[#O#Pg#S#T#|~_P#o#pb~gOx~~jVO#i!P#i#j!U#j#l!P#l#m!q#m;'S!P;'S;=`#v<%lO!P~!UO!U~~!XS!Q![!e!c!i!e#T#Z!e#o#p#Z~!hR!Q![!q!c!i!q#T#Z!q~!tR!Q![!}!c!i!}#T#Z!}~#QR!Q![!P!c!i!P#T#Z!P~#^R!Q![#g!c!i#g#T#Z#g~#jS!Q![#g!c!i#g#T#Z#g#q#r!P~#yP;=`<%l!P~$RO(c~~", 141, 340),
		new jh("j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~", 25, 323)
	],
	topRules: {
		Script: [0, 7],
	...
	/*@__PURE__*/ Hp("function ${name}(${params}) {\n	${}\n}", {
		label: "function",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n	${}\n}", {
		label: "for",
		detail: "loop",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("for (let ${name} of ${collection}) {\n	${}\n}", {
		label: "for",
		detail: "of loop",
		type: "keyword"
	}),
	...
	/*@__PURE__*/ Hp("class ${name} {\n	constructor(${params}) {\n		${}\n	}\n}", {
		label: "class",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("import {${names}} from \"${module}\"\n${}", {
		label: "import",
		detail: "named",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("import ${name} from \"${module}\"\n${}", {
		label: "import",
		detail: "default",
		type: "keyword"
	})
], Vv = /*@__PURE__*/ Bv.concat([
	/*@__PURE__*/ Hp("interface ${name} {\n	${}\n}", {
		label: "interface",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("type ${name} = ${type}", {
		label: "type",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Hp("enum ${name} {\n	${}\n}", {
		label: "enum",
		detail: "definition",
		type: "keyword"
	})
]), Hv = /*@__PURE__*/ new Yc(), Uv = /*@__PURE__*/ new Set([
	"Script",
	"Block",
	"FunctionExpression",
	"FunctionDeclaration",
...
var Gv = ["FunctionDeclaration"], Kv = {
	FunctionDeclaration: /*@__PURE__*/ Wv("function"),
	ClassDeclaration: /*@__PURE__*/ Wv("class"),
	ClassExpression: () => !0,
	EnumDeclaration: /*@__PURE__*/ Wv("constant"),
	TypeAliasDeclaration: /*@__PURE__*/ Wv("type"),
	NamespaceDeclaration: /*@__PURE__*/ Wv("namespace"),
	VariableDefinition(e, t) {
		e.matchContext(Gv) || t(e, "variable");
	},
	TypeDefinition(e, t) {
		t(e, "type");
	},
...
function qv(e, t) {
	...
	return t.cursor(G.IncludeAnonymous).iterate((t) => {
		if (i) i = !1;
			...
			let e = Kv[t.name];
			if (e && e(t, a) || Uv.has(t.name)) return !1;
		} else if (t.to - t.from > 8192) {
			for (let n of qv(e, t.node)) r.push(n);
			return !1;
		}
	}), Hv.set(t, r), r;
}
var Jv = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, Yv = [
	"TemplateString",
	"String",
	"RegExp",
	"LineComment",
...
function Xv(e) {
	...
	if (Yv.indexOf(t.name) > -1) return null;
	let n = t.name == "VariableName" || t.to - t.from < 20 && Jv.test(e.state.sliceDoc(t.from, t.to));
	if (!n && !e.explicit) return null;
	let r = [];
	for (let n = t; n; n = n.parent) Uv.has(n.name) && (r = r.concat(qv(e.state.doc, n)));
	return {
		options: r,
		from: n ? t.from : e.pos,
		validFor: Jv
...
var Zv = /*@__PURE__*/ Kl.define({
	name: "javascript",
	parser: /*@__PURE__*/ zv.configure({ props: [/*@__PURE__*/ uu.add({
		IfStatement: /*@__PURE__*/ Su({ except: /^\s*({|else\b)/ }),
		TryStatement: /*@__PURE__*/ Su({ except: /^\s*({|catch\b|finally\b)/ }),
		LabeledStatement: xu,
		SwitchBody: (e) => {
			let t = e.textAfter, n = /^\s*\}/.test(t), r = /^\s*(case|default)\b/.test(t);
			return e.baseIndent + (n ? 0 : r ? 1 : 2) * e.unit;
		},
		Block: /*@__PURE__*/ yu({ closing: "}" }),
		ArrowFunction: (e) => e.baseIndent + e.unit,
		"TemplateString BlockComment": () => null,
		"Statement Property": /*@__PURE__*/ Su({ except: /^\s*{/ }),
		JSXElement(e) {
		...
		"Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType": Tu,
		BlockComment(e) {
			return {
				from: e.from + 2,
				to: e.to - 2
	...
	facet: /*@__PURE__*/ Hl({ commentTokens: { block: {
		open: "{/*",
		close: "*/}"
	} } })
}, $v = /*@__PURE__*/ Zv.configure({ dialect: "ts" }, "typescript"), ey = /*@__PURE__*/ Zv.configure({
	dialect: "jsx",
	props: [/*@__PURE__*/ Ul.add((e) => e.isTop ? [Qv] : void 0)]
}), ty = /*@__PURE__*/ Zv.configure({
	dialect: "jsx ts",
	props: [/*@__PURE__*/ Ul.add((e) => e.isTop ? [Qv] : void 0)]
}, "typescript"), ny = (e) => ({
	label: e,
	type: "keyword"
}), ry = /*@__PURE__*/ "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield".split(" ").map(ny), iy = /*@__PURE__*/ ry.concat(/*@__PURE__*/ [
	"declare",
	"implements",
	"private",
	"protected",
...
function ay(e = {}) {
	let t = e.jsx ? e.typescript ? ty : ey : e.typescript ? $v : Zv, n = e.typescript ? Vv.concat(iy) : Bv.concat(ry);
	return new nu(t, [
		Zv.data.of({ autocomplete: Cp(Yv, Sp(n)) }),
		Zv.data.of({ autocomplete: Xv }),
		e.jsx ? ly : []
	]);
}
function oy(e) {
...
var cy = typeof navigator == "object" && /*@__PURE__*/ /Android\b/.test(navigator.userAgent), ly = /*@__PURE__*/ H.inputHandler.of((e, t, n, r, i) => {
	if ((cy ? e.composing : e.compositionStarted) || e.state.readOnly || t != n || r != ">" && r != "/" || !Zv.isActiveAt(e.state, t, -1)) return !1;
	let a = i(), { state: o } = a, s = o.changeByRange((e) => {
		...
		if (n.name == "JSXStartTag" && (n = n.parent), !(o.doc.sliceString(t - 1, t) != r || n.name == "JSXAttributeValue" && n.to > t)) {
			...
			if (r == "/" && n.name == "JSXStartCloseTag") {
				...
				if (r && e.from == t - 2 && ((i = sy(o.doc, r.firstChild, t)) || r.firstChild?.name == "JSXFragmentTag")) {
					let e = `${i}>`;
					return {
						range: E.cursor(t + e.length, -1),
						changes: {
							from: t,
							insert: e
						}
				...
				let r = oy(n);
				if (r && r.name == "JSXOpenTag" && !/^\/?>|^<\//.test(o.doc.sliceString(t, t + 2)) && (i = sy(o.doc, r, t))) return {
					range: e,
					changes: {
						from: t,
						insert: `</${i}>`
	...
	"aria-valuenow": null,
	"aria-valuetext": null
}, _y = /*@__PURE__*/ "beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload".split(" ").map((e) => "on" + e);
for (let e of _y) gy[e] = null;
var vy = class {
	constructor(e, t) {
		this.tags = {
			...hy,
...
vy.default = /*@__PURE__*/ new vy();
function yy(e, t, n = e.length) {
	if (!t) return "";
...
function xy(e, t, n) {
	return n.tags[yy(e, by(t))]?.children || n.allTags;
}
function Sy(e, t) {
	let n = [];
	for (let r = by(t); r && !r.type.isTop; r = by(r.parent)) {
		let i = yy(e, r);
...
function wy(e, t, n, r, i) {
	let a = /\s*>/.test(e.sliceDoc(i, i + 5)) ? "" : ">", o = by(n, n.name == "StartTag" || n.name == "TagName");
	return {
		from: r,
		to: i,
		options: xy(e.doc, o, t).map((e) => ({
			label: e,
			type: "type"
		})).concat(Sy(e.doc, n).map((e, t) => ({
			label: "/" + e,
			apply: "/" + e + a,
			type: "type",
			boost: 99 - t
...
function Ey(e, t, n, r) {
	let i = [], a = 0;
	for (let r of xy(e.doc, n, t)) i.push({
		label: "<" + r,
		type: "type"
	});
	for (let t of Sy(e.doc, n)) i.push({
		label: "</" + t + ">",
		type: "type",
		boost: 99 - a++
	});
...
function Dy(e, t, n, r, i) {
	let a = by(n), o = a ? t.tags[yy(e.doc, a)] : null, s = o && o.attrs ? Object.keys(o.attrs) : [];
	return {
		from: r,
		to: i,
...
function Oy(e, t, n, r, i) {
	...
	if (a) {
		...
		if (!l) {
			let r = by(n), i = r ? t.tags[yy(e.doc, r)] : null;
			l = i?.attrs && i.attrs[c];
		}
		if (l) {
...
function ky(e, t) {
	...
	return i.name == "TagName" ? i.parent && /CloseTag$/.test(i.parent.name) ? Ty(n, i, i.from, r) : wy(n, e, i, i.from, r) : i.name == "StartTag" || i.name == "IncompleteTag" ? wy(n, e, i, r, r) : i.name == "StartCloseTag" || i.name == "IncompleteCloseTag" ? Ty(n, i, r, r) : i.name == "OpenTag" || i.name == "SelfClosingTag" || i.name == "AttributeName" ? Dy(n, e, i, i.name == "AttributeName" ? i.from : r, r) : i.name == "Is" || i.name == "AttributeValue" || i.name == "UnquotedAttributeValue" ? Oy(n, e, i, i.name == "Is" ? r : i.from, r) : t.explicit && (a.name == "Element" || a.name == "Text" || a.name == "Document") ? Ey(n, e, i, r) : null;
}
function Ay(e) {
	return ky(vy.default, e);
}
function jy(e) {
	let { extraTags: t, extraGlobalAttributes: n } = e, r = n || t ? new vy(t, n) : vy.default;
	return (e) => ky(r, e);
}
var My = /*@__PURE__*/ Zv.parser.configure({ top: "SingleExpression" }), Ny = [
	{
		tag: "script",
	...
	name: "style",
	parser: /*@__PURE__*/ nv.parser.configure({ top: "Styles" })
}].concat(/*@__PURE__*/ _y.map((e) => ({
	name: e,
	parser: Zv.parser
}))), Fy = /*@__PURE__*/ Kl.define({
	name: "html",
	parser: /*@__PURE__*/ t_.configure({ props: [
		/*@__PURE__*/ uu.add({
			Element(e) {
		...
		/*@__PURE__*/ Iu.add({ "OpenTag CloseTag": (e) => e.getChild("TagName") })
	] }),
	languageData: {
		commentTokens: { block: {
			open: "<!--",
...
}), Iy = /*@__PURE__*/ Fy.configure({ wrap: /*@__PURE__*/ a_(Ny, Py) });
function Ly(e = {}) {
	let t = "", n;
	return e.matchClosingTags === !1 && (t = "noMatch"), e.selfClosingTags === !0 && (t = (t ? t + " " : "") + "selfClosing"), (e.nestedLanguages && e.nestedLanguages.length || e.nestedAttributes && e.nestedAttributes.length) && (n = a_((e.nestedLanguages || []).concat(Ny), (e.nestedAttributes || []).concat(Py))), new nu(n ? Fy.configure({
		wrap: n,
		dialect: t
	}) : t ? Iy.configure({ dialect: t }) : Iy, [
		Iy.data.of({ autocomplete: jy(e) }),
		e.autoCloseTags === !1 ? [] : By,
		ay().support,
		rv().support
	]);
}
var Ry = /*@__PURE__*/ new Set(/*@__PURE__*/ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" "));
function zy(e, t, n) {
	for (;;) {
		if (t.lastChild?.name != "CloseTag") return !1;
		let r = t.parent;
		if (!r || yy(e, r) != n) return !0;
		t = r;
	}
}
var By = /*@__PURE__*/ H.inputHandler.of((e, t, n, r, i) => {
	if (e.composing || e.state.readOnly || t != n || r != ">" && r != "/" || !Iy.isActiveAt(e.state, t, -1)) return !1;
	let a = i(), { state: o } = a, s = o.changeByRange((e) => {
		let t = o.doc.sliceString(e.from - 1, e.to) == r, { head: n } = e, i = Y(o).resolveInner(n, -1), a;
		if (t && r == ">" && i.name == "EndTag") {
			let t = i.parent;
			if ((a = yy(o.doc, t.parent, n)) && !Ry.has(a) && !zy(o.doc, t.parent, a)) return {
				range: e,
				changes: {
					from: n,
			...
			let e = i.parent;
			if (i.from == n - 2 && e.lastChild?.name != "CloseTag" && (a = yy(o.doc, e, n)) && !Ry.has(a)) {
				let e = n + +(o.doc.sliceString(n, n + 1) === ">"), t = `${a}>`;
				return {
					range: E.cursor(n + t.length, -1),
					changes: {
						from: n,
						to: e,
						insert: t
...
}), Vy = /*@__PURE__*/ Hl({ commentTokens: { block: {
	open: "<!--",
	close: "-->"
} } }), Hy = /*@__PURE__*/ new U(), Uy = /*@__PURE__*/ Zm.configure({ props: [
	/*@__PURE__*/ wu.add((e) => !e.is("Block") || e.is("Document") || Wy(e) != null || Gy(e) ? void 0 : (e, t) => ({
		from: t.doc.lineAt(e.from).to,
		to: e.to
	})),
	/*@__PURE__*/ Hy.add(Wy),
	/*@__PURE__*/ uu.add({ Document: () => null }),
	/*@__PURE__*/ Vl.add({ Document: Vy })
] });
function Wy(e) {
...
function Ky(e, t) {
	...
	for (;;) {
		...
		if (!e || (r = Wy(e.type)) != null && r <= t) break;
		n = e;
	}
	return n.to;
}
var qy = /*@__PURE__*/ Cu.of((e, t, n) => {
	for (let r = Y(e).resolveInner(n, -1); r && !(r.from < t); r = r.parent) {
		let e = r.type.prop(Hy);
		if (e == null) continue;
		let t = Ky(r, e);
		if (t > n) return {
			from: n,
...
function Jy(e) {
	return new Wl(Vy, e, [], "markdown");
}
var Yy = /*@__PURE__*/ Jy(Uy), Xy = /*@__PURE__*/ Jy(/* @__PURE__ */ Uy.configure([
	_h,
	bh,
	yh,
	xh,
	{ props: [/*@__PURE__*/ wu.add({ Table: (e, t) => ({
		from: t.doc.lineAt(e.from).to,
		to: e.to
	}) })] }
]));
function Zy(e, t) {
	return (n) => {
		if (n && e) {
			let t = null;
			if (n = /\S*/.exec(n)[0], t = typeof e == "function" ? e(n) : ru.matchLanguageName(e, n, !0), t instanceof ru) return t.support ? t.support.language.parser : Yl.getSkippingParser(t.load());
...
var Qy = class {
	...
	marker(e, t) {
		let n = this.node.name == "OrderedList" ? String(+eb(this.item, e)[2] + t) : "";
...
function $y(e, t) {
	...
	for (let e = n.length - 1; e >= 0; e--) {
		...
		if (i.name == "Blockquote" && (a = /^ *>( ?)/.exec(o.text.slice(s)))) r.push(new Qy(i, s, s + a[0].length, "", a[1], ">", null));
		else if (i.name == "ListItem" && i.parent.name == "OrderedList" && (a = /^( *)\d+([.)])( *)/.exec(o.text.slice(s)))) {
			let e = a[3], t = a[0].length;
			e.length >= 4 && (e = e.slice(0, e.length - 4), t -= 4), r.push(new Qy(i.parent, s, s + t, a[1], e, a[2], i));
			...
			let n = a[2];
			a[3] && (n += a[3].replace(/[xX]/, " ")), r.push(new Qy(i.parent, s, s + t, a[1], e, n, i));
		}
	}
	return r;
}
...
function nb(e, t) {
	...
	if (!n || t.facet(au) != "	") return e;
	let r = Jt(e, 4, n), i = "";
	for (let e = r; e > 0;) e >= 4 ? (i += "	", e -= 4) : (i += " ", e--);
	return i + e.slice(n);
}
var rb = /*@__PURE__*/ ((e = {}) => ({ state: t, dispatch: n }) => {
	let r = Y(t), { doc: i } = t, a = null, o = t.changeByRange((n) => {
		if (!n.empty || !Xy.isActiveAt(t, n.from, -1) && !Xy.isActiveAt(t, n.from, 1)) return a = { range: n };
		let o = n.from, s = i.lineAt(o), c = $y(r.resolveInner(o, -1), i);
		...
		if (l.item && u) {
			...
			if (r.to >= o || u && u.to < o || s.from > 0 && !/[^\s>]/.test(i.lineAt(s.from - 1).text) || e.nonTightLists === !1) {
				...
				return l.node.name == "OrderedList" && tb(l.item, i, r, -2), e && e.node.name == "OrderedList" && tb(e.item, i, r), {
		...
		let d = [];
		l.node.name == "OrderedList" && tb(l.item, i, d);
		let f = l.item && l.item.from < s.from, p = "";
		if (!f || /^[\s\d.)\-+*>]*/.exec(s.text)[0].length >= l.to) for (let e = 0, t = c.length - 1; e <= t; e++) p += e == t && !f ? c[e].marker(i, 1) : c[e].blank(e < t ? Jt(s.text, 4, c[e + 1].from) - p.length : null);
		let m = o;
		for (; m > s.from && /\s/.test(s.text.charAt(m - s.from - 1));) m--;
		return p = nb(p, t), ab(l.node, t.doc) && (p = ob(c, t, s) + t.lineBreak + p), d.push({
			from: m,
			to: o,
...
function ob(e, t, n) {
	let r = "";
	for (let t = 0, i = e.length - 2; t <= i; t++) r += e[t].blank(t < i ? Jt(n.text, 4, e[t + 1].from) - r.length : null, t < i);
	return nb(r, t);
}
function sb(e, t) {
	let n = e.resolveInner(t, -1), r = t;
	ib(n) && (r = n.from, n = n.parent);
	for (let e; e = n.childBefore(r);) if (ib(e)) r = e.from;
...
var cb = [{
	...
	run: ({ state: e, dispatch: t }) => {
		let n = Y(e), r = null, i = e.changeByRange((t) => {
			...
			if (t.empty && Xy.isActiveAt(e, t.from)) {
				let t = a.lineAt(i), r = $y(sb(n, i), a);
				if (r.length) {
					...
					if (i - t.from == a && (n.item && t.from <= n.item.from || /^[\s>]*$/.test(t.text.slice(0, n.to)))) {
						...
						if (n.item && n.node.from < n.item.from && /\S/.test(t.text.slice(n.from, n.to))) {
							let i = n.blank(Jt(t.text, 4, n.to) - Jt(t.text, 4, n.from));
							return r == t.from && (i = nb(i, e)), {
...
}], lb = /*@__PURE__*/ Ly({ matchClosingTags: !1 });
function ub(e = {}) {
	let { codeLanguages: t, defaultCodeLanguage: n, addKeymap: r = !0, base: { parser: i } = Yy, completeHTMLTags: a = !0, pasteURLAsLink: o = !0, htmlTagLanguage: s = lb } = e;
	if (!(i instanceof wm)) throw RangeError("Base parser provided to `markdown` should be a Markdown parser");
	let c = e.extensions ? [e.extensions] : [], l = [s.support, qy], u;
	o && l.push(hb), n instanceof nu ? (l.push(n.support), u = n.language) : n && (u = n);
	let d = t || u ? Zy(t, u) : void 0;
	c.push($m({
		codeParser: d,
		htmlParser: s.language.parser
	})), r && l.push($e.high(ls.of(cb)));
	let f = Jy(i.configure(c));
	return a && l.push(f.data.of({ autocomplete: db })), new nu(f, l);
}
function db(e) {
...
function pb() {
	if (fb) return fb;
	let e = Ay(new yp(A.create({ extensions: lb }), 0, !0));
	return fb = e ? e.options : [];
}
var mb = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, hb = /*@__PURE__*/ H.domEventHandlers({ paste: (e, t) => {
	let { main: n } = t.state.selection;
	if (n.empty) return !1;
	let r = e.clipboardData?.getData("text/plain");
	if (!r || !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(r) || (/^www\./.test(r) && (r = "https://" + r), !Xy.isActiveAt(t.state, n.from, 1))) return !1;
	let i = Y(t.state), a = !1;
	return i.iterate({
		from: n.from,
		to: n.to,
		enter: (e) => {
			(e.from > n.from || mb.test(e.name)) && (a = !0);
		},
		leave: (e) => {
			e.to < n.to && (a = !0);
		}
...
} }), gb = n("<div class=\"markdown-editor-primary-actions\"><button type=\"button\" class=\"secondary-button\"><!><span>Add annotation</span></button> <button type=\"button\" class=\"secondary-button\"><!><span>Copy annotations</span></button></div>"), _b = n("<div class=\"markdown-editor-save-actions\"><button type=\"button\"><!><span> </span></button></div>"), vb = n("<p class=\"markdown-editor-alert\" role=\"alert\">This file changed on disk while you were editing. Your draft is preserved; saving will report a conflict.</p>"), yb = n("<p class=\"markdown-editor-alert\" role=\"alert\"> </p>"), bb = n("<article><div class=\"markdown-annotation-heading\"><button type=\"button\" class=\"annotation-location\"> </button><button type=\"button\" class=\"icon-button\" title=\"Remove annotation\" aria-label=\"Remove annotation\"><!></button></div> <blockquote> </blockquote> <textarea rows=\"3\" placeholder=\"Add a comment…\"></textarea></article>"), xb = n("<aside class=\"markdown-annotation-panel\" aria-label=\"Annotations\"><header><strong>Annotations</strong><span> </span></header> <!></aside>"), Sb = n("<div class=\"markdown-copy-fallback\" role=\"status\"><strong>Copy annotations manually</strong><span>Press Cmd/Ctrl+C; the complete text is selected.</span><textarea readonly=\"\" rows=\"10\"></textarea></div>"), Cb = n("<section class=\"markdown-editor-shell\" data-component-owner=\"markdown-editor\"><div class=\"markdown-editor-toolbar\"><!></div> <!> <!> <div><div class=\"markdown-editor-host\"></div> <!></div> <!></section>");
function wb(n, o) {
	e(o, !0);
	let le = O.define(), ue = Xe.define({
		create: () => [],
		update(e, t) {
			let n = e;
			t.docChanged && (n = e.map((e) => {
				let n = t.changes.mapPos(e.from, 1, w.TrackAfter), r = t.changes.mapPos(e.to, -1, w.TrackBefore);
				if (n == null || r == null || r <= n) {
					let n = t.changes.mapPos(e.from, 1);
					return {
						...e,
						from: n,
						to: n,
				...
				let i = t.newDoc.sliceString(n, r);
				return {
					...e,
					from: n,
					to: r,
			...
			for (let e of t.effects) e.is(le) && (n = e.value);
			return n;
		},
		provide: (e) => H.decorations.from(e, de)
	});
	function de(e) {
		return I.set(e.filter((e) => !e.stale && e.to > e.from).map((e) => I.mark({
			class: "cm-review-annotation",
			attributes: { "data-annotation-id": e.id }
		}).range(e.from, e.to)), !0);
	}
	let fe = Eu.define([
		{
	...
	]), pe = g(void 0), me = g(void 0), b = null, he = g(""), ge = g(""), _e = g(""), ve = g(""), ye = g(""), x = g(se([])), S = g(0), be = g(0), xe = g(!1), Se = g(""), Ce = g(""), we = 0, Te = h(() => o.mode === "annotate"), Ee = h(() => t(ye) !== t(ge)), De = h(() => t(Ee) || t(x).length > 0), Oe = h(() => !!(t(De) && t(ve) && t(_e) && t(ve) !== t(_e))), C = h(() => t(be) > t(S));
	f(() => {
		if (!t(pe)) return;
		let e = o.identity, n = o.file.content || "", r = o.file.contentHash || "";
		if (i(ve, r, !0), !b || e !== t(he)) {
			i(he, e, !0);
			let a = ce.get(e);
			i(ge, a?.baseline ?? n, !0), i(_e, a?.baselineHash ?? r, !0), o.mode === "annotate" ? (i(ye, n, !0), i(x, (a?.annotations ?? []).map((e) => ({ ...e })), !0)) : (i(ye, a?.draft ?? n, !0), i(x, [], !0)), i(Se, ""), i(Ce, ""), ke(o.mode === "annotate" ? n : t(ye), o.mode === "annotate" ? t(x) : []);
		} else o.mode === "edit" && !t(De) && r !== t(_e) && (i(ge, n, !0), i(_e, r, !0), Ae(n));
	}), ae(() => {
		Me(), b?.destroy();
	});
	function ke(e, n = []) {
		if (b?.destroy(), !t(pe)) return;
		let r = e.includes("\r\n") ? "\r\n" : "\n";
		b = new H({
			parent: t(pe),
			state: A.create({
				...
				extensions: [
					...
					ue,
					H.lineWrapping,
					H.contentAttributes.of({
						spellcheck: "true",
						"aria-label": `Markdown editor for ${o.file.path}`
					}),
					H.updateListener.of((e) => {
						e.docChanged && i(ye, e.state.doc.toString(), !0);
						let t = e.state.selection.main;
						i(S, t.from, !0), i(be, t.to, !0), i(x, e.state.field(ue).map((e) => ({ ...e })), !0), (e.docChanged || e.transactions.some((e) => e.effects.length > 0)) && Me();
					})
				]
			})
		}), i(S, b.state.selection.main.from, !0), i(be, b.state.selection.main.to, !0), n.length && b.dispatch({ effects: le.of(n) }), queueMicrotask(o.onIconsChanged);
	}
	function Ae(e) {
		b && (b.dispatch({
			changes: {
				from: 0,
				to: b.state.doc.length,
				insert: e
			},
			effects: le.of([])
		}), i(ye, e, !0));
	...
	function je(e) {
		b && (b.dispatch({ effects: le.of(e) }), i(x, e.map((e) => ({ ...e })), !0), Me());
	}
	function Me() {
		if (t(he)) {
			if (!(o.mode === "edit" ? t(ye) !== t(ge) : t(x).length > 0)) {
				ce.delete(t(he));
				return;
			}
			ce.set(t(he), {
				...
				baselineHash: t(_e),
				draft: t(ye),
				annotations: t(x).map((e) => ({ ...e }))
			});
		}
	}
	function Ne() {
		if (!b || !t(C)) return;
		let e = b.state.doc.sliceString(t(S), t(be)), n = {
			id: `annotation-${Date.now()}-${++we}`,
			from: t(S),
			to: t(be),
			quote: e,
			comment: "",
		...
		je([...t(x), n]), queueMicrotask(() => document.querySelector(`[data-comment-for="${n.id}"]`)?.focus());
	}
	function Pe(e, n) {
		je(t(x).map((t) => t.id === e ? {
			...t,
	...
	async function Le() {
		if (!(t(xe) || !t(Ee))) {
			i(xe, !0), i(Se, "");
			try {
				let e = await o.onSave(t(ye), t(_e));
				i(ge, e.content ?? t(ye), !0), i(_e, e.contentHash || "", !0), i(ve, t(_e), !0), t(ge) !== t(ye) && Ae(t(ge)), Me(), o.onToast(`${o.file.name || "Markdown file"} saved.`);
			} catch (e) {
				i(Se, e instanceof Error ? e.message : String(e), !0);
			} finally {
				i(xe, !1), queueMicrotask(o.onIconsChanged);
			}
		}
	}
	function Re() {
		let e = t(_e) ? `sha256:${t(_e)}` : "unknown", n = [`文件：${o.file.path}`, `基础版本：${e}`];
		return t(Ee) && n.push("状态：包含未保存修改"), n.push(""), t(x).forEach((e, t) => {
			let r = e.stale ? `[选区已删除] ${e.quote}` : e.quote;
			n.push(`${t + 1}. 位置：${Ie(e)}`, "   原文：");
			for (let e of r.split("\n")) n.push(`   > ${e}`);
			n.push("", `   批注：${e.comment.trim() || "（未填写）"}`, "");
		}), n.join("\n").trimEnd() + "\n";
	}
	async function ze() {
		...
		try {
			if (navigator.clipboard?.writeText) {
				await navigator.clipboard.writeText(e), o.onToast("Annotations copied to the clipboard.");
				return;
			}
		} catch {}
		let n = document.createElement("textarea");
		n.value = e, n.setAttribute("readonly", ""), n.style.position = "fixed", n.style.opacity = "0", document.body.appendChild(n), n.select();
		let r = typeof document.execCommand == "function" && document.execCommand("copy");
		if (n.remove(), r) {
			o.onToast("Annotations copied to the clipboard.");
			return;
		}
		i(Ce, e, !0), await p(), t(me)?.focus(), t(me)?.select(), o.onToast("Automatic clipboard access is unavailable. Press Cmd/Ctrl+C to copy the selected text.");
	}
	var Be = Cb(), Ve = m(Be), E = m(Ve), He = (e) => {
		var n = gb(), i = m(n), o = m(i);
		ee(o, { name: "message-square-plus" }), ne(), y(i);
		var c = a(i, 2), l = m(c);
		ee(l, { name: "copy" }), ne(), y(c), y(n), r(() => {
			i.disabled = !t(C), c.disabled = !t(x).length;
		}), u("click", i, Ne), u("click", c, ze), s(e, n);
	}, Ue = (e) => {
		var n = _b(), i = m(n);
		let o;
		var c = m(i);
		{
			let e = h(() => t(xe) ? "loader-circle" : "save");
			ee(c, { get name() {
				return t(e);
			} });
		}
		var l = a(c), d = m(l, !0);
		y(l), y(i), y(n), r(() => {
			i.disabled = t(xe) || !t(Ee), o = te(i, 1, "", null, o, { busy: t(xe) }), v(d, t(xe) ? "Saving" : "Save");
		}), u("click", i, Le), s(e, n);
	};
	c(E, (e) => {
		o.mode === "annotate" ? e(He) : e(Ue, -1);
	}), y(Ve);
	var D = a(Ve, 2), We = (e) => {
		var t = vb();
		s(e, t);
	...
	c(D, (e) => {
		o.mode === "edit" && t(Oe) && e(We);
	});
	var Ge = a(D, 2), Ke = (e) => {
		var n = yb(), i = m(n, !0);
		y(n), r(() => v(i, t(Se))), s(e, n);
	};
	c(Ge, (e) => {
		t(Se) && e(Ke);
	});
	...
	ie(Ye, (e) => i(pe, e), () => t(pe));
	var Ze = a(Ye, 2), Qe = (e) => {
		var n = xb(), i = m(n), o = a(m(i)), c = m(o, !0);
		y(o), y(i);
		var l = a(i, 2);
		d(l, 17, () => t(x), (e) => e.id, (e, n) => {
			var i = bb();
			let o;
			var c = m(i), l = m(c), d = m(l, !0);
			y(l);
			var f = a(l), p = m(f);
			ee(p, { name: "trash-2" }), y(f), y(c);
			var h = a(c, 2), g = m(h, !0);
			y(h);
			var ne = a(h, 2);
			_(ne), y(i), r((e, r) => {
				o = te(i, 1, "", null, o, { stale: t(n).stale }), l.disabled = t(n).stale, v(d, e), v(g, t(n).stale ? `[Selection removed] ${t(n).quote}` : t(n).quote), re(ne, t(n).comment), oe(ne, "data-comment-for", t(n).id), oe(ne, "aria-label", r);
			}, [() => Ie(t(n)), () => `Comment for ${Ie(t(n))}`]), u("click", l, () => T(t(n))), u("click", f, () => Fe(t(n).id)), u("input", ne, (e) => Pe(t(n).id, e.currentTarget.value)), s(e, i);
		}), y(n), r(() => v(c, t(x).length)), s(e, n);
	};
	c(Ze, (e) => {
		o.mode === "annotate" && t(x).length && e(Qe);
	}), y(qe);
	var $e = a(qe, 2), et = (e) => {
		var n = Sb(), o = a(m(n), 2);
		_(o), ie(o, (e) => i(me, e), () => t(me)), y(n), r(() => re(o, t(Ce))), s(e, n);
	};
	c($e, (e) => {
		t(Ce) && e(et);
	}), y(Be), r(() => {
		oe(Be, "data-editor-identity", o.identity), Je = te(qe, 1, "markdown-editor-layout", null, Je, { "with-annotations": o.mode === "annotate" && t(x).length > 0 });
	}), s(n, Be), l();
}
o(["click", "input"]);
//#endregion
