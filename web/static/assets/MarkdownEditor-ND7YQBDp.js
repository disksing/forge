...
(() => {
	...
	for (let t = 0, n = 0; t < e.length; t++) (t % 2 ? le : ce).push(n += e[t]);
})();
function ue(e) {
	if (e < 768) return !1;
	for (let t = 0, n = ce.length;;) {
		let r = t + n >> 1;
		if (e < ce[r]) n = r;
		else if (e >= le[r]) t = r + 1;
		else return !0;
		if (t == n) return !1;
	}
}
...
var fe = 8205;
function pe(e, t, n = !0, r = !0) {
	return (n ? b : me)(e, t, r);
}
function b(e, t, n) {
	if (t == e.length) return t;
	t && ge(e.charCodeAt(t)) && _e(e.charCodeAt(t - 1)) && t--;
	let r = he(e, t);
	for (t += ve(r); t < e.length;) {
		let i = he(e, t);
		if (r == fe || i == fe || n && ue(i)) t += ve(i), r = i;
		else if (de(i)) {
			let n = 0, r = t - 2;
			for (; r >= 0 && de(he(e, r));) n++, r -= 2;
			if (n % 2 == 0) break;
			t += 2;
		} else break;
	}
...
var x = class e {
	...
	replace(e, t, n) {
		[e, t] = De(this, e, t);
		let r = [];
		return this.decompose(0, e, r, 2), n.length && n.decompose(0, n.length, r, 3), this.decompose(t, this.length, r, 1), ye.from(r, this.length - (t - e) + n.length);
	}
	append(e) {
	...
	slice(e, t = this.length) {
		[e, t] = De(this, e, t);
		let n = [];
		return this.decompose(e, t, n, 0), ye.from(n, t - e);
	}
	eq(e) {
		if (e == this) return !0;
	...
	static of(t) {
		...
		return t.length == 1 && !t[0] ? e.empty : t.length <= 32 ? new S(t) : ye.from(S.split(t, []));
	}
}, S = class e extends x {
	constructor(e, t = be(e)) {
	...
	lineInner(e, t, n, r) {
		for (let i = 0;; i++) {
			...
			if ((t ? n : o) >= e) return new Ee(r, o, n, a);
			r = o + 1, n++;
		}
	}
	decompose(t, n, r, i) {
		...
		if (i & 1) {
			let t = r.pop(), n = xe(a.text, t.text.slice(), 0, a.length);
	...
	replace(t, n, r) {
		...
		[t, n] = De(this, t, n);
		let i = xe(this.text, xe(r.text, Se(this.text, 0, t)), n), a = this.length + r.length - (n - t);
		return i.length <= 32 ? new e(i, a) : ye.from(e.split(i, []), a);
	}
	...
	replace(t, n, r) {
		if ([t, n] = De(this, t, n), r.lines < this.lines) for (let i = 0, a = 0; i < this.children.length; i++) {
			let o = this.children[i], s = a + o.length;
			if (t >= a && n <= s) {
...
typeof Symbol < "u" && (x.prototype[Symbol.iterator] = function() {
	return this.iter();
}, Ce.prototype[Symbol.iterator] = we.prototype[Symbol.iterator] = Te.prototype[Symbol.iterator] = function() {
	return this;
});
var Ee = class {
	constructor(e, t, n, r) {
...
var Me = /\r\n?|\n/, w = /*@__PURE__*/ (function(e) {
	...
	composeDesc(e) {
		return this.empty ? e : e.empty ? this : Re(this, e);
	}
	mapDesc(e, t = !1) {
	...
	compose(e) {
		return this.empty ? e : e.empty ? this : Re(this, e, !0);
	}
	map(e, t = !1) {
	...
	filter(t) {
		let n = [], r = [], i = [], a = new ze(this);
			...
			for (; o < s || o == s && a.len == 0;) {
				...
				T(n, e, t), t > 0 && Fe(r, n, a.text), a.forward(e), o += e;
			}
			let c = t[e++];
			for (; o < c;) {
				if (a.done) break done;
	...
	static of(t, n, r) {
		...
		function l(t) {
			if (Array.isArray(t)) for (let e of t) l(e);
				...
				let u = l ? typeof l == "string" ? x.of(l.split(r || Me)) : l : x.empty, d = u.length;
				if (e == s && d == 0) return;
				e < o && c(), e > o && T(i, e - o, -1), T(i, s - e, d), Fe(a, i, u), o = s;
			}
		}
		return l(t), c(!s), s;
	}
...
function Le(e, t, n, r = !1) {
	let i = [], a = r ? [] : null, o = new ze(e), s = new ze(t);
	for (let e = -1;;) if (o.done && s.len || s.done && o.len) throw Error("Mismatched change set lengths");
		...
		for (T(i, s.ins, -1); t;) {
			...
			o.ins >= 0 && e < o.i && o.len <= n && (T(i, 0, o.ins), a && Fe(a, i, o.text), e = o.i), o.forward(n), t -= n;
		}
		s.next();
	} else if (o.ins >= 0) {
		let t = 0, n = o.len;
		...
		T(i, t, e < o.i ? o.ins : 0), a && e < o.i && Fe(a, i, o.text), e = o.i, o.forward(o.len - n);
	} else if (o.done && s.done) return a ? Pe.createSet(i, a) : Ne.create(i);
	else throw Error("Mismatched change set lengths");
}
function Re(e, t, n = !1) {
	let r = [], i = n ? [] : null, a = new ze(e), o = new ze(t);
	for (let e = !1;;) if (a.done && o.done) return i ? Pe.createSet(r, i) : Ne.create(r);
	else if (a.ins == 0) T(r, a.len, 0, e), a.next();
	else if (o.len == 0 && !o.done) T(r, 0, o.ins, e), i && Fe(i, r, o.text), o.next();
		...
		if (a.ins == -1) {
			...
			T(r, t, n, e), i && n && Fe(i, r, o.text);
		} else o.ins == -1 ? (T(r, a.off ? 0 : a.len, t, e), i && Fe(i, r, a.textBit(t))) : (T(r, a.off ? 0 : a.len, o.off ? 0 : o.ins, e), i && !o.off && Fe(i, r, o.text));
...
var ze = class {
	...
	static fromJSON(t) {
		...
		return new e(t.ranges.map((e) => Be.fromJSON(e)), t.main);
	}
	static single(t, n = t) {
	...
	static cursor(e, t = 0, n, r) {
		return Be.create(e, e, (t == 0 ? 0 : t < 0 ? 8 : 16) | (n == null ? 7 : Math.min(6, n)), r);
	}
	static range(e, t, n, r, i) {
		let a = r == null ? 7 : Math.min(6, r);
		return !i && e != t && (i = t < e ? 1 : -1), i && (a |= i < 0 ? 8 : 16), t < e ? Be.create(t, e, a | 32, n) : Be.create(e, t, a, n);
	}
	static undirectionalRange(e, t) {
		return Be.create(e, t, 64, void 0);
	}
...
var He = 0, D = class e {
	constructor(e, t, n, r, i) {
		this.combine = e, this.compareInput = t, this.compare = n, this.isStatic = r, this.id = He++, this.default = e([]), this.extensions = typeof i == "function" ? i(this) : i;
	}
	get reader() {
		return this;
	}
	static define(t = {}) {
		return new e(t.combine || ((e) => e), t.compareInput || ((e, t) => e === t), t.compare || (t.combine ? (e, t) => e === t : Ue), !!t.static, t.enables);
	}
	of(e) {
		return new We([], this, 0, e);
	}
	compute(e, t) {
		if (this.isStatic) throw Error("Can't compute a static facet");
		return new We(e, this, 1, t);
	}
	computeN(e, t) {
		if (this.isStatic) throw Error("Can't compute a static facet");
		return new We(e, this, 2, t);
	}
	from(e, t) {
...
var We = class {
	constructor(e, t, n, r) {
		this.dependencies = e, this.facet = t, this.type = n, this.value = r, this.id = He++;
	}
	dynamicSlot(e) {
		...
		return {
			...
			update(e, r) {
				if (o && r.docChanged || s && (r.docChanged || r.selection) || Ke(e, c)) {
					let r = t(e);
					if (a ? !Ge(r, e.values[i], n) : !n(r, e.values[i])) return e.values[i] = r, 1;
				}
				return 0;
			},
			reconfigure: (e, o) => {
				...
				if (c != null) {
					let r = at(o, c);
					if (this.dependencies.every((t) => t instanceof D ? o.facet(t) === e.facet(t) : t instanceof Ye ? o.field(t, !1) == e.field(t, !1) : !0) || (a ? Ge(s = t(e), r, n) : n(s = t(e), r))) return e.values[i] = r, 0;
				} else s = t(e);
...
function qe(e, t, n) {
	...
	return {
		...
		reconfigure(e, i) {
			let a = Ke(e, r), c = i.config.facets[t.id], l = i.facet(t);
			if (c && !a && Ue(n, c)) return e.values[o] = l, 0;
			let u = s(e);
			return t.compare(u, l) ? (e.values[o] = l, 0) : (e.values[o] = u, 1);
		}
	};
}
var Je = /*@__PURE__*/ D.define({ static: !0 }), Ye = class e {
	constructor(e, t, n, r, i) {
		this.id = e, this.createF = t, this.updateF = n, this.compareF = r, this.spec = i, this.provides = void 0;
	}
	static define(t) {
		let n = new e(He++, t.create, t.update, t.compare || ((e, t) => e === t), t);
		return t.provide && (n.provides = t.provide(n)), n;
	}
	create(e) {
		return (e.facet(Je).find((e) => e.field == this)?.create || this.createF)(e);
	}
	slot(e) {
		let t = e[this.id] >> 1;
		return {
			...
			reconfigure: (e, n) => {
				let r = e.facet(Je), i = n.facet(Je), a;
...
var Qe = {
	highest: /*@__PURE__*/ Ze(Xe.highest),
	high: /*@__PURE__*/ Ze(Xe.high),
	default: /*@__PURE__*/ Ze(Xe.default),
	low: /*@__PURE__*/ Ze(Xe.low),
	lowest: /*@__PURE__*/ Ze(Xe.lowest)
}, $e = class {
	constructor(e, t) {
	...
	static resolve(t, n, r) {
		...
		for (let e of rt(t, n, o)) e instanceof Ye ? i.push(e) : (a[e.facet.id] || (a[e.facet.id] = [])).push(e);
		...
		for (let e in a) {
			...
			if (t.every((e) => e.type == 0)) {
				if (s[n.id] = c.length << 1 | 1, Ue(i, t)) c.push(r.facet(n));
				else {
...
function rt(e, t, n) {
	...
	function a(e, o) {
		...
		if (s != null) {
			if (s <= o) return;
			let t = r[s].indexOf(e);
			t > -1 && r[s].splice(t, 1), e instanceof tt && n.delete(e.compartment);
		}
		...
		} else if (e instanceof $e) a(e.inner, e.prec);
		else if (e instanceof Ye) r[o].push(e), e.provides && a(e.provides, o);
		else if (e instanceof We) r[o].push(e), e.facet.extensions && a(e.facet.extensions, Xe.default);
		else {
			let t = e.extension;
	...
	return a(e, Xe.default), r.reduce((e, t) => e.concat(t));
}
function it(e, t) {
	if (t & 1) return 2;
...
var ot = /*@__PURE__*/ D.define(), st = /*@__PURE__*/ D.define({
	combine: (e) => e.some((e) => e),
	static: !0
}), ct = /*@__PURE__*/ D.define({
	combine: (e) => e.length ? e[0] : void 0,
	static: !0
}), lt = /*@__PURE__*/ D.define(), ut = /*@__PURE__*/ D.define(), dt = /*@__PURE__*/ D.define(), ft = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : !1 }), pt = class {
	constructor(e, t) {
...
var k = class e {
	constructor(t, n, r, i, a, o) {
		this.startState = t, this.changes = n, this.selection = r, this.effects = i, this.annotations = a, this.scrollIntoView = o, this._doc = null, this._state = null, r && Ve(r, n.newLength), a.some((t) => t.type == e.time) || (this.annotations = a.concat(e.time.of(Date.now())));
	}
...
k.time = /*@__PURE__*/ pt.define(), k.userEvent = /*@__PURE__*/ pt.define(), k.addToHistory = /*@__PURE__*/ pt.define(), k.remote = /*@__PURE__*/ pt.define();
function gt(e, t) {
	let n = [];
	for (let r = 0, i = 0;;) {
		let a, o;
...
function _t(e, t, n) {
	let r, i, a;
	return n ? (r = t.changes, i = Pe.empty(t.changes.length), a = e.changes.compose(t.changes)) : (r = t.changes.map(e.changes), i = e.changes.mapDesc(t.changes, !0), a = e.changes.compose(r)), {
		changes: a,
...
function vt(e, t, n) {
	let r = t.selection, i = Ct(t.annotations);
	return t.userEvent && (i = i.concat(k.userEvent.of(t.userEvent))), {
		changes: t.changes instanceof Pe ? t.changes : Pe.of(t.changes || [], n, e.facet(ct)),
		selection: r && (r instanceof E ? r : E.single(r.anchor, r.head)),
		effects: Ct(t.effects),
		annotations: i,
		scrollIntoView: !!t.scrollIntoView
	};
}
function yt(e, t, n) {
	let r = vt(e, t.length ? t[0] : {}, e.doc.length);
	t.length && t[0].filter === !1 && (n = !1);
	for (let i = 1; i < t.length; i++) {
		t[i].filter === !1 && (n = !1);
		let a = !!t[i].sequential;
		r = _t(r, vt(e, t[i], a ? r.changes.newLength : e.doc.length), a);
	}
...
function bt(e) {
	...
	for (let r of t.facet(lt)) {
		let t = r(e);
		if (t === !1) {
			n = !1;
			break;
		}
		Array.isArray(t) && (n = n === !0 ? t : gt(n, t));
	}
	if (n !== !0) {
		let r, i;
		if (n === !1) i = e.changes.invertedDesc, r = Pe.empty(t.doc.length);
		else {
	...
	for (let n = r.length - 1; n >= 0; n--) {
		let i = r[n](e);
		e = i instanceof k ? i : Array.isArray(i) && i.length == 1 && i[0] instanceof k ? i[0] : yt(t, Ct(i), !1);
	}
	return e;
}
function xt(e) {
	let t = e.startState, n = t.facet(dt), r = e;
	for (let i = n.length - 1; i >= 0; i--) {
		let a = n[i](e);
		a && Object.keys(a).length && (r = _t(r, vt(t, a, e.changes.newLength), !0));
	}
	return r == e ? e : k.create(t, e.changes, e.selection, r.effects, r.annotations, r.scrollIntoView);
}
var St = [];
function Ct(e) {
	return e == null ? St : Array.isArray(e) ? e : [e];
}
var wt = /*@__PURE__*/ (function(e) {
	return e[e.Word = 0] = "Word", e[e.Space = 1] = "Space", e[e.Other = 2] = "Other", e;
})(wt ||= {}), Tt = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Et;
try {
...
function Dt(e) {
	...
	for (let t = 0; t < e.length; t++) {
		let n = e[t];
		if (/\w/.test(n) || n > "" && (n.toUpperCase() != n.toLowerCase() || Tt.test(n))) return !0;
	}
	return !1;
}
function Ot(e) {
	return (t) => {
		if (!/\S/.test(t)) return wt.Space;
		if (Dt(t)) return wt.Word;
		for (let n = 0; n < e.length; n++) if (t.indexOf(e[n]) > -1) return wt.Word;
		return wt.Other;
	};
}
var A = class e {
	constructor(e, t, n, r, i, a) {
		...
		for (let e = 0; e < this.config.dynamicSlots.length; e++) it(this, e << 1);
	...
	applyTransaction(t) {
		...
		for (let e of t.effects) e.is(et.reconfigure) ? (n &&= (i = /* @__PURE__ */ new Map(), n.compartments.forEach((e, t) => i.set(t, e)), null), i.set(e.value.compartment, e.value.extension)) : e.is(O.reconfigure) ? (n = null, r = e.value) : e.is(O.appendConfig) && (n = null, r = Ct(r).concat(e.value));
		let a;
		n ? a = t.startState.values.slice() : (n = nt.resolve(r, i, this), a = new e(n, this.doc, this.selection, n.dynamicSlots.map(() => null), (e, t) => t.reconfigure(e, this), null).values);
		let o = t.startState.facet(st) ? t.newSelection : t.newSelection.asSingle();
	...
	changeByRange(e) {
		let t = this.selection, n = e(t.ranges[0]), r = this.changes(n.changes), i = [n.range], a = Ct(n.effects);
		for (let n = 1; n < t.ranges.length; n++) {
			let o = e(t.ranges[n]), s = this.changes(o.changes), c = s.map(r);
			for (let e = 0; e < n; e++) i[e] = i[e].map(c);
			let l = r.mapDesc(s, !0);
			i.push(o.range.map(l)), r = r.compose(c), a = O.mapEffects(a, c).concat(O.mapEffects(Ct(o.effects), l));
		}
		return {
			changes: r,
	...
	changes(t = []) {
		return t instanceof Pe ? t : Pe.of(t, this.doc.length, this.facet(e.lineSeparator));
	}
	toText(t) {
		return x.of(t.split(this.facet(e.lineSeparator) || Me));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (it(this, t), at(this, t));
	}
	toJSON(e) {
		let t = {
			doc: this.sliceDoc(),
	...
	static create(t = {}) {
		let n = nt.resolve(t.extensions || [], /* @__PURE__ */ new Map()), r = t.doc instanceof x ? t.doc : x.of((t.doc || "").split(n.staticFacet(e.lineSeparator) || Me)), i = t.selection ? t.selection instanceof E ? t.selection : E.single(t.selection.anchor, t.selection.head) : E.single(0);
		return Ve(i, r.length), n.staticFacet(st) || (i = i.asSingle()), new e(n, r, i, n.dynamicSlots.map(() => null), (e, t) => t.create(e), null);
	}
	get tabSize() {
	...
	languageDataAt(e, t, n = -1) {
		let r = [];
		for (let i of this.facet(ot)) for (let a of i(this, t, n)) Object.prototype.hasOwnProperty.call(a, e) && r.push(a[e]);
		return r;
	}
	charCategorizer(e) {
		let t = this.languageDataAt("wordChars", e);
		return Ot(t.length ? t[0] : "");
	}
	wordAt(e) {
		let { text: t, from: n, length: r } = this.doc.lineAt(e), i = this.charCategorizer(e), a = e - n, o = e - n;
		for (; a > 0;) {
			let e = C(t, a, !1);
			if (i(t.slice(e, a)) != wt.Word) break;
			a = e;
		}
		for (; o < r;) {
			let e = C(t, o);
			if (i(t.slice(o, e)) != wt.Word) break;
			o = e;
		}
		return a == o ? null : E.range(a + n, o + n);
	}
};
A.allowMultipleSelections = st, A.tabSize = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : 4 }), A.lineSeparator = ct, A.readOnly = ft, A.phrases = /*@__PURE__*/ D.define({ compare(e, t) {
	let n = Object.keys(e), r = Object.keys(t);
	return n.length == r.length && n.every((n) => e[n] == t[n]);
} }), A.languageData = ot, A.changeFilter = lt, A.transactionFilter = ut, A.transactionExtender = dt, et.reconfigure = /*@__PURE__*/ O.define();
function kt(e, t, n = {}) {
	let r = {};
...
At.prototype.startSide = At.prototype.endSide = 0, At.prototype.point = !1, At.prototype.mapMode = w.TrackDel;
function jt(e, t) {
...
var Pt = class e {
	...
	update(t) {
		...
		if (r && (n = n.slice().sort(Nt)), this.isEmpty) return n.length ? e.of(n) : this;
		let s = new Rt(this, null, -1).goto(0), c = 0, l = [], u = new It();
		...
		} else s.rangeIndex == 1 && s.chunkIndex < this.chunk.length && (c == n.length || this.chunkEnd(s.chunkIndex) < n[c].from) && (!o || i > this.chunkEnd(s.chunkIndex) || a < this.chunkPos[s.chunkIndex]) && u.addChunk(this.chunkPos[s.chunkIndex], this.chunk[s.chunkIndex]) ? s.nextChunk() : ((!o || i > s.to || a < s.from || o(s.from, s.to, s.value)) && (u.addInner(s.from, s.to, s.value) || l.push(Mt.create(s.from, s.to, s.value))), s.next());
	...
	iter(e = 0) {
		return zt.from([this]).goto(e);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(e, t = 0) {
		return zt.from(e).goto(t);
	}
	static compare(e, t, n, r, i = -1) {
		let a = e.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), o = t.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), s = Lt(a, o, n), c = new Vt(a, s, i), l = new Vt(o, s, i);
		n.iterGaps((e, t, n) => Ht(c, e, l, t, n, r)), n.empty && n.length == 0 && Ht(c, 0, l, 0, 0, r);
	}
	static eq(e, t, n = 0, r) {
		r ??= 1e9 - 1;
		...
		let o = Lt(i, a), s = new Vt(i, o, 0).goto(n), c = new Vt(a, o, 0).goto(n);
		for (;;) {
			if (s.to != c.to || !Ut(s.active, c.active) || s.point && (!c.point || !jt(s.point, c.point))) return !1;
			if (s.to > r) return !0;
			s.next(), c.next();
		}
	}
	static spans(e, t, n, r, i = -1) {
		let a = new Vt(e, null, i).goto(t), o = t, s = a.openStart;
		for (;;) {
	...
	static of(e, t = !1) {
		let n = new It();
		for (let r of e instanceof Mt ? [e] : t ? Ft(e) : e) n.add(r.from, r.to, r.value);
		return n.finish();
	}
	static join(t) {
...
function Ft(e) {
	if (e.length > 1) for (let t = e[0], n = 1; n < e.length; n++) {
		let r = e[n];
		if (Nt(t, r) > 0) return e.slice().sort(Nt);
		t = r;
	}
	return e;
}
...
var It = class e {
	finishChunk(e) {
		this.chunks.push(new Pt(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, e && (this.from = [], this.to = [], this.value = []);
	}
	constructor() {
...
var Rt = class {
	...
	static from(t, n = null, r = -1) {
		let i = [];
		for (let e = 0; e < t.length; e++) for (let a = t[e]; !a.isEmpty; a = a.nextLayer) a.maxPoint >= r && i.push(new Rt(a, n, r, e));
	...
	goto(e, t = -1e9) {
		...
		for (let e = this.heap.length >> 1; e >= 0; e--) Bt(this.heap, e);
	...
	next() {
		if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
			...
			let e = this.heap[0];
			this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), Bt(this.heap, 0);
		}
	}
};
function Bt(e, t) {
...
var Vt = class {
	constructor(e, t, n) {
		this.minPoint = n, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = zt.from(e, t, n);
	}
	goto(e, t = -1e9) {
	...
	removeActive(e) {
		Wt(this.active, e), Wt(this.activeTo, e), Wt(this.activeRank, e), this.minActive = Kt(this.active, this.activeTo);
	}
	addActive(e) {
		let t = 0, { value: n, to: r, rank: i } = this.cursor;
		for (; t < this.activeRank.length && (i - this.activeRank[t] || r - this.activeTo[t]) > 0;) t++;
		Gt(this.active, t, n), Gt(this.activeTo, t, r), Gt(this.activeRank, t, i), e && Gt(e, t, this.cursor.from), this.minActive = Kt(this.active, this.activeTo);
	}
	next() {
...
function Ht(e, t, n, r, i, a) {
	...
	for (let t = !1;;) {
		...
		if (e.point || n.point ? (e.point && n.point && jt(e.point, n.point) && Ut(e.activeForPoint(e.to), n.activeForPoint(n.to)) || a.comparePoint(s, d, e.point, n.point), t = !1) : (t && a.boundChange(s), d > s && !Ut(e.active, n.active) && a.compareRange(s, d, e.active, n.active), l && d < o && (r || e.openEnd(u) != n.openEnd(u)) && (t = !0)), u > o) break;
		s = u, i <= 0 && e.next(), i >= 0 && n.next();
	}
}
function Ut(e, t) {
	if (e.length != t.length) return !1;
	for (let n = 0; n < e.length; n++) if (e[n] != t[n] && !jt(e[n], t[n])) return !1;
	return !0;
}
function Wt(e, t) {
...
for (var Yt = "ͼ", Xt = typeof Symbol > "u" ? "__ͼ" : Symbol.for(Yt), Zt = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), Qt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, $t = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
	...
	static newName() {
		let e = Qt[Xt] || 1;
		return Qt[Xt] = e + 1, Yt + e.toString(36);
	}
	static mount(e, t, n) {
		let r = e[Zt], i = n && n.nonce;
		r ? i && r.setNonce(i) : r = new tn(e, i), r.mount(Array.isArray(t) ? t : [t], e);
	}
}, en = /* @__PURE__ */ new Map(), tn = class {
	constructor(e, t) {
		let n = e.ownerDocument || e, r = n.defaultView;
		if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
			let t = en.get(n);
			if (t) return e[Zt] = t;
			this.sheet = new r.CSSStyleSheet(), en.set(n, this);
		} else this.styleTag = n.createElement("style"), t && this.styleTag.setAttribute("nonce", t);
		this.modules = [], e[Zt] = this;
	}
	mount(e, t) {
	...
	221: "}",
	222: "\""
}, an = typeof navigator < "u" && /Mac/.test(navigator.platform), on = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), M = 0; M < 10; M++) nn[48 + M] = nn[96 + M] = String(M);
for (var M = 1; M <= 24; M++) nn[M + 111] = "F" + M;
for (var M = 65; M <= 90; M++) nn[M] = String.fromCharCode(M + 32), rn[M] = String.fromCharCode(M);
for (var sn in nn) rn.hasOwnProperty(sn) || (rn[sn] = nn[sn]);
function cn(e) {
	var t = !(an && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || on && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? rn : nn)[e.keyCode] || e.key || "Unidentified";
...
var N = typeof navigator < "u" ? navigator : {
	...
	vendor: "",
	platform: ""
}, ln = typeof document < "u" ? document : { documentElement: { style: {} } }, un = /*@__PURE__*/ /Edge\/(\d+)/.exec(N.userAgent), dn = /*@__PURE__*/ /MSIE \d/.test(N.userAgent), fn = /*@__PURE__*/ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(N.userAgent), pn = !!(dn || fn || un), mn = !pn && /*@__PURE__*/ /gecko\/(\d+)/i.test(N.userAgent), hn = !pn && /*@__PURE__*/ /Chrome\/(\d+)/.exec(N.userAgent), gn = "webkitFontSmoothing" in ln.documentElement.style, _n = !pn && /*@__PURE__*/ /Apple Computer/.test(N.vendor), vn = _n && (/*@__PURE__*/ /Mobile\/\w+/.test(N.userAgent) || N.maxTouchPoints > 2), P = {
	mac: vn || /*@__PURE__*/ /Mac/.test(N.platform),
	windows: /*@__PURE__*/ /Win/.test(N.platform),
	linux: /*@__PURE__*/ /Linux|X11/.test(N.platform),
	ie: pn,
	ie_version: dn ? ln.documentMode || 6 : fn ? +fn[1] : un ? +un[1] : 0,
	gecko: mn,
	gecko_version: mn ? +(/*@__PURE__*/ /Firefox\/(\d+)/.exec(N.userAgent) || [0, 0])[1] : 0,
	chrome: !!hn,
	chrome_version: hn ? +hn[1] : 0,
	ios: vn,
	android: /*@__PURE__*/ /Android\b/.test(N.userAgent),
	webkit: gn,
	webkit_version: gn ? +(/*@__PURE__*/ /\bAppleWebKit\/(\d+)/.exec(N.userAgent) || [0, 0])[1] : 0,
	safari: _n,
	safari_version: _n ? +(/*@__PURE__*/ /\bVersion\/(\d+(\.\d+)?)/.exec(N.userAgent) || [0, 0])[1] : 0,
...
var Tn = class {
	...
	static widget(e) {
		...
		return t += n && !e.inlineOrder ? t > 0 ? 3e8 : -4e8 : t > 0 ? 1e8 : -1e8, new On(e, t, t, n, e.widget || null, !1);
	}
	static replace(e) {
		let t = !!e.block, n, r;
		if (e.isBlockGap) n = -5e8, r = 4e8;
		else {
			let { start: i, end: a } = kn(e, t);
			n = (i ? t ? -3e8 : -1 : 5e8) - 1, r = (a ? t ? 2e8 : 1 : -6e8) + 1;
		}
		return new On(e, n, r, t, e.widget || null, !0);
	}
	static line(e) {
		return new Dn(e);
	}
...
I.none = j.empty;
var En = class e extends I {
	constructor(e) {
		let { start: t, end: n } = kn(e);
		super(t ? -1 : 5e8, n ? 1 : -6e8, null, e), this.tagName = e.tagName || "span", this.attrs = e.class && e.attributes ? yn(e.attributes, { class: e.class }) : e.class ? { class: e.class } : e.attributes || bn;
	}
	eq(t) {
		return this == t || t instanceof e && this.tagName == t.tagName && xn(this.attrs, t.attrs);
	}
	range(e, t = e) {
...
var Dn = class e extends I {
	...
	eq(t) {
		return t instanceof e && this.spec.class == t.spec.class && xn(this.spec.attributes, t.spec.attributes);
	}
	range(e, t = e) {
...
Dn.prototype.mapMode = w.TrackBefore, Dn.prototype.point = !0;
...
var Mn = class e extends At {
	constructor(e, t, n) {
		super(), this.tagName = e, this.attributes = t, this.rank = n;
	}
	eq(t) {
		return t == this || t instanceof e && this.tagName == t.tagName && xn(this.attributes, t.attributes);
	}
	static create(t) {
		return new e(t.tagName, t.attributes || bn, t.rank == null ? 50 : Math.max(0, Math.min(t.rank, 100)));
	}
	static set(e, t = !1) {
		return j.of(e, t);
	}
...
function In(e) {
	return e.nodeType == 3 ? $n(e, 0, e.nodeValue.length).getClientRects() : e.nodeType == 1 ? e.getClientRects() : [];
}
function Ln(e, t, n, r) {
	return n ? Bn(e, t, n, r, -1) || Bn(e, t, n, r, 1) : !1;
}
function Rn(e) {
...
var qn = class {
	...
	setRange(e) {
		...
		this.set(t, Math.min(e.anchorOffset, t ? Vn(t) : 0), n, Math.min(e.focusOffset, n ? Vn(n) : 0));
	}
	set(e, t, n, r) {
...
var Xn = null;
P.safari && P.safari_version >= 26 && (Xn = !1);
function Zn(e) {
	if (e.setActive) return e.setActive();
	if (Xn) return e.focus(Xn);
	let t = Jn(e);
	e.focus(Xn == null ? { get preventScroll() {
...
function nr(e, t) {
	...
	for (r = Math.min(r, Vn(n));;) if (r) {
		if (n.nodeType != 1) return !1;
		let e = n.childNodes[r - 1];
		e.contentEditable == "false" ? r-- : (n = e, r = Vn(n));
	} else if (n == e) return !0;
	else r = Rn(n), n = n.parentNode;
}
function rr(e) {
...
function ir(e, t) {
	for (let n = e, r = t;;) if (n.nodeType == 3 && r > 0) return {
		...
		n = n.childNodes[r - 1], r = Vn(n);
	} else if (n.parentNode && !zn(n)) r = Rn(n), n = n.parentNode;
	else return null;
}
function ar(e, t) {
	...
	} else if (n.parentNode && !zn(n)) r = Rn(n) + 1, n = n.parentNode;
	else return null;
}
var or = class e {
	constructor(e, t, n = !0) {
	...
	static before(t, n) {
		return new e(t.parentNode, Rn(t), n);
	}
	static after(t, n) {
		return new e(t.parentNode, Rn(t) + 1, n);
	}
...
var ur = /*@__PURE__*/ lr("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), dr = /*@__PURE__*/ lr("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), fr = /*@__PURE__*/ Object.create(null), pr = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function mr(e) {
	return e <= 247 ? ur[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? dr[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var hr = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, gr = class {
	get dir() {
		return this.level % 2 ? cr : sr;
	}
	constructor(e, t, n) {
...
function _r(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !_r(r.inner, i.inner)) return !1;
	}
	return !0;
}
var R = [];
...
function yr(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = fr[n = e.charCodeAt(t)]) {
			if (r < 0) {
				for (let e = s - 3; e >= 0; e -= 3) if (pr[e + 1] == -r) {
					let n = pr[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
					r && (R[t] = R[pr[e]] = r), s = e;
					break;
				}
			} else if (pr.length == 189) break;
			else pr[s++] = t, pr[s++] = n, pr[s++] = c;
		} else if ((o = R[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function xr(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new gr(c, m.from, f)), Sr(e, m.direction == sr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? R[p] != s : R[p] == s)) break;
		else p++;
		d ? xr(e, c, p, r + 1, i, d, o) : c < p && o.push(new gr(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new gr(m.to, c, f)), Sr(e, m.direction == sr == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? R[p - 1] != s : R[p - 1] == s)) break;
		else p--;
		d ? xr(e, p, c, r + 1, i, d, o) : p < c && o.push(new gr(p, c, f)), c = p;
	}
}
function Sr(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	vr(e, i, a, r, s), yr(e, i, a, r, s), br(i, a, r, s), xr(e, i, a, t, n, r, o);
}
function Cr(e, t, n) {
	if (!e) return [new gr(0, 0, +(t == cr))];
	if (t == sr && !n.length && !hr.test(e)) return wr(e.length);
	if (n.length) for (; e.length > R.length;) R[R.length] = 256;
	let r = [], i = t == sr ? 0 : 1;
	return Sr(e, i, i, n, 0, e.length, r), r;
}
function wr(e) {
	return [new gr(0, e, 0)];
}
...
function Er(e, t, n, r, i) {
	let a = r.head - e.from, o = gr.find(t, a, r.bidiLevel ?? -1, r.assoc), s = t[o], c = s.side(i, n);
	if (a == c) {
		let e = o += i ? 1 : -1;
	...
	(l < s.from || l > s.to) && (l = c), Tr = e.text.slice(Math.min(a, l), Math.max(a, l));
...
function Dr(e, t, n) {
	for (let r = t; r < n; r++) {
		let t = mr(e.charCodeAt(r));
		if (t == 1) return sr;
		if (t == 2 || t == 4) return cr;
	}
	return sr;
}
var Or = /*@__PURE__*/ D.define(), kr = /*@__PURE__*/ D.define(), Ar = /*@__PURE__*/ D.define(), jr = /*@__PURE__*/ D.define(), Mr = /*@__PURE__*/ D.define(), Nr = /*@__PURE__*/ D.define(), Pr = /*@__PURE__*/ D.define(), Fr = /*@__PURE__*/ D.define(), Ir = /*@__PURE__*/ D.define(), Lr = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), Rr = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) }), zr = /*@__PURE__*/ D.define(), Br = class e {
...
}, Vr = /*@__PURE__*/ O.define({ map: (e, t) => e.map(t) }), Hr = /*@__PURE__*/ O.define();
function Ur(e, t, n) {
	let r = e.facet(jr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var Wr = /*@__PURE__*/ D.define({ combine: (e) => !e.length || e[0] }), Gr = 0, Kr = /*@__PURE__*/ D.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(Kr.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(Kr.of({
			plugin: this,
			arg: e
		}));
	}
	...
	update(e) {
		if (!this.value) {
			if (this.spec) try {
				...
				Ur(e.state, t, "CodeMirror plugin crashed"), this.deactivate();
			}
			...
			if (this.mustUpdate = null, this.value.update) try {
				...
				if (Ur(e.state, t, "CodeMirror plugin crashed"), this.value.destroy) try {
					this.value.destroy();
				} catch {}
				this.deactivate();
			}
	...
	destroy(e) {
		if (this.value?.destroy) try {
			...
			Ur(e.state, t, "CodeMirror plugin crashed");
		}
	}
	deactivate() {
		this.spec = this.value = null;
	}
}, Yr = /*@__PURE__*/ D.define(), Xr = /*@__PURE__*/ D.define(), Zr = /*@__PURE__*/ D.define(), Qr = /*@__PURE__*/ D.define(), $r = /*@__PURE__*/ D.define(), ei = /*@__PURE__*/ D.define(), ti = /*@__PURE__*/ D.define();
function ni(e, t) {
	let n = e.state.facet(ti);
	...
	return j.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n ??= Dr(t.text, o, s), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var ri = /*@__PURE__*/ D.define();
function ii(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(ri)) {
		let o = a(e);
...
var ai = /*@__PURE__*/ D.define(), oi = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		this.view = e, this.state = t, this.transactions = n, this.flags = 0, this.startState = e.state, this.changes = Pe.empty(this.startState.doc.length);
		for (let e of n) this.changes = this.changes.compose(e.changes);
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new oi(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		let n = Rn(this.dom), r = this.length ? e > 0 : t > 0;
		return new or(this.parent.dom, n + +!!r, e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof di) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = ui(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = ui(r);
		this.length = a;
	}
};
function ui(e) {
...
var di = class extends li {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof fi) t.push(r), n = a, r = 0;
			else {
	...
	coordsIn(e, t, n) {
		...
		return r ? r.tile.coordsIn(Math.max(0, r.offset), t, n) : mi(this);
	}
	domIn(e, t) {
		let n = this.resolveInline(e, t);
		if (n) {
			let { tile: e, offset: r } = n;
			if (this.dom.contains(e.dom)) return e.isText() ? new or(e.dom, Math.min(e.dom.nodeValue.length, r)) : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
			let i = n.tile.parent, a = !1;
			for (let e of i.children) {
				if (a) return new or(e.dom, 0);
				e == n.tile && (a = !0);
			}
		}
		return new or(this.dom, 0);
	}
};
function mi(e) {
...
var gi = class e extends li {
	...
	coordsIn(e, t, n) {
		...
		let s = $n(this.dom, i, a).getClientRects();
		if (!s.length) return null;
		let c = s[(o ? o < 0 : t >= 0) ? 0 : s.length - 1];
		return P.safari && !o && c.width == 0 && (c = Array.prototype.find.call(s, (e) => e.width) || c), n == null ? c : Hn(c, (o ? o > 0 : t < 0) == n);
	}
	static of(t, n) {
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new _i(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || _i.of(e, this.cache.find(_i)?.dom));
		this.pos += e.length, this.afterWidget = null;
	}
	addComposition(e, t) {
		let n = this.curLine;
		n.dom != t.line.dom && (n.setDOM(this.cache.reused.has(t.line) ? Mi(t.line.dom) : t.line.dom), this.cache.reused.set(t.line, 2));
		let r = n;
		for (let e = t.marks.length - 1; e >= 0; e--) {
			let n = t.marks[e], i = r.lastChild;
			if (i instanceof gi && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(Mi(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = z.get(n.dom);
					e && e.setDOM(Mi(n.dom));
				}
				let e = gi.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new _i(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= ki;
		let n = pi.start(e, t || this.cache.find(pi)?.dom, !!t);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let i = e[r], a;
			if (t > 0 && (a = n.lastChild) && a instanceof gi && a.mark.eq(i)) n = a, t--;
			else {
				let e = gi.of(i, this.cache.find(gi, (e) => e.mark.eq(i))?.dom);
				n.append(e), n = e, t = 0;
			}
		}
		return n;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !Di(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(P.ios && Di(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(Pi, 0, 32) || new vi(Pi.toDOM(), 0, Pi, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = e.rank * 102 + e.value.rank, n = new xi(e.from, e.to, e.value, t), r = this.wrappers.length;
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof fi && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = fi.of(t.wrapper, this.cache.find(fi, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(yi, void 0, 1);
		return n && (n.flags = t), n || new yi(t);
	}
	flushBuffer() {
...
for (let e = 0; e < wi.length; e++) wi[e].bucket = e;
var Ti = class {
	constructor(e) {
		this.view = e, this.buckets = wi.map(() => []), this.index = wi.map(() => 0), this.reused = /* @__PURE__ */ new Map();
	}
	add(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new vi(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Ti(e), this.text = new Ci(e.state.doc), this.builder = new Si(this.cache, new di(e, e.contentDOM), j.iter(n)), this.cache.reused.set(t, 2), this.old = new bi(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		let r = ji(this.old), i = this.openMarks;
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) {
					if (this.openWidget) this.builder.continueWidget(n - t);
					else {
						let a = n > 0 || t < e.length ? vi.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof yi) this.cache.add(e);
				else if (e instanceof gi) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof gi && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length &&= i = 0 : e instanceof gi && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof On) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? Ni.block : Ni.inline), c = Oi(a), l = this.cache.findWidget(i, t - e, c) || vi.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof gi ? t.push(e) : e?.isLine() ? n = e : e instanceof fi || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new pi(r, ki) : n || t.push(gi.of(new En({
...
function Ai(e, t) {
	...
	return !n && !r ? e : (e ||= { class: "cm-line" }, n && yn(n, e), r && (e.class += " " + r), e);
}
function ji(e) {
	let t = [];
	for (let n = e.parents.length; n > 1; n--) {
		let r = n == e.parents.length ? e.tile : e.parents[n].tile;
		r instanceof gi && t.push(r.mark);
	}
	return t;
}
function Mi(e) {
...
Ni.inline = /*@__PURE__*/ new Ni("span"), Ni.block = /*@__PURE__*/ new Ni("div");
var Pi = /*@__PURE__*/ new class extends Tn {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !Ki(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? zi(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new oi(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		...
		this.updateDeco();
		let o = Hi(i, this.decorations, e.changes);
		o.length && (t = oi.extendWithRanges(t, o));
		let s = Wi(a, this.blockWrappers, e.changes);
		return s.length && (t = oi.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				let n = this.tile, r = new Ei(this.view, n, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
				t && z.get(t.text) && r.cache.reused.set(z.get(t.text), 2), this.tile = r.run(e, t), Ii(n, r.cache.reused);
			}
		...
		let r = [];
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let e of this.tile.children) e.isWidget() && e.widget instanceof qi && r.push(e.dom);
		n.updateGaps(r);
	}
	...
	updateSelection(e = !1, t = !1) {
		...
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(Wr) || n.tabIndex > -1) && Fn(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), P.gecko && s.empty && !this.hasComposition && Li(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new or(e, 0), o = !0;
		}
		let u = this.view.observer.selectionRange;
		(o || !u.focusNode || (!Ln(c.node, c.offset, u.anchorNode, u.anchorOffset) || !Ln(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			P.android && P.chrome && n.contains(u.focusNode) && Gi(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = Nn(this.view.root);
			if (e) {
				if (s.empty) {
					if (P.gecko) {
						let e = Bi(c.node, c.offset);
						if (e && e != 3) {
							let t = (e == 1 ? ir : ar)(c.node, c.offset);
							t && (c = new or(t.node, t.offset));
						}
					}
		...
		}), this.view.observer.setSelectionRange(c, l)), this.impreciseAnchor = c.precise ? null : new or(u.anchorNode, u.anchorOffset), this.impreciseHead = l.precise ? null : new or(u.focusNode, u.focusOffset);
	}
	...
	enforceCursorAssoc() {
		...
		let { view: e } = this, t = e.state.selection.main, n = Nn(e.root), { anchorNode: r, anchorOffset: i } = e.observer.selectionRange;
	...
	coordsAt(e, t, n) {
		...
		return r.isWidget() ? r.widget instanceof qi ? null : r.coordsInWidget(i, t, !0) : r.coordsIn(i, t, n);
	}
	lineAt(e, t) {
	...
	coordsForChar(e) {
		...
		function r(e, t) {
			if (e.isComposite()) for (let n of e.children) {
				...
				let n = C(e.text, t);
				if (n == t) return null;
				let r = $n(e.dom, t, n).getClientRects();
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == L.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof fi) p > n && l(r, u, m);
				else if (u >= n && (c > 0 && t.push(-c), t.push(h + c), c = 0, a)) {
					let e = r.dom.lastChild, t = e ? In(e) : [];
					if (t.length) {
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(Zr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet($r).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(Qr).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(zr)) try {
			if (t(this.view, e.range, e)) return !0;
		} catch (e) {
			Ur(this.view.state, e, "scroll handler");
		}
...
function Ii(e, t) {
	...
	if (n != 1) {
		n ?? e.destroy();
		for (let n of e.children) Ii(n, t);
	}
}
function Li(e) {
...
function Ri(e, t) {
	...
	let r = ir(n.focusNode, n.focusOffset), i = ar(n.focusNode, n.focusOffset), a = r || i;
...
function zi(e, t, n) {
	...
	return {
		range: new oi(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function Bi(e, t) {
...
function Yi(e, t, n, r, i) {
	...
	return n.from + Jt(o, a, e.state.tabSize);
}
function Xi(e, t, n) {
...
function Zi(e, t, n, r) {
	let i = Xi(e, t.head, t.assoc || -1), a = !r || i.type != F.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function na(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = ta(e, i.from, -1), n = ta(e, i.to, 1);
...
function ra(e, t, n) {
	let r = ta(e.state.facet(ei).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function aa(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new ia(0, 1);
		if (c > e.viewState.docHeight) return new ia(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == F.Text) {
			let t = Yi(e, i, l, o, s);
			return new ia(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != F.Text) return c < (l.top + l.bottom) / 2 ? new ia(l.from, 1) : new ia(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new oa(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var oa = class {
	constructor(e, t, n, r) {
	...
	baseDirAt(e, t) {
		...
		return r[gr.find(r, e - n.from, -1, t)].level == this.baseDir;
	}
	dirAt(e, t) {
		let { line: n, spans: r } = this.bidiSpansAt(e);
		return r[gr.find(r, e - n.from, -1, t)].dir;
	}
	bidiIn(e, t) {
	...
	scanText(e, t) {
		...
		let r = this.scan(n, (r) => {
			...
			return $n(e.dom, i, a).getClientRects();
		});
		return r.after ? new ia(n[r.i + 1], -1) : new ia(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new ia(t, 1);
		...
		let r = this.scan(n, (t) => {
			let n = e.children[t];
			return n.flags & 48 ? null : (n.dom.nodeType == 1 ? n.dom : $n(n.dom, 0, n.length)).getClientRects();
		}), i = e.children[r.i], a = n[r.i];
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new ia(n[r.i + 1], -1) : new ia(a, 1);
	}
}, sa = "￿", ca = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = z.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : zn(r)) || zn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !ua(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (la(e, n.node, n.offset) ? t : 0));
	}
};
function la(e, t, n) {
	for (;;) {
		if (!t || n < Vn(t)) return !1;
		if (t == e) return !0;
		n = Rn(t) + 1, t = t.parentNode;
	}
}
function ua(e, t) {
	let n;
...
var da = class {
	...
	constructor(e, t, n, r) {
		...
		else if (t > -1 && (this.bounds = pa(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : va(e), n = new ca(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = ya(t, this.bounds.from);
		} else {
			let t = e.observer.selectionRange, n = i && i.node == t.focusNode && i.offset == t.focusOffset || !Pn(e.contentDOM, t.focusNode) ? o.main.head : e.docView.posFromDOM(t.focusNode, t.focusOffset), r = a && a.node == t.anchorNode && a.offset == t.anchorOffset || !Pn(e.contentDOM, t.anchorNode) ? o.main.anchor : e.docView.posFromDOM(t.anchorNode, t.anchorOffset), s = e.viewport;
...
function ma(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, sa), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: x.of(t.text.slice(a.from - e, u).split(sa))
		} : (d = _a(l, t.text, s - e, c)) && (P.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: x.of(t.text.slice(d.from, d.toB).split(sa))
		});
	} else r && (!e.hasFocus && i.facet(Wr) || ba(r, a)) && (r = null);
	if (!n && !r) return !1;
	...
	if (r && !ba(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = na(i.facet(ei).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function ha(e, t, n, r = -1) {
	...
	if (P.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && er(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && er(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && er(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o ||= ga(e, t, n);
	return e.state.facet(Nr).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()), !0;
}
function ga(e, t, n) {
	let r, i = e.state, a = i.selection.main, o = -1;
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = ta(i.facet(ei).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && Ri(e, n.main.head);
			if (u) {
...
function va(e) {
	...
	return n && (t.push(new da(n, r)), (i != n || a != r) && t.push(new da(i, a))), t;
}
function ya(e, t) {
...
var xa = class {
	...
	ensureHandlers(e) {
		let t = wa(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && Da.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), P.android && P.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (P.ios && !e.synthetic && !e.altKey && !e.metaKey && (Ta.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || Ea.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && P.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && Sa(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, er(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function wa(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(Ca(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(Ca(t.value, r));
		}
	}
	for (let e in Ia) n(e).handlers.push(Ia[e]);
...
var ja = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = Kn(e.contentDOM), this.atoms = e.state.facet(ei).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(A.allowMultipleSelections) && Ma(e, t), this.dragging = Pa(e, t) && Ka(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || this.dragging == null && Aa(this.startEvent, e) < 10) return;
		...
		let s = ii(this.view);
		e.clientX - s.left <= r + Oa ? t = -ka(r - e.clientX) : e.clientX + s.right >= a - Oa && (t = ka(e.clientX - a)), e.clientY - s.top <= i + Oa ? n = -ka(i - e.clientY) : e.clientY + s.bottom >= o - Oa && (n = ka(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = na(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var Ia = /*@__PURE__*/ Object.create(null), B = /*@__PURE__*/ Object.create(null), La = P.ie && P.ie_version < 15 || P.ios && P.webkit_version < 604;
function Ra(e) {
	let t = e.dom.parentNode;
	if (!t) return;
	let n = t.appendChild(document.createElement("textarea"));
	n.style.cssText = "position: fixed; left: -10000px; top: 10px", n.focus(), setTimeout(() => {
		e.focus(), n.remove(), Ba(e, n.value);
	}, 50);
}
function za(e, t, n) {
...
B.scroll = (e) => {
...
}, Ia.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), B.touchstart = (e, t) => {
	...
	let n = null;
	for (let r of e.state.facet(Ar)) if (n = r(e, t), n) break;
	if (!n && t.button == 0 && (n = qa(e, t)), n) {
		let r = !e.hasFocus;
		e.inputState.startMouseSelection(new ja(e, t, n, r)), r && e.observer.ignore(() => {
			Zn(e.contentDOM);
...
var Ha = P.ie && P.ie_version <= 11, Ua = null, Wa = 0, Ga = 0;
function Ka(e) {
	if (!Ha) return e.detail;
	let t = Ua, n = Ga;
	return Ua = e, Ga = Date.now(), Wa = !t || n > Date.now() - 400 && Math.abs(t.clientX - e.clientX) < 2 && Math.abs(t.clientY - e.clientY) < 2 ? (Wa + 1) % 3 : 1;
}
function qa(e, t) {
	let n = e.posAndSideAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = Ka(t), i = e.state.selection;
	return {
		update(e) {
		...
		get(t, a, o) {
			let s = e.posAndSideAtCoords({
				x: t.clientX,
				y: t.clientY
			}, !1), c, l = Va(e, s.pos, s.assoc, r);
			if (n.pos != s.pos && !a) {
				let t = Va(e, n.pos, n.assoc, r), i = Math.min(t.from, l.from), a = Math.max(t.to, l.to);
				l = i < l.from ? E.range(i, a, l.assoc) : E.range(a, i, l.assoc);
			}
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = Ja(i, s.pos)) ? c : o ? i.addRange(l) : E.create([l]);
		}
	};
}
function Ja(e, t) {
...
Ia.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", za(e.state, Ir, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, Ia.dragend = (e) => (e.inputState.draggedContent = null, !1);
function Ya(e, t, n, r) {
	if (n = za(e.state, Fr, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && Na(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
Ia.drop = (e, t) => {
	...
	return n ? (Ba(e, n.getData("text/plain") || n.getData("text/uri-list")), !0) : (Ra(e), !1);
};
function Xa(e, t) {
...
function Za(e) {
	...
	return {
		text: za(e, Ir, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
var Qa = null;
Ia.copy = Ia.cut = (e, t) => {
	if (!Fn(e.contentDOM, e.observer.selectionRange)) return !1;
	let { text: n, ranges: r, linewise: i } = Za(e.state);
	if (!n && !i) return !1;
...
var $a = /*@__PURE__*/ pt.define();
function eo(e, t) {
	let n = [];
	for (let r of e.facet(Pr)) {
		let i = r(e, t);
		i && n.push(i);
	}
...
B.focus = (e) => {
	e.inputState.lastFocusTime = Date.now(), !e.scrollDOM.scrollTop && (e.inputState.lastScrollTop || e.inputState.lastScrollLeft) && (e.scrollDOM.scrollTop = e.inputState.lastScrollTop, e.scrollDOM.scrollLeft = e.inputState.lastScrollLeft), to(e);
}, B.blur = (e) => {
	e.observer.clearSelectionRange(), to(e);
	...
	let n;
	if (P.chrome && P.android && (n = Ta.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
...
function ro(e) {
	no.has(e) || (no.add(e), e.addEventListener("copy", () => {}), e.addEventListener("cut", () => {}));
}
var io = [
	"pre-wrap",
	"normal",
...
var so = class {
	...
	refresh(e, t, n, r, i, a) {
		let o = io.indexOf(e) > -1, s = Math.abs(t - this.lineHeight) > .3 || this.lineWrapping != o;
	...
	get widget() {
		return this._content instanceof On ? this._content.widget : null;
	}
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > uo && (ao = !0), this.height = e);
	}
	replace(t, n, r) {
		return e.of(r);
	}
	...
	applyChanges(e, t, n, r) {
		...
		for (let o = r.length - 1; o >= 0; o--) {
			...
			l += d.from - s, s = d.from;
			let p = xo.build(n.setDoc(a), e, l, u);
			i = po(i, i.replace(s, c, p));
		}
	...
	static of(t) {
		...
		let o = 0;
		return t[n - 1] == null ? (o = 1, n--) : t[n] ?? (o = 1, r++), new vo(e.of(t.slice(0, n)), o, e.of(t.slice(r)));
	}
};
function po(e, t) {
	return e == t ? e : (e.constructor != t.constructor && (ao = !0), t);
}
fo.prototype.size = 1;
var mo = /*@__PURE__*/ I.replace({}), ho = class extends fo {
	constructor(e, t, n) {
	...
	blockAt(e, t, n, r) {
		return this.spaceAbove && e < n + this.spaceAbove ? new lo(r, 0, n, this.spaceAbove, mo) : this.mainBlock(n, r);
	}
	lineAt(e, t, n, r, i) {
	...
	replace(t, n, r) {
		let i = r[0];
		return r.length == 1 && (i instanceof e || i instanceof _o && i.flags & 4) && Math.abs(this.length - i.length) < 10 ? (i instanceof _o ? i = new e(i.length, this.height, this.spaceAbove) : i.height = this.height, this.outdated || (i.outdated = !1), i) : fo.of(r);
	}
	updateHeight(e, t = 0, n = !1, r) {
	...
	updateHeight(t, n = 0, r = !1, i) {
		...
		if (i && i.from <= n + this.length && i.more) {
			...
			for (i.from > n && r.push(new e(i.from - n - 1).updateHeight(t, n)); o <= a && i.more;) {
				...
				n < 0 && (a = -n, n = i.heights[i.index++]), s == -1 ? s = n : Math.abs(n - s) >= uo && (s = -2);
				let c = new go(e, n, a);
				c.outdated = !1, r.push(c), o += e + 1;
			}
			o <= a && r.push(null, new e(a - o).updateHeight(t, o));
			let c = fo.of(r);
			return (s < 0 || Math.abs(c.height - this.height) >= uo || Math.abs(s - this.heightMetrics(t, n).perLine) >= uo) && (ao = !0), po(this, c);
		}
	...
	replace(e, t, n) {
		...
		if (e > 0 && yo(i, a - 1), t < this.length) {
			let e = i.length;
			this.decomposeRight(t, i), yo(i, e);
		}
		return fo.of(i);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size ? fo.of(this.break ? [
			e,
			null,
			t
		] : [e, t]) : (this.left = po(this.left, e), this.right = po(this.right, t), this.setHeight(e.height + t.height), this.outdated = e.outdated || t.outdated, this.size = e.size + t.size, this.length = e.length + this.break + t.length, this);
	}
	updateHeight(e, t = 0, n = !1, r) {
...
function yo(e, t) {
	let n, r;
	e[t] == null && (n = e[t - 1]) instanceof _o && (r = e[t + 1]) instanceof _o && e.splice(t - 1, 3, new _o(n.length + 1 + r.length));
}
var bo = 5, xo = class e {
	constructor(e, t) {
	...
	span(e, t) {
		if (this.lineStart > -1) {
			...
			n instanceof go ? n.length += e - this.pos : (e > this.pos || !this.isCovered) && this.nodes.push(new go(e - this.pos, -1, 0)), this.writtenTo = e, t > e && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
		}
		this.pos = t;
	}
	point(e, t, n) {
		if (e < t || n.heightRelevant) {
			...
			let a = t - e;
			n.block ? this.addBlock(new ho(a, r, n)) : (a || i || r >= bo) && this.addLineDeco(r, i, a);
	...
	enterLine() {
		...
		this.lineStart = e, this.lineEnd = t, this.writtenTo < e && ((this.writtenTo < e - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, e - 1)), this.nodes.push(null)), this.pos > e && this.nodes.push(new go(this.pos - e, -1, 0)), this.writtenTo = this.pos;
	}
	blankContent(e, t) {
		let n = new _o(t - e);
	...
	finish(e) {
		...
		this.lineStart > -1 && !(t instanceof go) && !this.isCovered ? this.nodes.push(new go(0, -1, 0)) : (this.writtenTo < this.pos || t == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
		let n = e;
		for (let e of this.nodes) e instanceof go && e.updateHeight(this.oracle, n), n += e ? e.length : 1;
		return this.nodes;
	}
...
var Co = class {
	...
	comparePoint(e, t, n, r) {
		(e < t || n && n.heightRelevant || r && r.heightRelevant) && jn(e, t, this.changes, 5);
	}
};
function wo(e, t) {
...
var Do = class {
	...
	draw(e, t) {
		return I.replace({ widget: new Oo(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, Oo = class extends Tn {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = Fo, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = L.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(Xr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new so(n), this.stateDeco = Io(t), this.heightMap = fo.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle.setDoc(t.doc), [new oi(0, 0, 0, t.doc.length)]);
	...
	updateScaler() {
		let e = this.scaler;
		return this.scaler = this.heightMap.height <= 7e6 ? Fo : new Lo(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
	}
	updateViewportLines() {
	...
	update(e, t = null) {
		...
		this.stateDeco = Io(this.state);
		let r = e.changedRanges, i = oi.extendWithRanges(r, So(n, this.stateDeco, e ? e.changes : Pe.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		oo(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), i), (this.heightMap.height != a || ao) && (e.flags |= 2), o ? (this.scrollAnchorPos = e.changes.mapPos(o.from, -1), this.scrollAnchorHeight = o.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = a);
		...
		this.viewport = s, e.flags |= this.updateForViewport(), (c || !e.changes.empty || e.flags & 2) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps, e.changes))), e.flags |= this.computeVisibleRanges(e.changes), t && (this.scrollTarget = t), !this.mustEnforceCursorAssoc && (e.selectionSet || e.focusChanged) && e.view.lineWrapping && e.state.selection.main.empty && e.state.selection.main.assoc && !e.state.facet(Rr) && (this.mustEnforceCursorAssoc = !0);
	}
	measure() {
		...
		let f = Kn(this.view.contentDOM, !1).y;
		f != this.scrollParent && (this.scrollParent = f, this.scrollAnchorHeight = -1, this.scrollOffset = 0);
		let p = this.getScrollOffset();
		this.scrollOffset != p && (this.scrollAnchorHeight = -1, this.scrollOffset = p), this.scrolledToBottom = rr(this.scrollParent || e.win);
		let m = (this.printing ? Eo : wo)(t, this.paddingTop), h = m.top - this.pixelViewport.top, g = m.bottom - this.pixelViewport.bottom;
		...
		if (_ != this.inView && (this.inView = _, _ && (s = !0)), !this.inView && !this.scrollTarget && !To(e.dom)) return 0;
		let ee = o.width;
		if ((this.contentDOMWidth != ee || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			h > 0 && g > 0 ? l = Math.max(h, g) : h < 0 && g < 0 && (l = Math.min(h, g)), oo();
			for (let n of this.viewports) {
				let i = n.from == this.viewport.from ? t : e.docView.measureVisibleLineHeights(n);
				this.heightMap = (a ? fo.empty().applyChanges(this.stateDeco, x.empty, this.heightOracle, [new oi(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new co(n.from, i));
			}
			ao && (c |= 2);
		}
		let v = !this.viewportIsAppropriate(this.viewport, l) || this.scrollTarget && (this.scrollTarget.range.head < this.viewport.from || this.scrollTarget.range.head > this.viewport.to);
		return v && (c & 2 && (c |= this.updateScaler()), this.viewport = this.getViewport(l, this.scrollTarget), c |= this.updateForViewport()), (c & 2 || v) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(a ? [] : this.lineGaps, e)), c |= this.computeVisibleRanges(), this.mustEnforceCursorAssoc && (this.mustEnforceCursorAssoc = !1, e.docView.enforceCursorAssoc()), c;
	}
	get visibleTop() {
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new Ao(r.lineAt(a - n * 1e3, V.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, V.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, V.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new Ao(r.lineAt(o - 500, V.ByHeight, i, 0, 0).from, r.lineAt(o + n + 500, V.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new Ao(this.heightMap.lineAt(n, V.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, V.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	mapLineGaps(e, t) {
		...
		let n = [];
		for (let r of e) t.touchesRange(r.from, r.to) || n.push(new Do(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
		return n;
	}
	ensureLineGaps(e, t) {
		...
		let o = [], s = (r, a, c, l) => {
			...
			let f = Po(e, (e) => e.from >= c.from && e.to <= c.to && Math.abs(e.from - r) < i && Math.abs(e.to - a) < i && !d.some((t) => e.from < t && e.to > t));
			if (!f) {
				...
				f = new Do(r, a, e, n || e < 2e6 ? e : 2e6);
			}
			o.push(f);
		}, c = (t) => {
			if (t.length < a || t.type != F.Text) return;
			let i = jo(t.from, t.to, this.stateDeco);
			if (i.total < a) return;
	...
	updateLineGaps(e) {
		Do.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = I.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || Ro(this.heightMap.lineAt(e, V.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || Ro(this.heightMap.lineAt(this.scaler.fromDOM(e), V.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
...
function Mo({ total: e, ranges: t }, n) {
...
function Io(e) {
	let t = e.facet(Zr).filter((e) => typeof e != "function"), n = e.facet($r).filter((e) => typeof e != "function");
...
function Ro(e, t) {
	...
	return new lo(e.from, e.length, n, r - n, Array.isArray(e._content) ? e._content.map((e) => Ro(e, t)) : e._content);
}
var zo = /*@__PURE__*/ D.define({ combine: (e) => e.join(" ") }), Bo = /*@__PURE__*/ D.define({ combine: (e) => e.indexOf(!0) > -1 }), Vo = /*@__PURE__*/ $t.newName(), Ho = /*@__PURE__*/ $t.newName(), Uo = /*@__PURE__*/ $t.newName(), Wo = {
	"&light": "." + Ho,
	"&dark": "." + Uo
};
function Go(e, t, n) {
	return new $t(t, { finish(t) {
...
var Ko = /*@__PURE__*/ Go("." + Vo, {
...
}, Jo = P.ie && P.ie_version <= 11, Yo = class {
	constructor(e) {
		this.view = e, this.active = !1, this.editContext = null, this.selectionRange = new qn(), this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = e.contentDOM, this.observer = new MutationObserver((t) => {
		...
		}), window.EditContext && P.android && e.constructor.EDIT_CONTEXT !== !1 && !(P.chrome && P.chrome_version < 126) && (this.editContext = new $o(e), e.state.facet(Wr) && (e.contentDOM.editContext = this.editContext.editContext)), Jo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(Wr) ? n.root.activeElement != this.dom : !Fn(this.dom, r)) return;
		let i = r.anchorNode && n.docView.tile.nearest(r.anchorNode);
		if (i && i.isWidget() && i.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		(P.ie && P.ie_version <= 11 || P.android && P.chrome) && !n.state.selection.main.empty && r.focusNode && Ln(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset) ? this.flushSoon() : this.flush(!1);
	}
	readSelectionRange() {
		let { view: e } = this, t = Nn(e.root);
		if (!t) return !1;
		let n = P.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && Qo(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = Fn(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && nr(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	start() {
		this.active ||= (this.observer.observe(this.dom, qo), Jo && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), !0);
	}
	stop() {
	...
	delayAndroidKey(e, t) {
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && er(this.dom, e.key, e.keyCode));
			};
	...
	readChange() {
		let { from: e, to: t, typeOver: n } = this.processRecords(), r = this.selectionChanged && Fn(this.dom, this.selectionRange);
		if (e < 0 && !r) return null;
		e > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = !1;
		let i = new fa(this.view, e, t, n);
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = ma(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !ba(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
		let t = this.view.docView.tile.nearest(e.target);
		if (!t || t.isWidget()) return null;
		if (t.markDirty(e.type == "attributes"), e.type == "childList") {
			let n = Xo(t, e.previousSibling || e.target.previousSibling, -1), r = Xo(t, e.nextSibling || e.target.nextSibling, 1);
			return {
...
function Zo(e, t) {
	...
	return Ln(o.node, o.offset, i, a) && ([n, r, i, a] = [
		i,
		a,
		n,
		r
...
function Qo(e, t) {
	...
	return e.contentDOM.addEventListener("beforeinput", r, !0), e.dom.ownerDocument.execCommand("indent"), e.contentDOM.removeEventListener("beforeinput", r, !0), n ? Zo(e, n) : null;
}
var $o = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = _a(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			e.dispatch({ effects: Hr.of(I.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || tr(e.parent) || document, this.viewState = new ko(this, e.state || A.create(e)), e.scrollTo && e.scrollTo.is(Vr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(Kr).map((e) => new Jr(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new Yo(this), this.inputState = new xa(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Fi(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		t.some((e) => e.annotation($a)) ? (this.inputState.notifiedFocused = o, s = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, c = eo(a, o), c || (s = 1));
		...
		i = si.create(this, a, t), i.flags |= s;
		...
		try {
			...
			for (let n of t) {
				if (d &&= d.map(n.changes), n.scrollIntoView) {
					...
					d = new Br(t.empty ? t : E.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(Vr) && (d = e.value.clip(this.state));
			}
			this.viewState.update(i, d), this.bidiCache = ns.update(this.bidiCache, i.changes), i.empty || (this.updatePlugins(i), this.inputState.update(i)), n = this.docView.update(i), this.state.facet(ai) != this.styleModules && this.mountStyles(), r = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(n, t.some((e) => e.isUserEvent("select.pointer")));
		} finally {
			this.updateState = 0;
		}
		if (i.startState.facet(zo) != i.state.facet(zo) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(Mr)) try {
			e(i);
		} catch (e) {
			Ur(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !ma(this, u) && l.force && er(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new ko(this, e), this.plugins = e.facet(Kr).map((e) => new Jr(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
			this.docView.destroy(), this.docView = new Fi(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
		} finally {
			this.updateState = 0;
		}
	...
	updatePlugins(e) {
		let t = e.startState.facet(Kr), n = e.state.facet(Kr);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
				if (n < 0) r.push(new Jr(i));
				else {
	...
	docViewUpdate() {
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate) try {
				...
				Ur(this.state, e, "doc view update listener");
			}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) {
					if (rr(n || this.win)) i = -1, a = this.viewState.heightMap.height;
					else {
				...
				let c = s.map((e) => {
					try {
						...
						return Ur(this.state, e), ts;
					}
				}), l = si.create(this, this.state, []), u = !1;
				...
				for (let e = 0; e < s.length; e++) if (c[e] != ts) try {
					let t = s[e];
		...
		if (t && !t.empty) for (let e of this.state.facet(Mr)) e(t);
	}
	get themeClasses() {
		return Vo + " " + (this.state.facet(Bo) ? Uo : Ho) + " " + this.state.facet(zo);
	}
	updateAttrs() {
		let e = rs(this, Yr, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
		...
		this.state.readOnly && (t["aria-readonly"] = "true"), rs(this, Xr, t);
		let n = this.observer.ignore(() => {
			let n = Cn(this.contentDOM, this.contentAttrs, t), r = Cn(this.dom, this.editorAttrs, e);
			return n || r;
		});
	...
	mountStyles() {
		...
		$t.mount(this.root, this.styleModules.concat(Ko).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return ra(this, e, Qi(this, e, t, n));
	}
	moveByGroup(e, t) {
		return ra(this, e, Qi(this, e, t, (t) => $i(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return ra(this, e, ea(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	posAndSideAtCoords(e, t = !0) {
		return this.readMeasured(), aa(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), i = r[gr.find(r, e - n.from, -1, t)];
	...
	textDirectionAt(e) {
		return !this.state.facet(Lr) || e < this.viewport.from || e > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(e));
	}
	get lineWrapping() {
		return this.viewState.heightOracle.lineWrapping;
	}
	bidiSpans(e) {
		if (e.length > es) return wr(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || _r(r.isolates, n = ni(this, e)))) return r.order;
		n ||= ni(this, e);
		let r = Cr(e.text, t, n);
		return this.bidiCache.push(new ns(e.from, e.to, t, n, !0, r)), r;
	}
	get hasFocus() {
	...
	focus() {
		this.observer.ignore(() => {
			Zn(this.contentDOM), this.docView.updateSelection();
		});
	}
	setRoot(e) {
	...
	static scrollIntoView(e, t = {}) {
		return Vr.of(new Br(typeof e == "number" ? E.cursor(e) : e, t.y ?? "nearest", t.x ?? "nearest", t.yMargin ?? 5, t.xMargin ?? 5));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return Vr.of(new Br(E.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
		e == null ? this.inputState.tabFocusMode = this.inputState.tabFocusMode < 0 ? 0 : -1 : typeof e == "boolean" ? this.inputState.tabFocusMode = e ? 0 : -1 : this.inputState.tabFocusMode != 0 && (this.inputState.tabFocusMode = Date.now() + e);
	}
	static domEventHandlers(e) {
		return qr.define(() => ({}), { eventHandlers: e });
	}
	static domEventObservers(e) {
		return qr.define(() => ({}), { eventObservers: e });
	}
	static theme(e, t) {
		let n = $t.newName(), r = [zo.of(n), ai.of(Go(`.${n}`, e))];
		return t && t.dark && r.push(Bo.of(!0)), r;
	}
	static baseTheme(e) {
		return Qe.lowest(ai.of(Go("." + Vo, e, Wo)));
	}
...
H.styleModule = ai, H.inputHandler = Nr, H.clipboardInputFilter = Fr, H.clipboardOutputFilter = Ir, H.scrollHandler = zr, H.focusChangeEffect = Pr, H.perLineTextDirection = Lr, H.exceptionSink = jr, H.updateListener = Mr, H.editable = Wr, H.mouseSelectionStyle = Ar, H.dragMovesSelection = kr, H.clickAddsSelectionRange = Or, H.decorations = Zr, H.blockWrappers = Qr, H.outerDecorations = $r, H.atomicRanges = ei, H.bidiIsolatedRanges = ti, H.cursorScrollMargin = /*@__PURE__*/ D.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), H.scrollMargins = ri, H.darkTheme = Bo, H.cspNonce = /*@__PURE__*/ D.define({ combine: (e) => e.length ? e[0] : "" }), H.contentAttributes = Xr, H.editorAttributes = Yr, H.lineWrapping = /*@__PURE__*/ H.contentAttributes.of({ class: "cm-lineWrapping" }), H.announce = /*@__PURE__*/ O.define();
var es = 4096, ts = {}, ns = class e {
	constructor(e, t, n, r, i, a) {
...
var is = P.mac ? "mac" : P.windows ? "win" : P.linux ? "linux" : "key";
function as(e, t) {
...
var ss = /*@__PURE__*/ Qe.default(/*@__PURE__*/ H.domEventHandlers({ keydown(e, t) {
	return hs(us(t.state), e, t, "editor");
} })), cs = /*@__PURE__*/ D.define({ enables: ss }), ls = /*@__PURE__*/ new WeakMap();
function us(e) {
	let t = e.facet(cs), n = ls.get(t);
	return n || ls.set(t, n = ps(t.reduce((e, t) => e.concat(t), []))), n;
}
var ds = null, fs = 4e3;
function ps(e, t = is) {
	let n = Object.create(null), r = Object.create(null), i = (e, t) => {
		...
		let c = n[e] || (n[e] = Object.create(null)), l = r.split(/ (?!$)/).map((e) => as(e, t));
	...
	for (let r of e) {
		...
		if (r.any) for (let t of e) {
			...
			let { any: i } = r;
			for (let t in e) e[t].run.push((e) => i(e, ms));
		}
		let i = r[t] || r.key;
...
function hs(e, t, n, r) {
	ms = t;
	let i = cn(t), a = je(Ae(i, 0)) == i.length && i != " ", o = "", s = !1, c = !1, l = !1;
	ds && ds.view == n && ds.scope == r && (o = ds.prefix + " ", Da.indexOf(t.keyCode) < 0 && (c = !0, ds = null));
	...
	return f && (d(f[o + os(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(P.windows && t.ctrlKey && t.altKey) && !(P.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = nn[t.keyCode]) && p != i ? (d(f[o + os(p, t, !0)]) || t.shiftKey && (m = rn[t.keyCode]) != i && m != p && d(f[o + os(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + os(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), ms = null, s;
}
var gs = class e {
	constructor(e, t, n, r, i) {
...
function ys(e, t, n) {
	...
	let r = Math.max(n.from, e.viewport.from), i = Math.min(n.to, e.viewport.to), a = e.textDirection == L.LTR, o = e.contentDOM, s = o.getBoundingClientRect(), c = _s(e), l = o.querySelector(".cm-line"), u = l && window.getComputedStyle(l), d = s.left + (u ? parseInt(u.paddingLeft) + Math.min(0, parseInt(u.textIndent)) : 0), f = s.right - (u ? parseInt(u.paddingRight) : 0), p = Xi(e, r, 1), m = Xi(e, i, -1), h = p.type == F.Text ? p : null, g = m.type == F.Text ? m : null;
	if (h && (e.lineWrapping || p.widgetLineBreaks) && (h = vs(e, r, 1, h)), g && (e.lineWrapping || m.widgetLineBreaks) && (g = vs(e, i, -1, g)), h && g && h.from == g.from && h.to == g.to) return ee(v(n.from, n.to, h));
	{
		let t = h ? v(n.from, null, h) : te(p, !1), r = g ? v(null, n.to, g) : te(m, !0), i = [];
	...
	function _(e, n, r, i) {
		return new gs(t, e - c.left, n - c.top, Math.max(0, r - e), i - n);
	}
...
var xs = class {
	...
	draw(e) {
		if (e.length != this.drawn.length || e.some((e, t) => !bs(e, this.drawn[t]))) {
...
}, Ss = /*@__PURE__*/ D.define();
function Cs(e) {
	return [qr.define((t) => new xs(t, e)), Ss.of(e)];
}
var ws = /*@__PURE__*/ D.define({ combine(e) {
	return kt(e, {
...
function Es(e) {
	return e.startState.facet(ws) != e.state.facet(ws);
}
var Ds = /*@__PURE__*/ Cs({
	above: !0,
	markers(e) {
		let { state: t } = e, n = t.facet(ws), r = [];
		for (let i of t.selection.ranges) {
			...
			if (i.empty || n.drawRangeCursor && !(a && P.ios && n.iosSelectionHandles)) {
				...
				for (let i of gs.forRange(e, t, n)) r.push(i);
			}
		}
		return r;
	},
	update(e, t) {
		...
		let n = Es(e);
		return n && Os(e.state, t), e.docChanged || e.selectionSet || n;
	},
	mount(e, t) {
		Os(t.state, e);
	},
...
function Os(e, t) {
	t.style.animationDuration = e.facet(ws).cursorBlinkRate + "ms";
}
var ks = /*@__PURE__*/ Cs({
	above: !1,
	markers(e) {
		let t = [], { main: n, ranges: r } = e.state.selection;
		for (let n of r) if (!n.empty) for (let r of gs.forRange(e, "cm-selectionBackground", n)) t.push(r);
		if (P.ios && !n.empty && e.state.facet(ws).iosSelectionHandles) {
			for (let r of gs.forRange(e, "cm-selectionHandle cm-selectionHandle-start", E.cursor(n.from, 1))) t.push(r);
			for (let r of gs.forRange(e, "cm-selectionHandle cm-selectionHandle-end", E.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || Es(e);
	},
	class: "cm-selectionLayer"
}), As = P.gecko && P.gecko_version == 153 ? "#ffffff01" : "transparent", js = /*@__PURE__*/ Qe.highest(/*@__PURE__*/ H.theme({
	".cm-line": {
		"& ::selection, &::selection": { backgroundColor: `${As} !important` },
...
var Bs = /*@__PURE__*/ D.define({ combine(e) {
	let t = kt(e, {
		render: null,
		specialChars: Is,
...
var Hs = null;
function Us() {
	return Hs ||= qr.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = I.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(Bs)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new Ps({
				...
				decoration: (t, n, r) => {
					...
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = qt(e.text, t, r - e.from);
						return I.replace({ widget: new qs((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = I.replace({ widget: new Ks(e, a) }));
				},
...
var Ys = /*@__PURE__*/ I.line({ class: "cm-activeLine" }), Xs = /*@__PURE__*/ qr.fromClass(class {
	constructor(e) {
...
}, { decorations: (e) => e.decorations }), Zs = class extends At {
	compare(e) {
		return this == e || this.constructor == e.constructor && this.eq(e);
	}
	eq(e) {
...
Zs.prototype.elementClass = "", Zs.prototype.toDOM = void 0, Zs.prototype.mapMode = w.TrackBefore, Zs.prototype.startSide = Zs.prototype.endSide = -1, Zs.prototype.point = !0;
var Qs = /*@__PURE__*/ D.define(), $s = /*@__PURE__*/ D.define(), ec = /*@__PURE__*/ D.define(), tc = /*@__PURE__*/ D.define({ combine: (e) => e.some((e) => e) });
function nc(e) {
	let t = [rc];
	return e && e.fixed === !1 && t.push(tc.of(!0)), t;
}
var rc = /*@__PURE__*/ qr.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(ec).map((t) => new sc(e, t)), this.fixed = !e.state.facet(tc);
	...
	update(e) {
		...
		this.view.state.facet(tc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = j.iter(this.view.state.facet(Qs), this.view.viewport.from), r = [], i = this.gutters.map((e) => new oc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(ec), n = e.state.facet(ec), r = e.docChanged || e.heightChanged || e.viewportChanged || !j.eq(e.startState.facet(Qs), e.state.facet(Qs), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new sc(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var oc = class {
	...
	line(e, t, n) {
		let r = [];
		ac(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = ic(t.markers(e)), t.initialSpacer && (this.spacer = new cc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), lc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var uc = /*@__PURE__*/ D.define(), dc = /*@__PURE__*/ D.define(), fc = /*@__PURE__*/ D.define({ combine(e) {
	return kt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
function mc(e, t) {
	return e.state.facet(fc).formatNumber(t, e.state);
}
var hc = /*@__PURE__*/ ec.compute([fc], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(uc);
	},
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new pc(mc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(dc)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	},
	lineMarkerChange: (e) => e.startState.facet(fc) != e.state.facet(fc),
	initialSpacer(e) {
		return new pc(mc(e, _c(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = mc(t.view, _c(t.view.state.doc.lines));
		return n == e.number ? e : new pc(n);
	},
	domEventHandlers: e.facet(fc).domEventHandlers,
	side: "before"
}));
function gc(e = {}) {
	return [
...
var vc = /*@__PURE__*/ new class extends Zs {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), yc = /*@__PURE__*/ Qs.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(vc.range(i)));
	}
	return j.of(t);
});
function bc() {
...
}, Tc = Object.create(null), W = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Tc, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
}, Dc = /* @__PURE__ */ new WeakMap(), Oc = /* @__PURE__ */ new WeakMap(), G;
(function(e) {
...
var K = class e {
	...
	cursorAt(e, t = 0, n = 0) {
		let r = new Hc(Dc.get(this) || this.topNode);
		return r.moveTo(e, t), Dc.set(this, r._tree), r;
	}
	get topNode() {
		return new Pc(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = Mc(Dc.get(this) || this.topNode, e, t, !1);
		return Dc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = Mc(Oc.get(this) || this.topNode, e, t, !0);
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : qc(W.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(W.none, t, n, r)));
	}
	static build(e) {
		return Wc(e);
	}
...
var kc = class e {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(jc(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function Mc(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof Pc && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : G.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof Pc && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var Nc = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & G.EnterBracketed && l instanceof K && (d = wc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !jc(i, r, u, u + l.length))) {
					if (l instanceof Ac) {
						if (a & G.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new Rc(new Lc(o, l, t, u), null, e);
					} else if (a & G.IncludeAnonymous || !l.type.isAnonymous || Uc(l)) {
						let s;
						if (!(a & G.IgnoreMounts) && (s = wc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & G.IgnoreOverlays) && (i = wc.get(this._tree)) && i.overlay) {
...
function zc(e) {
	...
	let r = n instanceof Pc && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new Bc(i, n);
}
var Bc = class {
	constructor(e, t) {
...
function Vc(e, t, n) {
	...
	for (let e = r instanceof Pc ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = wc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new Pc(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(Mc(o, t, n, !1));
		}
	}
	return i ? zc(i) : r;
...
var Hc = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~G.EnterBracketed, e instanceof Pc) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof Pc ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & G.IncludeAnonymous || e instanceof Ac || !e.type.isAnonymous || Uc(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	matchContext(e) {
		if (!this.buffer) return Ic(this.node.parent, e);
		let { buffer: t } = this.buffer, { types: n } = t.set;
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return Ic(this._tree, e, r);
...
function Uc(e) {
	return e.children.some((e) => e instanceof Ac || !e.type.isAnonymous || Uc(e));
}
function Wc(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = xc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new kc(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, ee, v, te) {
		let { id: ne, start: y, end: re, size: ie } = o, ae = l, oe = c;
		if (ie < 0) {
			if (o.next(), ie == -1) {
				let t = i[ne];
				_.push(t), ee.push(y - e);
				return;
			}
			if (ie == -3) {
				c = ne;
		...
		let se = s[ne], ce, le, ue = y - e;
		if (re - y <= r && (le = h(o.pos - t, v))) {
			let t = new Uint16Array(le.size - le.skip), r = o.pos - le.size, i = t.length;
			for (; o.pos > r;) i = g(le.start, t, i);
			ce = new Ac(t, re - le.start, n), ue = le.start - e;
		} else {
			let e = o.pos - ie;
			o.next();
			let t = [], n = [], i = ne >= a ? ne : -1, s = 0, c = re;
			for (; o.pos > e;) i >= 0 && o.id == i && o.size >= 0 ? (o.end <= c - r && (p(t, n, y, s, o.end, c, i, ae, oe), s = t.length, c = o.end), o.next()) : te > 2500 ? d(y, e, t, n) : u(y, e, t, n, i, te + 1);
			if (i >= 0 && s > 0 && s < t.length && p(t, n, y, s, y, c, i, ae, oe), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(se, oe);
				ce = qc(se, t, n, 0, t.length, 0, re - y, e, e);
			} else ce = m(se, t, n, re - y, ae - re, oe);
		}
		_.push(ce), ee.push(ue);
	}
	function d(e, t, i, a) {
		let s = [], c = 0, l = -1;
		for (; o.pos > t;) {
		...
		if (c) {
			...
			i.push(new Ac(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
	...
	let v = e.length ?? (_.length ? ee[0] + _[0].length : 0);
	return new K(s[e.topID], _.reverse(), ee.reverse(), v);
}
var Gc = /* @__PURE__ */ new WeakMap();
function Kc(e, t) {
	if (!e.isAnonymous || t instanceof Ac || t.type != e) return 1;
	let n = Gc.get(t);
	if (n == null) {
		n = 1;
...
function qc(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += Kc(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = Kc(e, t[s]);
			for (s++; s < i; s++) {
				let n = Kc(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(qc(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var Jc = class {
	...
	set(e, t) {
		e instanceof Rc ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof Pc && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof Rc ? this.getBuffer(e.context.buffer, e.index) : e instanceof Pc ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new Zc(e)), n = n ? n.length ? n.map((e) => new Cc(e.from, e.to)) : [new Cc(0, 0)] : [new Cc(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function Qc(e) {
	return (t, n, r, i) => new rl(t, e, n, r, i);
}
var $c = class {
	constructor(e, t, n, r, i, a) {
...
var tl = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new K(e.type, e.children, e.positions, e.length, e.propValues.concat([[nl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[U.mounted.id] = new wc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new cl(this.fragments), t = null, n = null, r = new Hc(new Pc(this.baseTree, this.ranges[0].from, 0, null), G.IncludeAnonymous | G.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = il(n.ranges, r.from, r.to))) o = a != 2;
			else if (!r.type.isAnonymous && (i = this.nest(r, this.input)) && (r.from < r.to || !i.overlay)) {
				r.tree || (ol(r), t && t.depth++, n && n.depth++);
				let a = e.findMounts(r.from, i.parser);
				if (typeof i.overlay == "function") t = new tl(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = ll(this.ranges, i.overlay || (r.from < r.to ? [new Cc(r.from, r.to)] : []));
					e.length && el(e), (e.length || !i.overlay) && this.inner.push(new $c(i.parser, e.length ? i.parser.startParse(this.input, dl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new Cc(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
				}
			} else if (t && (s = t.predicate(r)) && (s === !0 && (s = new Cc(r.from, r.to)), s.from < s.to)) {
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = ll(this.ranges, t.ranges);
					e.length && (el(e), this.inner.splice(t.index, 0, new $c(t.parser, t.parser.startParse(this.input, dl(t.mounts, e), e), t.ranges.map((e) => new Cc(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
var sl = class {
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(nl) ?? t.to, this.inner = new sl(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(nl) ?? e.to, this.inner = new sl(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function ll(e, t) {
	...
	for (let i = 1, a = 0; i < e.length; i++) {
		...
		for (; a < r.length; a++) {
			let e = r[a];
			if (e.from >= s) break;
			e.to <= o || (n || (r = n = t.slice()), e.from < o ? (n[a] = new Cc(e.from, o), e.to > s && n.splice(a + 1, 0, new Cc(s, e.to))) : e.to > s ? n[a--] = new Cc(s, e.to) : n.splice(a--, 1));
		}
	}
	return r;
}
...
function dl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = ul(t, i.overlay.map((e) => new Cc(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new Yc(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new Yc(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var fl = 0, pl = class e {
	...
	static defineModifier(e) {
		let t = new hl(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : hl.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, ml = 0, hl = class e {
	constructor(e) {
		this.name = e, this.instances = [], this.id = ml++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && gl(n, e.modified));
		if (r) return r;
		let i = [], a = new pl(t.name, i, t, n);
...
function vl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new bl(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return yl.add(t);
}
var yl = new U({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new bl(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), bl = class {
...
function Cl(e, t, n, r = 0, i = e.length) {
	let a = new wl(r, Array.isArray(t) ? t : [t], n);
...
var wl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Tl(e) || bl.empty, u = Sl(i, l.tags);
...
var q = pl.define, El = q(), Dl = q(), Ol = q(Dl), kl = q(Dl), Al = q(), jl = q(Al), Ml = q(Al), Nl = q(), Pl = q(Nl), Fl = q(), Il = q(), Ll = q(), Rl = q(Ll), zl = q(), J = {
	comment: El,
	lineComment: q(El),
	blockComment: q(El),
	docComment: q(El),
	...
	unit: q(Fl),
	modifier: q(Fl),
	operatorKeyword: q(Fl),
	controlKeyword: q(Fl),
	definitionKeyword: q(Fl),
	moduleKeyword: q(Fl),
	operator: Il,
	derefOperator: q(Il),
	arithmeticOperator: q(Il),
	logicOperator: q(Il),
	bitwiseOperator: q(Il),
	compareOperator: q(Il),
	updateOperator: q(Il),
	definitionOperator: q(Il),
	typeOperator: q(Il),
	controlOperator: q(Il),
	punctuation: Ll,
	separator: q(Ll),
	bracket: Rl,
	angleBracket: q(Rl),
	...
	documentMeta: q(zl),
	annotation: q(zl),
	processingInstruction: q(zl),
	definition: pl.defineModifier("definition"),
	constant: pl.defineModifier("constant"),
	function: pl.defineModifier("function"),
	standard: pl.defineModifier("standard"),
	local: pl.defineModifier("local"),
	special: pl.defineModifier("special")
};
for (let e in J) {
	let t = J[e];
	t instanceof pl && (t.name = e);
}
xl([
	{
		tag: J.link,
...
var Hl = /*@__PURE__*/ new U(), Ul = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, A.prototype.hasOwnProperty("tree") || Object.defineProperty(A.prototype, "tree", { get() {
			return Y(this);
		} }), this.parser = t, this.extension = [eu.of(this), A.languageData.of((e, t, n) => {
			let r = Wl(e, t, n), i = r.type.prop(Bl);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(Hl);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return Wl(e, t, n).type.prop(Bl) == this.data;
	}
	findRegions(e) {
		let t = e.facet(eu);
...
Ul.setState = /*@__PURE__*/ O.define();
function Wl(e, t, n) {
	let r = e.facet(eu), i = Y(e).topNode;
...
var Gl = class e extends Ul {
	...
	static define(t) {
		let n = Vl(t.languageData);
		return new e(n, t.parser.configure({ props: [Bl.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var Kl = class {
	...
	startParse() {
		return this.parser.startParse(new Kl(this.state.doc), this.fragments);
	}
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != K.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) {
					if (this.fragments = this.withoutTempSkipped(Yc.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
					else return !0;
				}
				if (e()) return !1;
			}
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = Yl(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = Yl(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
...
var Xl = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = Jl.create(t.facet(eu).parser, t, {
			from: 0,
			to: n
		});
...
Ul.state = /*@__PURE__*/ Ye.define({
	create: Xl.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(Ul.setState)) return e.value;
		return t.startState.facet(eu) == t.state.facet(eu) ? e.apply(t) : Xl.init(t.state);
	}
});
var Zl = (e) => {
...
typeof requestIdleCallback < "u" && (Zl = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var Ql = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, $l = /*@__PURE__*/ qr.fromClass(class {
	constructor(e) {
		this.view = e, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
	}
	update(e) {
		let t = this.view.state.field(Ul.state).context;
		(t.updateViewport(e.view.viewport) || this.view.viewport.to > t.treeLen) && this.scheduleWork(), (e.docChanged || e.selectionSet) && (this.view.hasFocus && (this.chunkBudget += 50), this.scheduleWork()), this.checkAsyncSchedule(t);
	}
	scheduleWork() {
		if (this.working) return;
		let { state: e } = this.view, t = e.field(Ul.state);
		(t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = Zl(this.work));
	}
	work(e) {
		this.working = null;
		let t = Date.now();
		if (this.chunkEnd < t && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = t + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0) return;
		let { state: n, viewport: { to: r } } = this.view, i = n.field(Ul.state);
		if (i.tree == i.context.tree && i.context.isDone(r + 1e5)) return;
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !Ql ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => Ql && Ql() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Ul.setState.of(new Xl(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
	checkAsyncSchedule(e) {
		e.scheduleOn &&= (this.workScheduled++, e.scheduleOn.then(() => this.scheduleWork()).catch((e) => Ur(this.view.state, e)).then(() => this.workScheduled--), null);
	}
	destroy() {
...
}, ru = /*@__PURE__*/ D.define(), iu = /*@__PURE__*/ D.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function su(e, t) {
	e instanceof A && (e = new cu(e));
	for (let n of e.state.facet(ru)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = Y(e.state);
	return n.length >= t ? uu(e, n, t) : null;
}
var cu = class {
	constructor(e, t = {}) {
		this.state = e, this.options = t, this.unit = au(e);
	}
	lineAt(e, t = 1) {
	...
	countColumn(e, t = e.length) {
		return qt(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
...
function pu(e) {
	...
	if (n && (r = n.type.prop(U.closedBy))) {
		...
		return (e) => yu(e, !0, 1, void 0, n && !fu(e) ? t.from : void 0);
	}
	return e.parent == null ? mu : null;
}
function mu() {
	return 0;
}
var hu = class e extends cu {
	constructor(e, t, n) {
...
function yu(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? _u(e) : null;
	return c ? s ? e.column(c.from) : e.column(c.to) : e.baseIndent + (s ? 0 : e.unit * n);
}
var bu = (e) => e.baseIndent;
function xu({ except: e, units: t = 1 } = {}) {
	return (n) => {
		let r = e && e.test(n.textAfter);
		return n.baseIndent + (r ? 0 : t * n.unit);
	};
}
var Su = /*@__PURE__*/ D.define(), Cu = /*@__PURE__*/ new U();
function wu(e) {
...
var Tu = class e {
	constructor(e, t) {
		...
		this.scope = a instanceof Ul ? (e) => e.prop(Bl) == a.data : a ? (e) => e == a : void 0, this.style = xl(e.map((e) => ({
			tag: e.tag,
			class: e.class || r(Object.assign({}, e, { tag: null }))
		})), { all: i }).style, this.module = n ? new $t(n) : null, this.themeType = t.themeType;
	}
	static define(t, n) {
		return new e(t, n || {});
	}
}, Eu = /*@__PURE__*/ D.define(), Du = /*@__PURE__*/ D.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function Ou(e) {
	let t = e.facet(Eu);
	return t.length ? t : e.facet(Du);
}
function ku(e, t) {
	let n = [ju], r;
	return e instanceof Tu && (e.module && n.push(H.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(Du.of(e)) : r ? n.push(Eu.computeN([H.darkTheme], (t) => t.facet(H.darkTheme) == (r == "dark") ? [e] : [])) : n.push(Eu.of(e)), n;
}
var Au = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = Y(e.state), this.decorations = this.buildDeco(e, Ou(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = Y(e.state), n = Ou(e.state), r = n != Ou(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new It();
		for (let { from: r, to: i } of e.visibleRanges) Cl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = I.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, ju = /*@__PURE__*/ Qe.high(/*@__PURE__*/ qr.fromClass(Au, { decorations: (e) => e.decorations })), Mu = /*@__PURE__*/ Tu.define([
	{
		tag: J.meta,
		color: "#404740"
	},
...
function Ru(e, t, n, r = {}) {
	let i = r.maxScanDistance || Nu, a = r.brackets || Pu, o = Y(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Iu(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Lu(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return zu(e, t, n, r, o, i, a);
		}
	}
	return Bu(e, t, n, o, s.type, i, a);
}
...
var Vu = /*@__PURE__*/ Object.create(null), Hu = [W.none], Uu = [], Wu = /*@__PURE__*/ Object.create(null), Gu = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
function qu(e, t) {
	...
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || J[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : Ku(n, `Modifier ${n} used at start of tag`) : t.length ? Ku(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : Ku(n, `Unknown highlighting tag ${n}`);
		}
...
var Xu = /*@__PURE__*/ Yu(id, 0), Zu = /*@__PURE__*/ Yu(rd, 0), Qu = /*@__PURE__*/ Yu((e, t) => rd(e, t, nd(t)), 0);
function $u(e, t) {
	let n = e.languageDataAt("commentTokens", t, 1);
	return n.length ? n[0] : {};
}
var ed = 50;
function td(e, { open: t, close: n }, r, i) {
	let a = e.sliceDoc(r - ed, r), o = e.sliceDoc(i, i + ed), s = /\s*$/.exec(a)[0].length, c = /^\s*/.exec(o)[0].length, l = a.length - s;
	...
	let u, d;
	i - r <= 100 ? u = d = e.sliceDoc(r, i) : (u = e.sliceDoc(r, r + ed), d = e.sliceDoc(i - ed, i));
...
function rd(e, t, n = t.selection.ranges) {
	let r = n.map((e) => $u(t, e.from).block);
	if (!r.every((e) => e)) return null;
	let i = n.map((e, n) => td(t, r[n], e.from, e.to));
...
function id(e, t, n = t.selection.ranges) {
	...
	ranges: for (let { from: e, to: a } of n) {
		...
		for (let n = e; n <= a;) {
			...
			if (s == null && (s = $u(t, c.from).line, !s)) continue ranges;
...
var ad = /*@__PURE__*/ pt.define(), od = /*@__PURE__*/ pt.define(), sd = /*@__PURE__*/ D.define(), cd = /*@__PURE__*/ D.define({ combine(e) {
	return kt(e, {
		minDepth: 100,
		newGroupDelay: 500,
		joinToEvent: (e, t) => t
...
} }), ld = /*@__PURE__*/ Ye.define({
	create() {
		return Od.empty;
	},
	update(e, t) {
		let n = t.state.facet(cd), r = t.annotation(ad);
		if (r) {
			let i = gd.fromTransaction(t, r.selection), a = r.side, o = a == 0 ? e.undone : e.done;
			return o = i ? _d(o, o.length, n.minDepth, i) : Cd(o, t.startState.selection), new Od(a == 0 ? r.rest : o, a == 0 ? o : r.rest);
		}
		let i = t.annotation(od);
		if ((i == "full" || i == "before") && (e = e.isolate()), t.annotation(k.addToHistory) === !1) return t.changes.empty ? e : e.addMapping(t.changes.desc);
		let a = gd.fromTransaction(t), o = t.annotation(k.time), s = t.annotation(k.userEvent);
	...
	fromJSON(e) {
		return new Od(e.done.map(gd.fromJSON), e.undone.map(gd.fromJSON));
	}
});
function ud(e = {}) {
	return [
		...
		H.domEventHandlers({ beforeinput(e, t) {
			let n = e.inputType == "historyUndo" ? fd : e.inputType == "historyRedo" ? pd : null;
...
var fd = /*@__PURE__*/ dd(0, !1), pd = /*@__PURE__*/ dd(1, !1), md = /*@__PURE__*/ dd(0, !0), hd = /*@__PURE__*/ dd(1, !0), gd = class e {
	constructor(e, t, n, r, i) {
	...
	static fromJSON(t) {
		return new e(t.changes && Pe.fromJSON(t.changes), [], t.mapped && Ne.fromJSON(t.mapped), t.startSelection && E.fromJSON(t.startSelection), t.selectionsAfter.map(E.fromJSON));
	}
	static fromTransaction(t, n) {
		let r = xd;
		for (let e of t.startState.facet(sd)) {
			let n = e(t);
			n.length && (r = r.concat(n));
		}
		return !r.length && t.changes.empty ? null : new e(t.changes.invert(t.startState.doc), r, void 0, n || t.startState.selection, xd);
	}
	static selection(t) {
		return new e(void 0, xd, void 0, void 0, t);
	}
};
function _d(e, t, n, r) {
...
function Cd(e, t) {
	if (e.length) {
		...
		return r.length && r[r.length - 1].eq(t) ? e : (r.push(t), _d(e, e.length - 1, 1e9, n.setSelAfter(r)));
	}
	return [gd.selection([t])];
}
function wd(e) {
...
function Td(e, t) {
	...
	return r.length ? [gd.selection(r)] : xd;
}
function Ed(e, t, n) {
	let r = bd(e.selectionsAfter.length ? e.selectionsAfter.map((e) => e.map(t)) : xd, n);
	if (!e.changes) return gd.selection(r);
	let i = e.changes.map(t), a = t.mapDesc(e.changes, !0), o = e.mapped ? e.mapped.composeDesc(a) : a;
	return new gd(i, O.mapEffects(e.effects, t), o, e.startSelection.map(a), r);
}
var Dd = /^(input\.type|delete)($|\.)/, Od = class e {
	...
	addChanges(t, n, r, i, a) {
		...
		return o = s && s.changes && !s.changes.empty && t.changes && (!r || Dd.test(r)) && (!s.selectionsAfter.length && n - this.prevTime < i.newGroupDelay && i.joinToEvent(a, vd(s.changes, t.changes)) || r == "input.type.compose") ? _d(o, o.length - 1, i.minDepth, new gd(t.changes.compose(s.changes), bd(O.mapEffects(t.effects, s.changes), s.effects), s.mapped, s.startSelection, xd)) : _d(o, o.length, i.minDepth, t), new e(o, xd, n, r);
	}
	addSelection(t, n, r, i) {
		let a = this.done.length ? this.done[this.done.length - 1].selectionsAfter : xd;
		return a.length > 0 && n - this.prevTime < i && r == this.prevUserEvent && r && /^select($|\.)/.test(r) && yd(a[a.length - 1], t) ? this : new e(Cd(this.done, t), this.undone, n, r);
	}
	addMapping(t) {
		return new e(Td(this.done, t), Td(this.undone, t), this.prevTime, this.prevUserEvent);
	}
	pop(e, t, n) {
		...
		if (i.changes) {
			let n = r.length == 1 ? xd : r.slice(0, r.length - 1);
			return i.mapped && (n = Td(n, i.mapped)), t.update({
				changes: i.changes,
...
Od.empty = /*@__PURE__*/ new Od(xd, xd);
var kd = [
	{
		key: "Mod-z",
		run: fd,
...
function Md({ state: e, dispatch: t }, n) {
	let r = Ad(e.selection, n);
	return !r.eq(e.selection, !0) && (t(jd(e, r)), !0);
}
function Nd(e, t) {
	return E.cursor(t ? e.to : e.from);
}
function Pd(e, t) {
	return Md(e, (n) => n.empty ? e.moveByChar(n, t) : Nd(n, t));
}
function X(e) {
	return e.textDirectionAt(e.state.selection.main.head) == L.LTR;
}
var Fd = (e) => Pd(e, !X(e)), Id = (e) => Pd(e, X(e));
function Ld(e, t) {
	return Md(e, (n) => n.empty ? e.moveByGroup(n, t) : Nd(n, t));
}
var Rd = (e) => Ld(e, !X(e)), zd = (e) => Ld(e, X(e));
...
function Vd(e, t, n) {
	...
	for (let a = t.head;;) {
		...
		if (!t) break;
		Bd(e, t, i) ? r = t : a = n ? t.to : t.from;
	}
	let a = r.type.prop(i), o, s;
	return s = a && (o = n ? Ru(e, r.from, 1) : Ru(e, r.to, -1)) && o.matched ? n ? o.end.to : o.end.from : n ? r.to : r.from, E.cursor(s, n ? -1 : 1);
}
var Hd = (e) => Md(e, (t) => Vd(e.state, t, !X(e))), Ud = (e) => Md(e, (t) => Vd(e.state, t, X(e)));
function Wd(e, t) {
	return Md(e, (n) => {
		if (!n.empty) return Nd(n, t);
		let r = e.moveVertically(n, t);
		return r.head == n.head ? e.moveToLineBoundary(n, t) : r;
	});
}
var Gd = (e) => Wd(e, !1), Kd = (e) => Wd(e, !0);
function qd(e) {
...
function Jd(e, t) {
	let n = qd(e), { state: r } = e, i = Ad(r.selection, (r) => r.empty ? e.moveVertically(r, t, n.height) : Nd(r, t));
	...
	return e.dispatch(jd(r, i), { effects: a }), !0;
}
var Yd = (e) => Jd(e, !1), Xd = (e) => Jd(e, !0);
function Zd(e, t, n) {
...
var Qd = (e) => Md(e, (t) => Zd(e, t, !0)), $d = (e) => Md(e, (t) => Zd(e, t, !1)), ef = (e) => Md(e, (t) => Zd(e, t, !X(e))), tf = (e) => Md(e, (t) => Zd(e, t, X(e))), nf = (e) => Md(e, (t) => E.cursor(e.lineBlockAt(t.head).from, 1)), rf = (e) => Md(e, (t) => E.cursor(e.lineBlockAt(t.head).to, -1));
function af(e, t, n) {
	let r = !1, i = Ad(e.selection, (t) => {
		let i = Ru(e, t.head, -1) || Ru(e, t.head, 1) || t.head > 0 && Ru(e, t.head - 1, 1) || t.head < e.doc.length && Ru(e, t.head + 1, -1);
		if (!i || !i.end) return t;
		r = !0;
		let a = i.start.from == t.head ? i.end.to : i.end.from;
		return n ? E.range(t.anchor, a) : E.cursor(a);
	});
	return r ? (t(jd(e, i)), !0) : !1;
}
var of = ({ state: e, dispatch: t }) => af(e, t, !1);
function sf(e, t, n) {
	let r = Ad(e.state.selection, (e) => {
	...
	return !r.eq(e.state.selection) && (e.dispatch(jd(e.state, r)), !0);
}
function cf(e, t) {
	return sf(e, t, (n) => e.moveByChar(n, t));
}
var lf = (e) => cf(e, !X(e)), uf = (e) => cf(e, X(e));
function df(e, t) {
	return sf(e, t, (n) => e.moveByGroup(n, t));
}
var ff = (e) => df(e, !X(e)), pf = (e) => df(e, X(e)), mf = (e) => {
	let t = !X(e);
	return sf(e, t, (n) => Vd(e.state, n, t));
}, hf = (e) => {
	let t = X(e);
	return sf(e, t, (n) => Vd(e.state, n, t));
};
function gf(e, t) {
	return sf(e, t, (n) => e.moveVertically(n, t));
}
var _f = (e) => gf(e, !1), vf = (e) => gf(e, !0);
function yf(e, t) {
	return sf(e, t, (n) => e.moveVertically(n, t, qd(e).height));
}
var bf = (e) => yf(e, !1), xf = (e) => yf(e, !0), Sf = (e) => sf(e, !0, (t) => Zd(e, t, !0)), Cf = (e) => sf(e, !1, (t) => Zd(e, t, !1)), wf = (e) => {
	let t = !X(e);
	return sf(e, t, (n) => Zd(e, n, t));
}, Tf = (e) => {
	let t = X(e);
	return sf(e, t, (n) => Zd(e, n, t));
}, Ef = (e) => sf(e, !1, (t) => E.cursor(e.lineBlockAt(t.head).from)), Df = (e) => sf(e, !0, (t) => E.cursor(e.lineBlockAt(t.head).to)), Of = ({ state: e, dispatch: t }) => (t(jd(e, { anchor: 0 })), !0), kf = ({ state: e, dispatch: t }) => (t(jd(e, { anchor: e.doc.length })), !0), Af = ({ state: e, dispatch: t }) => (t(jd(e, {
	anchor: e.selection.main.anchor,
	head: 0
})), !0), jf = ({ state: e, dispatch: t }) => (t(jd(e, {
	anchor: e.selection.main.anchor,
	head: e.doc.length
})), !0), Mf = ({ state: e, dispatch: t }) => (t(e.update({
	selection: {
		anchor: 0,
		head: e.doc.length
	},
	userEvent: "select"
})), !0), Nf = ({ state: e, dispatch: t }) => {
	let n = Qf(e).map(({ from: t, to: n }) => E.range(t, Math.min(n + 1, e.doc.length)));
	return t(e.update({
		selection: E.create(n),
		userEvent: "select"
	})), !0;
}, Pf = ({ state: e, dispatch: t }) => {
	let n = Ad(e.selection, (t) => {
	...
	return !n.eq(e.selection) && (t(jd(e, n)), !0);
};
function Ff(e, t) {
	...
	return i.length != r.ranges.length && (e.dispatch(jd(n, E.create(i, i.length - 1))), !0);
}
var If = (e) => Ff(e, !1), Lf = (e) => Ff(e, !0), Rf = ({ state: e, dispatch: t }) => {
	let n = e.selection, r = null;
	return n.ranges.length > 1 ? r = E.create([n.main]) : n.main.empty || (r = E.create([E.cursor(n.main.head)])), r ? (t(jd(e, r)), !0) : !1;
};
function zf(e, t) {
	...
	let n = "delete.selection", { state: r } = e, i = r.changeByRange((r) => {
		...
		if (i == a) {
			let o = t(r);
			o < i ? (n = "delete.backward", o = Bf(e, o, !1)) : o > i && (n = "delete.forward", o = Bf(e, o, !0)), i = Math.min(i, o), a = Math.max(a, o);
		} else i = Bf(e, i, !1), a = Bf(e, a, !0);
		return i == a ? { range: r } : {
			changes: {
				from: i,
				to: a
...
var Vf = (e, t, n) => zf(e, (r) => {
	...
	if (n && !t && i > o.from && i < o.from + 200 && !/[^ \t]/.test(s = o.text.slice(0, i - o.from))) {
		...
		let e = qt(s, a.tabSize) % au(a) || au(a);
	...
	return c;
}), Hf = (e) => Vf(e, !1, !0), Uf = (e) => Vf(e, !0, !1), Wf = (e, t) => zf(e, (n) => {
	...
	return r;
}), Gf = (e) => Wf(e, !1), Kf = (e) => Wf(e, !0), qf = (e) => zf(e, (t) => {
...
var ep = ({ state: e, dispatch: t }) => $f(e, t, !1), tp = ({ state: e, dispatch: t }) => $f(e, t, !0);
function np(e, t, n) {
	if (e.readOnly) return !1;
	let r = [];
	for (let t of Qf(e)) n ? r.push({
		from: t.from,
...
var rp = ({ state: e, dispatch: t }) => np(e, t, !1), ip = ({ state: e, dispatch: t }) => np(e, t, !0), ap = (e) => {
	if (e.state.readOnly) return !1;
	let { state: t } = e, n = t.changes(Qf(t).map(({ from: e, to: n }) => (e > 0 ? e-- : n < t.doc.length && n++, {
		from: e,
		to: n
	}))), r = Ad(t.selection, (t) => {
		let n;
...
var sp = /*@__PURE__*/ lp(!1), cp = /*@__PURE__*/ lp(!0);
function lp(e) {
	return ({ state: t, dispatch: n }) => {
		if (t.readOnly) return !1;
		let r = t.changeByRange((n) => {
			let { from: r, to: i } = n, a = t.doc.lineAt(r), o = !e && r == i && op(t, r);
			e && (r = i = (i <= a.to ? a : t.doc.lineAt(i)).to);
			let s = new cu(t, {
				simulateBreak: r,
				simulateDoubleBreak: !!o
			}), c = su(s, r);
			for (c ??= qt(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize); i < a.to && /\s/.test(a.text[i - a.from]);) i++;
			o ? {from: r, to: i} = o : r > a.from && r < a.from + 100 && !/\S/.test(a.text.slice(0, r)) && (r = a.from);
			let l = ["", ou(t, c)];
			return o && l.push(ou(t, s.lineIndent(a.from, -1))), {
				changes: {
					from: r,
					to: i,
					insert: x.of(l)
...
var dp = ({ state: e, dispatch: t }) => {
	if (e.readOnly) return !1;
	let n = Object.create(null), r = new cu(e, { overrideIndentation: (e) => n[e] ?? -1 }), i = up(e, (t, i, a) => {
		let o = su(r, t.from);
		if (o == null) return;
		/\S/.test(t.text) || (o = 0);
		let s = /^\s*/.exec(t.text)[0], c = ou(e, o);
...
}, fp = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(up(e, (t, n) => {
	n.push({
		from: t.from,
		insert: e.facet(iu)
	});
}), { userEvent: "input.indent" })), !0), pp = ({ state: e, dispatch: t }) => !e.readOnly && (t(e.update(up(e, (t, n) => {
	let r = /^\s*/.exec(t.text)[0];
	if (!r) return;
	let i = qt(r, e.tabSize), a = 0, o = ou(e, Math.max(0, i - au(e)));
...
}), { userEvent: "delete.dedent" })), !0), mp = (e) => (e.setTabFocusMode(), !0), hp = [
	{
		key: "Ctrl-b",
		run: Fd,
		shift: lf,
	...
	matchBefore(e) {
		let t = this.state.doc.lineAt(this.pos), n = Math.max(t.from, this.pos - 250), r = t.text.slice(n - t.from, this.pos - t.from), i = r.search(Cp(e, !1));
		return i < 0 ? null : {
			from: n + i,
			to: this.pos,
			text: r.slice(i)
...
function xp(e) {
	let t = e.map((e) => typeof e == "string" ? { label: e } : e), [n, r] = t.every((e) => /^\w+$/.test(e.label)) ? [/\w*$/, /\w+$/] : bp(t);
	return (e) => {
...
var wp = /*@__PURE__*/ pt.define();
typeof navigator == "object" && navigator.platform;
var Tp = /*@__PURE__*/ H.baseTheme({
	...
	instantiate(e, t) {
		...
		return {
			text: n,
			ranges: this.fieldPositions.map((e) => new Dp(e.field, r[e.line] + e.from, r[e.line] + e.to))
		};
	}
	static parse(t) {
		let n = [], r = [], i = [], a;
		for (let e of t.split(/\r\n?|\n/)) {
			for (; a = /[#$]\{(?:(\d+)(?::([^{}]*))?|((?:\\[{}]|[^{}])*))\}/.exec(e);) {
				...
				i.push(new Ep(s, r.length, a.index, a.index + c.length)), e = e.slice(0, a.index) + o + e.slice(a.index + a[0].length);
			}
			e = e.replace(/\\([{}])/g, (e, t, n) => {
...
}, kp = /*@__PURE__*/ I.widget({ widget: /*@__PURE__*/ new class extends Tn {
	toDOM() {
		let e = document.createElement("span");
...
}() }), Ap = /*@__PURE__*/ I.mark({ class: "cm-snippetField" }), jp = class e {
	constructor(e, t) {
		this.ranges = e, this.active = t, this.deco = I.set(e.map((e) => (e.from == e.to ? kp : Ap).range(e.from, e.to)), !0);
	}
	map(t) {
		let n = [];
...
}, Mp = /*@__PURE__*/ O.define({ map(e, t) {
	return e && e.map(t);
} }), Np = /*@__PURE__*/ O.define(), Pp = /*@__PURE__*/ Ye.define({
	create() {
		return null;
	},
	update(e, t) {
		for (let n of t.effects) {
			if (n.is(Mp)) return n.value;
			if (n.is(Np) && e) return new jp(e.ranges, n.value);
		}
...
function Ip(e) {
	...
	return (e, n, r, i) => {
		let { text: a, ranges: o } = t.instantiate(e.state, r), { main: s } = e.state.selection, c = {
			...
			scrollIntoView: !0,
			annotations: n ? [wp.of(n), k.userEvent.of("input.complete")] : void 0
		};
		if (o.length && (c.selection = Fp(o, 0)), o.some((e) => e.field > 0)) {
			let t = new jp(o, 0), n = c.effects = [Mp.of(t)];
			e.state.field(Pp, !1) === void 0 && n.push(O.appendConfig.of([
				Pp,
				Bp,
				Hp,
				Tp
...
function Lp(e) {
	return ({ state: t, dispatch: n }) => {
		...
		return n(t.update({
			selection: Fp(r.ranges, i),
			effects: Mp.of(a ? null : new jp(r.ranges, i)),
			scrollIntoView: !0
		})), !0;
	};
}
var Rp = [{
	...
	key: "Escape",
	run: ({ state: e, dispatch: t }) => e.field(Pp, !1) ? (t(e.update({ effects: Mp.of(null) })), !0) : !1
}], zp = /*@__PURE__*/ D.define({ combine(e) {
	return e.length ? e[0] : Rp;
} }), Bp = /*@__PURE__*/ Qe.highest(/*@__PURE__*/ cs.compute([zp], (e) => e.facet(zp)));
function Vp(e, t) {
	return {
		...t,
		apply: Ip(e)
...
var Hp = /*@__PURE__*/ H.domEventHandlers({ mousedown(e, t) {
	...
	return !i || i.field == n.active ? !1 : (t.dispatch({
		selection: Fp(n.ranges, i.field),
		effects: Mp.of(n.ranges.some((e) => e.field > i.field) ? new jp(n.ranges, i.field) : null),
		scrollIntoView: !0
	}), !0);
...
function Jp(e, t, n) {
	...
	let r = (e.type == Z.OrderedList ? im : rm)(n, t, !1);
	return r > 0 && (e.type != Z.BulletList || tm(n, t, !1) < 0) && n.text.charCodeAt(n.pos + r - 1) == e.value;
}
var Yp = {
	[Z.Blockquote](e, t, n) {
		return n.next == 62 && (n.markers.push(Q(Z.QuoteMark, t.lineStart + n.pos, t.lineStart + n.pos + 1)), n.moveBase(n.pos + (Xp(n.text.charCodeAt(n.pos + 1)) ? 2 : 1)), e.end = t.lineStart + n.text.length, !0);
	},
	[Z.ListItem](e, t, n) {
...
function Zp(e, t = 0) {
	for (; t < e.length && Xp(e.charCodeAt(t));) t++;
	return t;
}
function Qp(e, t, n) {
	for (; t > n && Xp(e.charCodeAt(t - 1));) t--;
	return t;
}
function $p(e) {
...
function tm(e, t, n) {
	...
	for (let t = e.pos + 1; t < e.text.length; t++) {
		...
		if (n == e.next) r++;
		else if (!Xp(n)) return -1;
	}
	return n && e.next == 45 && om(e) > -1 && e.depth == t.stack.length && t.parser.leafBlockParsers.indexOf(vm.SetextHeading) > -1 || r < 3 ? -1 : 1;
}
function nm(e, t) {
...
function rm(e, t, n) {
	return (e.next == 45 || e.next == 43 || e.next == 42) && (e.pos == e.text.length - 1 || Xp(e.text.charCodeAt(e.pos + 1))) && (!n || nm(t, Z.BulletList) || e.skipSpace(e.pos + 2) < e.text.length) ? 1 : -1;
}
function im(e, t, n) {
	...
	return r == e.pos || r > e.pos + 9 || i != 46 && i != 41 || r < e.text.length - 1 && !Xp(e.text.charCodeAt(r + 1)) || n && !nm(t, Z.OrderedList) && (e.skipSpace(r + 1) == e.text.length || r > e.pos + 1 || e.next != 49) ? -1 : r + 1 - e.pos;
}
function am(e) {
...
function om(e) {
	...
	for (; t < e.text.length && e.text.charCodeAt(t) == e.next;) t++;
	let n = t;
	for (; t < e.text.length && Xp(e.text.charCodeAt(t));) t++;
...
var sm = /^[ \t]*$/, cm = /-->/, lm = /\?>/, um = [
	...
	[/^\s*<![A-Z]/, />/],
	[/^\s*<!\[CDATA\[/, /\]\]>/],
	[/^\s*<\/?(?:address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h1|h2|h3|h4|h5|h6|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul)(?:\s|\/?>|$)/i, sm],
	[/^\s*(?:<\/[a-z][\w-]*\s*>|<[a-z][\w-]*(\s+[a-z:_][\w-.]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*>)\s*$/i, sm]
];
function dm(e, t, n) {
	if (e.next != 60) return -1;
	let r = e.text.slice(e.pos);
	for (let e = 0, t = um.length - +!!n; e < t; e++) if (um[e][0].test(r)) return e;
	return -1;
}
function fm(e, t) {
...
var mm = {
	...
	IndentedCode(e, t) {
		...
		for (pm(o, i, a); e.nextLine() && t.depth >= e.stack.length;) if (t.pos == t.text.length) {
			pm(s, e.lineStart - 1, e.lineStart);
			for (let e of t.markers) s.push(e);
		} else if (t.indent < n) break;
		else {
			if (s.length) {
				for (let e of s) e.type == Z.CodeText ? pm(o, e.from, e.to) : o.push(e);
				s = [];
			}
			pm(o, e.lineStart - 1, e.lineStart);
	...
	FencedCode(e, t) {
		let n = $p(t);
		if (n < 0) return !1;
		let r = e.lineStart + t.pos, i = t.next, a = n - t.pos, o = t.skipSpace(n), s = Qp(t.text, t.text.length, o), c = [Q(Z.CodeMark, r, r + a)];
		...
		for (let n = !0, r = !0, o = !1; e.nextLine() && t.depth >= e.stack.length; n = !1) {
			...
			if (s - t.pos >= a && t.skipSpace(s) == t.text.length) {
				...
				r && o && pm(c, e.lineStart - 1, e.lineStart), c.push(Q(Z.CodeMark, e.lineStart + t.pos, e.lineStart + s)), e.nextLine();
				break;
			}
			{
				o = !0, n || (pm(c, e.lineStart - 1, e.lineStart), r = !1);
				for (let e of t.markers) c.push(e);
	...
	ATXHeading(e, t) {
		let n = am(t);
		if (n < 0) return !1;
		let r = t.pos, i = e.lineStart + r, a = Qp(t.text, t.text.length, r), o = a;
		for (; o > r && t.text.charCodeAt(o - 1) == t.next;) o--;
		(o == a || o == r || !Xp(t.text.charCodeAt(o - 1))) && (o = t.text.length);
	...
	HTMLBlock(e, t) {
		let n = dm(t, e, !1);
		if (n < 0) return !1;
		let r = e.lineStart + t.pos, i = um[n][1], a = [], o = i != sm;
		...
		o && e.nextLine();
		let s = i == cm ? Z.CommentBlock : i == lm ? Z.ProcessingInstructionBlock : Z.HTMLBlock, c = e.prevLineEnd();
	...
	finish(e, t) {
		return (this.stage == 2 || this.stage == 3) && Zp(t.content, this.pos) == t.content.length && this.complete(e, t, t.content.length);
	}
	complete(e, t, n) {
	...
	advance(e) {
		for (;;) if (this.stage == -1) return -1;
			...
			if (!this.nextStage(Um(e, this.pos, this.start, !0))) return -1;
			...
			if (!this.nextStage(Vm(e, Zp(e, this.pos), this.start))) return -1;
		} else if (this.stage == 2) {
			let t = Zp(e, this.pos), n = 0;
			if (t > this.pos) {
				let r = Hm(e, t, this.start);
				if (r) {
					let t = gm(e, r.to - this.start);
					t > 0 && (this.nextStage(r), n = t);
				}
			}
			return n ||= gm(e, this.pos), n > 0 && n < e.length ? n : -1;
		} else return gm(e, this.pos);
	}
};
function gm(e, t) {
	for (; t < e.length; t++) {
...
var _m = class {
	nextLine(e, t, n) {
		let r = t.depth < e.stack.length ? -1 : om(t), i = t.next;
		if (r < 0) return !1;
	...
	LinkReference(e, t) {
		return t.content.charCodeAt(0) == 91 ? new hm(t) : null;
	},
	SetextHeading() {
		return new _m();
	}
	...
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.line = new qp(), this.atEnd = !1, this.reusePlaceholders = /* @__PURE__ */ new Map(), this.stoppedAt = null, this.rangeI = 0, this.to = r[r.length - 1].to, this.lineStart = this.absoluteLineStart = this.absoluteLineEnd = r[0].from, this.block = Gp.create(Z.Document, 0, this.lineStart, 0, 0), this.stack = [this.block], this.fragments = n.length ? new qm(n, t) : null, this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let t = new Kp(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	reuseFragment(e) {
		...
		return t ? (this.absoluteLineStart += t, this.lineStart = Jm(this.absoluteLineStart, this.ranges), this.moveRangeI(), this.absoluteLineStart < this.to ? (this.lineStart++, this.absoluteLineStart++, this.readLine()) : (this.atEnd = !0, this.readLine()), !0) : !1;
	}
	get depth() {
	...
	startContext(e, t, n = 0) {
		this.block = Gp.create(e, n, this.lineStart + t, this.block.hash, this.lineStart + this.line.text.length), this.stack.push(this.block);
	}
	startComposite(e, t, n = 0) {
		this.startContext(this.parser.getNodeType(e), t, n);
	}
	addNode(e, t, n) {
		typeof e == "number" && (e = new K(this.parser.nodeSet.types[e], Om, Om, (n ?? this.prevLineEnd()) - t)), this.block.addChild(e, t - this.block.from);
	}
	addElement(e) {
		this.block.addChild(e.toTree(this.parser.nodeSet), e.from - this.block.from);
	}
	addLeafElement(e, t) {
		this.addNode(this.buffer.writeElements(Gm(t.children, e.marks), -t.from).finish(t.type, t.to - t.from), t.from);
	}
	finishContext() {
	...
	addGaps(e) {
		return this.ranges.length > 1 ? Sm(this.ranges, 0, e.topNode, this.ranges[0].from, this.reusePlaceholders) : e;
	}
	finishLeaf(e) {
		for (let t of e.parsers) if (t.finish(this, e)) return;
		let t = Gm(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(this.buffer.writeElements(t, -e.start).finish(Z.Paragraph, e.content.length), e.start);
	}
	elt(e, t, n, r) {
		return typeof e == "string" ? Q(this.parser.getNodeType(e), t, n, r) : new jm(e, t);
	}
	get buffer() {
		return new km(this.parser.nodeSet);
	}
};
function Sm(e, t, n, r, i) {
	...
	for (let u = n.firstChild; u; u = u.nextSibling) {
		...
		f ? d = f : u.to + r > a ? (d = Sm(e, t, u, r, i), l(u.to + r, !1)) : d = u.toTree(), o.push(d), s.push(n - c);
	}
	return l(n.to + r, !1), new K(n.type, o, s, n.to + r - c, n.tree ? n.tree.propValues : void 0);
}
var Cm = class e extends Xc {
		...
		if (wm(n.defineNodes)) {
			...
			for (let r of n.defineNodes) {
				...
				e.push(W.define({
					...
					name: n,
					props: l && [[U.group, l]]
				})), s && (t ||= {}, Array.isArray(s) || s instanceof pl ? t[n] = s : Object.assign(t, s));
			}
			r = new Ec(e), t && (r = r.extend(vl(t)));
		}
		if (wm(n.props) && (r = r.extend(...n.props)), wm(n.remove)) for (let e of n.remove) {
			let t = this.blockNames.indexOf(e), n = this.inlineNames.indexOf(e);
			t > -1 && (a[t] = o[t] = void 0), n > -1 && (c[n] = void 0);
		}
		if (wm(n.parseBlock)) for (let e of n.parseBlock) {
			let t = s.indexOf(e.name);
			if (t > -1) a[t] = e.parse, o[t] = e.leaf;
			else {
				let t = e.before ? Em(s, e.before) : e.after ? Em(s, e.after) + 1 : s.length - 1;
				a.splice(t, 0, e.parse), o.splice(t, 0, e.leaf), s.splice(t, 0, e.name);
			}
			e.endLeaf && u.push(e.endLeaf);
		}
		if (wm(n.parseInline)) for (let e of n.parseInline) {
			let t = l.indexOf(e.name);
			if (t > -1) c[t] = e.parse;
			else {
				let t = e.before ? Em(l, e.before) : e.after ? Em(l, e.after) + 1 : l.length - 1;
...
function Tm(e) {
	...
	let n = Tm(e.slice(1));
	if (!n || !t) return t || n;
	let r = (e, t) => (e || Om).concat(t || Om), i = t.wrap, a = n.wrap;
	return {
...
var Dm = [W.none];
for (let e = 1, t; t = Z[e]; e++) Dm[e] = W.define({
	id: e,
	name: t,
	props: e >= Z.Escape ? [] : [[U.group, e in Yp ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
	top: t == "Document"
});
var Om = [], km = class {
	constructor(e) {
	...
	toTree(e) {
		return new km(e).writeElements(this.children, -this.from).finish(this.type, this.to - this.from);
	}
}, jm = class {
	constructor(e, t) {
...
try {
	Rm = /* @__PURE__ */ RegExp("[\\p{S}|\\p{P}]", "u");
} catch {}
var zm = {
	Escape(e, t, n) {
		if (t != 92 || n == e.end - 1) return -1;
		let r = e.char(n + 1);
		for (let t = 0; t < 32; t++) if (Lm.charCodeAt(t) == r) return e.append(Q(Z.Escape, n, n + 2));
		return -1;
	},
	Entity(e, t, n) {
		if (t != 38) return -1;
	...
	Emphasis(e, t, n) {
		...
		let r = n + 1;
		for (; e.char(r) == t;) r++;
		let i = e.slice(n - 1, n), a = e.slice(r, r + 1), o = Rm.test(i), s = Rm.test(a), c = /\s|^$/.test(i), l = /\s|^$/.test(a), u = !l && (!s || c || o), d = !c && (!o || l || s), f = u && (t == 42 || !d || o), p = d && (t == 42 || !u || s);
		return e.append(new Im(t == 95 ? Mm : Nm, n, r, !!f | (p ? 2 : 0)));
	},
	HardBreak(e, t, n) {
	...
	Link(e, t, n) {
		return t == 91 ? e.append(new Im(Pm, n, n + 1, 1)) : -1;
	},
	Image(e, t, n) {
		return t == 33 && e.char(n + 1) == 91 ? e.append(new Im(Fm, n, n + 2, 1)) : -1;
	},
	LinkEnd(e, t, n) {
		if (t != 93) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let r = e.parts[t];
			if (r instanceof Im && (r.type == Pm || r.type == Fm)) {
				if (!r.side || e.skipSpace(r.to) == n && !/[(\[]/.test(e.slice(n + 1, n + 2))) return e.parts[t] = null, -1;
				let i = e.takeContent(t), a = e.parts[t] = Bm(e, i, r.type == Pm ? Z.Link : Z.Image, r.from, n + 1);
				if (r.type == Pm) for (let n = 0; n < t; n++) {
					let t = e.parts[n];
					t instanceof Im && t.type == Pm && (t.side = 0);
				}
				return a.to;
			}
		}
...
function Bm(e, t, n, r, i) {
	...
	if (t.unshift(Q(Z.LinkMark, r, r + (n == Z.Image ? 2 : 1))), t.push(Q(Z.LinkMark, i - 1, i)), o == 40) {
		let n = e.skipSpace(i + 1), r = Vm(a, n - e.offset, e.offset), o;
		r && (n = e.skipSpace(r.to), n != r.to && (o = Hm(a, n - e.offset, e.offset), o && (n = e.skipSpace(o.to)))), e.char(n) == 41 && (t.push(Q(Z.LinkMark, i, i + 1)), s = n + 1, r && t.push(r), o && t.push(o), t.push(Q(Z.LinkMark, n, s)));
	} else if (o == 91) {
		let n = Um(a, i - e.offset, e.offset, !1);
		n && (t.push(n), s = n.to);
	}
	return Q(n, r, s, t);
}
...
var Wm = class {
	...
	addDelimiter(e, t, n, r, i) {
		return this.append(new Im(e, t, n, !!r | (i ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof Im && (t.type == Pm || t.type == Fm)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let n = this.parts[t];
			if (!(n instanceof Im && n.type.resolve && n.side & 2)) continue;
			let r = n.type == Mm || n.type == Nm, i = n.to - n.from, a, o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
				if (e instanceof Im && e.side & 1 && e.type == n.type && !(r && (n.side & 1 || e.side & 2) && (e.to - e.from + i) % 3 == 0 && ((e.to - e.from) % 3 || i % 3))) {
					a = e;
					break;
				}
			}
			...
			for (let e = o + 1; e < t; e++) this.parts[e] instanceof Am && c.push(this.parts[e]), this.parts[e] = null;
			n.type.mark && c.push(this.elt(n.type.mark, n.from, u));
			let d = this.elt(s, l, u, c);
			this.parts[o] = r && a.from != l ? new Im(a.type, a.from, l, a.side) : null, (this.parts[t] = r && n.to != u ? new Im(n.type, u, n.to, n.side) : null) ? this.parts.splice(t, 0, d) : this.parts[t] = d;
		}
		let t = [];
		for (let n = e; n < this.parts.length; n++) {
			let e = this.parts[n];
			e instanceof Am && t.push(e);
		}
		return t;
	}
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let n = this.parts[t];
			if (n instanceof Im && n.type == e && n.side & 1) return t;
		}
		return null;
	}
	takeContent(e) {
	...
	getDelimiterAt(e) {
		let t = this.parts[e];
		return t instanceof Im ? t : null;
	}
	skipSpace(e) {
		return Zp(this.text, e - this.offset) + this.offset;
	}
	elt(e, t, n, r) {
		return typeof e == "string" ? Q(this.parser.getNodeType(e), t, n, r) : new jm(e, t);
	}
};
Wm.linkStart = Pm, Wm.imageStart = Fm;
function Gm(e, t) {
	...
	for (let e of t) {
		...
		if (r < n.length && n[r].from < e.from) {
			let t = n[r];
			t instanceof Am && (n[r] = new Am(t.type, t.from, t.to, Gm(t.children, [e])));
		} else n.splice(r++, 0, e);
	}
	return n;
}
var Km = [
	...
	takeNodes(e) {
		...
		for (;;) {
			...
			if (t.type.is("Block") && (Km.indexOf(t.type.id) < 0 ? (a = t.to - n, o = e.block.children.length) : (a = s, o = c), s = t.to - n, c = e.block.children.length), !t.nextSibling()) break;
		}
...
var Ym = vl({
	...
	LinkTitle: J.string,
	Paragraph: J.content
}), Xm = new Cm(new Ec(Dm).extend(Ym), Object.keys(mm).map((e) => mm[e]), Object.keys(mm).map((e) => vm[e]), Object.keys(mm), ym, Yp, Object.keys(zm).map((e) => zm[e]), Object.keys(zm), []);
function Zm(e, t, n) {
	let r = [];
...
var $m = {
	...
	parseInline: [{
		...
		parse(e, t, n) {
			...
			let r = e.slice(n - 1, n), i = e.slice(n + 2, n + 3), a = /\s|^$/.test(r), o = /\s|^$/.test(i), s = Rm.test(r), c = Rm.test(i);
			return e.addDelimiter($m, n, n + 2, !o && (!c || a || s), !a && (!s || o || c));
		},
		after: "Emphasis"
	}]
};
function th(e, t, n = 0, r, i = 0) {
...
var rh = /^[>\s]*\|?(\s*:?-+:?\s*\|)+(\s*:?-+:?\s*)?$/, ih = class {
	...
	nextLine(e, t, n) {
		if (this.rows == null) {
			this.rows = !1;
			let r;
			if ((t.next == 45 || t.next == 58 || t.next == 124) && rh.test(r = t.text.slice(t.pos))) {
				let i = [];
				th(e, n.content, 0, i, n.start) == th(e, r, 0) && (this.rows = [e.elt("TableHeader", n.start, n.start + n.content.length, i), e.elt("TableDelimiter", e.lineStart + t.pos, e.lineStart + t.text.length)]);
			}
		} else if (this.rows) {
			let n = [];
			th(e, t.text, t.pos, n, e.lineStart), this.rows.push(e.elt("TableRow", e.lineStart + t.pos, e.lineStart + t.text.length, n));
		}
		return !1;
	}
	finish(e, t) {
	...
	parseBlock: [{
		name: "Table",
		leaf(e, t) {
			return nh(t.content, 0) ? new ih() : null;
		},
		endLeaf(e, t, n) {
			if (n.parsers.some((e) => e instanceof ih) || !nh(t.text, t.basePos)) return !1;
			let r = e.peekLine();
			return rh.test(r) && th(e, t.text, t.basePos) == th(e, r, t.basePos);
		},
	...
	parseBlock: [{
		name: "TaskList",
		leaf(e, t) {
			return /^\[[ xX]\][ \t]/.test(t.content) && e.parentType().name == "ListItem" ? new oh() : null;
		},
		after: "SetextHeading"
	}]
}, ch = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy, lh = /[\w-]+(\.[\w-]+)+(:\d+)?(\/[^\s<]*)?/gy, uh = /[\w-]+\.[\w-]+($|[/:])/, dh = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy, fh = /\/[a-zA-Z\d@.]+/gy;
function ph(e, t, n, r) {
	let i = 0;
...
function mh(e, t) {
	lh.lastIndex = t;
	let n = lh.exec(e);
	if (!n || uh.exec(n[0])[0].indexOf("_") > -1) return -1;
	let r = t + n[0].length;
	for (;;) {
		let n = e[r - 1], i;
		if (/[?!.,:*_~]/.test(n) || n == ")" && ph(e, t, r, ")") > ph(e, t, r, "(")) r--;
...
var gh = [
	...
	{ parseInline: [{
		...
		parse(e, t, n) {
			...
			ch.lastIndex = r;
			let i = ch.exec(e.text), a = -1;
			return !i || (i[1] || i[2] ? (a = mh(e.text, r + i[0].length), a > -1 && e.hasOpenLink && (a = r + /([^\[\]]|\[[^\]]*\])*/.exec(e.text.slice(r, a))[0].length)) : i[3] ? a = hh(e.text, r) : (a = hh(e.text, r + i[0].length), a > -1 && i[0] == "xmpp:" && (fh.lastIndex = a, i = fh.exec(e.text), i && (a = i.index + i[0].length))), a < 0) ? -1 : (e.addElement(e.elt("URL", n, a + e.offset)), a + e.offset);
		}
	}] }
];
function _h(e, t, n) {
	return (r, i, a) => {
		...
		for (let i = a + 1; i < r.end; i++) {
			...
			if (s == 92 && o.push(r.elt("Escape", i, i++ + 2)), Xp(s)) break;
		}
		return -1;
	};
}
var vh = {
	...
	parseInline: [{
		name: "Superscript",
		parse: _h(94, "Superscript", "SuperscriptMark")
	}]
}, yh = {
	defineNodes: [{
		name: "Subscript",
	...
	parseInline: [{
		name: "Subscript",
		parse: _h(126, "Subscript", "SubscriptMark")
	}]
}, bh = {
	defineNodes: [{
		name: "Emoji",
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new Sh(i, i.start) : null, 0, null);
	}
	get context() {
...
var Eh = class {
	...
	token(e, t) {
		let { parser: n } = t.p;
		Mh(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
kh.prototype.contextual = kh.prototype.fallback = kh.prototype.extend = !1;
var Ah = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? Th(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
			let n = e.next < 0, i = e.resolveOffset(1, 1);
			if (Mh(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1) break;
...
Ah.prototype.contextual = kh.prototype.fallback = kh.prototype.extend = !1;
var jh = class {
	constructor(e, t = {}) {
...
function Mh(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || Ph(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function Ph(e, t, n, r) {
	let i = Nh(n, r, t);
	return i < 0 || Nh(n, r, e) < i;
}
var Fh = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Ih = null;
function Lh(e, t, n) {
...
var Rh = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? Lh(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? Lh(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new Eh());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new Eh(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new Eh(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) {
				if (o[s + 1] == 1) s = Kh(o, s + 2);
				else {
					r == 0 && o[s + 1] == 2 && (r = this.putAction(Kh(o, s + 2), t, n, r));
					break;
				}
			}
			o[s] == t && (r = this.putAction(Kh(o, s + 1), t, n, r));
		}
		return r;
	}
}, Bh = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new Oh(t, r), this.tokens = new zh(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [xh.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new Rh(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	advance() {
		...
		if (!n.length) {
			let e = r && qh(r);
			if (e) return Fh && console.log("Finish with " + this.stackID(e)), this.stackToTree(e);
			if (this.parser.strict) throw Fh && r && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), SyntaxError("No parse at " + t);
			this.recovering ||= 5;
		}
		if (this.recovering && r) {
			let e = this.stoppedAt != null && r[0].pos > this.stoppedAt ? r[0] : this.runRecovery(r, i, n);
			if (e) return Fh && console.log("Force-finish " + this.stackID(e)), this.stackToTree(e.forceAll());
		}
		if (this.recovering) {
	...
	advanceStack(e, t, n) {
		let r = e.pos, { parser: i } = this, a = Fh ? this.stackID(e) + " -> " : "";
		...
		if (this.fragments) {
			...
			for (let o = this.fragments.nodeAt(r); o;) {
				...
				if (r > -1 && o.length && (!t || (o.prop(U.contextHash) || 0) == n)) return e.useNode(o, r), Fh && console.log(a + this.stackID(e) + ` (via reuse of ${i.getName(o.type.id)})`), !0;
		...
		if (o > 0) return e.reduce(o), Fh && console.log(a + this.stackID(e) + ` (via always-reduce ${i.getName(o & 65535)})`), !0;
		...
		for (let o = 0; o < s.length;) {
			...
			if (f.apply(c, l, p ? p.start : f.pos, u), Fh && console.log(a + this.stackID(f) + ` (via ${c & 65536 ? `reduce of ${i.getName(c & 65535)}` : "shift"} for ${i.getName(l)} @ ${r}${f == e ? "" : ", split"})`), d) return !0;
	...
	advanceFully(e, t) {
		...
		for (;;) {
			...
			if (e.pos > n) return Vh(e, t), !0;
		}
	}
	runRecovery(e, t, n) {
		let r = null, i = !1;
		for (let a = 0; a < e.length; a++) {
			let o = e[a], s = t[a << 1], c = t[(a << 1) + 1], l = Fh ? this.stackID(o) + " -> " : "";
			if (o.deadEnd && (i || (i = !0, o.restart(), Fh && console.log(l + this.stackID(o) + " (restarted)"), this.advanceFully(o, n)))) continue;
			let u = o.split(), d = l;
			for (let e = 0; e < 10 && u.forceReduce() && (Fh && console.log(d + this.stackID(u) + " (via force-reduce)"), !this.advanceFully(u, n)); e++) Fh && (d = this.stackID(u) + " -> ");
			for (let e of o.recoverByInsert(s)) Fh && console.log(l + this.stackID(e) + " (via recover-insert)"), this.advanceFully(e, n);
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), Fh && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), Vh(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Ih ||= /* @__PURE__ */ new WeakMap()).get(e);
		return t || Ih.set(e, t = String.fromCodePoint(this.nextStackID++)), t + e;
	}
};
function Vh(e, t) {
...
var Hh = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Uh, this.reduce = e.reduce || Uh, this.reuse = e.reuse || Uh, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Gh = class e extends Xc {
	constructor(e) {
		...
		this.nodeSet = new Ec(t.map((t, i) => W.define({
		...
		}))), e.propSources && (this.nodeSet = this.nodeSet.extend(...e.propSources)), this.strict = !1, this.bufferLength = xc;
		let a = Th(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Jh), this.states = Th(e.states, Uint32Array), this.data = Th(e.stateData), this.goto = Th(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new kh(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new Bh(this, e, t, n);
		for (let i of this.wrappers) r = i(r, e, t, n);
		return r;
	}
	getGoto(e, t, n = !1) {
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) {
				if (n[i + 1] == 1) a = n[i = Kh(n, i + 2)];
				else if (n[i + 1] == 2) return Kh(n, i + 2);
				else break;
			}
			if (a == t || a == 0) return Kh(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) {
				if (this.data[n + 1] == 1) n = Kh(this.data, n + 2);
				else break;
			}
			r = t(Kh(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Jh(a), a;
...
var Mg = null, Ng = null, Pg = 0;
function Fg(e, t) {
	let n = e.pos + t;
	if (Pg == n && Ng == e) return Mg;
	let r = e.peek(t), i = "";
	for (; jg(r);) i += String.fromCharCode(r), r = e.peek(++t);
	return Ng = e, Pg = n, Mg = i ? i.toLowerCase() : r == zg || r == Bg ? void 0 : null;
}
var Ig = 60, Lg = 62, Rg = 47, zg = 63, Bg = 33, Vg = 45;
function Hg(e, t) {
...
var Ug = [
	...
	start: null,
	shift(e, t, n, r) {
		return Ug.indexOf(t) > -1 ? new Hg(Fg(r, 1) || "", e) : e;
	},
	reduce(e, t) {
		return t == hg && e ? e.parent : e;
	},
	reuse(e, t, n, r) {
		let i = t.type.id;
		return i == rg || i == wg ? new Hg(Fg(r, 1) || "", e) : e;
	},
	strict: !1
}), Gg = new jh((e, t) => {
	if (e.next != Ig) {
		e.next < 0 && t.context && e.acceptToken(dg);
		return;
	}
	e.advance();
	let n = e.next == Rg;
	...
	let r = Fg(e, 0);
	if (r === void 0) return;
	if (!r) return e.acceptToken(n ? pg : fg);
	let i = t.context ? t.context.name : null;
	if (n) {
		if (r == i) return e.acceptToken(cg);
		if (i && kg[i]) return e.acceptToken(dg, -2);
		if (t.dialectEnabled(Eg)) return e.acceptToken(lg);
		for (let e = t.context; e; e = e.parent) if (e.name == r) return;
		e.acceptToken(ug);
	} else {
		if (r == "script") return e.acceptToken(ig);
		if (r == "style") return e.acceptToken(ag);
		if (r == "textarea") return e.acceptToken(og);
		if (Og.hasOwnProperty(r)) return e.acceptToken(sg);
		i && Ag[i] && Ag[i][r] ? e.acceptToken(dg, -1) : e.acceptToken(rg);
	}
}, { contextual: !0 }), Kg = new jh((e) => {
	for (let t = 0, n = 0;; n++) {
		if (e.next < 0) {
			n && e.acceptToken(mg);
			break;
		...
		if (e.next == Vg) t++;
		else if (e.next == Lg && t >= 2) {
			n >= 3 && e.acceptToken(mg, -2);
			break;
		} else t = 0;
		e.advance();
	}
...
var Jg = new jh((e, t) => {
	if (e.next == Rg && e.peek(1) == Lg) {
		let n = t.dialectEnabled(Dg) || qg(t.context);
		e.acceptToken(n ? ng : tg, 2);
	} else e.next == Lg && e.acceptToken(tg, 1);
});
function Yg(e, t, n) {
	let r = 2 + e.length;
	return new jh((i) => {
		for (let a = 0, o = 0, s = 0;; s++) {
			...
			if (a == 0 && i.next == Ig || a == 1 && i.next == Rg || a >= 2 && a < r && i.next == e.charCodeAt(a - 2)) a++, o++;
			else if (a == r && i.next == Lg) {
...
var Xg = Yg("script", Yh, Xh), Zg = Yg("style", Zh, Qh), Qg = Yg("textarea", $h, eg), $g = vl({
...
function t_(e, t) {
	let n = Object.create(null);
	for (let r of e.getChildren(_g)) {
		let e = r.getChild(vg), i = r.getChild(yg) || r.getChild(bg);
		e && (n[t.read(e.from, e.to)] = i ? i.type.id == yg ? t.read(i.from + 1, i.to - 1) : t.read(i.from, i.to) : "");
	}
	return n;
}
function n_(e, t) {
...
function r_(e, t, n) {
	let r;
	for (let i of n) if (!i.attrs || i.attrs(r ||= t_(e.node.parent.firstChild, t))) return {
		parser: i.parser,
		bracketed: !0
	};
	return null;
...
function i_(e = [], t = []) {
	...
	return Qc((e, t) => {
		let s = e.type.id;
		if (s == xg) return r_(e, t, n);
		if (s == Sg) return r_(e, t, r);
		if (s == Cg) return r_(e, t, i);
		if (s == hg && a.length) {
			let n = e.node, r = n.firstChild, i = r && n_(r, t), o;
			if (i) {
				for (let e of a) if (e.tag == i && (!e.attrs || e.attrs(o ||= t_(r, t)))) {
					let t = n.lastChild, i = t.type.id == Tg ? t.from : n.to;
					if (i > r.to) return {
						parser: e.parser,
						overlay: [{
							from: r.to,
		...
		if (o && s == _g) {
			...
			if (r = n.firstChild) {
				...
				if (e) for (let r of e) {
					if (r.tagName && r.tagName != n_(n.parent, t)) continue;
					let e = n.lastChild;
					if (e.type.id == yg) {
...
var a_ = 148, o_ = 1, s_ = 149, c_ = 150, l_ = 2, u_ = 151, d_ = 3, f_ = 4, p_ = [
	...
	8287,
	12288
], m_ = 58, h_ = 40, g_ = 95, __ = 91, v_ = 45, y_ = 46, b_ = 35, x_ = 37, S_ = 38, C_ = 92, w_ = 10, T_ = 42;
function E_(e) {
...
function O_(e) {
	return D_(e) || e >= 97 && e <= 102 || e >= 65 && e <= 70;
}
var k_ = (e, t, n) => (r, i) => {
	for (let a = !1, o = 0, s = 0;; s++) {
		let { next: c } = r;
		if (E_(c) || c == v_ || c == g_ || a && D_(c)) !a && (c != v_ || s > 0) && (a = !0), o === s && c == v_ && o++, r.advance();
		else if (c == C_ && r.peek(1) != w_) {
			if (r.advance(), O_(r.next)) {
				do
					r.advance();
				while (O_(r.next));
				r.next == 32 && r.advance();
			...
			a && r.acceptToken(o == 2 && i.canShift(l_) ? t : c == h_ ? n : e);
			break;
		}
	}
}, A_ = new jh(k_(s_, l_, c_), { contextual: !0 }), j_ = new jh(k_(u_, d_, f_), { contextual: !0 }), M_ = new jh((e) => {
	if (p_.includes(e.peek(-1))) {
		let { next: t } = e;
		(E_(t) || t == g_ || t == b_ || t == y_ || t == T_ || t == __ || t == m_ && E_(e.peek(1)) || t == v_ || t == S_) && e.acceptToken(a_);
	}
}), N_ = new jh((e) => {
	if (!p_.includes(e.peek(-1))) {
		let { next: t } = e;
		if (t == x_ && (e.advance(), e.acceptToken(o_)), E_(t)) {
			do
				e.advance();
			while (E_(e.next) || D_(e.next));
			e.acceptToken(o_);
		}
	}
}), P_ = vl({
	...
	tokenizers: [
		...
		3,
		4,
		new Ah("m~RRYZ[z{a~~g~aO$b~~dP!P!Qg~lO$c~~", 28, 155)
	],
	topRules: {
		StyleSheet: [0, 6],
		Styles: [1, 129]
...
function H_() {
	if (!V_ && typeof document == "object" && document.body) {
...
var X_ = /*@__PURE__*/ new Jc(), Z_ = ["Declaration"];
function Q_(e) {
	for (let t = e;;) {
...
function $_(e, t, n) {
	if (t.to - t.from > 4096) {
		...
		if (o.firstChild()) do
			for (let t of $_(e, o.node, n)) a.has(t.label) || (a.add(t.label), i.push(t));
		while (o.nextSibling());
		return X_.set(t, i), i;
	}
	{
		...
		return t.cursor().iterate((t) => {
			if (n(t) && t.matchContext(Z_) && t.node.nextSibling?.name == ":") {
...
var ev = /*@__PURE__*/ ((e) => (t) => {
	...
	if (e(i) || (t.explicit || a) && Y_(i, n.doc)) return {
		from: e(i) || a ? i.from : r,
		options: $_(n.doc, Q_(i), e),
		validFor: J_
	};
	if (i.name == "TagName") {
...
})((e) => e.name == "VariableName"), tv = /*@__PURE__*/ Gl.define({
	name: "css",
	parser: /*@__PURE__*/ B_.configure({ props: [/*@__PURE__*/ lu.add({ Declaration: /*@__PURE__*/ xu() }), /*@__PURE__*/ Cu.add({ "Block KeyframeList": wu })] }),
	languageData: {
		commentTokens: { block: {
			open: "/*",
			close: "*/"
...
var rv = 316, iv = 317, av = 1, ov = 2, sv = 3, cv = 4, lv = 318, uv = 320, dv = 321, fv = 5, pv = 6, mv = 0, hv = [
	...
	8287,
	12288
], gv = 125, _v = 59, vv = 47, yv = 42, bv = 43, xv = 45, Sv = 60, Cv = 44, wv = 63, Tv = 46, Ev = 91, Dv = new Wh({
	start: !1,
	shift(e, t) {
		return t == fv || t == pv || t == uv ? e : t == dv;
	},
	strict: !1
}), Ov = new jh((e, t) => {
	let { next: n } = e;
	(n == gv || n == -1 || t.context) && e.acceptToken(lv);
}, {
	contextual: !0,
	fallback: !0
}), kv = new jh((e, t) => {
	let { next: n } = e, r;
	hv.indexOf(n) > -1 || (n != vv || (r = e.peek(1)) != vv && r != yv) && n != gv && n != _v && n != -1 && !t.context && e.acceptToken(rv);
}, { contextual: !0 }), Av = new jh((e, t) => {
	e.next == Ev && !t.context && e.acceptToken(iv);
}, { contextual: !0 }), jv = new jh((e, t) => {
	let { next: n } = e;
	if (n == bv || n == xv) {
		if (e.advance(), n == e.next) {
			e.advance();
			let n = !t.context && t.canShift(av);
			e.acceptToken(n ? av : ov);
		}
	} else n == wv && e.peek(1) == Tv && (e.advance(), e.advance(), (e.next < 48 || e.next > 57) && e.acceptToken(sv));
}, { contextual: !0 });
function Mv(e, t) {
	return e >= 65 && e <= 90 || e >= 97 && e <= 122 || e == 95 || e >= 192 || !t && e >= 48 && e <= 57;
}
var Nv = new jh((e, t) => {
	if (e.next != Sv || !t.dialectEnabled(mv) || (e.advance(), e.next == vv)) return;
	let n = 0;
	for (; hv.indexOf(e.next) > -1;) e.advance(), n++;
	if (Mv(e.next, !0)) {
		for (e.advance(), n++; Mv(e.next, !1);) e.advance(), n++;
		for (; hv.indexOf(e.next) > -1;) e.advance(), n++;
		if (e.next == Cv) return;
		for (let t = 0;; t++) {
			if (t == 7) {
				if (!Mv(e.next, !0)) return;
				break;
			}
	...
	tokenizers: [
		...
		14,
		Ov,
		new Ah("$S~RRtu[#O#Pg#S#T#|~_P#o#pb~gOx~~jVO#i!P#i#j!U#j#l!P#l#m!q#m;'S!P;'S;=`#v<%lO!P~!UO!U~~!XS!Q![!e!c!i!e#T#Z!e#o#p#Z~!hR!Q![!q!c!i!q#T#Z!q~!tR!Q![!}!c!i!}#T#Z!}~#QR!Q![!P!c!i!P#T#Z!P~#^R!Q![#g!c!i#g#T#Z#g~#jS!Q![#g!c!i#g#T#Z#g#q#r!P~#yP;=`<%l!P~$RO(c~~", 141, 340),
		new Ah("j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~", 25, 323)
	],
	topRules: {
		Script: [0, 7],
	...
	/*@__PURE__*/ Vp("function ${name}(${params}) {\n	${}\n}", {
		label: "function",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n	${}\n}", {
		label: "for",
		detail: "loop",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("for (let ${name} of ${collection}) {\n	${}\n}", {
		label: "for",
		detail: "of loop",
		type: "keyword"
	}),
	...
	/*@__PURE__*/ Vp("class ${name} {\n	constructor(${params}) {\n		${}\n	}\n}", {
		label: "class",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("import {${names}} from \"${module}\"\n${}", {
		label: "import",
		detail: "named",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("import ${name} from \"${module}\"\n${}", {
		label: "import",
		detail: "default",
		type: "keyword"
	})
], Bv = /*@__PURE__*/ zv.concat([
	/*@__PURE__*/ Vp("interface ${name} {\n	${}\n}", {
		label: "interface",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("type ${name} = ${type}", {
		label: "type",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Vp("enum ${name} {\n	${}\n}", {
		label: "enum",
		detail: "definition",
		type: "keyword"
	})
]), Vv = /*@__PURE__*/ new Jc(), Hv = /*@__PURE__*/ new Set([
	"Script",
	"Block",
	"FunctionExpression",
	"FunctionDeclaration",
...
var Wv = ["FunctionDeclaration"], Gv = {
	FunctionDeclaration: /*@__PURE__*/ Uv("function"),
	ClassDeclaration: /*@__PURE__*/ Uv("class"),
	ClassExpression: () => !0,
	EnumDeclaration: /*@__PURE__*/ Uv("constant"),
	TypeAliasDeclaration: /*@__PURE__*/ Uv("type"),
	NamespaceDeclaration: /*@__PURE__*/ Uv("namespace"),
	VariableDefinition(e, t) {
		e.matchContext(Wv) || t(e, "variable");
	},
	TypeDefinition(e, t) {
		t(e, "type");
	},
...
function Kv(e, t) {
	...
	return t.cursor(G.IncludeAnonymous).iterate((t) => {
		if (i) i = !1;
			...
			let e = Gv[t.name];
			if (e && e(t, a) || Hv.has(t.name)) return !1;
		} else if (t.to - t.from > 8192) {
			for (let n of Kv(e, t.node)) r.push(n);
			return !1;
		}
	}), Vv.set(t, r), r;
}
var qv = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, Jv = [
	"TemplateString",
	"String",
	"RegExp",
	"LineComment",
...
function Yv(e) {
	...
	if (Jv.indexOf(t.name) > -1) return null;
	let n = t.name == "VariableName" || t.to - t.from < 20 && qv.test(e.state.sliceDoc(t.from, t.to));
	if (!n && !e.explicit) return null;
	let r = [];
	for (let n = t; n; n = n.parent) Hv.has(n.name) && (r = r.concat(Kv(e.state.doc, n)));
	return {
		options: r,
		from: n ? t.from : e.pos,
		validFor: qv
...
var Xv = /*@__PURE__*/ Gl.define({
	name: "javascript",
	parser: /*@__PURE__*/ Rv.configure({ props: [/*@__PURE__*/ lu.add({
		IfStatement: /*@__PURE__*/ xu({ except: /^\s*({|else\b)/ }),
		TryStatement: /*@__PURE__*/ xu({ except: /^\s*({|catch\b|finally\b)/ }),
		LabeledStatement: bu,
		SwitchBody: (e) => {
		...
		"Statement Property": /*@__PURE__*/ xu({ except: /^\s*{/ }),
		JSXElement(e) {
		...
		"Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType": wu,
		BlockComment(e) {
			return {
				from: e.from + 2,
				to: e.to - 2
	...
	facet: /*@__PURE__*/ Vl({ commentTokens: { block: {
		open: "{/*",
		close: "*/}"
	} } })
}, Qv = /*@__PURE__*/ Xv.configure({ dialect: "ts" }, "typescript"), $v = /*@__PURE__*/ Xv.configure({
	dialect: "jsx",
	props: [/*@__PURE__*/ Hl.add((e) => e.isTop ? [Zv] : void 0)]
}), ey = /*@__PURE__*/ Xv.configure({
	dialect: "jsx ts",
	props: [/*@__PURE__*/ Hl.add((e) => e.isTop ? [Zv] : void 0)]
}, "typescript"), ty = (e) => ({
	label: e,
	type: "keyword"
}), ny = /*@__PURE__*/ "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield".split(" ").map(ty), ry = /*@__PURE__*/ ny.concat(/*@__PURE__*/ [
	"declare",
	"implements",
	"private",
	"protected",
...
function iy(e = {}) {
	let t = e.jsx ? e.typescript ? ey : $v : e.typescript ? Qv : Xv, n = e.typescript ? Bv.concat(ry) : zv.concat(ny);
	return new tu(t, [
		Xv.data.of({ autocomplete: Sp(Jv, xp(n)) }),
		Xv.data.of({ autocomplete: Yv }),
		e.jsx ? cy : []
	]);
}
function ay(e) {
...
var sy = typeof navigator == "object" && /*@__PURE__*/ /Android\b/.test(navigator.userAgent), cy = /*@__PURE__*/ H.inputHandler.of((e, t, n, r, i) => {
	if ((sy ? e.composing : e.compositionStarted) || e.state.readOnly || t != n || r != ">" && r != "/" || !Xv.isActiveAt(e.state, t, -1)) return !1;
	let a = i(), { state: o } = a, s = o.changeByRange((e) => {
		...
		if (n.name == "JSXStartTag" && (n = n.parent), !(o.doc.sliceString(t - 1, t) != r || n.name == "JSXAttributeValue" && n.to > t)) {
			...
			if (r == "/" && n.name == "JSXStartCloseTag") {
				...
				if (r && e.from == t - 2 && ((i = oy(o.doc, r.firstChild, t)) || r.firstChild?.name == "JSXFragmentTag")) {
					let e = `${i}>`;
					return {
				...
				let r = ay(n);
				if (r && r.name == "JSXOpenTag" && !/^\/?>|^<\//.test(o.doc.sliceString(t, t + 2)) && (i = oy(o.doc, r, t))) return {
					range: e,
					changes: {
						from: t,
						insert: `</${i}>`
	...
	"aria-valuenow": null,
	"aria-valuetext": null
}, gy = /*@__PURE__*/ "beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload".split(" ").map((e) => "on" + e);
for (let e of gy) hy[e] = null;
var _y = class {
	constructor(e, t) {
		this.tags = {
			...my,
...
_y.default = /*@__PURE__*/ new _y();
function vy(e, t, n = e.length) {
	if (!t) return "";
...
function by(e, t, n) {
	return n.tags[vy(e, yy(t))]?.children || n.allTags;
}
function xy(e, t) {
	let n = [];
	for (let r = yy(t); r && !r.type.isTop; r = yy(r.parent)) {
		let i = vy(e, r);
...
function Cy(e, t, n, r, i) {
	let a = /\s*>/.test(e.sliceDoc(i, i + 5)) ? "" : ">", o = yy(n, n.name == "StartTag" || n.name == "TagName");
	return {
		from: r,
		to: i,
		options: by(e.doc, o, t).map((e) => ({
			label: e,
			type: "type"
		})).concat(xy(e.doc, n).map((e, t) => ({
			label: "/" + e,
			apply: "/" + e + a,
			type: "type",
			boost: 99 - t
...
function Ty(e, t, n, r) {
	let i = [], a = 0;
	for (let r of by(e.doc, n, t)) i.push({
		label: "<" + r,
		type: "type"
	});
	for (let t of xy(e.doc, n)) i.push({
		label: "</" + t + ">",
		type: "type",
		boost: 99 - a++
	});
...
function Ey(e, t, n, r, i) {
	let a = yy(n), o = a ? t.tags[vy(e.doc, a)] : null, s = o && o.attrs ? Object.keys(o.attrs) : [];
	return {
		from: r,
		to: i,
...
function Dy(e, t, n, r, i) {
	...
	if (a) {
		...
		if (!l) {
			let r = yy(n), i = r ? t.tags[vy(e.doc, r)] : null;
			l = i?.attrs && i.attrs[c];
		}
		if (l) {
...
function Oy(e, t) {
	...
	return i.name == "TagName" ? i.parent && /CloseTag$/.test(i.parent.name) ? wy(n, i, i.from, r) : Cy(n, e, i, i.from, r) : i.name == "StartTag" || i.name == "IncompleteTag" ? Cy(n, e, i, r, r) : i.name == "StartCloseTag" || i.name == "IncompleteCloseTag" ? wy(n, i, r, r) : i.name == "OpenTag" || i.name == "SelfClosingTag" || i.name == "AttributeName" ? Ey(n, e, i, i.name == "AttributeName" ? i.from : r, r) : i.name == "Is" || i.name == "AttributeValue" || i.name == "UnquotedAttributeValue" ? Dy(n, e, i, i.name == "Is" ? r : i.from, r) : t.explicit && (a.name == "Element" || a.name == "Text" || a.name == "Document") ? Ty(n, e, i, r) : null;
}
function ky(e) {
	return Oy(_y.default, e);
}
function Ay(e) {
	let { extraTags: t, extraGlobalAttributes: n } = e, r = n || t ? new _y(t, n) : _y.default;
	return (e) => Oy(r, e);
}
var jy = /*@__PURE__*/ Xv.parser.configure({ top: "SingleExpression" }), My = [
	{
		tag: "script",
	...
	name: "style",
	parser: /*@__PURE__*/ tv.parser.configure({ top: "Styles" })
}].concat(/*@__PURE__*/ gy.map((e) => ({
	name: e,
	parser: Xv.parser
}))), Py = /*@__PURE__*/ Gl.define({
	name: "html",
	parser: /*@__PURE__*/ e_.configure({ props: [
		/*@__PURE__*/ lu.add({
			Element(e) {
		...
		/*@__PURE__*/ Fu.add({ "OpenTag CloseTag": (e) => e.getChild("TagName") })
	] }),
	languageData: {
		commentTokens: { block: {
			open: "<!--",
...
}), Fy = /*@__PURE__*/ Py.configure({ wrap: /*@__PURE__*/ i_(My, Ny) });
function Iy(e = {}) {
	let t = "", n;
	return e.matchClosingTags === !1 && (t = "noMatch"), e.selfClosingTags === !0 && (t = (t ? t + " " : "") + "selfClosing"), (e.nestedLanguages && e.nestedLanguages.length || e.nestedAttributes && e.nestedAttributes.length) && (n = i_((e.nestedLanguages || []).concat(My), (e.nestedAttributes || []).concat(Ny))), new tu(n ? Py.configure({
		wrap: n,
		dialect: t
	}) : t ? Fy.configure({ dialect: t }) : Fy, [
		Fy.data.of({ autocomplete: Ay(e) }),
		e.autoCloseTags === !1 ? [] : zy,
		iy().support,
		nv().support
	]);
}
var Ly = /*@__PURE__*/ new Set(/*@__PURE__*/ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" "));
function Ry(e, t, n) {
	for (;;) {
		if (t.lastChild?.name != "CloseTag") return !1;
		let r = t.parent;
		if (!r || vy(e, r) != n) return !0;
		t = r;
	}
}
var zy = /*@__PURE__*/ H.inputHandler.of((e, t, n, r, i) => {
	if (e.composing || e.state.readOnly || t != n || r != ">" && r != "/" || !Fy.isActiveAt(e.state, t, -1)) return !1;
	let a = i(), { state: o } = a, s = o.changeByRange((e) => {
		let t = o.doc.sliceString(e.from - 1, e.to) == r, { head: n } = e, i = Y(o).resolveInner(n, -1), a;
		if (t && r == ">" && i.name == "EndTag") {
			let t = i.parent;
			if ((a = vy(o.doc, t.parent, n)) && !Ly.has(a) && !Ry(o.doc, t.parent, a)) return {
				range: e,
				changes: {
					from: n,
			...
			let e = i.parent;
			if (i.from == n - 2 && e.lastChild?.name != "CloseTag" && (a = vy(o.doc, e, n)) && !Ly.has(a)) {
...
}), By = /*@__PURE__*/ Vl({ commentTokens: { block: {
	open: "<!--",
	close: "-->"
} } }), Vy = /*@__PURE__*/ new U(), Hy = /*@__PURE__*/ Xm.configure({ props: [
	/*@__PURE__*/ Cu.add((e) => !e.is("Block") || e.is("Document") || Uy(e) != null || Wy(e) ? void 0 : (e, t) => ({
		from: t.doc.lineAt(e.from).to,
		to: e.to
	})),
	/*@__PURE__*/ Vy.add(Uy),
	/*@__PURE__*/ lu.add({ Document: () => null }),
	/*@__PURE__*/ Bl.add({ Document: By })
] });
function Uy(e) {
...
function Gy(e, t) {
	...
	for (;;) {
		...
		if (!e || (r = Uy(e.type)) != null && r <= t) break;
		n = e;
	}
	return n.to;
}
var Ky = /*@__PURE__*/ Su.of((e, t, n) => {
	for (let r = Y(e).resolveInner(n, -1); r && !(r.from < t); r = r.parent) {
		let e = r.type.prop(Vy);
		if (e == null) continue;
		let t = Gy(r, e);
		if (t > n) return {
			from: n,
...
function qy(e) {
	return new Ul(By, e, [], "markdown");
}
var Jy = /*@__PURE__*/ qy(Hy), Yy = /*@__PURE__*/ qy(/* @__PURE__ */ Hy.configure([
	gh,
	yh,
	vh,
	bh,
	{ props: [/*@__PURE__*/ Cu.add({ Table: (e, t) => ({
		from: t.doc.lineAt(e.from).to,
		to: e.to
	}) })] }
]));
function Xy(e, t) {
	return (n) => {
		if (n && e) {
			let t = null;
			if (n = /\S*/.exec(n)[0], t = typeof e == "function" ? e(n) : nu.matchLanguageName(e, n, !0), t instanceof nu) return t.support ? t.support.language.parser : Jl.getSkippingParser(t.load());
...
var Zy = class {
	...
	marker(e, t) {
		let n = this.node.name == "OrderedList" ? String(+$y(this.item, e)[2] + t) : "";
...
function Qy(e, t) {
	...
	for (let e = n.length - 1; e >= 0; e--) {
		...
		if (i.name == "Blockquote" && (a = /^ *>( ?)/.exec(o.text.slice(s)))) r.push(new Zy(i, s, s + a[0].length, "", a[1], ">", null));
		else if (i.name == "ListItem" && i.parent.name == "OrderedList" && (a = /^( *)\d+([.)])( *)/.exec(o.text.slice(s)))) {
			let e = a[3], t = a[0].length;
			e.length >= 4 && (e = e.slice(0, e.length - 4), t -= 4), r.push(new Zy(i.parent, s, s + t, a[1], e, a[2], i));
			...
			let n = a[2];
			a[3] && (n += a[3].replace(/[xX]/, " ")), r.push(new Zy(i.parent, s, s + t, a[1], e, n, i));
		}
	}
	return r;
}
...
var nb = /*@__PURE__*/ ((e = {}) => ({ state: t, dispatch: n }) => {
	let r = Y(t), { doc: i } = t, a = null, o = t.changeByRange((n) => {
		if (!n.empty || !Yy.isActiveAt(t, n.from, -1) && !Yy.isActiveAt(t, n.from, 1)) return a = { range: n };
		let o = n.from, s = i.lineAt(o), c = Qy(r.resolveInner(o, -1), i);
		...
		if (l.item && u) {
			...
			if (r.to >= o || u && u.to < o || s.from > 0 && !/[^\s>]/.test(i.lineAt(s.from - 1).text) || e.nonTightLists === !1) {
				...
				return l.node.name == "OrderedList" && eb(l.item, i, r, -2), e && e.node.name == "OrderedList" && eb(e.item, i, r), {
		...
		let d = [];
		l.node.name == "OrderedList" && eb(l.item, i, d);
		let f = l.item && l.item.from < s.from, p = "";
		if (!f || /^[\s\d.)\-+*>]*/.exec(s.text)[0].length >= l.to) for (let e = 0, t = c.length - 1; e <= t; e++) p += e == t && !f ? c[e].marker(i, 1) : c[e].blank(e < t ? qt(s.text, 4, c[e + 1].from) - p.length : null);
		let m = o;
		for (; m > s.from && /\s/.test(s.text.charAt(m - s.from - 1));) m--;
		return p = tb(p, t), ib(l.node, t.doc) && (p = ab(c, t, s) + t.lineBreak + p), d.push({
			from: m,
			to: o,
...
function ab(e, t, n) {
	let r = "";
	for (let t = 0, i = e.length - 2; t <= i; t++) r += e[t].blank(t < i ? qt(n.text, 4, e[t + 1].from) - r.length : null, t < i);
	return tb(r, t);
}
function ob(e, t) {
	let n = e.resolveInner(t, -1), r = t;
	rb(n) && (r = n.from, n = n.parent);
	for (let e; e = n.childBefore(r);) if (rb(e)) r = e.from;
...
var sb = [{
	...
	run: ({ state: e, dispatch: t }) => {
		let n = Y(e), r = null, i = e.changeByRange((t) => {
			...
			if (t.empty && Yy.isActiveAt(e, t.from)) {
				let t = a.lineAt(i), r = Qy(ob(n, i), a);
				if (r.length) {
					...
					if (i - t.from == a && (n.item && t.from <= n.item.from || /^[\s>]*$/.test(t.text.slice(0, n.to)))) {
						...
						if (n.item && n.node.from < n.item.from && /\S/.test(t.text.slice(n.from, n.to))) {
							let i = n.blank(qt(t.text, 4, n.to) - qt(t.text, 4, n.from));
							return r == t.from && (i = tb(i, e)), {
...
}], cb = /*@__PURE__*/ Iy({ matchClosingTags: !1 });
function lb(e = {}) {
	let { codeLanguages: t, defaultCodeLanguage: n, addKeymap: r = !0, base: { parser: i } = Jy, completeHTMLTags: a = !0, pasteURLAsLink: o = !0, htmlTagLanguage: s = cb } = e;
	if (!(i instanceof Cm)) throw RangeError("Base parser provided to `markdown` should be a Markdown parser");
	let c = e.extensions ? [e.extensions] : [], l = [s.support, Ky], u;
	o && l.push(mb), n instanceof tu ? (l.push(n.support), u = n.language) : n && (u = n);
	let d = t || u ? Xy(t, u) : void 0;
	c.push(Qm({
		codeParser: d,
		htmlParser: s.language.parser
	})), r && l.push(Qe.high(cs.of(sb)));
	let f = qy(i.configure(c));
	return a && l.push(f.data.of({ autocomplete: ub })), new tu(f, l);
}
function ub(e) {
...
function fb() {
	if (db) return db;
	let e = ky(new vp(A.create({ extensions: cb }), 0, !0));
	return db = e ? e.options : [];
}
var pb = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, mb = /*@__PURE__*/ H.domEventHandlers({ paste: (e, t) => {
	let { main: n } = t.state.selection;
	if (n.empty) return !1;
	let r = e.clipboardData?.getData("text/plain");
	if (!r || !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(r) || (/^www\./.test(r) && (r = "https://" + r), !Yy.isActiveAt(t.state, n.from, 1))) return !1;
	let i = Y(t.state), a = !1;
	return i.iterate({
		from: n.from,
		to: n.to,
		enter: (e) => {
			(e.from > n.from || pb.test(e.name)) && (a = !0);
		},
		leave: (e) => {
			e.to < n.to && (a = !0);
		}
...
function Sb(c, v) {
	...
	let ce = O.define(), le = Ye.define({
		...
		update(e, t) {
			...
			for (let e of t.effects) e.is(ce) && (n = e.value);
			return n;
		},
		provide: (e) => H.decorations.from(e, ue)
	});
	function ue(e) {
			...
			state: A.create({
				...
				extensions: [
					...
					H.contentAttributes.of({
						spellcheck: "true",
						"aria-label": `Markdown editor for ${v.file.path}`
					}),
	...
	async function Fe() {
		if (!(i(be) || !i(we))) {
			...
			try {
				...
				f(be, !1), queueMicrotask(v.onIconsChanged);
			}
		}
	}
	function Ie() {
	...
	async function Le() {
		...
		try {
			if (navigator.clipboard?.writeText) {
				await navigator.clipboard.writeText(e), v.onToast("Annotations copied to the clipboard.");
				return;
			}
		} catch {}
		let t = document.createElement("textarea");
		t.value = e, t.setAttribute("readonly", ""), t.style.position = "fixed", t.style.opacity = "0", document.body.appendChild(t), t.select();
		let n = typeof document.execCommand == "function" && document.execCommand("copy");
		if (t.remove(), n) {
			v.onToast("Annotations copied to the clipboard.");
			return;
		}
