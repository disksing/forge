...
var Qd = /* @__PURE__ */ H("<div class=\"file-modal-empty\"><!><strong>Loading diff</strong><span> </span></div>"), $d = /* @__PURE__ */ H("<div class=\"file-modal-empty error-preview\"><!><strong>Diff unavailable</strong><span> </span></div>"), ef = /* @__PURE__ */ H("<div class=\"file-modal-empty\"><!><strong>No changes</strong><span>This worktree has no diff to show.</span></div>"), tf = /* @__PURE__ */ H("<div class=\"diff-viewer\"></div>"), nf = /* @__PURE__ */ H("<div class=\"diff-modal-layer\" role=\"presentation\"><button class=\"file-modal-backdrop modal-enter\" type=\"button\" aria-label=\"Close worktree diff\"></button> <div class=\"diff-modal modal-enter\" role=\"dialog\" aria-modal=\"true\" aria-label=\"Worktree diff\"><header class=\"file-modal-header diff-modal-header\"><div><strong> </strong><span> </span></div><button class=\"icon-button\" type=\"button\" title=\"Close\" aria-label=\"Close\"><!></button></header> <!></div></div>");
function rf(e, t) {
	We(t, !0);
...
var Mf = /* @__PURE__ */ H("<a class=\"markdown-open-file\" target=\"_blank\" rel=\"noopener\" title=\"Open file in new window\"><!><span>Open</span></a>"), Nf = /* @__PURE__ */ H("<div class=\"markdown-preview\"><div class=\"markdown-view markdown-rendered\"></div></div>"), Pf = /* @__PURE__ */ H("<pre class=\"markdown-view\"> </pre>"), Ff = /* @__PURE__ */ H("<div class=\"content-section\"><h3><!><span> </span> <!></h3> <!></div>");
function If(e, t) {
	We(t, !0);
