...
function J(t, n, i, a, o, s = null) {
	...
	var v = {
		effect: En(() => {
			...
			if (e === 0 && s && !d && (h ? d = Dn(() => s(c)) : (d = Dn(() => s(Hr ??= sn())), d.f |= w)), e > r.size && me("", "", ""), D && e > 0 && Pe(Ie()), !h) {
				if (m.set(u, r), v) {
...
function Si(e, t, n = t) {
	...
	st(e, "input", async (i) => {
		...
		if (a = wi(e) ? Ti(a) : a, n(a), P !== null && r.add(P), await lr(), a !== (a = t())) {
	...
	}), (D && e.defaultValue !== e.value || fr(t) == null && e.value) && (n(wi(e) ? Ti(e.value) : e.value), P !== null && r.add(P)), Tn(() => {
		var n = t();
		if (e === document.activeElement) {
			var i = P;
			if (r.has(i)) return;
...
function Pi(e, t) {
	...
	var r = Ar(), i = un(r), a = (e) => {
		...
		J(r, 21, () => t.status.statuses, (e) => e.key, (e, t) => {
			...
			}), k(n), z(() => ai(n, 1, `task-status-indicator ${H(t).className} ${H(t).recentOutput ? "task-status-fresh" : ""}`)), G(e, n);
		}), k(r), z(() => ai(r, 1, `task-status-slot ${n()} ${t.status.slotClassName}`)), G(e, r);
	};
	q(i, (e) => {
...
function zi(e, t) {
	...
	bn(() => {
		t.identity !== H(i) && (I(i, t.identity, !0), u());
	});
	function a(e) {
	...
	function s(e, i) {
		e.stopPropagation(), I(n, {
			...
			id: i,
			projectId: ""
		}, !0), I(r, null), t.onDragState(H(n)), e.dataTransfer && (e.dataTransfer.effectAllowed = "move", e.dataTransfer.setData("text/plain", i));
	}
	function c(e, t) {
	...
	var p = Ri(), m = R(L(p), 2), h = L(m), g = (e) => {
		var t = Fi();
		X(L(t), { name: "message-square" }), A(), k(t), G(e, t);
	}, _ = (e) => {
		var r = Ar();
		J(un(r), 17, () => t.sessions, (e) => e.id, (e, t) => {
			var r = Li(), i = L(r);
			Pi(i, {
				get status() {
					return H(t).status;
...
function ea(e, t) {
	...
	var p = $i(), m = L(p), h = R(L(m));
	X(L(h), { name: "plus" }), k(h), k(m);
	var g = R(m, 2), _ = L(g), v = (e) => {
		var t = Ki();
		X(L(t), {
			name: "loader-circle",
		...
		J(un(r), 17, () => t.projects, (e) => e.id, (e, t) => {
			var r = Qi(), i = un(r), s = L(i), p = L(s), m = (e) => {
				{
	...
	}), k(g), k(p), z(() => Y(g, "data-navigation-identity", t.identity)), U("click", h, function(...e) {
...
function oa(e, t) {
	...
	var s = aa(), c = L(s), l = L(c), u = L(l), d = L(u);
	k(u);
	var f = R(u, 2), p = L(f, !0);
	k(f);
	var m = R(f, 2);
...
function ca(e, t) {
	...
	var S = R(y, 2), C = L(S), w = L(C), T = R(w, 2);
	k(C);
	var E = R(C, 2);
	Vi(L(E), {
		get preference() {
	...
	var ee = R(S, 2), te = L(ee), ne = (e) => {
		var n = Ar();
		Yr(un(n), () => t.details), G(e, n);
	};
	q(te, (e) => {
		t.details && e(ne);
	}), k(ee);
	...
	var ie = R(re, 2), ae = L(ie), oe = L(ae), se = L(oe), ce = (e) => {
		var n = Ar();
		Yr(un(n), () => t.timeline), G(e, n);
	};
	q(se, (e) => {
		t.timeline && e(ce);
	}), k(oe);
	var le = R(oe), ue = L(le), de = (e) => {
		var n = Ar();
		Yr(un(n), () => t.composer), G(e, n);
	};
	q(ue, (e) => {
		t.composer && e(de);
	}), k(le), k(ae), k(ie), k(v), k(i), z(() => {
	...
	}), U("click", b, () => H(n).onMobileSidebar(!0)), U("click", w, () => H(n).onMobileView("details")), U("click", T, () => H(n).onMobileView("chat")), G(e, i), M();
}
Sr(["click"]);
//#endregion
//#region src/components/AgentBindingSelector.svelte
var la = /* @__PURE__ */ W("<button type=\"button\" class=\"agent-binding-option\" role=\"option\"><span class=\"agent-binding-option-label\"> </span> <!></button>"), ua = /* @__PURE__ */ W("<div class=\"agent-binding-group\" role=\"group\" aria-label=\"Profiles\"><div class=\"agent-binding-group-title\">Profiles</div> <!></div>"), da = /* @__PURE__ */ W("<div class=\"agent-binding-group\" role=\"group\" aria-label=\"Agents\"><div class=\"agent-binding-group-title\">Agents</div> <!></div>"), fa = /* @__PURE__ */ W("<div class=\"agent-binding-menu\" role=\"listbox\" tabindex=\"-1\"><!> <!></div>"), pa = /* @__PURE__ */ W("<span class=\"agent-binding\"><button type=\"button\" class=\"agent-binding-button\" aria-haspopup=\"listbox\"><span class=\"agent-binding-label\"> </span> <!></button> <!></span>");
function ma(e, t) {
	j(t, !0);
	let n = Oi(t, "disabled", 3, !1), r = Oi(t, "ariaLabel", 3, "Agent binding"), i = /* @__PURE__ */ N(p), a = /* @__PURE__ */ N(m), o = /* @__PURE__ */ N(() => h(t.value)), s = /* @__PURE__ */ N(() => [...H(i), ...H(a)].find((e) => h(e.value) === H(o))?.label || t.value.name || "Unavailable"), c = /* @__PURE__ */ F(!1), l = /* @__PURE__ */ F(void 0), u = /* @__PURE__ */ F(void 0);
	bn(() => {
		if (!H(c) || !H(u)) return;
	...
	function f(e) {
		return t.agents.find((t) => d(t.id) === d(e))?.label || e || "Unavailable";
	}
	function p() {
		let e = t.profiles.map((e) => ({
			...
			label: `${e.key} (current: ${f(e.agentName || "")})`
		}));
		return t.value.kind === "profile" && !t.profiles.some((e) => d(e.key) === d(t.value.name)) && e.unshift({
			value: t.value,
	...
	function m() {
		let e = t.agents.map((e) => {
			let n = t.profiles.filter((t) => d(t.agentName || "") === d(e.id)).map((e) => e.key);
			return {
				value: {
					kind: "agent",
					name: e.id
		...
		return t.value.kind === "agent" && !t.agents.some((e) => d(e.id) === d(t.value.name)) && e.unshift({
			value: t.value,
	...
	function g(e) {
		I(c, !1), h(e.value) !== H(o) && t.onSelect(e.value);
	}
	function _(e) {
		e.key === "Escape" && (e.stopPropagation(), I(c, !1));
	}
	var v = pa(), y = L(v), b = L(y), x = L(b, !0);
	k(b), X(R(b, 2), {
	...
	var S = R(y, 2), C = (e) => {
		var t = fa(), n = L(t), s = (e) => {
			var t = ua();
			J(R(L(t), 2), 17, () => H(i), (e) => h(e.value), (e, t) => {
				...
				}, c = /* @__PURE__ */ N(() => h(H(t).value) === H(o));
				q(a, (e) => {
					H(c) && e(s);
				}), k(n), z((e, r) => {
					Y(n, "aria-selected", e), Y(n, "data-binding", r), K(i, H(t).label);
				}, [() => h(H(t).value) === H(o), () => h(H(t).value)]), U("click", n, () => g(H(t))), G(e, n);
			}), k(t), G(e, t);
		};
		q(n, (e) => {
			H(i).length && e(s);
		...
		var c = R(n, 2), l = (e) => {
			var t = da();
			J(R(L(t), 2), 17, () => H(a), (e) => h(e.value), (e, t) => {
				var n = la(), r = L(n), i = L(r, !0);
				k(r);
				var a = R(r, 2), s = (e) => {
					X(e, {
		...
		q(c, (e) => {
			H(a).length && e(l);
		}), k(t), Di(t, (e) => I(u, e), () => H(u)), z(() => Y(t, "aria-label", r())), U("keydown", t, _), G(e, t);
	};
	q(S, (e) => {
		H(c) && e(C);
	}), k(v), Di(v, (e) => I(l, e), () => H(l)), z(() => {
		y.disabled = n(), Y(y, "aria-expanded", H(c)), Y(y, "aria-label", r()), K(x, H(s));
	}), U("click", y, () => {
		I(c, !H(c));
	}), G(e, v), M();
}
...
var ha = /* @__PURE__ */ W("<div class=\"tty-message-item\"><span class=\"tty-message-text\"> </span> <span class=\"tty-message-mode\"> </span> <button type=\"button\" class=\"tty-message-steer\"><!> <span>Insert now</span></button></div>"), ga = /* @__PURE__ */ W("<div class=\"tty-message-queue-error\" role=\"alert\"> </div>"), _a = /* @__PURE__ */ W("<section class=\"tty-message-queue\" aria-label=\"Waiting messages\"><div class=\"tty-message-queue-header\"><span>Waiting messages</span><span class=\"tty-message-count\"> </span></div> <div class=\"tty-message-list\"></div> <!></section>"), va = /* @__PURE__ */ W("<button type=\"button\" id=\"agentEndTurnButton\" class=\"tty-composer-action tty-end-turn-button\" title=\"End current turn\" aria-label=\"End current turn\"><!></button>"), ya = /* @__PURE__ */ W("<div class=\"tty-composer-error\" role=\"alert\"><span> </span><button type=\"button\" class=\"secondary-button\">Retry</button></div>"), ba = /* @__PURE__ */ W("<!> <form id=\"ttyForm\" class=\"tty-input\"><textarea id=\"ttyInput\" rows=\"1\" autocomplete=\"off\"></textarea> <div class=\"tty-composer-bar\"><button type=\"button\" id=\"agentUploadButton\" class=\"tty-upload-button\" title=\"Upload files\" aria-label=\"Upload files\"><!></button> <div class=\"tty-composer-options\"><span class=\"tty-agent-binding\"><!></span> <!> <button type=\"submit\" class=\"tty-send-button\"><!></button></div></div></form> <!>", 1);
function xa(e, t) {
	j(t, !0);
...
var Sa = /* @__PURE__ */ W("<div class=\"project-create-form\" data-component-owner=\"project-create-form\"><textarea name=\"description\" required=\"\" placeholder=\"Describe the project\"></textarea> <input name=\"slug\" placeholder=\"optional-slug\"/></div>");
function Ca(e, t) {
	j(t, !0);
	let n = Oi(t, "draft", 7);
	var r = Sa(), i = L(r);
...
var wa = /* @__PURE__ */ W("<button type=\"button\" class=\"secondary compact\"> </button>"), Ta = /* @__PURE__ */ W("<p class=\"create-task-preview-error\" role=\"alert\"> </p>"), Ea = /* @__PURE__ */ W("<p class=\"create-task-preview-hint\">Updating preview...</p>"), Da = /* @__PURE__ */ W("<div class=\"template-preview-actions\" data-preview-edited-note=\"\"><small>Modified — the task will be created with this edited content instead of the template output.</small> <button type=\"button\" class=\"secondary compact\">Reset edits</button></div>"), Oa = /* @__PURE__ */ W("<small data-preview-edit-hint=\"\">Edit the content above to override the template output for this task.</small>"), ka = /* @__PURE__ */ W("<small> </small>"), Aa = /* @__PURE__ */ W("<section class=\"template-preview\" aria-label=\"Rendered task content\"><h4> </h4> <textarea name=\"previewMarkdown\" class=\"create-task-preview-editor\" aria-label=\"Task markdown\" spellcheck=\"false\"></textarea> <!> <!> <!></section>"), ja = /* @__PURE__ */ W("<p class=\"create-task-preview-hint\">Rendering preview...</p>"), Ma = /* @__PURE__ */ W("<p class=\"create-task-preview-hint\">Fill in the template fields and the preview renders automatically.</p>"), Na = /* @__PURE__ */ W("<!> <!> <!>", 1), Pa = /* @__PURE__ */ W("<p class=\"create-task-blank-detail\"> </p>"), Fa = /* @__PURE__ */ W("<p class=\"create-task-preview-hint\">Write the task detail and the preview updates as you type.</p>"), Ia = /* @__PURE__ */ W("<section class=\"template-preview create-task-blank-preview\" aria-label=\"Task content preview\"><h4> </h4> <!> <!></section>"), La = /* @__PURE__ */ W("<aside class=\"create-task-preview-col\" aria-label=\"Task preview\" data-component-owner=\"task-preview\"><div class=\"create-section-title create-preview-title\"><span>Task preview</span> <!></div> <!></aside>");
function Ra(e, t) {
	j(t, !0);
	let n = Oi(t, "draft", 7), r = /* @__PURE__ */ F(Qt(n().editedMarkdown ?? "")), i = null, a = /* @__PURE__ */ N(() => !!t.preview && H(r) !== t.preview?.markdown);
	bn(() => {
...
var za = /* @__PURE__ */ W("<input type=\"checkbox\"/><span> </span>", 1), Ba = /* @__PURE__ */ W("<span> </span>"), Va = /* @__PURE__ */ W("<textarea></textarea>"), Ha = /* @__PURE__ */ W("<option> </option>"), Ua = /* @__PURE__ */ W("<select><option>Select...</option><!></select>"), Wa = /* @__PURE__ */ W("<input/>"), Ga = /* @__PURE__ */ W("<small> </small>"), Ka = /* @__PURE__ */ W("<label><!> <!> <!> <!> <!></label>"), qa = /* @__PURE__ */ W("<div class=\"template-fields\" data-component-owner=\"template-field-group\"></div>");
function Ja(e, t) {
	j(t, !0);
	function n(e, n) {
...
var $a = /* @__PURE__ */ W("<small>(generated by template)</small>"), eo = /* @__PURE__ */ W("<small class=\"create-required\">*</small>"), to = /* @__PURE__ */ W("<button type=\"button\" class=\"secondary compact\">Use generated</button>"), no = /* @__PURE__ */ W("<section class=\"create-section create-template-fields\" aria-label=\"Template fields\"><div class=\"create-section-title\">Template fields</div> <!> <!></section>"), ro = /* @__PURE__ */ W("<section class=\"create-section create-task-details\" aria-label=\"Details\"><div class=\"create-section-title\">Details</div> <textarea name=\"detail\" placeholder=\"Task detail\"></textarea></section>"), io = /* @__PURE__ */ W("<div class=\"create-task-split\" data-component-owner=\"task-create-form\"><div class=\"create-task-form-col\"><!> <section class=\"create-section create-task-basic\" aria-label=\"Basic information\"><div class=\"create-section-title\">Basic information</div> <div class=\"create-title-slug-row\"><label><span>Task title <!></span> <span class=\"template-title-control\"><input name=\"title\"/> <!></span></label> <label class=\"create-task-slug-field\"><span>Slug <small>(optional)</small></span> <span class=\"create-task-slug-wrap\"><span class=\"create-task-slug-prefix\" aria-hidden=\"true\">#</span> <input name=\"slug\" placeholder=\"optional-slug\"/></span></label></div></section> <!></div> <!></div>");
function ao(e, t) {
	j(t, !0);
	...
	var le = R(S, 2), ue = (e) => {
		...
		var t = ro(), r = R(L(t), 2);
		rt(r), k(t), z(() => _i(r, n().detail)), U("input", r, (e) => n().detail = e.currentTarget.value), G(e, t);
	};
	q(le, (e) => {
		H(i) ? e(ue) : e(de, -1);
	}), k(y), Ra(R(y, 2), {
...
function co(e, t) {
	...
	var l = Ar(), u = un(l), d = (e) => {
		...
		k(b);
		var S = R(b, 2);
		k(y), k(_), k(s), Di(s, (e) => I(a, e), () => H(a)), k(t), z(() => {
...
var go = /* @__PURE__ */ W("<div class=\"file-modal-empty\"><!><strong>Loading diff</strong><span> </span></div>"), _o = /* @__PURE__ */ W("<div class=\"file-modal-empty error-preview\"><!><strong>Diff unavailable</strong><span> </span></div>"), vo = /* @__PURE__ */ W("<div class=\"file-modal-empty\"><!><strong>No changes</strong><span>This worktree has no diff to show.</span></div>"), yo = /* @__PURE__ */ W("<div class=\"diff-viewer\"></div>"), bo = /* @__PURE__ */ W("<div class=\"diff-modal-layer\" data-component-owner=\"diff-modal\" role=\"presentation\"><button class=\"file-modal-backdrop modal-enter\" type=\"button\" aria-label=\"Close worktree diff\"></button> <div class=\"diff-modal modal-enter\" role=\"dialog\" aria-modal=\"true\" aria-label=\"Worktree diff\"><header class=\"file-modal-header diff-modal-header\"><div><strong> </strong><span> </span></div><button class=\"icon-button\" type=\"button\" title=\"Close\" aria-label=\"Close\"><!></button></header> <!></div></div>");
function xo(e, t) {
	j(t, !0);
...
function Co(e) {
	return window.marked && window.DOMPurify ? (window.marked.setOptions({
		breaks: !0,
		gfm: !0
	}), window.DOMPurify.sanitize(window.marked.parse(String(e ?? "")))) : `<pre>${ko(e)}</pre>`;
}
function wo(e) {
	let t = "", n = 0;
	for (; n < e.length;) {
...
function Oo(e, t, n, r = 0) {
	...
	for (let a of e || []) i.push({
		entry: a,
		depth: r
	}), a.type === "directory" && t.has(`${n}:${a.path}`) && i.push(...Oo(a.children || [], t, n, r + 1));
	return i;
}
function ko(e) {
...
var Ao = /* @__PURE__ */ W("<h3><!><span> </span></h3>"), jo = /* @__PURE__ */ W("<a class=\"artifact-download\"><!></a>"), Mo = /* @__PURE__ */ W("<div class=\"artifact-node\"><button type=\"button\"><span class=\"artifact-main\"><span class=\"artifact-chevron\"><!></span><!><span class=\"artifact-name\"> </span></span> <span class=\"artifact-side\"><!><small> </small></span></button></div>"), No = /* @__PURE__ */ W("<div class=\"empty-list-row\"><!><span> </span></div>"), Po = /* @__PURE__ */ W("<div class=\"content-section\" data-component-owner=\"file-browser\"><!> <div class=\"artifact-browser\"><div class=\"artifact-tree\" role=\"tree\"><!></div></div></div>");
function Fo(e, t) {
	j(t, !0);
	let n = Oi(t, "entries", 19, () => []), r = Oi(t, "emptyMessage", 3, "No files."), i = Oi(t, "activePath", 3, ""), a = Oi(t, "showHeading", 3, !0), o = /* @__PURE__ */ N(() => Oo(n(), t.expanded, t.title)), s = /* @__PURE__ */ N(() => t.title === "Wiki" ? "book-open" : "paperclip");
	function c(e) {
	...
	var f = R(u, 2), p = L(f), m = L(p), h = (e) => {
		...
		J(un(n), 17, () => H(o), (e) => `${t.title}:${e.entry.path}`, (e, n) => {
			...
			}, [() => H(r) ? `${(H(n).entry.children || []).length} items` : Do(H(n).entry.size || 0)]), U("click", s, () => H(r) ? t.onToggle(`${t.title}:${H(n).entry.path}`) : t.onPreview(t.title, H(n).entry.path)), G(e, o);
		}), G(e, n);
	}, g = (e) => {
		var n = No(), i = L(n);
		{
...
var Io = /* @__PURE__ */ W("<div class=\"file-modal-empty\"><!><strong>Loading preview</strong><span> </span></div>"), Lo = /* @__PURE__ */ W("<div class=\"file-modal-empty error-preview\"><!><strong>Preview unavailable</strong><span> </span></div>"), Ro = /* @__PURE__ */ W("<div class=\"image-preview\" data-preview-scroll=\"\"><img/></div>"), zo = /* @__PURE__ */ W("<div class=\"file-modal-empty\"><!><strong> </strong><span> </span></div>"), Bo = /* @__PURE__ */ W("<div class=\"modal-markdown markdown-rendered\" data-preview-scroll=\"\"></div>"), Vo = /* @__PURE__ */ W("<pre class=\"modal-preview-content\" data-preview-scroll=\"\"> </pre>"), Ho = /* @__PURE__ */ W("<div class=\"file-modal-layer\" data-component-owner=\"file-preview-modal\" role=\"presentation\"><button class=\"file-modal-backdrop modal-enter\" type=\"button\" aria-label=\"Close file preview\"></button> <div class=\"file-modal modal-enter\" role=\"dialog\" aria-modal=\"true\" aria-label=\"File preview\"><header class=\"file-modal-header\"><div><strong> </strong><span> </span></div><div class=\"file-modal-actions\"><a class=\"secondary-button file-modal-open\" target=\"_blank\" rel=\"noopener\" title=\"Open file in new window\"><!><span>Open</span></a><button class=\"icon-button\" type=\"button\" title=\"Close\" aria-label=\"Close\"><!></button></div></header> <!></div></div>");
function Uo(e, t) {
	j(t, !0);
	...
	var s = Ar(), c = un(s), l = (e) => {
		var a = Ho(), s = L(a), c = R(s, 2), l = L(c), u = L(l), d = L(u), f = L(d, !0);
		k(d);
		var p = R(d), m = L(p);
		k(p), k(u);
		var h = R(u), g = L(h);
		...
		var v = R(l, 2), y = (e) => {
			...
			var t = Bo();
			Jr(t, () => Co(H(n)?.content || ""), !0), k(t), G(e, t);
		}, w = /* @__PURE__ */ N(() => So(H(n)?.path || t.selection.path)), T = (e) => {
			var t = Vo(), r = L(t, !0);
		...
		}, [() => H(n)?.name || t.selection.path.split("/").pop() || "File preview", () => H(n)?.size == null ? "" : ` · ${Do(H(n).size)}`]), U("click", s, function(...e) {
			t.onClose?.apply(this, e);
...
var Wo = /* @__PURE__ */ W("<div class=\"markdown-rendered\"></div>"), Go = /* @__PURE__ */ W("<details class=\"log-entry\"><summary><span class=\"log-time\"><strong> </strong><small> </small></span> <span class=\"log-title\"> </span> <span class=\"log-chevron\" aria-hidden=\"true\"><!></span></summary> <div><!></div></details>"), Ko = /* @__PURE__ */ W("<p class=\"log-load-error\" role=\"alert\"> </p>"), qo = /* @__PURE__ */ W("<div class=\"log-load-actions\"><button type=\"button\" class=\"secondary-button log-load-more\"><!><span> </span></button></div>"), Jo = /* @__PURE__ */ W("<div class=\"content-section\" data-component-owner=\"log-timeline\"><div class=\"log-timeline\"></div> <!> <!></div>");
function Yo(e, t) {
	j(t, !0);
	let n = /* @__PURE__ */ N(() => [...t.logs || []].sort(To)), r = /* @__PURE__ */ F(!1);
	async function i() {
		if (!(t.loading || H(r))) {
			I(r, !0);
			try {
	...
	var a = Ar(), o = un(a), s = (e) => {
		...
		J(o, 21, () => H(n), (e) => e.id, (e, t) => {
			var n = Go(), r = L(n), i = L(r), a = L(i), o = L(a, !0);
			k(a);
			var s = R(a), c = L(s, !0);
			k(s), k(i);
			var l = R(i, 2), u = L(l, !0);
			...
			var m = L(f), h = (e) => {
				var n = Wo();
				Jr(n, () => Co(H(t).details), !0), k(n), G(e, n);
			}, g = (e) => {
				G(e, kr("No details."));
			};
			q(m, (e) => {
...
var Xo = /* @__PURE__ */ W("<div class=\"markdown-preview\"><div class=\"markdown-view markdown-rendered\"></div></div>"), Zo = /* @__PURE__ */ W("<pre class=\"markdown-view\"> </pre>"), Qo = /* @__PURE__ */ W("<div class=\"content-section\" data-component-owner=\"markdown-document\"><!></div>");
function $o(e, t) {
	j(t, !0);
	let n = /* @__PURE__ */ N(() => So(t.file.name));
	var r = Qo(), i = L(r), a = (e) => {
		var n = Xo(), r = L(n);
		Jr(r, () => Co(t.file.content || ""), !0), k(r), k(n), G(e, n);
	}, o = (e) => {
		var n = Zo(), r = L(n, !0);
...
function is(e, t) {
	...
	var m = rs(), h = un(m), g = R(L(h), 2), _ = L(g);
	gi(_), A(), k(g);
	var v = R(g, 2);
	...
	}, [() => H(c) || !H(i).trim() || !H(a).trim() || !H(o).trim()]), Si(_, () => H(s), (e) => I(s, e)), U("click", v, p), Si(ee, () => H(i), (e) => I(i, e)), Si(ne, () => H(a), (e) => I(a, e)), Si(ie, () => H(o), (e) => I(o, e)), U("click", ae, d), G(e, m), M();
}
Sr(["click"]);
//#endregion
//#region src/components/WorkspaceAgentsEditor.svelte
var as = /* @__PURE__ */ W("<div class=\"empty-state\"><!><strong>Loading AGENTS.md...</strong></div>"), os = /* @__PURE__ */ W("<div class=\"file-modal-empty error-preview\"><!><strong>AGENTS.md unavailable</strong><span> </span></div>"), ss = /* @__PURE__ */ W("<p class=\"log-load-error\" role=\"alert\">AGENTS.md changed on disk while you were editing. Your draft is preserved; saving now will report a conflict.</p>"), cs = /* @__PURE__ */ W("<p class=\"log-load-error\" role=\"alert\"> </p>"), ls = /* @__PURE__ */ W("<form id=\"workspaceAgentsForm\" class=\"details-form workspace-agents-form\"><textarea id=\"workspaceAgentsContent\" rows=\"10\" spellcheck=\"false\"></textarea> <!> <!> <div class=\"form-actions\"><button type=\"submit\"><!><span> </span></button></div></form>"), us = /* @__PURE__ */ W("<div class=\"content-section\" data-component-owner=\"workspace-agents-editor\"><h3><!><span>Workspace AGENTS.md</span></h3> <!></div>");
function ds(e, t) {
	j(t, !0);
	...
	async function d(e) {
		...
		try {
			...
			if (H(n) !== u) return;
			I(i, wo(e.content || H(r)), !0), I(r, H(i), !0), I(a, e.contentHash || "", !0), I(o, H(a), !0), t.onToast("Workspace AGENTS.md saved.");
		} catch (e) {
	...
	var m = R(p, 2), h = (e) => {
		...
		}), xr("submit", t, d), Si(n, () => H(r), (e) => I(r, e)), G(e, t);
	};
	q(m, (e) => {
...
var fs = /* @__PURE__ */ W("<div id=\"detailsContent\" class=\"details-content\"><div class=\"empty-state\"><!><strong>No workspace selected</strong><span>Add an AgentWorkspace path in the sidebar.</span></div></div>"), ps = /* @__PURE__ */ W("<div class=\"content-section\"><h3><!><span>Wiki</span></h3><div class=\"file-modal-empty error-preview wiki-status\"><!><strong>Wiki unavailable</strong><span> </span></div></div>"), ms = /* @__PURE__ */ W("<div class=\"content-section\"><h3><!><span>Wiki</span></h3><div class=\"file-modal-empty wiki-status\"><!><strong>Wiki not initialized</strong><span>Run forge migrate to create wiki/index.md.</span></div></div>"), hs = /* @__PURE__ */ W("<div class=\"details-header\"><nav class=\"breadcrumb\" aria-label=\"Location\"><button type=\"button\" class=\"breadcrumb-link current\"> </button></nav><div class=\"title-row\"><h1> <span class=\"resource-creator-badge\"> </span></h1></div></div> <div id=\"detailsContent\" class=\"details-content\"><!> <!></div>", 1), gs = /* @__PURE__ */ W("<span class=\"breadcrumb-separator\">/</span><button type=\"button\" class=\"breadcrumb-link\"> </button>", 1), _s = /* @__PURE__ */ W("<code class=\"resource-ref-badge\"> </code>"), vs = /* @__PURE__ */ W("<button type=\"button\" id=\"newTaskButton\"><!><span>New Task</span></button>"), ys = /* @__PURE__ */ W("<button type=\"button\" class=\"danger\" id=\"archiveButton\"><!><span>Archive</span></button>"), bs = /* @__PURE__ */ W("<div class=\"details-actions\"><!><!></div>"), xs = /* @__PURE__ */ W("<div id=\"detailsContent\" class=\"details-content\"><div class=\"empty-state\"><!><strong>Loading details...</strong></div></div>"), Ss = /* @__PURE__ */ W("<span class=\"details-tab-count\"> </span>"), Cs = /* @__PURE__ */ W("<button type=\"button\" role=\"tab\"><!><span> </span><!></button>"), ws = /* @__PURE__ */ W("<div><!></div>"), Ts = /* @__PURE__ */ W("<button type=\"button\"><!><span><strong> </strong><small> </small></span><!></button>"), Es = /* @__PURE__ */ W("<div class=\"empty-list-row\"><!><span>No task templates in templates/*.md.</span></div>"), Ds = /* @__PURE__ */ W("<div class=\"content-section\"><div class=\"template-list\"><!></div></div>"), Os = /* @__PURE__ */ W("<div class=\"content-section\"><div class=\"template-list\"><div class=\"template-row\"><!><span><strong> </strong><small> </small></span></div></div></div>"), ks = /* @__PURE__ */ W("<div class=\"worktree-row\"><div class=\"worktree-main\"><!><div><strong> </strong><span> </span><small> </small></div></div><button type=\"button\" class=\"secondary-button\"><!><span>View Diff</span></button></div>"), As = /* @__PURE__ */ W("<div class=\"empty-list-row\"><!><span>No worktrees.</span></div>"), js = /* @__PURE__ */ W("<div class=\"details-tabs\" role=\"tablist\" aria-label=\"Resource details\"></div> <div id=\"detailsContent\" class=\"details-content\"><!> <!> <div><!></div> <div><!></div> <div><!></div> <div><div class=\"content-section\"><div class=\"worktree-list\"><!></div></div></div></div>", 1), Ms = /* @__PURE__ */ W("<div class=\"details-header\"><nav class=\"breadcrumb\" aria-label=\"Location\"><button type=\"button\" class=\"breadcrumb-link\"> </button> <!> <span class=\"breadcrumb-separator\">/</span><button type=\"button\" class=\"breadcrumb-link current\"> </button></nav> <div class=\"title-row\"><h1> <!><span class=\"resource-creator-badge\"> </span></h1><!></div></div> <!>", 1), Ns = /* @__PURE__ */ W("<!> <!> <!>", 1);
function Ps(e, t) {
	j(t, !0);
	let n = /* @__PURE__ */ F(Qt(t.channel.current())), r = /* @__PURE__ */ F(""), i = /* @__PURE__ */ F(""), a = /* @__PURE__ */ F(Qt(/* @__PURE__ */ new Set())), o = /* @__PURE__ */ F(null), s = /* @__PURE__ */ F(null), c = /* @__PURE__ */ new Map(), l = new po(), u = /* @__PURE__ */ N(() => (H(n).detail?.files || []).filter((e) => e.name !== "AGENTS.md")), d = /* @__PURE__ */ N(() => new Set(H(u).map((e) => e.name))), f = /* @__PURE__ */ N(h), p = /* @__PURE__ */ N(() => H(o) ? `${H(o).section}:${H(o).path}` : "");
	ki(() => t.channel.subscribe((e) => {
	...
	var T = Ns(), E = un(T), ee = (e) => {
		...
		var t = hs(), r = un(t), i = L(r), o = L(i), s = L(o, !0);
		k(o), k(i);
		...
		var t = Ms(), r = un(t), o = L(r), c = L(o), l = L(c, !0);
		k(c);
		var d = R(c, 2), m = (e) => {
			var t = gs(), r = R(un(t)), i = L(r, !0);
...
var Fs = /* @__PURE__ */ W("<p class=\"approval-question\"> </p>"), Is = /* @__PURE__ */ W("<p> </p>"), Ls = /* @__PURE__ */ W("<button> </button>"), Rs = /* @__PURE__ */ W("<div class=\"approval-options\"></div>"), zs = /* @__PURE__ */ W("<div class=\"approval-actions\"><button><!><span>Allow once</span></button><button class=\"secondary-button\"><!><span>Decline</span></button></div>"), Bs = /* @__PURE__ */ W("<form class=\"approval-reply\"><input placeholder=\"Reply with a custom answer…\" aria-label=\"Custom reply\"/><button type=\"submit\">Send</button></form>"), Vs = /* @__PURE__ */ W("<!> <!>", 1), Hs = /* @__PURE__ */ W("<div data-component-owner=\"event-timeline\" class=\"agent-event approval\"><div><!><strong> </strong></div> <!> <!> <!></div>");
function Us(e, t) {
	j(t, !0);
...
var ec = 20, tc = 250, nc = 80, rc = /* @__PURE__ */ new Set(["session.launch-environment"]), ic = class {
	api;
	eventSourceFactory;
	...
	disposed = !1;
	constructor(e = {}) {
		this.api = e.api ?? new po(), this.eventSourceFactory = e.eventSourceFactory ?? ((e) => new EventSource(e)), this.onEvent = e.onEvent, this.onNotice = e.onNotice, this.streamBatchWindowMs = Math.max(0, e.streamBatchWindowMs ?? nc);
	}
	subscribe(e) {
	...
	async loadOlder() {
		...
		try {
			...
			return n instanceof uo || !this.isCurrent(e, t) || (e.error = Sc(n)), !1;
		} finally {
	...
	async expandRange(e, t, n) {
		...
		o && (r.liveEvents.set(o, qs(Ws([...r.liveEvents.get(o) || [], ...a]))), this.emit());
	}
	snapshot() {
		let e = this.activeContext();
		return e ? {
	...
	connect(e) {
		if (!this.isActive(e) || e.stream || !e.generationId || !vc(e.status)) return;
	...
	async fetchEventRange(e, t, n, r, i) {
		...
		for (; a < n;) {
			let s = new URLSearchParams({
				...
				after: String(a),
				limit: String(tc)
			}), c = await this.api.latest(`${dc(e)}/events?${s}`, { scope: uc(e, i) });
			if (!this.isCurrent(e, r)) return [];
			let l = gc(c.events).filter((t) => this.eventBelongsToContext(e, t));
			o = Ws([...o, ...l]);
			let u = Number(c.page?.nextAfter) || _c(l);
...
var wc = /* @__PURE__ */ W("<div data-component-owner=\"event-timeline\"><!><span> </span><span class=\"agent-note-time\"> </span></div>");
function Tc(e, t) {
	j(t, !0);
...
var Ec = /* @__PURE__ */ W("<details data-component-owner=\"event-timeline\" class=\"agent-reasoning-note\"><summary><!><span> </span><span class=\"agent-reasoning-chevron\"><!></span></summary> <p> </p></details>");
function Dc(e, t) {
	j(t, !0);
...
var Oc = /* @__PURE__ */ W("<span class=\"agent-message-tag agent-message-role-tag\"> </span>"), kc = /* @__PURE__ */ W("<span class=\"agent-message-tag\">steer</span>"), Ac = /* @__PURE__ */ W("<span class=\"agent-message-source\"> </span>"), jc = /* @__PURE__ */ W("<div class=\"agent-message-content markdown-rendered\"></div>"), Mc = /* @__PURE__ */ W("<p> </p>"), Nc = /* @__PURE__ */ W("<div data-component-owner=\"event-timeline\"><div class=\"agent-message-main\"><div class=\"agent-message-meta\"><strong> </strong> <!> <!> <!> <span> </span></div> <div class=\"agent-message-bubble\"><!></div></div></div>");
function Pc(e, t) {
	j(t, !0);
	let n = /* @__PURE__ */ N(() => [
		"assistant",
	...
	var s = Nc(), c = L(s), l = L(c), u = L(l), d = L(u, !0);
	k(u);
	var f = R(u, 2), p = (e) => {
		var t = Oc(), r = L(t, !0);
		k(t), z(() => K(r, H(n))), G(e, t);
...
var Fc = /* @__PURE__ */ W("<div data-component-owner=\"event-timeline\"><div><!><strong> </strong></div> <p> </p></div>");
function Ic(e, t) {
...
var Lc = /* @__PURE__ */ W("<pre> </pre>"), Rc = /* @__PURE__ */ W("<details data-component-owner=\"event-timeline\"><summary><!><span> </span><small> </small></summary> <!></details>");
function zc(e, t) {
	j(t, !0);
	function n() {
...
var Bc = /* @__PURE__ */ W("<details data-component-owner=\"event-timeline\" class=\"agent-tool-group\"><summary><span class=\"agent-tool-group-icon\"><!></span><span class=\"agent-tool-group-title\"> </span><span class=\"agent-tool-group-preview\"> </span><span class=\"agent-tool-group-chevron\"><!></span></summary> <div class=\"agent-tool-list\"></div></details>");
function Vc(e, t) {
	j(t, !0);
	...
	}, [() => `${t.runId}:${String(t.item.key || t.item.time || "tools")}`, () => H(r).slice(0, 2).join(" · ")]), xr("toggle", a, (e) => t.onToggle(e.currentTarget.open)), G(e, a), M();
}
//#endregion
//#region src/components/UnknownEvent.svelte
var Hc = /* @__PURE__ */ W("<details data-component-owner=\"event-timeline\" class=\"agent-tool-item agent-unknown-event\"><summary><!><span> </span></summary><pre> </pre></details>");
function Uc(e, t) {
	j(t, !0);
...
var Wc = /* @__PURE__ */ W("<button type=\"button\" class=\"load-older-events\"><!><span> </span></button>"), Gc = /* @__PURE__ */ W("<div class=\"conversation-generation\"><span> </span><strong> </strong><small> </small></div>"), Kc = /* @__PURE__ */ W("<button type=\"button\" class=\"secondary-button\">Retry</button>"), qc = /* @__PURE__ */ W("<div class=\"conversation-gap\"><!><span><strong>History unavailable</strong><small> </small></span><!></div>"), Jc = /* @__PURE__ */ W("<div class=\"turn-summary-preview\"> </div>"), Yc = /* @__PURE__ */ W("<div><!></div>"), Xc = /* @__PURE__ */ W("<div class=\"turn-loading\"><!><span>Loading turn details</span></div>"), Zc = /* @__PURE__ */ W("<section><!> <!> <!> <!></section>"), Qc = /* @__PURE__ */ W("<!> <!>", 1), $c = /* @__PURE__ */ W("<div class=\"turn-working-indicator\" role=\"status\" aria-live=\"polite\" data-timeline-key=\"turn-working\"><!><span>working...</span></div>"), el = /* @__PURE__ */ W("<div class=\"tty-empty\"><!><strong>Loading resource history</strong></div>"), tl = /* @__PURE__ */ W("<div class=\"tty-empty\"><!><strong>No conversation yet</strong><span>Send a message to start this resource's conversation.</span></div>"), nl = /* @__PURE__ */ W("<!> <!> <!> <!> <!> <!> <!>", 1), rl = /* @__PURE__ */ W("<div class=\"tty-empty\"><!><strong>No resource selected</strong></div>"), il = /* @__PURE__ */ W("<div data-component-owner=\"event-timeline\" class=\"event-timeline-root\"><!></div>");
function al(e, t) {
	j(t, !0);
	...
	var ne = il(), re = L(ne), ie = (e) => {
		...
		J(s, 19, () => H(i).blocks, (e) => e.key, (e, t, r) => {
			...
			var l = R(s, 2), u = (e) => {
				...
				q(d, (e) => {
					H(t).error && e(f);
				}), k(r), Xr(r, (e, t) => m?.(e, t), () => H(t).turn?.reference || ""), z(() => {
	...
	}), k(ne), Di(ne, (e) => I(a, e), () => H(a)), z(() => Y(ne, "data-chat-context", H(i).identity)), G(e, ne), M();
}
Sr(["click"]);
//#endregion
...
var ll = /* @__PURE__ */ W("<span class=\"settings-pill\"> </span>"), ul = /* @__PURE__ */ W("<div class=\"settings-service-row\"><div class=\"settings-provider-main\"><span class=\"settings-agent-mark\"> </span><span><strong> </strong><small> </small></span></div></div>"), dl = /* @__PURE__ */ W("<div class=\"settings-empty\">No AgentHub agents available.</div>"), fl = /* @__PURE__ */ W("<div class=\"settings-panel settings-agent-panel\" data-component-owner=\"agenthub-settings-panel\" data-settings-panel=\"\" data-settings-section=\"agenthub\"><div class=\"settings-panel-header\"><h2>AgentHub</h2><p>Forge connects to AgentHub for providers, agents, and durable sessions. Provider and agent definitions are read-only here.</p></div> <section class=\"settings-agent-section\"><div class=\"settings-section-heading\"><h3>Connection</h3><span class=\"settings-pill\"> </span></div> <label class=\"settings-default-agent\"><span>Endpoint</span><input id=\"settingsAgentHubEndpoint\"/></label> <small> </small> <div class=\"settings-provider-list\"></div></section> <section class=\"settings-agent-section\"><div class=\"settings-section-heading\"><h3>Catalog</h3><span> </span></div> <div class=\"settings-agent-list\"></div></section> <div class=\"settings-form-actions settings-save-bar\"><span> </span><button id=\"settingsSaveButton\" type=\"button\"><!><span>Save All</span></button></div></div>");
function pl(e, t) {
	j(t, !0);
	...
	async function i() {
		if (!(!n().dirty || r())) {
			r("agenthub");
			try {
				await t.onSaveAgentHub(sl(n())), n(n().dirty = !1, !0);
			} catch (e) {
				t.onToast(cl(e));
			} finally {
				r("");
	...
	var a = fl(), o = R(L(a), 2), s = L(o), c = R(L(s)), l = L(c, !0);
	k(c), k(s);
	var u = R(s, 2), d = R(L(u));
	gi(d), k(u);
	var f = R(u, 2), p = L(f, !0);
	...
	}), Si(d, () => n().endpoint, (e) => n(n().endpoint = e, !0)), U("click", w, i), G(e, a), M();
}
Sr(["input", "click"]);
//#endregion
//#region src/components/NotificationSettingsPanel.svelte
var ml = /* @__PURE__ */ W("<small class=\"settings-notification-help\"> </small>"), hl = /* @__PURE__ */ W("<div class=\"settings-panel\" data-component-owner=\"notification-settings-panel\" data-settings-panel=\"\"><div class=\"settings-panel-header\"><h2>Notifications</h2><p>Choose how this browser notifies you when an Agent run finishes.</p></div> <section class=\"settings-agent-section\"><label class=\"settings-notification-option\"><span class=\"settings-notification-copy\"><strong>Browser notifications</strong><small>Show one notification when a background run finishes.</small></span> <input id=\"settingsBrowserNotifications\" type=\"checkbox\"/></label> <!></section> <section class=\"settings-agent-section\"><label class=\"settings-notification-option\"><span class=\"settings-notification-copy\"><strong>Completion sound</strong><small>Play one short local sound for each new notification.</small></span> <input id=\"settingsCompletionSound\" type=\"checkbox\"/></label> <small class=\"settings-notification-help\"> </small></section></div>");
function gl(e, t) {
	j(t, !0);
	var n = hl(), r = R(L(n), 2), i = L(r), a = R(L(i), 2);
	gi(a), k(i);
	var o = R(i, 2), s = (e) => {
		var n = ml(), r = L(n, !0);
...
function Cl(e, t) {
	...
	}, [() => !n().dirty || !!r()]), Si(S, () => n().newProfile.key, (e) => n(n().newProfile.key = e, !0)), Si(C, () => n().newProfile.description, (e) => n(n().newProfile.description = e, !0)), ui(w, () => n().newProfile.agentName, (e) => n(n().newProfile.agentName = e, !0)), U("click", T, o), U("click", re, d), G(e, f), M();
}
Sr([
	"change",
	"input",
...
var wl = /* @__PURE__ */ W("<span class=\"settings-tab-dot\" aria-hidden=\"true\"></span>"), Tl = /* @__PURE__ */ W("<button type=\"button\"><!> <span> </span> <!></button>"), El = /* @__PURE__ */ W("<aside class=\"settings-tabs\" data-component-owner=\"settings-navigation\"><div class=\"settings-title\">System Settings</div> <!></aside>");
function Dl(e, t) {
	j(t, !0);
	let n = [
		{
...
function kl(e, t) {
	...
	var a = Ol(), o = R(L(a), 2), s = L(o), c = R(L(s), 2);
	gi(c), A(2), k(s);
	var l = R(s, 2), u = L(l);
	X(L(u), { name: "save" }), A(), k(u), k(l), k(o), k(a), z(() => u.disabled = r() === "user"), xr("submit", o, i), Si(c, () => n().userName, (e) => n(n().userName = e, !0)), G(e, a), M();
}
//#endregion
//#region src/components/WorkspaceSettingsPanel.svelte
var Al = /* @__PURE__ */ W("<span class=\"settings-pill\">Active</span>"), jl = /* @__PURE__ */ W("<button type=\"button\" role=\"radio\"><img alt=\"\"/><span> </span><!></button>"), Ml = /* @__PURE__ */ W("<div class=\"settings-workspace-icon-picker\" role=\"radiogroup\"></div>"), Nl = /* @__PURE__ */ W("<div class=\"settings-workspace-entry\"><div class=\"settings-list-row\"><div class=\"settings-row-main\"><span class=\"settings-workspace-mark\"><img alt=\"\" aria-hidden=\"true\"/></span> <span><strong> </strong><small> </small></span></div> <div class=\"settings-row-actions\"><!> <button type=\"button\" class=\"settings-workspace-icon-button\" title=\"Change workspace icon\"><img alt=\"\"/> <span> </span> <!></button> <button type=\"button\" class=\"settings-danger-button\" title=\"Remove workspace\"><!></button></div></div> <!></div>"), Pl = /* @__PURE__ */ W("<div class=\"settings-empty\">No workspaces managed by Forge GUI.</div>"), Fl = /* @__PURE__ */ W("<div class=\"settings-panel\" data-component-owner=\"workspace-settings-panel\" data-settings-panel=\"\"><div class=\"settings-panel-header\"><h2>Workspaces</h2> <p>Add existing AgentWorkspace folders or create and initialize a new Forge workspace.</p></div> <form id=\"settingsWorkspaceForm\" class=\"settings-path-form\"><input id=\"settingsWorkspacePath\" placeholder=\"/Users/me/Documents/AgentWorkspace\"/> <label class=\"settings-check\"><input id=\"settingsWorkspaceCreate\" type=\"checkbox\"/> <span>Create directory and run forge init</span></label> <button type=\"submit\"><!><span> </span></button></form> <div class=\"settings-list\"></div></div>");
function Il(e, t) {
	j(t, !0);
	...
	async function a(e) {
		if (e.preventDefault(), !(!n().workspacePath.trim() || r())) {
			r("workspace");
			try {
				await t.onAddWorkspace(sl(n())), n(n().workspacePath = "", !0), n(n().createWorkspace = !1, !0);
			} catch (e) {
				t.onToast(cl(e));
			} finally {
				r("");
	...
	async function o(e) {
		if (!r()) {
			r(`remove:${e}`);
			try {
				await t.onRemoveWorkspace(e, sl(n()));
			} catch (e) {
				t.onToast(cl(e));
			} finally {
				r("");
	...
	async function s(e, a) {
		if (!r()) {
			r(`icon:${e}`), I(i, "");
			try {
				await t.onWorkspaceIcon(e, a, sl(n()));
			} catch (e) {
				t.onToast(cl(e));
			} finally {
				r("");
	...
	J(v, 21, () => t.workspaces, (e) => e.id, (e, n) => {
		...
		var l = Nl(), u = L(l), d = L(u), f = L(d), p = L(f);
		k(f);
	...
	}, [() => !!r()]), xr("submit", u, a), Si(d, () => n().workspacePath, (e) => n(n().workspacePath = e, !0)), Ci(p, () => n().createWorkspace, (e) => n(n().createWorkspace = e, !0)), G(e, l), M();
}
Sr(["click"]);
//#endregion
//#region src/components/SettingsModal.svelte
var Ll = /* @__PURE__ */ W("<button class=\"settings-overlay modal-enter\" type=\"button\" aria-label=\"Close settings\"></button> <div class=\"settings-modal modal-enter\" role=\"dialog\" aria-modal=\"true\" aria-label=\"System Settings\"><!> <div class=\"settings-content\"><button type=\"button\" class=\"settings-close\" title=\"Close\" aria-label=\"Close\"><!></button> <!></div></div>", 1);
function Rl(e, t) {
	j(t, !0);
	let n = /* @__PURE__ */ F(Qt(t.channel.current())), r = /* @__PURE__ */ F(""), i = /* @__PURE__ */ F(-1), a = /* @__PURE__ */ F(Qt(ol(H(n)))), o = /* @__PURE__ */ F("");
	ki(() => t.channel.subscribe((e) => {
		I(n, e, !0), e.identity === H(r) ? e.dataVersion !== H(i) && !H(a).dirty && (I(i, e.dataVersion, !0), I(a, ol(e), !0)) : (I(r, e.identity, !0), I(i, e.dataVersion, !0), I(a, ol(e), !0), I(o, "")), queueMicrotask(e.onIconsChanged);
	})), ki(() => {
		let e = (e) => {
...
var zl = /* @__PURE__ */ W("<div id=\"toast\" class=\"toast\" role=\"status\" aria-live=\"polite\"> </div>");
function Bl(e, t) {
	j(t, !0);
...
function Kl(e, t) {
	...
	var b = Ar(), x = un(b), S = (e) => {
		var t = Gl(), n = L(t), r = R(n, 2), a = L(r), s = R(L(a), 2);
...
var ql = /* @__PURE__ */ W("<!> <div data-component-owner=\"toast\" style=\"display: contents\"><!></div> <div data-component-owner=\"upload-dialog\" style=\"display: contents\"><!></div> <div data-component-owner=\"create-dialog\" style=\"display: contents\"><!></div> <div data-component-owner=\"settings\" style=\"display: contents\"><!></div>", 1);
function Jl(e, t) {
	j(t, !0);
	var n = ql(), r = un(n);
	ca(r, {
...
var Ql = "forge.gui.agentDraft.v1", $l = 1, eu = 50, tu = 7776e6;
function nu(e) {
...
function au(e = {}) {
	let t = e.now || Date.now, n = e.maxOrphanCount ?? eu, r = e.maxAgeMs ?? tu;
	function i() {
	...
	function a(e, t) {
		let n = String(t || "").trim(), r = ru(e);
		return !n || !r ? "" : `${Ql}.session.${nu(n)}.${nu(r)}`;
	}
	function o(e, t) {
		let n = String(e || "").trim(), r = iu(t);
		return !n || !r ? "" : `${Ql}.resource.${nu(n)}.${nu(r)}`;
	}
	function s(e) {
		if (!e) return null;
		try {
			let t = JSON.parse(e);
			return !t || t.version !== $l || typeof t.text != "string" ? null : {
				version: $l,
				text: t.text,
	...
	function f(e, a, o) {
		let s = i(), l = String(e || "").trim(), d = iu(a);
		if (!s || !l) return;
		let f = `${Ql}.session.${nu(l)}.`, p = [], m = t();
		try {
			for (let e = 0; e < s.length; e++) {
				let t = s.key(e);
				if (!t || !t.startsWith(f)) continue;
				let n = c(t);
				if (!(!n || iu(n.resourceId) !== d || o.has(t))) {
...
function ou(e) {
	...
	function l(i, o = e.workspaceId()) {
		let s = r(i, o);
		if (!s) return c();
		n.ttyDraftKey !== s && (n.ttyDraftKey = s, n.ttyDraftWorkspaceId = o.trim(), n.ttyDraftResourceId = iu(i.resourceId), n.ttyDraftRunId = i.id, n.ttyDraft = t.read(s), n.ttyMultiline = n.ttyDraft.includes("\n"), n.ttyDraftVersion++, a(n.ttyDraftWorkspaceId, n.ttyDraftResourceId));
	}
	function u(r, i = e.workspaceId()) {
		let a = iu(r), o = t.keyForResource(i, a);
		if (!o) return c();
	...
	function d(r) {
		return e.workspaceId() !== r.workspaceId || n.ttyDraftResourceId !== iu(r.resourceId) || n.ttyDraftKey !== r.key || n.ttyDraft !== r.text || n.ttyDraftVersion !== r.version ? !1 : (t.remove(r.key), s("", !1), !0);
	}
	function f(r) {
...
function cu(e, t = "Unexpected error") {
...
function du(e) {
	...
	function u() {
		...
		e.publish({
			...
			onPreview: p,
			onSubmit: m,
			previewRequestKey: (e) => JSON.stringify(uu({
				...t,
				...s(e),
				templateDigest: ""
			})),
	...
	async function m(r) {
		...
		try {
			...
			n.identity === a && (n.submitting = !1, u(), e.toast(cu(t)));
		}
	}
	return {
		open: d,
...
function hu(e) {
	...
	function a(t) {
		if (!(!e.settings().browser || fu() !== "granted")) try {
			let n = new window.Notification(pu(t), {
				body: mu(t),
				tag: `forge-${t.marker}`,
				icon: "/favicon.svg"
			});
	...
	function o(t) {
		let n = e.settings();
		n.browser && fu() === "granted" && e.claim(t, "browser", () => a(t)), n.sound && e.claim(t, "sound", i);
	}
	async function s() {
		let t = e.settings(), n = fu();
...
var gu = "forge.gui.notifications.v1", _u = `${gu}.settings`;
function vu(e) {
...
function xu(e) {
	...
	}).filter((e) => e.marker) : [], r = Array.isArray(t.pending) ? t.pending.map(yu).filter((e) => !!e) : [], i = Array.isArray(t.unread) ? t.unread.map(yu).filter((e) => !!e) : [], a = Array.isArray(t.effects) ? t.effects.map((e) => {
		let t = vu(e);
		return {
...
function Su(e) {
	let t = e.trim();
	return t ? `${gu}.state.${encodeURIComponent(t)}` : "";
}
function Cu(e) {
	function t(t) {
		let n = Su(t);
	...
	function r() {
		...
		try {
			let t = vu(JSON.parse(e.getItem(_u) || "null"));
...
function Ou(e, t) {
	let n = Eu(e, t.navigationTarget), r = t.findResource(n);
	return yu({
...
function Au(e) {
	...
	function v(e) {
		...
		if (typeof t == "function") try {
			let r = new t(`${gu}.${encodeURIComponent(e)}`);
	...
	function y(e) {
		let r = e.trim();
		r && (_(), n.workspaceId = r, n.store = t.readStore(r), n.settings = t.readSettings(), fu() !== "granted" && (n.settings.browser = !1, t.writeSettings(n.settings)), n.ready = !1, v(r));
	}
	function b(t) {
	...
	function S(e) {
		for (let t of e) wu(t) && x(t, t.completionState || t.agentRunCompletionState || "");
	}
	function C(e, t) {
		let n = Du(e);
	...
	function te() {
		e.scope.listen(window, "storage", (r) => {
			r.key === Su(n.workspaceId) && r.newValue && (n.store = t.readStore(n.workspaceId), e.hasTree() && e.renderSessions()), r.key === _u && (n.settings = t.readSettings(), fu() !== "granted" && (n.settings.browser = !1), e.notificationsSettingsVisible() && e.renderSettings());
...
var ju = "forge.gui.paneSizes", Mu = "forge.gui.mobileImmersive", Nu = "forge.gui.layoutPreference", Pu = 8, Fu = 220, Iu = 360, Lu = 320, Ru = 1e4, zu = Object.freeze({
	sidebarWidth: 280,
	chatWidth: 420,
	sidebarSessionHeight: 210
}), Bu = Object.freeze({
...
function Wu(e) {
	return Uu.includes(e) ? e : "auto";
}
function Gu(e, t = 0) {
	let n = e && typeof e == "object" ? e : {}, r = { ...zu };
	if (Hu(n.sidebarWidth) && (r.sidebarWidth = Vu(n.sidebarWidth, Fu, Ru)), Hu(n.chatWidth)) r.chatWidth = Vu(n.chatWidth, Lu, Ru);
	else if (Hu(n.detailsWidth) && t >= 688) {
		let e = Vu(n.detailsWidth, Iu, t - Pu - Lu);
		r.chatWidth = Vu(t - Pu - e, Lu, Ru);
	}
	return Hu(n.sidebarSessionHeight) && (r.sidebarSessionHeight = Vu(n.sidebarSessionHeight, 84, Ru)), r;
}
function Ku(e, t = window.localStorage) {
	let n = { ...zu }, r = {
		sidebarOpen: !1,
		view: "details",
		immersive: !1
	...
	function u(e, t) {
		...
		let r = e, i = Math.round(Vu(t, r === "sidebarWidth" ? Fu : r === "chatWidth" ? Lu : 84, Ru));
		n[r] = i, l(Bu[r], i);
	}
	function d() {
	...
	function p() {
		let l = s();
		n = Gu(l, 0), d(), Hu(l.detailsWidth) && !Hu(l.chatWidth) && !a.matches && (n = Gu(l, c()), d(), f());
		try {
			r.immersive = t?.getItem(Mu) === "1";
		} catch {
			r.immersive = !1;
		}
	...
	function m(e) {
		...
		for (let e of Object.keys(Bu)) Hu(i[e]) || (i[e] = n[e]);
		i[r] = n[r], t.setItem(ju, JSON.stringify(i));
	}
	function h() {
		if (a.matches) return;
		let e = s();
		!Hu(e.detailsWidth) || Hu(e.chatWidth) || (n = Gu(e, c()), d(), f());
	}
	function g() {
	...
	function y() {
		let e = Uu[(Uu.indexOf(i) + 1) % Uu.length];
		v(e);
	}
	function b(t) {
...
function Yu(e, t = 10, n = 20) {
	...
	function s(t, n = "head") {
		...
		let l = e.details[r], u = Ju(l.logs || [], o, n !== "older");
	...
	async function u(t = e.context().selectedId) {
		...
		try {
			...
			d(r, t, a, l) && (a.error = cu(e, "Could not load older logs."));
		} finally {
...
function Zu(e) {
	...
	return t[0] === "w" ? {
		workspaceId: Xu(t[1]),
		resourceId: t[2] === "r" ? Xu(t[3]) : "workspace"
	} : {};
}
function Qu(e, t = "") {
	let n = String(e || "").trim();
...
function td(e) {
	...
	async function p() {
		...
		}), await o(), e.setConfig(ed(await e.request("/api/workspaces"), n.data?.agentHub || {})), n.agentDirty = !1, e.renderAgentViews(), r(), e.onIconsChanged(), e.toast("AgentHub settings saved.");
	}
	return {
		open: i,
		close: a,
...
function id(e) {
	...
	function g(e) {
		let t = (e.children || []).filter((e) => e.archived !== !0), n = new Set(t.filter((e) => f(e.id).some((e) => e.source === "internal" && nd.has(e.agentRunStatus || ""))).map((e) => e.id)), r = `${t.length} ${t.length === 1 ? "task" : "tasks"}`, i = `${n.size} running`;
		return {
			taskCount: t.length,
			runningCount: n.size,
			taskLabel: r,
	...
	function v() {
		...
		if (t.scheduler) {
			let e = m(t.scheduler);
			n.push(`scheduler:session=${_(e.session)}:${e.label}`);
		}
...
var ad = "forge.gui.user.v1", od = 1, sd = 80;
function cd(e) {
	let t = String(e || "").trim();
	return t && Array.from(t).slice(0, sd).join("") || "User";
}
function ld(e) {
	if (!e) return "User";
	try {
		let t = JSON.parse(e);
		return !t || t.version !== od ? "User" : cd(t.name);
	} catch {
		return "User";
	}
}
function ud(e, t) {
	...
	function r() {
		try {
			return ld(window.localStorage.getItem(ad));
		} catch {
			return "User";
		}
	}
	function i(e) {
		let t = cd(e);
		try {
			window.localStorage.setItem(ad, JSON.stringify({
				version: od,
				name: t
			}));
		} catch {
...
function Cd(e) {
	...
	if (n.startsWith("item/") || n.startsWith("command/")) {
		...
		return n === "item/started" && (u = "running"), n === "item/completed" && u === "running" && (u = "completed"), l && u === "completed" && (u = "failed"), {
			...
			status: u,
			error: l,
			summary: md(s.replace(/\s+/g, " ").trim(), 120),
			output: md(c, pd)
		};
	}
	let a = r.update && typeof r.update == "object" ? r.update : r, o = Q(a.sessionUpdate);
	if (o === "tool_call" || o === "tool_call_update") {
		let e = Q(a.toolCallId, a.id), t = a.rawInput && typeof a.rawInput == "object" ? a.rawInput : {}, r = Q(a.title, _d(t.command), t.path, t.filePath, gd(a.kind));
		return {
			callId: e,
			method: n,
			time: i,
			name: gd(a.kind) || "Tool",
			status: xd(a.status || (o === "tool_call" ? "in_progress" : "")),
			summary: md(r.replace(/\s+/g, " ").trim(), 120),
			output: md(Sd(a.content), pd),
			error: ""
		};
	}
	if (n === "tool_execution_start" || n === "tool_execution_end") {
		let e = Q(r.toolName, r.name, r.tool), t = r.args && typeof r.args == "object" ? r.args : {}, a = Q(_d(t.command), t.path, t.filePath, ""), o = r.isError === !0 || !!Q(r.error);
		return {
			...
			summary: md(a.replace(/\s+/g, " ").trim(), 120),
			output: md(Q(typeof r.result == "string" ? r.result : "", Sd(r.result?.content)), pd),
			error: Q(r.error)
		};
	}
	return {
...
function wd(e) {
	let t = e?.data ?? {}, n = Q(t.method), r = t.params && typeof t.params == "object" ? t.params : {}, i = Array.isArray(r.options) ? r.options.map((e) => ({
		...
		name: Q(e?.name),
		kind: Q(e?.kind)
	})).filter((e) => e.optionId) : [], a = _d(r.command) || _d(r?.rawInput?.command);
	if (a) return {
		title: "Run command",
		detail: md(a, 160),
		question: "",
	...
	if (r.toolCall && typeof r.toolCall == "object") {
		let e = Q(r.toolCall.title, r.toolCall.kind && gd(r.toolCall.kind)), t = Sd(r.toolCall.content);
		return {
...
function kd(e, t) {
	let n = { ...e };
	return t.name && (n.name = t.name), t.summary && (n.summary = t.summary), t.status && (n.status = t.status), t.error && (n.error = t.error), t.deltaOnly ? n.output = md((n.output || "") + (t.output || ""), pd) : t.output && (n.output = t.output), n.time = t.time || e.time, n.key = e.key, n;
}
function Ad(e, t) {
	return {
		key: t.id,
	...
	for (let a of e || []) {
		...
		switch (e) {
			...
			case "approval.requested": {
				let { title: e, detail: r, question: i, options: c } = wd(a), l = {
					kind: "approval",
					key: a.id,
					time: s,
			...
			case "approval.resolved": {
				let e = Q(o.approvalId), r = Q(o.decision) || "decline", i = Q(o.optionId), c = Q(o.text), l = e ? n.get(e) : null, u = (e) => r === "text" ? "Replied" : i ? `Answered: ${e?.options?.find((e) => e.optionId === i)?.name || i}` : Td[r] || gd(r), d = r === "accept" || r === "acceptForSession" || r === "text";
			...
			case "session.state": {
				let e = Ed[o.state];
				o.state === "failed" ? i("failed", s) : o.state === "stopped" && i(o.reason === "completed" ? "completed" : "failed", s), o.state === "stopped" && Dd[o.reason] && (e += ` · ${Dd[o.reason]}`);
...
var Fd = ou({
	...
	runs: () => $.agent.runs,
	currentRun: () => Zp()
}), Id = Fd.clearResourceAfterAccepted, Ld = Fd.clearMemory, Rd = Fd.flush, zd = Fd.restoreResource, Bd = Fd.update, Vd = su(() => {
	Im && (Bp(), Em());
}), Hd = Ku(() => Xf()), Ud = $u(() => Xf()), Wd = Yu({
	details: $.details,
	...
	request: (e, t) => Ef(e, t),
	publish: (e) => Md.renderCreateDialog(e),
	toast: Tm,
	reloadTree: () => Of(),
...
}), Kd = (e) => document.getElementById(e), qd = 5e3, Jd = 10, Yd = /* @__PURE__ */ new Set(["session.launch-environment"]), Xd = {
	id: "",
	label: "Forge default",
	src: "/favicon.svg",
	type: "image/svg+xml"
...
], Qd = new Map(Zd.map((e) => [e.id, e])), { applyCustomOrder: $d, moveIdInList: ef, noTaskOperationalState: tf, operationalStatusPresentation: nf, projectTaskSummary: rf, resourceRefText: af, sessionOperationalLabel: of, sessionStatusPresentation: sf, sortedSessionsForDisplay: cf, statusModel: lf, taskOperationalState: uf, taskOperationalStateKey: df, taskStatusState: ff } = id({
	tree: () => $.tree,
	findResource: (e) => sm(e),
	...
	request: (e, t) => Ef(e, t),
	publish: (e) => Md.renderSettings(e),
	agentOptions: hf,
	workspaceIcons: [Xd, ...Zd],
	userName: Tf,
	saveUser: (e) => {
		if (!vf) throw Error("User settings are unavailable.");
		return vf.save(e);
	},
	notificationPreferences: () => _f?.preferences() || {
		browser: !1,
		sound: !1,
	...
	setBrowserNotifications: (e) => _f?.setBrowserEnabled(e),
	setCompletionSound: (e) => _f?.setSoundEnabled(e),
	flushDraft: Rd,
	resetAgentState: Op,
...
function bf() {
	_f?.establishBaseline();
}
function xf(e) {
	_f?.observeProjections(e);
}
function Sf(e, t) {
	t && _f?.observeEvent(e, t);
}
function Cf(e) {
	return _f?.hasUnreadForSession(e) ?? !1;
}
function wf(e) {
	_f?.clearResource(e);
}
function Tf() {
	return vf?.current() || "User";
}
...
async function Df() {
	let e = fm(), [t, n] = await Promise.all([Ef("/api/workspaces"), Ef("/api/settings/agenthub")]);
	$.config = Sm(t, n), gm(), $.activeWorkspaceId = pm(e.workspaceId) ? e.workspaceId || "" : $.config?.activeId || $.config?.workspaces[0]?.id || "", $.selectedId = e.resourceId || "workspace", Kf(), $.activeWorkspaceId ? (yf($.activeWorkspaceId), await If(), !e.resourceId && $.lastResourceId && ($.selectedId = $.lastResourceId), await Of({ replaceURL: !0 })) : ($.navigationLoading = !1, $.tree = null, Pd(), $.workspaceAgents = null, $.preview = null, $.diff = null, Op(), Bf());
}
async function Of(e = {}) {
	...
	let i;
	try {
		i = await Ef(`/api/workspaces/${t}/tree`);
	} catch (e) {
		throw Hf(t, n, r) && ($.navigationLoading = !1, $.navigationError = cu(e), Xf()), e;
	}
	Hf(t, n, r) && ($.tree = i, Pd(), $.workspaceAgents = null, $.workspaceAgentsSaving = !1, $.preview = null, $.diff = null, cm(), dm(!1), $.selectedId === "workspace" ? await Ff() : $.selectedId && await kf($.selectedId), Hf(t, n, r) && (await yp(), Hf(t, n, r) && (await Tp(t, $p()), Hf(t, n, r) && (bf(), $.navigationLoading = !1, $.navigationError = "", Bf(), e.updateURL !== !1 && mm({ replace: !!e.replaceURL })))));
}
async function kf(e, t = {}) {
	return Wd.load(e, t);
}
function Af(e, t = $.activeWorkspaceId, n = {}) {
	return Wd.fetch(e, t, n);
}
function jf(e) {
	Wd.reset(e);
}
function Mf(e) {
	return Wd.snapshot(e);
}
function Nf(e, t = "head") {
	return Wd.apply(e, t);
}
async function Pf(e = $.selectedId) {
	await Wd.loadMore(e);
}
async function Ff(e = {}) {
	...
	try {
		let e = await Ef(`/api/workspaces/${t}/files?path=AGENTS.md`);
		if (!Hf(t, n) || r !== $.workspaceAgentsRequestVersion) return null;
		$.workspaceAgents = e;
	} catch (e) {
		if (!Hf(t, n) || r !== $.workspaceAgentsRequestVersion) return null;
		$.workspaceAgents = {
...
async function If(e = $.activeWorkspaceId, t = $.navigationVersion) {
	let n = await Ef(`/api/workspaces/${e}/ui-state`);
	return Hf(e, t) ? ($.expandedProjects = new Set(n.expandedProjects || []), $.lastResourceId = n.lastResourceId || "", $.projectOrder = Array.isArray(n.projectOrder) ? n.projectOrder : [], $.taskOrder = n.taskOrder && typeof n.taskOrder == "object" ? n.taskOrder : {}, $.sessionOrder = Array.isArray(n.sessionOrder) ? n.sessionOrder : [], !0) : !1;
}
async function Lf() {
	if (!$.activeWorkspaceId) return;
	let e = $.activeWorkspaceId, t = $.navigationVersion, n = $.selectedId;
	await Ef(`/api/workspaces/${e}/ui-state`, {
		method: "PUT",
		body: JSON.stringify({
			version: 1,
	...
	}), Hf(e, t) && ($.lastResourceId = n);
}
function Rf() {
	$.autoRefreshTimer ||= Nd?.interval(() => {
		zf().catch((e) => {
...
async function zf() {
	...
	try {
		let i = await Sp(t);
		if (!i || !Uf(t, n, e)) return;
		let a = !Cm($.tree, i);
		if (a && ($.tree = i), typeof xf == "function" && xf(i.sessions || []), a && $.preview?.section === "Wiki" && !$.preview.loading && (await mp("Wiki", $.preview.path), !Uf(t, n, e))) return;
		...
		if (dm(!1), a ||= o !== $.expandedProjects.size, $.selectedId === "workspace") {
			...
			if (await Ff({ force: !0 }), !Uf(t, n, e)) return;
			Cm(r, $.workspaceAgents) || (a = !0);
		} else if (r) {
			let i = ++$.detailRequestVersion, o = await Af(r, t, { logsLimit: Jd });
			if (!Uf(t, n, e) || $.selectedId !== r || i !== $.detailRequestVersion) return;
			let s = Mf(r);
			Nf(o, "head"), Cm(s, Mf(r)) || (a = !0);
		}
		$.agentRunProjectionVersion = (Number($.agentRunProjectionVersion) || 0) + 1;
		let s = $.agentRunProjectionVersion, c = await wp();
		if (!Uf(t, n, e) || s !== $.agentRunProjectionVersion) return;
		if (Cm($.agent.runs, c) || ($.agent.runs = c, a = !0), typeof xf == "function" && xf(c), bp(c)) {
			if (!Uf(t, n, e) || s !== $.agentRunProjectionVersion) return;
			a = !0;
		}
		await Tp(t, $p()) && (a = !0), df() !== $.taskOperationalStateKey && (a = !0), a && Bf();
	} finally {
		$.autoRefreshInFlight = !1;
	}
}
...
function Uf(e, t, n) {
	return Hf(e, t) && n === $.autoRefreshVersion;
}
function Wf(e) {
	return Qd.get(String(e?.icon || "").trim()) || Xd;
}
function Gf(e) {
	let t = Wf(e), n = document.querySelector("link[rel=\"icon\"]");
...
function qf(e, t, n = "") {
	let r = uf(e), i = t === "project" && um(e.id), a = t === "project" ? rf(e) : null, o = e.title || e.id;
	return {
		id: e.id,
		type: t,
		title: o,
		...
		statusLabel: r.label || "",
		status: lf(r.statusPresentation),
		summary: a ? {
			taskLabel: a.taskLabel,
			runningLabel: a.runningLabel,
			ariaLabel: a.ariaLabel
		} : null,
		children: t === "project" ? $d(e.children || [], $.taskOrder[e.id]).map((t) => qf(t, "task", e.id)) : [],
		projectId: n
	};
}
function Jf(e) {
	...
	return {
		...
		status: lf(t.statusPresentation),
		summary: null,
		children: []
	};
}
function Yf(e) {
	let t = ip(e), n = t.displayResourceId, r = e.source === "internal", i = r ? sf(e) : ff("session-external", "session-status-external", "message-square", "External session active", "session"), a = ap(e), o = a ? uf(a) : tf(), s = nf([i]), c = Cf(e.id), l = `${of(e, a, o, i)}${c ? ". Unread turn completion." : ""}`, u = r ? ($.config?.agents || []).find((t) => t.id === e.agentRunAgentName) : null, d = [r ? "AgentHub" : "External"];
	return n && d.push(n), e.updatedAt && d.push(em(e.updatedAt)), {
		id: e.id,
...
function Xf() {
	let e = $.tree ? $d($.tree.projects || [], $.projectOrder).map((e) => qf(e, "project")) : [], t = $d(cf($.tree?.sessions || []), $.sessionOrder).map(Yf);
	$.tree && ($.taskOperationalStateKey = df()), Md.renderAppShell({
		...
		scheduler: Jf($.tree?.scheduler),
		projects: e,
		sessions: t,
		...Hd.snapshot(),
		route: Ud.projection(),
		onSwitchWorkspace: (e) => Zf(e),
		onAddWorkspace: () => xm("workspace").catch((e) => Tm(e.message)),
		onCreateProject: () => tm(),
		onOpenSettings: () => xm().catch((e) => Tm(e.message)),
		onToggleProject: (e) => ep(e),
		onSelectResource: (e) => $f(e),
		onReorder: (e, t, n) => Qf(e, t, n),
		onDragState: (e) => {
			$.listDrag = e;
		},
		...
		onLayoutCycle: () => Hd.cycleLayoutPreference(),
...
async function Zf(e) {
	...
	Mm(!1), Rd(), $.navigationVersion++, $.autoRefreshVersion++, $.treeRequestVersion++, $.detailRequestVersion++, $.workspaceAgentsRequestVersion++, $.previewRequestVersion++, $.diffRequestVersion++;
	let t = $.navigationVersion;
	await Lf().catch((e) => console.warn("failed to save UI state", e)), $.activeWorkspaceId = e, $.selectedId = "workspace", $.tree = null, $.navigationLoading = !0, $.navigationError = "", Pd(), yf(e), $.sessionMenu = null, pp(), $.workspaceAgentsSaving = !1, im(), Op(), Kf(), await If(e, t) && ($.selectedId = $.lastResourceId || "workspace", await Of());
}
async function Qf(e, t, n) {
	...
	if (e.kind === "session") $.sessionOrder = ef($d(cf($.tree?.sessions || []), $.sessionOrder).map((e) => e.id), e.id, t.id, n);
	else if (e.kind === "task") {
		let r = sm(e.projectId);
		if (!r) return;
		let i = $d(r.children || [], $.taskOrder[e.projectId]);
		$.taskOrder = {
			...$.taskOrder,
			[e.projectId]: ef(i.map((e) => e.id), e.id, t.id, n)
		};
	} else if (e.kind === "project") $.projectOrder = ef($d($.tree?.projects || [], $.projectOrder).map((e) => e.id), e.id, t.id, n);
	else return;
	Xf();
	try {
		await Lf();
...
async function $f(e, t = {}) {
	let n = $.selectedId !== e;
	t.clearUnread !== !1 && wf(e);
	let r = n || !!t.forceDetail;
	r && ($.navigationVersion++, $.autoRefreshVersion++, $.treeRequestVersion++, $.detailRequestVersion++, $.workspaceAgentsRequestVersion++, $.previewRequestVersion++, $.diffRequestVersion++, e !== "workspace" && (jf(e), delete $.details[e])), n && ($.workspaceAgentsSaving = !1, Rd(), Kp(), $.preview = null, $.diff = null, kp(), $.agent.runs = [], $.agent.activeRunId = "", $.agent.events = [], $.agent.notices = [], $.agent.historyBeforeId = 0, Ld(), $.messageStatus = null, $.messageStatusKey = "", $.messageStatusRequestVersion++, $.steeringMessageId = ""), $.selectedId = e, $.sessionMenu = null, Mm(!1), dm(!1), mm(), Lf().catch((e) => console.warn("failed to save UI state", e)), Vf(), await Promise.all([
		e === "workspace" ? Ff({ force: !!t.forceDetail }) : kf(e, { force: r }),
		n ? yp() : Promise.resolve(),
		Tp($.activeWorkspaceId, e)
	]), Hf($.activeWorkspaceId, $.navigationVersion) && Vf();
}
async function ep(e) {
...
function np(e, t = ip(e)) {
	let n = (typeof t == "string" ? t : t.displayResourceId) || "", r = sm(n)?.title || "";
...
function sp() {
	let e = $.activeWorkspaceId || "", t = {
		...
		onNavigate: (e) => up(e).catch((e) => Tm(cu(e))),
		onCreateTask: (e) => nm(e),
		onArchive: (e) => om(e).catch((e) => Tm(cu(e))),
		onLoadMoreLogs: (e) => Pf(e),
		onSaveWorkspaceAgents: (e, t) => hp(e, t),
		onSaveAgentBinding: async (t) => {
			let n = $.selectedId || "workspace";
			await Ef(`/api/workspaces/${encodeURIComponent(e)}/resources/${encodeURIComponent(n)}/agent-binding`, {
				method: "PUT",
				body: JSON.stringify(t)
			}), await Of({ updateURL: !1 }), n !== "workspace" && await kf(n, { force: !0 }), Bf(), Tm("Resource agent binding saved.");
		},
		onRefreshScheduler: async () => {
			await Of({ updateURL: !1 }), $.selectedId === "scheduler" && await kf("scheduler", { force: !0 }), Bf();
		},
		onToast: Tm,
		onIconsChanged: Em
	};
...
function lp() {
	Md.renderDetailPanel(sp());
}
async function up(e) {
	await $f(e, { forceDetail: e === $.selectedId && e !== "workspace" });
}
function dp(e) {
	let t = "", n = 0;
	for (; n < e.length;) {
...
async function hp(e, t) {
	...
	let n = $.activeWorkspaceId, r = $.navigationVersion, i = await Ef(`/api/workspaces/${n}/files?path=AGENTS.md`, {
		method: "PUT",
		body: JSON.stringify({
			content: e,
	...
	if (!Hf(n, r) || $.selectedId !== "workspace") throw Error("The workspace changed before AGENTS.md finished saving.");
	return $.workspaceAgents = i, $.workspaceAgentsDraft = fp(i.content || ""), $.workspaceAgentsDirty = !1, i;
}
function gp() {
	$.previewRequestVersion++, $.preview = null, Bf();
}
function _p() {
	$.diffRequestVersion++, $.diff = null, Bf();
}
function vp(e, t, n = $.activeWorkspaceId) {
...
async function yp() {
	...
	$.agentRunProjectionVersion = (Number($.agentRunProjectionVersion) || 0) + 1;
	let e = $.agentRunProjectionVersion, t = await wp();
	return !(e !== $.agentRunProjectionVersion || !$.activeWorkspaceId || ($.agent.runs = t, xf($.agent.runs), bp($.agent.runs), $.agent.activeRunId || ($.agent.historyBeforeId = 0), e !== $.agentRunProjectionVersion));
}
function bp(e) {
	let t = xp(e);
...
async function Sp(e = $.activeWorkspaceId) {
	let t = ++$.treeRequestVersion, n = $.navigationVersion, r = await Ef(`/api/workspaces/${e}/tree`);
	return Hf(e, n, t) ? r : null;
}
async function Cp() {
...
function wp() {
	let e = $p(), t = e ? `?resourceId=${encodeURIComponent(e)}` : "";
	return Ef(`/api/workspaces/${$.activeWorkspaceId}/agent/runs${t}`).then((e) => e.runs || []);
}
async function Tp(e = $.activeWorkspaceId, t = $p()) {
	if (!e || !t) return !1;
	let n = ++$.messageStatusRequestVersion, r = `${e}:${t}`, i = await Ef(`/api/workspaces/${encodeURIComponent(e)}/resources/${encodeURIComponent(t)}/status`);
...
async function Ep(e) {
	...
	$.steeringMessageId = e, Bp();
	try {
		await Ef(`/api/workspaces/${encodeURIComponent(t)}/messages/${encodeURIComponent(e)}/steer`, { method: "POST" }), await Tp(t, n), t === $.activeWorkspaceId && n === $p() && (Bf(), Tm("Message inserted into the current turn."));
	} catch (e) {
		try {
			await Tp(t, n);
		} catch {}
		...
		$.steeringMessageId === e && ($.steeringMessageId = "", Bp());
	}
}
async function Dp() {
	Rd(), kp(), Vd.reset(), $.agent.activeRunId = "", $.agent.events = [], $.agent.notices = [], $.agent.historyBeforeId = 0, Ld(), $.messageStatus = null, $.messageStatusKey = "", $.messageStatusRequestVersion++, await Promise.all([yp(), Tp()]);
}
function Op() {
	Rd(), Kp(), kp(), $.agent.runs = [], $.agentRunProjectionVersion = (Number($.agentRunProjectionVersion) || 0) + 1, $.agent.activeRunId = "", $.agent.events = [], $.agent.notices = [], $.agent.eventsHasMore = !1, $.agent.historyBeforeId = 0, $.agent.loadingOlder = !1, $.agent.optionsOpen = !1, $.agent.agentChooserOpen = !1, $.agent.historyOpen = !1, Ld(), Vd.reset(), $.messageStatus = null, $.messageStatusKey = "", $.messageStatusRequestVersion++, $.steeringMessageId = "", $.agent.toolGroupOpen.clear(), $.agent.approvalDrafts.clear(), $.agent.renderDeferredForSelection = !1, Mp();
}
function kp() {
...
function Ap(e, t, n) {
	...
	[
		...
		"approval.requested",
		"approval.resolved"
	].includes(n.type) && Tp().then(Bf).catch((e) => console.warn("agent refresh failed", e));
}
function jp(e, t, n) {}
function Mp() {
...
function Np(e) {
	let t = (e || []).filter((e) => !Yd.has(e?.type)), n = jd(t), r = new Map(t.map((e) => [Number(e.id), e]));
	for (let e of n) {
...
function Pp(e) {
	if (!e) return "";
	let t = [Fp(e.providerId)];
	return e.options?.model && t.push(e.options.model), t.filter(Boolean).join(" · ");
}
function Fp(e) {
	return ($.config?.agentHubProviders || mf.providers()).find((t) => t.id === e)?.name || e || "Provider";
}
function Ip(e) {
...
function Bp(e = {}) {
	...
	let t = $p();
	$.activeWorkspaceId && t && zd(t);
	let n = Vd.active("turn-stop") && Vd.key("turn-stop") === t, r = $.messageStatusKey === `${$.activeWorkspaceId}:${t}` ? $.messageStatus : null, i = $.activeWorkspaceId;
	Md.renderComposer({
		...
		sending: Vd.isSending(Rp($.activeWorkspaceId, t)),
		...
		onSend: Qp,
		onOpenUpload: Wp,
		onEndTurn: () => Yp().catch((e) => Tm(e.message)),
		onSteerWaiting: Ep,
		onSaveAgentBinding: async (e) => {
			if (t === $p()) {
				zp = t, Bp();
				try {
					await Ef(`/api/workspaces/${encodeURIComponent(i)}/resources/${encodeURIComponent(t)}/agent-binding`, {
						method: "PUT",
						body: JSON.stringify(e)
					}), await Of({ updateURL: !1 }), t !== "workspace" && await kf(t, { force: !0 }), Bf(), Tm("Resource agent binding saved.");
				} catch (e) {
					Tm(cu(e));
				} finally {
					zp = "", Bp();
...
function Up(e, t) {
	!t || t.workspaceId !== $.activeWorkspaceId || t.resourceId !== $p() || t.draftKey !== $.agent.ttyDraftKey || Bd(e);
}
function Wp() {
	let e = $p();
	...
	let t = Kd("ttyInput");
	t && Bd(t.value), $.modalEnter = "upload", $.uploadDialog = {
		open: !0,
		identity: ++pf,
		resourceId: e,
		items: [],
...
function Gp(e = [], t = {}) {
	...
	i && (Bd(qp($.agent.ttyDraft, e)), $.agent.ttyDraftResetVersion++), Kp();
	let a = Kd("ttyComposer");
	a && delete a.dataset.composerKey, Bp({ skipDraftSync: i }), Kd("ttyInput")?.focus({ preventScroll: !0 }), Em();
}
function Kp() {
	$.uploadDialog = {
		open: !1,
...
async function Yp() {
	let e = $.activeWorkspaceId, t = $p(), n = $.messageStatus?.generation?.generationId || "", r = Vd.begin("turn-stop", t);
	if (r) try {
		let r = n ? `?generationId=${encodeURIComponent(n)}` : "";
		await Ef(`/api/workspaces/${encodeURIComponent(e)}/resources/${encodeURIComponent(t)}/turn/end${r}`, { method: "POST" }), await Tp(e, t), Bf();
	} finally {
		Vd.finish(r);
	}
}
async function Xp(e, t, n) {
	...
	await Ef(`/api/workspaces/${encodeURIComponent(r)}/resources/${encodeURIComponent(i)}/approval?generationId=${encodeURIComponent(e)}`, {
		method: "POST",
		body: JSON.stringify({
			requestId: t,
			...n
...
async function Qp(e, t) {
	...
	let n = Rp(t.workspaceId, t.resourceId);
	if (!Vd.startSending(n)) return {
		accepted: !1,
		clear: !1
	};
	let r = $.agent.ttyDraftVersion;
	try {
		await Ef(`/api/workspaces/${encodeURIComponent(t.workspaceId)}/resources/${encodeURIComponent(t.resourceId)}/messages`, {
			method: "POST",
			body: JSON.stringify({
				text: e,
				role: "user",
		...
		return n && $.agent.ttyDraftResetVersion++, await Promise.all([Tp(t.workspaceId, t.resourceId), Cp()]), Bf(), {
			accepted: !0,
			clear: n
		};
	} finally {
...
async function om(e) {
	confirm(`Archive ${e}?`) && (await Ef(`/api/workspaces/${$.activeWorkspaceId}/archive`, {
		method: "POST",
		body: JSON.stringify({ resourceId: e })
	}), Tm("Archived."), $.selectedId = "workspace", await Of());
}
function sm(e) {
	if (!$.tree) return null;
...
function dm(e = !1) {
	let t = lm($.selectedId);
	!t || t.id === $.selectedId || $.expandedProjects.has(t.id) || ($.expandedProjects.add(t.id), e && Lf().catch((e) => Tm(e.message)));
}
...
function mm(e = {}) {
	Ud.project($.activeWorkspaceId, $.selectedId, e);
}
function hm() {
...
function ym() {
	let e = vm();
	return bm($.config?.agentProfiles, "default") || bm(mf.profiles(), "default") || e[0]?.id || "";
}
function bm(e, t) {
...
function Sm(e, t) {
	return mf.withAgentHubCatalog(e, t);
}
function Cm(e, t) {
...
function Em() {
	let e = window.lucide;
	!e || $.iconRefreshScheduled || ($.iconRefreshScheduled = !0, Nd?.animationFrame(() => {
		$.iconRefreshScheduled = !1, e.createIcons({ attrs: { "stroke-width": 2 } });
	}));
}
function Dm(e) {
	Em(), e === "markdown" && window.marked && window.DOMPurify && (lp(), Em()), e === "diff" && lp();
}
...
function Mm(e) {
	Hd.setMobileSidebar(e);
}
function Nm(e) {
	Hd.setMobileView(e);
}
function Pm(e) {
	Hd.setMobileImmersive(e);
}
function Fm() {
	Nd?.listen(document, "selectionchange", () => {
		if (!$.agent.renderDeferredForSelection) return;
		let e = Kd("ttyLog");
		e && Ip(e) || ($.agent.renderDeferredForSelection = !1, Lp(), Em());
	}), Nd?.listen(document, "keydown", (e) => {
		e.key === "Escape" && $.diff ? _p() : e.key === "Escape" && $.preview ? gp() : e.key === "Escape" && ($.agent.optionsOpen || $.agent.agentChooserOpen || $.agent.historyOpen) && ($.agent.optionsOpen = !1, $.agent.agentChooserOpen = !1, $.agent.historyOpen = !1, Bp(), Em());
	}), Nd?.listen(document, "click", (e) => {
		let t = e.target instanceof Element ? e.target : null, n = t?.closest("[data-breadcrumb-resource]");
		if (n) {
			up(n.dataset.breadcrumbResource || "workspace").catch((e) => Tm(cu(e)));
			return;
		}
		...
		(r || i) && ($.agent.optionsOpen = !1, $.agent.agentChooserOpen = !1, $.agent.historyOpen = !1, Bp(), Em()), $.sessionMenu && (t?.closest(".session-row") || t?.closest(".session-resource-menu") || ($.sessionMenu = null, tp(), Em()));
	}), Nd?.listen(window, "beforeunload", Rm), Nd?.listen(document, "visibilitychange", () => {
...
function Lm(e) {
	...
	Nd = t, _f = Au({
		...
		hasTree: () => !!$.tree,
		findResource: sm,
		sessionNavigationTarget: ip,
		selectResource: $f,
		activateRun: (e) => {
			let t = $.agent.runs.find((t) => t.id === e);
			t && ($.agent.activeRunId = t.id, Lp(), Em());
		},
		notificationsSettingsVisible: () => mf.isOpenTab("notifications"),
		renderSettings: Hp,
		renderSessions: tp,
		refreshIcons: Em,
		flushDraft: Rm
	}), vf = ud(t, () => {
		mf.isOpenTab("user") && Hp();
	}), Fm(), Om(), _f.install(), Xf(), Df().catch((e) => {
		$.navigationLoading = !1, $.navigationError = e.message, Tm(e.message), Bf();
	}), Rf();
}
function Rm() {
	Rd();
...
function zm() {
	Im && (Rm(), Im = !1, kp(), _f?.dispose(), _f = null, vf = null, Vd.reset(), Mp(), Gd.dispose(), Nd?.dispose(), Nd = null, $.autoRefreshTimer = null);
}
async function Bm(e) {
	let t = fm(e);
	if (!pm(t.workspaceId)) {
	...
	Rd(), $.navigationVersion++, $.autoRefreshVersion++, $.treeRequestVersion++, $.detailRequestVersion++, $.workspaceAgentsRequestVersion++, $.previewRequestVersion++, $.diffRequestVersion++, $.workspaceAgentsSaving = !1;
	let i = $.navigationVersion;
	if ($.activeWorkspaceId = t.workspaceId || "", $.selectedId = t.resourceId || "workspace", !n && r !== $.selectedId && $.selectedId !== "workspace" && (jf($.selectedId), delete $.details[$.selectedId]), $.preview = null, $.diff = null, $.sessionMenu = null, n && ($.tree = null, $.navigationLoading = !0, $.navigationError = "", pp(), $.workspaceAgentsSaving = !1, im(), yf($.activeWorkspaceId)), n && Op(), Kf(), n) {
		if (!await If(t.workspaceId || "", i)) return;
		!t.resourceId && $.lastResourceId && ($.selectedId = $.lastResourceId), await Of({ updateURL: !1 }), Hf(t.workspaceId || "", i) && mm({ replace: !0 });
	} else {
		let e = cm();
		if ($.selectedId === "workspace" ? await Ff() : (dm(!1), await kf($.selectedId)), !Hf(t.workspaceId || "", i)) return;
		r !== $.selectedId && await Dp(), Bf(), e && mm({ replace: !0 });
	}
}
//#endregion
//#region src/entry.ts
...
async function Wm() {
	...
	e.dataset.componentOwner = "app-shell", Um = jr(Jl, {
		target: e,
		props: { channels: Vm }
	}), Lm(Hm);
}
async function Gm() {
	if (zm(), !Um) return;
	let e = Um;
	Um = null, await Fr(e), document.getElementById("app")?.removeAttribute("data-component-owner");
}
