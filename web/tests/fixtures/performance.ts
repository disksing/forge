...
export function largeTreeModel(): AppShellModel {
  ...
  return {
    ...
    projects, treeEditing: false, activity: { running: [], favorites: [], unread: [], problems: [] }, inbox: [], doctor: { checking: false, complete: true, summary: { errors: 0, warnings: 0 }, workspaces: [] }, paneSizes: { sidebarWidth: 280, chatWidth: 420, sidebarAttentionHeight: 210 },
