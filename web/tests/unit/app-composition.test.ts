...
describe("application composition", () => {
  ...
  it("composes every published channel under ForgeApp", () => {
    ...
    for (const component of ["AppShell", "DetailPanel", "SelfDrivingBar", "SessionSwitcher", "EventTimeline", "ChatComposer", "Toast", "UploadDialog", "CreateDialog", "SelfDrivingDialog", "SettingsModal"]) {
