...
import { ChatSessionController, compactTimelineEvents, mergeCanonicalEvents } from "../../src/components/chat-state";
...
describe("ChatSessionController", () => {
  ...
  it("compacts consecutive cumulative ACP tool updates without crossing timeline boundaries", () => {
    const update = (id: number, callId: string, text: string): AgentEvent => ({
